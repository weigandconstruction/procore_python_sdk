...
class TestBody130BimModelRevisionOneOf2(unittest.TestCase):
    """Body130BimModelRevisionOneOf2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Body130BimModelRevisionOneOf2:
        """Test Body130BimModelRevisionOneOf2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body130BimModelRevisionOneOf2`
        """
        model = Body130BimModelRevisionOneOf2()
        if include_optional:
            return Body130BimModelRevisionOneOf2(
                bim_file_id = 123,
                bim_model_id = 456,
    ...
    def testBody130BimModelRevisionOneOf2(self):
        """Test Body130BimModelRevisionOneOf2"""
