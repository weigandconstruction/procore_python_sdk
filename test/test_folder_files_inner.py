...
class TestFolderFilesInner(unittest.TestCase):
    """FolderFilesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderFilesInner:
        """Test FolderFilesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderFilesInner`
        """
        model = FolderFilesInner()
        if include_optional:
            return FolderFilesInner(
                id = 12,
                name = 'file.pdf',
                parent_id = 1,
                size = 54332,
                ...
                private = False,
                is_tracked = False,
                tracked_folder = procore_sdk.models.tracked_folder.tracked_folder(),
