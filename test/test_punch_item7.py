...
class TestPunchItem7(unittest.TestCase):
    """PunchItem7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem7:
        """Test PunchItem7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem7`
        """
        model = PunchItem7()
        if include_optional:
            return PunchItem7(
