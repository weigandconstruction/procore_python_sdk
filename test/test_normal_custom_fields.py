...
class TestNormalCustomFields(unittest.TestCase):
    """NormalCustomFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NormalCustomFields:
        """Test NormalCustomFields
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormalCustomFields`
        """
        model = NormalCustomFields()
        if include_optional:
            return NormalCustomFields(
    ...
    def testNormalCustomFields(self):
        """Test NormalCustomFields"""
