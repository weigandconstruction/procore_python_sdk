...
class TestBidFormBaseBidSection(unittest.TestCase):
    """BidFormBaseBidSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BidFormBaseBidSection:
        """Test BidFormBaseBidSection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BidFormBaseBidSection`
        """
        model = BidFormBaseBidSection()
        if include_optional:
            return BidFormBaseBidSection(
                id = 75414,
                title = 'Concrete',
                position = 1,
                section_totals = [
    ...
    def testBidFormBaseBidSection(self):
        """Test BidFormBaseBidSection"""
