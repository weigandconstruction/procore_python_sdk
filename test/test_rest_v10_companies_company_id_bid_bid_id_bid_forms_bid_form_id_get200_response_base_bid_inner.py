...
class TestRestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner(unittest.TestCase):
    """RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner:
        """Test RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner`
        """
        model = RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner()
        if include_optional:
            return RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner(
                id = 1234,
                title = 'Concrete',
                position = 1,
                header = True,
    ...
    def testRestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner(self):
        """Test RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner"""
