...
class TestRestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner(unittest.TestCase):
    """RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner:
        """Test RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner`
        """
        model = RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner()
        if include_optional:
            return RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner(
                id = 352362,
                amount = '',
    ...
    def testRestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner(self):
        """Test RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner"""
