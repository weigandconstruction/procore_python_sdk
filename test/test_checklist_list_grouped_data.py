...
class TestChecklistListGroupedData(unittest.TestCase):
    """ChecklistListGroupedData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistListGroupedData:
        """Test ChecklistListGroupedData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistListGroupedData`
        """
        model = ChecklistListGroupedData()
        if include_optional:
            return ChecklistListGroupedData(
                id = 42,
                ...
                default_response_phrasing = procore_sdk.models.checklist_5_default_response_phrasing.Checklist_5_default_response_phrasing(
                ...
                closed_by = procore_sdk.models.punch_item_6_created_by.Punch_Item_6_created_by(
                    id = 1738090, 
                    name = 'John Doe', 
                    login = 'johndoe@example.com', ),
                responsible_contractor = procore_sdk.models.checklist_list_grouped_data_responsible_contractor.Checklist_List_Grouped_Data_responsible_contractor(
                    id = 1, 
                    name = 'Freddie's Excavating', ),
                point_of_contact = procore_sdk.models.punch_item_6_created_by.Punch_Item_6_created_by(
                    id = 1738090, 
                    name = 'John Doe', 
                    login = 'johndoe@example.com', ),
                ...
                specification_section = procore_sdk.models.checklist_5_specification_section.Checklist_5_specification_section(
                    id = 1, 
                    description = 'Vinyl Windows', 
                    section = '08560', 
                    latest_revision_url = 'link_to_pdf', ),
                permissions = procore_sdk.models.checklist_list_grouped_data_permissions.Checklist_List_Grouped_Data_permissions(
                    can_edit = True, ),
    ...
    def testChecklistListGroupedData(self):
        """Test ChecklistListGroupedData"""
