...
class TestPunchItemBody6(unittest.TestCase):
    """PunchItemBody6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItemBody6:
        """Test PunchItemBody6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItemBody6`
        """
        model = PunchItemBody6()
        if include_optional:
            return PunchItemBody6(
                project_id = 56,
