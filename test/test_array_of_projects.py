...
class TestArrayOfProjects(unittest.TestCase):
    """ArrayOfProjects unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayOfProjects:
        """Test ArrayOfProjects
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayOfProjects`
        """
        model = ArrayOfProjects()
        if include_optional:
            return ArrayOfProjects(
                entities = [
                    procore_sdk.models.project.Project(
                        id = 89025, 
                ...
                errors = [
                    procore_sdk.models.array_of_projects_errors_inner.arrayOfProjects_errors_inner()
                    ]
            )
        else:
            return ArrayOfProjects(
