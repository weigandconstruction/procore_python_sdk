...
class TestTimesheetEntries1(unittest.TestCase):
    """TimesheetEntries1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimesheetEntries1:
        """Test TimesheetEntries1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimesheetEntries1`
        """
        model = TimesheetEntries1()
        if include_optional:
            return TimesheetEntries1(
                id = 1,
    ...
    def testTimesheetEntries1(self):
        """Test TimesheetEntries1"""
