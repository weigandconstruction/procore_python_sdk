...
class TestRestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner(unittest.TestCase):
    """RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner:
        """Test RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner`
        """
        model = RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner()
        if include_optional:
            return RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner(
                id = 333675,
                created_at = '2012-10-23T21:39:40Z',
                comments = 'Delivered on Time',
                contents = 'Delivery Content',
    ...
    def testRestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner(self):
        """Test RestV10ProjectsProjectIdDeliveryLogsGet200ResponseInner"""
