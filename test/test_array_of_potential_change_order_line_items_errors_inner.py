...
class TestArrayOfPotentialChangeOrderLineItemsErrorsInner(unittest.TestCase):
    """ArrayOfPotentialChangeOrderLineItemsErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayOfPotentialChangeOrderLineItemsErrorsInner:
        """Test ArrayOfPotentialChangeOrderLineItemsErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayOfPotentialChangeOrderLineItemsErrorsInner`
        """
        model = ArrayOfPotentialChangeOrderLineItemsErrorsInner()
        if include_optional:
            return ArrayOfPotentialChangeOrderLineItemsErrorsInner(
                id = 4896147,
                amount = '1000.0',
    ...
    def testArrayOfPotentialChangeOrderLineItemsErrorsInner(self):
        """Test ArrayOfPotentialChangeOrderLineItemsErrorsInner"""
