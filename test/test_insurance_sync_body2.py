...
class TestInsuranceSyncBody2(unittest.TestCase):
    """InsuranceSyncBody2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsuranceSyncBody2:
        """Test InsuranceSyncBody2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsuranceSyncBody2`
        """
        model = InsuranceSyncBody2()
        if include_optional:
            return InsuranceSyncBody2(
                updates = [
    ...
    def testInsuranceSyncBody2(self):
        """Test InsuranceSyncBody2"""
