...
class TestChecklistSignature(unittest.TestCase):
    """ChecklistSignature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistSignature:
        """Test ChecklistSignature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistSignature`
        """
    ...
    def testChecklistSignature(self):
        """Test ChecklistSignature"""
