...
class TestRestV10RfqsPostRequest(unittest.TestCase):
    """RestV10RfqsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10RfqsPostRequest:
        """Test RestV10RfqsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10RfqsPostRequest`
        """
        model = RestV10RfqsPostRequest()
        if include_optional:
            return RestV10RfqsPostRequest(
                project_id = 585355,
                contract_id = 423400,
    ...
    def testRestV10RfqsPostRequest(self):
        """Test RestV10RfqsPostRequest"""
