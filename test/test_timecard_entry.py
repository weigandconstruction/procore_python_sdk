...
class TestTimecardEntry(unittest.TestCase):
    """TimecardEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimecardEntry:
        """Test TimecardEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimecardEntry`
        """
        model = TimecardEntry()
        if include_optional:
