...
class TestManagedEquipmentType(unittest.TestCase):
    """ManagedEquipmentType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedEquipmentType:
        """Test ManagedEquipmentType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedEquipmentType`
        """
        model = ManagedEquipmentType()
        if include_optional:
            return ManagedEquipmentType(
                id = 75414,
                name = 'Backhoe',
    ...
    def testManagedEquipmentType(self):
        """Test ManagedEquipmentType"""
