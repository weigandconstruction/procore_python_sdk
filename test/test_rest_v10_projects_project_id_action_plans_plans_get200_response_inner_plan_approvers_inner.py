...
class TestRestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner(unittest.TestCase):
    """RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner:
        """Test RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner`
        """
        model = RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner()
        if include_optional:
            return RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner(
                id = 12,
                plan_id = 54,
    ...
    def testRestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner(self):
        """Test RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner"""
