...
class TestExtended6(unittest.TestCase):
    """Extended6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Extended6:
        """Test Extended6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Extended6`
        """
        model = Extended6()
        if include_optional:
            return Extended6(
