...
class TestCompanyUser4(unittest.TestCase):
    """CompanyUser4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUser4:
        """Test CompanyUser4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUser4`
        """
        model = CompanyUser4()
        if include_optional:
            return CompanyUser4(
