...
class TestRestV10ProjectsProjectIdDirectCostsPost201Response(unittest.TestCase):
    """RestV10ProjectsProjectIdDirectCostsPost201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdDirectCostsPost201Response:
        """Test RestV10ProjectsProjectIdDirectCostsPost201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdDirectCostsPost201Response`
        """
        model = RestV10ProjectsProjectIdDirectCostsPost201Response()
        if include_optional:
            return RestV10ProjectsProjectIdDirectCostsPost201Response(
                id = 3,
                attachments = [
    ...
    def testRestV10ProjectsProjectIdDirectCostsPost201Response(self):
        """Test RestV10ProjectsProjectIdDirectCostsPost201Response"""
