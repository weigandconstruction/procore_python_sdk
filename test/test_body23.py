...
class TestBody23(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body23:
        """Test Body23
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body23`
        """
        model = Body23()
        if include_optional:
            return Body23(
                requisition_contract_item = procore_sdk.models.requisition_contract_item.RequisitionContractItem(
