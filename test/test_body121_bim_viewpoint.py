...
class TestBody121BimViewpoint(unittest.TestCase):
    """Body121BimViewpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Body121BimViewpoint:
        """Test Body121BimViewpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body121BimViewpoint`
        """
        model = Body121BimViewpoint()
        if include_optional:
            return Body121BimViewpoint(
                bim_file_id = 56,
                name = 'Ceiling view',
                view_folder_id = 56,
    ...
    def testBody121BimViewpoint(self):
        """Test Body121BimViewpoint"""
