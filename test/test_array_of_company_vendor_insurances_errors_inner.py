...
class TestArrayOfCompanyVendorInsurancesErrorsInner(unittest.TestCase):
    """ArrayOfCompanyVendorInsurancesErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayOfCompanyVendorInsurancesErrorsInner:
        """Test ArrayOfCompanyVendorInsurancesErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayOfCompanyVendorInsurancesErrorsInner`
        """
        model = ArrayOfCompanyVendorInsurancesErrorsInner()
        if include_optional:
            return ArrayOfCompanyVendorInsurancesErrorsInner(
                id = 311823,
    ...
    def testArrayOfCompanyVendorInsurancesErrorsInner(self):
        """Test ArrayOfCompanyVendorInsurancesErrorsInner"""
