...
class TestInsuranceSyncBody(unittest.TestCase):
    """InsuranceSyncBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsuranceSyncBody:
        """Test InsuranceSyncBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsuranceSyncBody`
        """
        model = InsuranceSyncBody()
        if include_optional:
            return InsuranceSyncBody(
                updates = [
    ...
    def testInsuranceSyncBody(self):
        """Test InsuranceSyncBody"""
