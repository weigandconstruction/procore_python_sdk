...
class TestRestV10BimViewpointsPost201ResponseOneOf1(unittest.TestCase):
    """RestV10BimViewpointsPost201ResponseOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10BimViewpointsPost201ResponseOneOf1:
        """Test RestV10BimViewpointsPost201ResponseOneOf1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10BimViewpointsPost201ResponseOneOf1`
        """
        model = RestV10BimViewpointsPost201ResponseOneOf1()
        if include_optional:
            return RestV10BimViewpointsPost201ResponseOneOf1(
                id = 206,
                bim_file_id = 809,
                view_folder_id = 316,
    ...
    def testRestV10BimViewpointsPost201ResponseOneOf1(self):
        """Test RestV10BimViewpointsPost201ResponseOneOf1"""
