...
class TestRFIBody1Rfi(unittest.TestCase):
    """RFIBody1Rfi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFIBody1Rfi:
        """Test RFIBody1Rfi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFIBody1Rfi`
        """
        model = RFIBody1Rfi()
        if include_optional:
            return RFIBody1Rfi(
                ...
                cost_code_id = 123,
                rfi_manager_id = 1,
                question = procore_sdk.models.rfi_body_1_rfi_question.RFI_Body_1_rfi_question(
