...
class TestChecklistSectionItem(unittest.TestCase):
    """ChecklistSectionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistSectionItem:
        """Test ChecklistSectionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistSectionItem`
        """
        model = ChecklistSectionItem()
        if include_optional:
            return ChecklistSectionItem(
                id = 2,
                name = 'Item 1',
                details = '+/- 1 degrees',
                status = 'yes',
    ...
    def testChecklistSectionItem(self):
        """Test ChecklistSectionItem"""
