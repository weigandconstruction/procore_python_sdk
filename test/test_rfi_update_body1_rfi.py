...
class TestRFIUpdateBody1Rfi(unittest.TestCase):
    """RFIUpdateBody1Rfi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFIUpdateBody1Rfi:
        """Test RFIUpdateBody1Rfi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFIUpdateBody1Rfi`
        """
        model = RFIUpdateBody1Rfi()
        if include_optional:
            return RFIUpdateBody1Rfi(
                subject = 'Wall Color',
                ...
                cost_code_id = 123,
                rfi_manager_id = 123,
                question = procore_sdk.models.rfi_update_body_1_rfi_question.RFI_Update_Body_1_rfi_question(
    ...
    def testRFIUpdateBody1Rfi(self):
        """Test RFIUpdateBody1Rfi"""
