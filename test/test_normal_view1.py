...
class TestNormalView1(unittest.TestCase):
    """NormalView1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NormalView1:
        """Test NormalView1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormalView1`
        """
        model = NormalView1()
        if include_optional:
            return NormalView1(
