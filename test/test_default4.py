...
class TestDefault4(unittest.TestCase):
    """Default4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Default4:
        """Test Default4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Default4`
        """
        model = Default4()
        if include_optional:
            return Default4(
