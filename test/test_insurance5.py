...
class TestInsurance5(unittest.TestCase):
    """Insurance5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Insurance5:
        """Test Insurance5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Insurance5`
        """
        model = Insurance5()
        if include_optional:
            return Insurance5(
