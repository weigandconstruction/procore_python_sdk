...
class TestTimecardEntry8(unittest.TestCase):
    """TimecardEntry8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimecardEntry8:
        """Test TimecardEntry8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimecardEntry8`
        """
        model = TimecardEntry8()
        if include_optional:
            return TimecardEntry8(
                id = 1,
                billable = True,
