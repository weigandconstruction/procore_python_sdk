...
class TestTimesheet2(unittest.TestCase):
    """Timesheet2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Timesheet2:
        """Test Timesheet2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Timesheet2`
        """
        model = Timesheet2()
        if include_optional:
            return Timesheet2(
