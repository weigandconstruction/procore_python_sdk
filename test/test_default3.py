...
class TestDefault3(unittest.TestCase):
    """Default3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Default3:
        """Test Default3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Default3`
        """
        model = Default3()
        if include_optional:
            return Default3(
