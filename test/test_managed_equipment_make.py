...
class TestManagedEquipmentMake(unittest.TestCase):
    """ManagedEquipmentMake unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedEquipmentMake:
        """Test ManagedEquipmentMake
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedEquipmentMake`
        """
        model = ManagedEquipmentMake()
        if include_optional:
            return ManagedEquipmentMake(
                id = 75414,
                name = 'CAT',
                company_id = 3355,
                is_active = True,
    ...
    def testManagedEquipmentMake(self):
        """Test ManagedEquipmentMake"""
