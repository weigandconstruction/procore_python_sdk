...
class TestRestV10MeetingsPost201ResponseMeetingCategoriesInner(unittest.TestCase):
    """RestV10MeetingsPost201ResponseMeetingCategoriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10MeetingsPost201ResponseMeetingCategoriesInner:
        """Test RestV10MeetingsPost201ResponseMeetingCategoriesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10MeetingsPost201ResponseMeetingCategoriesInner`
        """
        model = RestV10MeetingsPost201ResponseMeetingCategoriesInner()
        if include_optional:
            return RestV10MeetingsPost201ResponseMeetingCategoriesInner(
                id = 192424,
    ...
    def testRestV10MeetingsPost201ResponseMeetingCategoriesInner(self):
        """Test RestV10MeetingsPost201ResponseMeetingCategoriesInner"""
