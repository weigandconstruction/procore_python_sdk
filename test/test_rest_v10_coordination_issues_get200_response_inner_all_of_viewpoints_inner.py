...
class TestRestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner(unittest.TestCase):
    """RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner:
        """Test RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner`
        """
        model = RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner()
        if include_optional:
            return RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner(
                id = 206,
                bim_file_id = 809,
                view_folder_id = 316,
    ...
    def testRestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner(self):
        """Test RestV10CoordinationIssuesGet200ResponseInnerAllOfViewpointsInner"""
