...
class TestRestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner(unittest.TestCase):
    """RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner:
        """Test RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner`
        """
        model = RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner()
        if include_optional:
            return RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner(
                id = 29,
                communication_id = 2,
                private = True,
                attachments = [
    ...
    def testRestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner(self):
        """Test RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner"""
