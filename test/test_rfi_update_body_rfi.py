...
class TestRFIUpdateBodyRfi(unittest.TestCase):
    """RFIUpdateBodyRfi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFIUpdateBodyRfi:
        """Test RFIUpdateBodyRfi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFIUpdateBodyRfi`
        """
        model = RFIUpdateBodyRfi()
        if include_optional:
            return RFIUpdateBodyRfi(
                subject = 'Wall Color',
