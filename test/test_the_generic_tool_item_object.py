...
class TestTheGenericToolItemObject(unittest.TestCase):
    """TheGenericToolItemObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TheGenericToolItemObject:
        """Test TheGenericToolItemObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TheGenericToolItemObject`
        """
        model = TheGenericToolItemObject()
        if include_optional:
            return TheGenericToolItemObject(
    ...
    def testTheGenericToolItemObject(self):
        """Test TheGenericToolItemObject"""
