...
class TestPunchItem9(unittest.TestCase):
    """PunchItem9 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem9:
        """Test PunchItem9
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem9`
        """
        model = PunchItem9()
        if include_optional:
            return PunchItem9(
