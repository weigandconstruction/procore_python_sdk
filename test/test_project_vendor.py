...
class TestProjectVendor(unittest.TestCase):
    """ProjectVendor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectVendor:
        """Test ProjectVendor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectVendor`
        """
        model = ProjectVendor()
        if include_optional:
