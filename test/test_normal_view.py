...
class TestNormalView(unittest.TestCase):
    """NormalView unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NormalView:
        """Test NormalView
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NormalView`
        """
        model = NormalView()
        if include_optional:
            return NormalView(
