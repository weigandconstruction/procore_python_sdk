...
class TestRestV10ProjectsProjectIdIncidentsPostRequest(unittest.TestCase):
    """RestV10ProjectsProjectIdIncidentsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdIncidentsPostRequest:
        """Test RestV10ProjectsProjectIdIncidentsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdIncidentsPostRequest`
        """
        model = RestV10ProjectsProjectIdIncidentsPostRequest()
        if include_optional:
            return RestV10ProjectsProjectIdIncidentsPostRequest(
                incident = procore_sdk.models.rest_v10_projects_project_id_incidents_post_request_incident.RestV10ProjectsProjectIdIncidentsPost_request_incident(
    ...
    def testRestV10ProjectsProjectIdIncidentsPostRequest(self):
        """Test RestV10ProjectsProjectIdIncidentsPostRequest"""
