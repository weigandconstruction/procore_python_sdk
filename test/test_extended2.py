...
class TestExtended2(unittest.TestCase):
    """Extended2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Extended2:
        """Test Extended2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Extended2`
        """
        model = Extended2()
        if include_optional:
            return Extended2(
