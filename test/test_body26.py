...
class TestBody26(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body26:
        """Test Body26
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body26`
        """
        model = Body26()
        if include_optional:
            return Body26(
                ...
                purchase_order_contract = procore_sdk.models.purchase_order_contract.Purchase Order Contract(
