...
class TestCompanyUser3(unittest.TestCase):
    """CompanyUser3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUser3:
        """Test CompanyUser3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUser3`
        """
        model = CompanyUser3()
        if include_optional:
            return CompanyUser3(
