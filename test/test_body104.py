...
class TestBody104(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body104:
        """Test Body104
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body104`
        """
        model = Body104()
        if include_optional:
            return Body104(
                project_id = 12345,
                coordination_issue = procore_sdk.models.body_104_coordination_issue.Body_104_coordination_issue(
