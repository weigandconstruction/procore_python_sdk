...
class TestRestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner(unittest.TestCase):
    """RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner:
        """Test RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner`
        """
        model = RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner()
        if include_optional:
            return RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner(
                id = 54,
                plan_id = 54,
    ...
    def testRestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner(self):
        """Test RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner"""
