...
class TestPunchItemBody4(unittest.TestCase):
    """PunchItemBody4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItemBody4:
        """Test PunchItemBody4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItemBody4`
        """
        model = PunchItemBody4()
        if include_optional:
            return PunchItemBody4(
                project_id = 56,
