...
class TestPunchItem2(unittest.TestCase):
    """PunchItem2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem2:
        """Test PunchItem2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem2`
        """
        model = PunchItem2()
        if include_optional:
            return PunchItem2(
