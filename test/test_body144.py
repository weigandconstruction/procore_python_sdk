...
class TestBody144(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body144:
        """Test Body144
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body144`
        """
        model = Body144()
        if include_optional:
            return Body144(
                title = 'Concrete',
                base_bid = [
                    procore_sdk.models.body_144_base_bid_inner.Body_144_base_bid_inner(
                        title = 'Concrete', 
                        position = 1, 
                        header = True, 
                        bid_form_items = [
                ...
                alternates = [
                    procore_sdk.models.body_144_alternates_inner.Body_144_alternates_inner(
                        title = 'Flooring', 
                        position = 1, 
                        header = True, 
                        bid_form_items = [
