...
class TestBody106(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body106:
        """Test Body106
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body106`
        """
        model = Body106()
        if include_optional:
            return Body106(
                project_id = 12345,
                updates = [
                    procore_sdk.models.body_104_coordination_issue.Body_104_coordination_issue(
