...
class TestBody143(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body143:
        """Test Body143
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body143`
        """
        model = Body143()
        if include_optional:
            return Body143(
                title = 'Concrete',
                base_bid = [
                    procore_sdk.models.body_143_base_bid_inner.Body_143_base_bid_inner(
                        title = 'Concrete', 
                        position = 1, 
                        header = True, 
                        bid_form_items = [
                ...
                alternates = [
                    procore_sdk.models.body_143_alternates_inner.Body_143_alternates_inner(
                        title = 'Flooring', 
                        position = 1, 
                        header = True, 
                        bid_form_items = [
