...
class TestRFIBodyRfi(unittest.TestCase):
    """RFIBodyRfi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFIBodyRfi:
        """Test RFIBodyRfi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFIBodyRfi`
        """
        model = RFIBodyRfi()
        if include_optional:
            return RFIBodyRfi(
