...
class TestManagedEquipment(unittest.TestCase):
    """ManagedEquipment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedEquipment:
        """Test ManagedEquipment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedEquipment`
        """
        model = ManagedEquipment()
        if include_optional:
