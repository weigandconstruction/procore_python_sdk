...
class TestDrawingUpload(unittest.TestCase):
    """DrawingUpload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrawingUpload:
        """Test DrawingUpload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrawingUpload`
        """
        model = DrawingUpload()
        if include_optional:
            return DrawingUpload(
                ...
                language = 'es',
                drawing_log_imports = [
                    procore_sdk.models.drawing_log_import.DrawingLogImport(
                        id = 85, 
