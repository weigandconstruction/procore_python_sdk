...
class TestProjectVendor1(unittest.TestCase):
    """ProjectVendor1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectVendor1:
        """Test ProjectVendor1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectVendor1`
        """
        model = ProjectVendor1()
        if include_optional:
            return ProjectVendor1(
                abbreviated_name = 'PE',
