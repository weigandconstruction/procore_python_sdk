...
class TestArrayOfChangeOrderRequestsEntitiesInner(unittest.TestCase):
    """ArrayOfChangeOrderRequestsEntitiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayOfChangeOrderRequestsEntitiesInner:
        """Test ArrayOfChangeOrderRequestsEntitiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayOfChangeOrderRequestsEntitiesInner`
        """
        model = ArrayOfChangeOrderRequestsEntitiesInner()
        if include_optional:
            return ArrayOfChangeOrderRequestsEntitiesInner(
                id = 3284756,
    ...
    def testArrayOfChangeOrderRequestsEntitiesInner(self):
        """Test ArrayOfChangeOrderRequestsEntitiesInner"""
