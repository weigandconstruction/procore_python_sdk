...
class TestPunchItem1(unittest.TestCase):
    """PunchItem1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem1:
        """Test PunchItem1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem1`
        """
        model = PunchItem1()
        if include_optional:
            return PunchItem1(
