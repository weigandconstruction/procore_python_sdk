...
class TestRequisitionSubcontractorInvoice1(unittest.TestCase):
    """RequisitionSubcontractorInvoice1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequisitionSubcontractorInvoice1:
        """Test RequisitionSubcontractorInvoice1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequisitionSubcontractorInvoice1`
        """
        model = RequisitionSubcontractorInvoice1()
        if include_optional:
            return RequisitionSubcontractorInvoice1(
                items = [
    ...
    def testRequisitionSubcontractorInvoice1(self):
        """Test RequisitionSubcontractorInvoice1"""
