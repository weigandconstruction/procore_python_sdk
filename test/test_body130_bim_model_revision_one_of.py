...
class TestBody130BimModelRevisionOneOf(unittest.TestCase):
    """Body130BimModelRevisionOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Body130BimModelRevisionOneOf:
        """Test Body130BimModelRevisionOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body130BimModelRevisionOneOf`
        """
        model = Body130BimModelRevisionOneOf()
        if include_optional:
            return Body130BimModelRevisionOneOf(
                bim_file_id = 123,
                bim_model_id = 456,
    ...
    def testBody130BimModelRevisionOneOf(self):
        """Test Body130BimModelRevisionOneOf"""
