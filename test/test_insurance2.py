...
class TestInsurance2(unittest.TestCase):
    """Insurance2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Insurance2:
        """Test Insurance2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Insurance2`
        """
        model = Insurance2()
        if include_optional:
            return Insurance2(
