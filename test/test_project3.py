...
class TestProject3(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Project3:
        """Test Project3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Project3`
        """
        model = Project3()
        if include_optional:
            return Project3(
                ...
                photo_id = 1,
                inbound_email = 'user',
                inbound_email_address = 'user@example.com',
