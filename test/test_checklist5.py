...
class TestChecklist5(unittest.TestCase):
    """Checklist5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Checklist5:
        """Test Checklist5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Checklist5`
        """
        model = Checklist5()
        if include_optional:
            return Checklist5(
