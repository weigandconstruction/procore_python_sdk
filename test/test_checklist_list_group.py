...
class TestChecklistListGroup(unittest.TestCase):
    """ChecklistListGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistListGroup:
        """Test ChecklistListGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistListGroup`
        """
        model = ChecklistListGroup()
        if include_optional:
            return ChecklistListGroup(
                header = procore_sdk.models.checklist_list_group_header.Checklist_List_Group_header(
                    id = 42, 
                    name = 'Window Inspection', ),
                data = [
                    procore_sdk.models.checklist_list_grouped_data.Checklist List Grouped Data(
                        id = 42, 
                        name = 'Window Inspection', 
                        list_template_id = 1, 
    ...
    def testChecklistListGroup(self):
        """Test ChecklistListGroup"""
