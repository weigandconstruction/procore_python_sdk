...
class TestBody104CoordinationIssueViewpointsInner(unittest.TestCase):
    """Body104CoordinationIssueViewpointsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Body104CoordinationIssueViewpointsInner:
        """Test Body104CoordinationIssueViewpointsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body104CoordinationIssueViewpointsInner`
        """
        model = Body104CoordinationIssueViewpointsInner()
        if include_optional:
            return Body104CoordinationIssueViewpointsInner(
                name = 'Ceiling view',
                view_folder_id = 56,
    ...
    def testBody104CoordinationIssueViewpointsInner(self):
        """Test Body104CoordinationIssueViewpointsInner"""
