...
class TestManagedEquipmentModel(unittest.TestCase):
    """ManagedEquipmentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagedEquipmentModel:
        """Test ManagedEquipmentModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagedEquipmentModel`
        """
        model = ManagedEquipmentModel()
        if include_optional:
            return ManagedEquipmentModel(
                id = 75414,
                name = 'Earthmoving',
    ...
    def testManagedEquipmentModel(self):
        """Test ManagedEquipmentModel"""
