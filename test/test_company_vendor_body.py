...
class TestCompanyVendorBody(unittest.TestCase):
    """CompanyVendorBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyVendorBody:
        """Test CompanyVendorBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyVendorBody`
        """
        model = CompanyVendorBody()
        if include_optional:
            return CompanyVendorBody(
                company_id = 123,
                vendor = procore_sdk.models.company_vendor.Company Vendor(
    ...
    def testCompanyVendorBody(self):
        """Test CompanyVendorBody"""
