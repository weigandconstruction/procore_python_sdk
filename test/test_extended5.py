...
class TestExtended5(unittest.TestCase):
    """Extended5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Extended5:
        """Test Extended5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Extended5`
        """
        model = Extended5()
        if include_optional:
            return Extended5(
