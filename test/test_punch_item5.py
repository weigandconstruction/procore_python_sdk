...
class TestPunchItem5(unittest.TestCase):
    """PunchItem5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem5:
        """Test PunchItem5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem5`
        """
        model = PunchItem5()
        if include_optional:
            return PunchItem5(
