...
class TestRestV13CompaniesCompanyIdUsersSyncPatch200Response(unittest.TestCase):
    """RestV13CompaniesCompanyIdUsersSyncPatch200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV13CompaniesCompanyIdUsersSyncPatch200Response:
        """Test RestV13CompaniesCompanyIdUsersSyncPatch200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV13CompaniesCompanyIdUsersSyncPatch200Response`
        """
        model = RestV13CompaniesCompanyIdUsersSyncPatch200Response()
        if include_optional:
            return RestV13CompaniesCompanyIdUsersSyncPatch200Response(
                entities = [
                    procore_sdk.models.company_user.Company User(
                ...
                errors = [
                    procore_sdk.models.rest_v13_companies_company_id_users_sync_patch_200_response_errors_inner.RestV13CompaniesCompanyIdUsersSyncPatch_200_response_errors_inner()
                    ]
            )
        else:
            return RestV13CompaniesCompanyIdUsersSyncPatch200Response(
    ...
    def testRestV13CompaniesCompanyIdUsersSyncPatch200Response(self):
        """Test RestV13CompaniesCompanyIdUsersSyncPatch200Response"""
