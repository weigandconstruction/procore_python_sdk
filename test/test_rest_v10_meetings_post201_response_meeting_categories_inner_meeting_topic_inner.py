...
class TestRestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner(unittest.TestCase):
    """RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner:
        """Test RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner`
        """
        model = RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner()
        if include_optional:
            return RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner(
                id = 965039,
                number = '1.1',
    ...
    def testRestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner(self):
        """Test RestV10MeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner"""
