...
class TestCompanyUser7(unittest.TestCase):
    """CompanyUser7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyUser7:
        """Test CompanyUser7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyUser7`
        """
        model = CompanyUser7()
        if include_optional:
            return CompanyUser7(
