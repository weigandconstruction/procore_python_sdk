...
class TestIncidentInjuryUpdateParameters(unittest.TestCase):
    """IncidentInjuryUpdateParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentInjuryUpdateParameters:
        """Test IncidentInjuryUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentInjuryUpdateParameters`
        """
        model = IncidentInjuryUpdateParameters()
        if include_optional:
            return IncidentInjuryUpdateParameters(
    ...
    def testIncidentInjuryUpdateParameters(self):
        """Test IncidentInjuryUpdateParameters"""
