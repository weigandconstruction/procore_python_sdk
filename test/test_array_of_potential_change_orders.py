...
class TestArrayOfPotentialChangeOrders(unittest.TestCase):
    """ArrayOfPotentialChangeOrders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArrayOfPotentialChangeOrders:
        """Test ArrayOfPotentialChangeOrders
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArrayOfPotentialChangeOrders`
        """
        model = ArrayOfPotentialChangeOrders()
        if include_optional:
            return ArrayOfPotentialChangeOrders(
                entities = [
                    procore_sdk.models.array_of_potential_change_orders_entities_inner.arrayOfPotentialChangeOrders_entities_inner(
                        id = 2843048, 
                ...
                errors = [
                    procore_sdk.models.array_of_potential_change_orders_errors_inner.arrayOfPotentialChangeOrders_errors_inner()
                    ]
            )
        else:
            return ArrayOfPotentialChangeOrders(
    ...
    def testArrayOfPotentialChangeOrders(self):
        """Test ArrayOfPotentialChangeOrders"""
