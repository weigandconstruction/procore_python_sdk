...
class TestIncidentNormalAllOfEnvironmentalsInner(unittest.TestCase):
    """IncidentNormalAllOfEnvironmentalsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentNormalAllOfEnvironmentalsInner:
        """Test IncidentNormalAllOfEnvironmentalsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentNormalAllOfEnvironmentalsInner`
        """
        model = IncidentNormalAllOfEnvironmentalsInner()
        if include_optional:
            return IncidentNormalAllOfEnvironmentalsInner(
                type = 'environmental',
                environmental_type = procore_sdk.models.environmental_type.Environmental Type(
                    id = 999, 
                    name = 'Air Quality', 
                    active = True, 
                    global = True, 
    ...
    def testIncidentNormalAllOfEnvironmentalsInner(self):
        """Test IncidentNormalAllOfEnvironmentalsInner"""
