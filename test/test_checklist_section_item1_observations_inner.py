...
class TestChecklistSectionItem1ObservationsInner(unittest.TestCase):
    """ChecklistSectionItem1ObservationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistSectionItem1ObservationsInner:
        """Test ChecklistSectionItem1ObservationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistSectionItem1ObservationsInner`
        """
        model = ChecklistSectionItem1ObservationsInner()
        if include_optional:
            return ChecklistSectionItem1ObservationsInner(
                id = 2085,
    ...
    def testChecklistSectionItem1ObservationsInner(self):
        """Test ChecklistSectionItem1ObservationsInner"""
