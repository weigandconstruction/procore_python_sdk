...
class TestRestV10ProjectsSyncPatchRequestUpdatesInner(unittest.TestCase):
    """RestV10ProjectsSyncPatchRequestUpdatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsSyncPatchRequestUpdatesInner:
        """Test RestV10ProjectsSyncPatchRequestUpdatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsSyncPatchRequestUpdatesInner`
        """
        model = RestV10ProjectsSyncPatchRequestUpdatesInner()
        if include_optional:
            return RestV10ProjectsSyncPatchRequestUpdatesInner(
                id = 1,
                active = True,
    ...
    def testRestV10ProjectsSyncPatchRequestUpdatesInner(self):
        """Test RestV10ProjectsSyncPatchRequestUpdatesInner"""
