...
class TestTimesheetEntries(unittest.TestCase):
    """TimesheetEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimesheetEntries:
        """Test TimesheetEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimesheetEntries`
        """
