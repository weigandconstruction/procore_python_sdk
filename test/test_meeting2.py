...
class TestMeeting2(unittest.TestCase):
    """Meeting2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Meeting2:
        """Test Meeting2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Meeting2`
        """
        model = Meeting2()
        if include_optional:
            return Meeting2(
