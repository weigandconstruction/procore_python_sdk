...
class TestRestV10BimModelRevisionsGet200ResponseInner(unittest.TestCase):
    """RestV10BimModelRevisionsGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10BimModelRevisionsGet200ResponseInner:
        """Test RestV10BimModelRevisionsGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10BimModelRevisionsGet200ResponseInner`
        """
        model = RestV10BimModelRevisionsGet200ResponseInner()
        if include_optional:
            return RestV10BimModelRevisionsGet200ResponseInner(
                id = 126,
                bim_file_id = 51,
                bim_gridline_id = 107,
                bim_model_id = 16,
    ...
    def testRestV10BimModelRevisionsGet200ResponseInner(self):
        """Test RestV10BimModelRevisionsGet200ResponseInner"""
