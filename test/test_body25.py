...
class TestBody25(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Body25:
        """Test Body25
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Body25`
        """
        model = Body25()
        if include_optional:
            return Body25(
                requisition_change_order_item = procore_sdk.models.requisition_change_order_item.RequisitionChangeOrderItem(
