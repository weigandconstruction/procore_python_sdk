...
class TestRestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner(unittest.TestCase):
    """RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner:
        """Test RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner`
        """
        model = RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner()
        if include_optional:
            return RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner(
                id = 333675,
                ...
                cost_code = procore_sdk.models.timecard_entry_full_cost_code.TimecardEntry_full_cost_code(
                    id = 12345, 
                    name = 'Earthwork', ),
                equipment = procore_sdk.models.rest_v10_projects_project_id_equipment_logs_get_200_response_inner_equipment.RestV10ProjectsProjectIdEquipmentLogsGet_200_response_inner_equipment(
                    id = 15504, 
                    project_id = 14406, 
                    position = 18300, 
                    name = 'Jackhammer', ),
    ...
    def testRestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner(self):
        """Test RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInner"""
