...
class TestBidForm(unittest.TestCase):
    """BidForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BidForm:
        """Test BidForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BidForm`
        """
        model = BidForm()
        if include_optional:
            return BidForm(
