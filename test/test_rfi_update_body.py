...
class TestRFIUpdateBody(unittest.TestCase):
    """RFIUpdateBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RFIUpdateBody:
        """Test RFIUpdateBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RFIUpdateBody`
        """
        model = RFIUpdateBody()
        if include_optional:
            return RFIUpdateBody(
                rfi = procore_sdk.models.rfi_update_body_rfi.RFI_Update_Body_rfi(
                    subject = 'Wall Color', 
                    ...
                    cost_code_id = 123, 
                    rfi_manager_id = 123, 
                    question = procore_sdk.models.rfi_update_body_rfi_question.RFI_Update_Body_rfi_question(
