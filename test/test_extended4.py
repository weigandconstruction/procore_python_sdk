...
class TestExtended4(unittest.TestCase):
    """Extended4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Extended4:
        """Test Extended4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Extended4`
        """
        model = Extended4()
        if include_optional:
            return Extended4(
