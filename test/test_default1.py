...
class TestDefault1(unittest.TestCase):
    """Default1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Default1:
        """Test Default1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Default1`
        """
        model = Default1()
        if include_optional:
            return Default1(
