...
class TestIncidentNormalAllOfActionsInner(unittest.TestCase):
    """IncidentNormalAllOfActionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentNormalAllOfActionsInner:
        """Test IncidentNormalAllOfActionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentNormalAllOfActionsInner`
        """
        model = IncidentNormalAllOfActionsInner()
        if include_optional:
            return IncidentNormalAllOfActionsInner(
                id = 99,
                incident_id = 42,
    ...
    def testIncidentNormalAllOfActionsInner(self):
        """Test IncidentNormalAllOfActionsInner"""
