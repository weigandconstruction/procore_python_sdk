...
class TestInsuranceSyncBody1(unittest.TestCase):
    """InsuranceSyncBody1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsuranceSyncBody1:
        """Test InsuranceSyncBody1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsuranceSyncBody1`
        """
        model = InsuranceSyncBody1()
        if include_optional:
            return InsuranceSyncBody1(
                updates = [
    ...
    def testInsuranceSyncBody1(self):
        """Test InsuranceSyncBody1"""
