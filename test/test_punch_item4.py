...
class TestPunchItem4(unittest.TestCase):
    """PunchItem4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem4:
        """Test PunchItem4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem4`
        """
        model = PunchItem4()
        if include_optional:
            return PunchItem4(
