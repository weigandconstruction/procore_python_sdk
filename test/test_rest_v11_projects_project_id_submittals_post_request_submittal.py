...
class TestRestV11ProjectsProjectIdSubmittalsPostRequestSubmittal(unittest.TestCase):
    """RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal:
        """Test RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal`
        """
        model = RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal()
        if include_optional:
            return RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal(
    ...
    def testRestV11ProjectsProjectIdSubmittalsPostRequestSubmittal(self):
        """Test RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal"""
