...
class TestChecklistItemResponseSetBody(unittest.TestCase):
    """ChecklistItemResponseSetBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChecklistItemResponseSetBody:
        """Test ChecklistItemResponseSetBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChecklistItemResponseSetBody`
        """
        model = ChecklistItemResponseSetBody()
        if include_optional:
            return ChecklistItemResponseSetBody(
    ...
    def testChecklistItemResponseSetBody(self):
        """Test ChecklistItemResponseSetBody"""
