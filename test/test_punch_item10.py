...
class TestPunchItem10(unittest.TestCase):
    """PunchItem10 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PunchItem10:
        """Test PunchItem10
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PunchItem10`
        """
        model = PunchItem10()
        if include_optional:
            return PunchItem10(
