...
class TestExtended3(unittest.TestCase):
    """Extended3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Extended3:
        """Test Extended3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Extended3`
        """
        model = Extended3()
        if include_optional:
            return Extended3(
