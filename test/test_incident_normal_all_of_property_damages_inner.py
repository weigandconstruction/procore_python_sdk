...
class TestIncidentNormalAllOfPropertyDamagesInner(unittest.TestCase):
    """IncidentNormalAllOfPropertyDamagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentNormalAllOfPropertyDamagesInner:
        """Test IncidentNormalAllOfPropertyDamagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentNormalAllOfPropertyDamagesInner`
        """
        model = IncidentNormalAllOfPropertyDamagesInner()
        if include_optional:
            return IncidentNormalAllOfPropertyDamagesInner(
                type = 'property_damage',
                estimated_cost_impact = '20000.00',
                responsible_company = procore_sdk.models.rest_v10_projects_project_id_waste_logs_get_200_response_inner_vendor.RestV10ProjectsProjectIdWasteLogsGet_200_response_inner_vendor(
                    id = 161072, 
    ...
    def testIncidentNormalAllOfPropertyDamagesInner(self):
        """Test IncidentNormalAllOfPropertyDamagesInner"""
