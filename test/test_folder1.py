...
class TestFolder1(unittest.TestCase):
    """Folder1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Folder1:
        """Test Folder1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Folder1`
        """
        model = Folder1()
        if include_optional:
            return Folder1(
