...
class TestTimecardEntry1(unittest.TestCase):
    """TimecardEntry1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimecardEntry1:
        """Test TimecardEntry1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimecardEntry1`
        """
        model = TimecardEntry1()
        if include_optional:
            return TimecardEntry1(
                id = 1,
