...
class TestTimecardEntry2(unittest.TestCase):
    """TimecardEntry2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimecardEntry2:
        """Test TimecardEntry2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimecardEntry2`
        """
        model = TimecardEntry2()
        if include_optional:
            return TimecardEntry2(
                id = 1,
