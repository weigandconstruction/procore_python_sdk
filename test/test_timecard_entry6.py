...
class TestTimecardEntry6(unittest.TestCase):
    """TimecardEntry6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimecardEntry6:
        """Test TimecardEntry6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimecardEntry6`
        """
        model = TimecardEntry6()
        if include_optional:
            return TimecardEntry6(
                id = 1,
