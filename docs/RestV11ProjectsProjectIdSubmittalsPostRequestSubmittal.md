# RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal
...
**buffer_time** | **int** | The buffer working days for the dynamic submittal plan calculation *This field is only available to be set if Dynamic Submittal Plan is enabled | [optional] 
...
**for_record_only** | **bool** | The field that controls if the dynamic submittal plan is for record only or not *This field is only available to be set if Dynamic Submittal Plan is enabled | [optional] 
