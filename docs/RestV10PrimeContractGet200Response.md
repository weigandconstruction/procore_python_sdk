...
**outstanding_balance** | **str** | Revised contract amount minus total payments | [optional] 
**owner_invoices_amount** | **str** | Total of owner invoices | [optional] 
**payment_terms** | **str** | Payment terms | [optional] 
**pending_change_orders_amount** | **str** | Total of all pending and revised change orders | [optional] 
**pending_revised_contract_amount** | **str** | Revised contract amount, plus pending and revised change orders | [optional] 
...
**revised_contract_amount** | **str** | Grand total, plus approved change orders | [optional] 
