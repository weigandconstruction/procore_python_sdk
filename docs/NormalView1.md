...
json = "{}"
# create an instance of NormalView1 from a JSON string
normal_view1_instance = NormalView1.from_json(json)
# print the JSON string representation of the object
print(NormalView1.to_json())

# convert the object into a dict
normal_view1_dict = normal_view1_instance.to_dict()
# create an instance of NormalView1 from a dict
normal_view1_from_dict = NormalView1.from_dict(normal_view1_dict)
```
