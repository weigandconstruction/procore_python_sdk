...
company_user7_instance = CompanyUser7.from_json(json)
# print the JSON string representation of the object
print(CompanyUser7.to_json())

# convert the object into a dict
company_user7_dict = company_user7_instance.to_dict()
# create an instance of CompanyUser7 from a dict
company_user7_from_dict = CompanyUser7.from_dict(company_user7_dict)
```
