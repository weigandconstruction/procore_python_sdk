...
json = "{}"
# create an instance of NormalView from a JSON string
normal_view_instance = NormalView.from_json(json)
# print the JSON string representation of the object
print(NormalView.to_json())

# convert the object into a dict
normal_view_dict = normal_view_instance.to_dict()
# create an instance of NormalView from a dict
normal_view_from_dict = NormalView.from_dict(normal_view_dict)
```
