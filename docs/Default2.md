...
json = "{}"
# create an instance of Default2 from a JSON string
default2_instance = Default2.from_json(json)
# print the JSON string representation of the object
print(Default2.to_json())

# convert the object into a dict
default2_dict = default2_instance.to_dict()
# create an instance of Default2 from a dict
default2_from_dict = Default2.from_dict(default2_dict)
```
