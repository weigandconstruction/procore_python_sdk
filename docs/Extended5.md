...
extended5_instance = Extended5.from_json(json)
# print the JSON string representation of the object
print(Extended5.to_json())

# convert the object into a dict
extended5_dict = extended5_instance.to_dict()
# create an instance of Extended5 from a dict
extended5_from_dict = Extended5.from_dict(extended5_dict)
```
