...
class ConstructionFinancialsPrimeContractPaymentApplicationOwnerInvoiceMarkupLineItemsApi:
    ...
    def rest_v10_prime_contracts_prime_contract_id_payment_application_markup_line_items_id_patch(
        ...
        id: Annotated[StrictInt, Field(description="Payment Application (Owner Invoice) Markup Line item ID")],
        body52: Body52,
        ...
        :param id: Payment Application (Owner Invoice) Markup Line item ID (required)
        :type id: int
        :param body52: (required)
        :type body52: Body52
        ...
        _param = self._rest_v10_prime_contracts_prime_contract_id_payment_application_markup_line_items_id_patch_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10PrimeContractsPrimeContractIdPaymentApplicationMarkupLineItemsIdPatch200Response",
    ...
    @validate_call
    def rest_v10_prime_contracts_prime_contract_id_payment_application_markup_line_items_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        prime_contract_id: Annotated[StrictInt, Field(description="Prime Contract ID")],
        id: Annotated[StrictInt, Field(description="Payment Application (Owner Invoice) Markup Line item ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10PrimeContractsPrimeContractIdPaymentApplicationMarkupLineItemsIdPatch200Response]:
        """Update Payment Application (Owner Invoice) Markup Line item for Prime Contract
    ...
    @validate_call
    def rest_v10_prime_contracts_prime_contract_id_payment_application_markup_line_items_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        prime_contract_id: Annotated[StrictInt, Field(description="Prime Contract ID")],
        id: Annotated[StrictInt, Field(description="Payment Application (Owner Invoice) Markup Line item ID")],
    ...
    def _rest_v10_prime_contracts_prime_contract_id_payment_application_markup_line_items_id_patch_serialize(
        self,
        procore_company_id,
        prime_contract_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/prime_contracts/{prime_contract_id}/payment_application_markup_line_items/{id}',
