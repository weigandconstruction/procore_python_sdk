...
class ProjectManagementBiddingBidUploadsApi:
    ...
    def rest_v10_companies_company_id_bids_bid_id_uploads_get(
    ...
    ) -> List[RestV10CompaniesCompanyIdBidsBidIdUploadsGet200ResponseInner]:
        """List Bid Uploads
        ...
        _param = self._rest_v10_companies_company_id_bids_bid_id_uploads_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdBidsBidIdUploadsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_companies_company_id_bids_bid_id_uploads_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_id: Annotated[StrictInt, Field(description="Bid ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdBidsBidIdUploadsGet200ResponseInner]]:
        """List Bid Uploads
    ...
    @validate_call
    def rest_v10_companies_company_id_bids_bid_id_uploads_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_id: Annotated[StrictInt, Field(description="Bid ID")],
    ...
    def _rest_v10_companies_company_id_bids_bid_id_uploads_get_serialize(
        self,
        procore_company_id,
        company_id,
        bid_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/bids/{bid_id}/uploads',
