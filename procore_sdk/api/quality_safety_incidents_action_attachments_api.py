...
class QualitySafetyIncidentsActionAttachmentsApi:
    ...
    def rest_v10_projects_project_id_incidents_actions_action_id_attachments_post(
        ...
        attachment: Annotated[Union[StrictBytes, StrictStr], Field(description="Action Attachment. To upload an attachment you must upload the entire payload as `multipart/form-data` content-type with the `attachment` file.")],
        ...
        :type action_id: int
        :param attachment: Action Attachment. To upload an attachment you must upload the entire payload as `multipart/form-data` content-type with the `attachment` file. (required)
        ...
        _param = self._rest_v10_projects_project_id_incidents_actions_action_id_attachments_post_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_incidents_actions_action_id_attachments_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        action_id: Annotated[StrictInt, Field(description="Action ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_incidents_actions_action_id_attachments_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        action_id: Annotated[StrictInt, Field(description="Action ID")],
    ...
    def _rest_v10_projects_project_id_incidents_actions_action_id_attachments_post_serialize(
        self,
        procore_company_id,
        project_id,
        action_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/projects/{project_id}/incidents/actions/{action_id}/attachments',
