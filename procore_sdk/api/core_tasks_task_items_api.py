...
class CoreTasksTaskItemsApi:
    ...
    def rest_v10_task_items_get(
        ...
        filters_task_item_category_id: Annotated[Optional[StrictStr], Field(description="Returns item(s) matching the specified Task Item Category ID.")] = None,
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Return item(s) with the specified sort.")] = None,
    ...
    ) -> List[ArrayOfTaskItemsThatWereSentOutInner]:
        """List task items
        ...
        :param filters_task_item_category_id: Returns item(s) matching the specified Task Item Category ID.
        :type filters_task_item_category_id: str
        :param filters_id: Return item(s) with the specified IDs.
        :type filters_id: List[int]
        :param sort: Return item(s) with the specified sort.
        :type sort: str
        ...
        _param = self._rest_v10_task_items_get_serialize(
            ...
            filters_task_item_category_id=filters_task_item_category_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ArrayOfTaskItemsThatWereSentOutInner]",
    ...
    @validate_call
    def rest_v10_task_items_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ArrayOfTaskItemsThatWereSentOutInner]]:
        """List task items
    ...
    @validate_call
    def rest_v10_task_items_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_task_items_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        if filters_task_item_category_id is not None:
            
            _query_params.append(('filters[task_item_category_id]', filters_task_item_category_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/task_items',
    ...
    @validate_call
    def rest_v10_task_items_id_delete(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param id: Task Item ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_task_items_id_delete_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_task_items_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
    ...
    @validate_call
    def rest_v10_task_items_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
    ...
    def _rest_v10_task_items_id_delete_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/task_items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def rest_v10_task_items_id_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
        ...
        _param = self._rest_v10_task_items_id_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10TaskItemsPost201Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def rest_v10_task_items_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10TaskItemsPost201Response]:
        """Show task item
    ...
    @validate_call
    def rest_v10_task_items_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
    ...
    def _rest_v10_task_items_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
    ...
    def rest_v10_task_items_id_patch(
        ...
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
        task_item: RestV10TaskItemsPostRequestTaskItem,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Task Item ID (required)
        :type id: int
        :param task_item: (required)
        :type task_item: RestV10TaskItemsPostRequestTaskItem
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_task_items_id_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            task_item=task_item,
    ...
    @validate_call
    def rest_v10_task_items_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
    ...
    @validate_call
    def rest_v10_task_items_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Task Item ID")],
    ...
    def _rest_v10_task_items_id_patch_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        if task_item is not None:
            _form_params.append(('task_item', task_item))
        # process the body parameter
    ...
    def rest_v10_task_items_post(
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param rest_v10_task_items_post_request: (required)
        :type rest_v10_task_items_post_request: RestV10TaskItemsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_task_items_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            rest_v10_task_items_post_request=rest_v10_task_items_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10TaskItemsPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_task_items_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_task_items_post_request: RestV10TaskItemsPostRequest,
    ...
    @validate_call
    def rest_v10_task_items_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_task_items_post_request: RestV10TaskItemsPostRequest,
    ...
    def _rest_v10_task_items_post_serialize(
        self,
        procore_company_id,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_task_items_post_request is not None:
            _body_params = rest_v10_task_items_post_request
    ...
    @validate_call
    def rest_v10_task_items_send_unsent_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._rest_v10_task_items_send_unsent_post_serialize(
            procore_company_id=procore_company_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def rest_v10_task_items_send_unsent_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def rest_v10_task_items_send_unsent_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        _request_timeout: Union[
            None,
    ...
    def _rest_v10_task_items_send_unsent_post_serialize(
        self,
        procore_company_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/task_items/send_unsent',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
