...
class ProjectManagementCoordinationIssuesCoordinationIssueChangeHistoryApi:
    ...
    def rest_v10_coordination_issues_id_change_history_get(
        ...
        view: Annotated[Optional[StrictStr], Field(description="The extended view provides what is shown below. The normal view is the same as the extended view but excludes attribute created_by. The compact view returns ids only. The default view is normal.")] = None,
    ...
    ) -> List[RestV10CoordinationIssuesIdChangeHistoryGet200ResponseInner]:
        ...
        :type project_id: int
        :param view: The extended view provides what is shown below. The normal view is the same as the extended view but excludes attribute created_by. The compact view returns ids only. The default view is normal.
        :type view: str
        :param page: Page
        :type page: int
        ...
        _param = self._rest_v10_coordination_issues_id_change_history_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CoordinationIssuesIdChangeHistoryGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_coordination_issues_id_change_history_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CoordinationIssuesIdChangeHistoryGet200ResponseInner]]:
        """List Coordination Issue Change History
    ...
    @validate_call
    def rest_v10_coordination_issues_id_change_history_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_coordination_issues_id_change_history_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/coordination_issues/{id}/change_history',
