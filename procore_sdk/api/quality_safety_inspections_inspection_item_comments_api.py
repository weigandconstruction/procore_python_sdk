...
class QualitySafetyInspectionsInspectionItemCommentsApi:
    ...
    def rest_v10_projects_project_id_inspections_inspection_id_comments_post(
        ...
        _param = self._rest_v10_projects_project_id_inspections_inspection_id_comments_post_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_inspections_inspection_id_comments_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        inspection_id: Annotated[StrictInt, Field(description="Unique identifier for the inspection.")],
    ...
    @validate_call
    def rest_v10_projects_project_id_inspections_inspection_id_comments_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        inspection_id: Annotated[StrictInt, Field(description="Unique identifier for the inspection.")],
    ...
    def _rest_v10_projects_project_id_inspections_inspection_id_comments_post_serialize(
        self,
        procore_company_id,
        project_id,
        inspection_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/projects/{project_id}/inspections/{inspection_id}/comments',
