...
class ConstructionFinancialsBudgetBudgetDetailsApi:
    ...
    def rest_v10_budget_views_budget_view_id_budget_details_post(
    ...
    ) -> List[RestV10BudgetViewsBudgetViewIdBudgetDetailsPost200ResponseInner]:
        """List Budget Details
        ...
        :type project_id: int
        :param budget_details_body: (required)
        :type budget_details_body: BudgetDetailsBody
        ...
        _param = self._rest_v10_budget_views_budget_view_id_budget_details_post_serialize(
            procore_company_id=procore_company_id,
            budget_view_id=budget_view_id,
            project_id=project_id,
            budget_details_body=budget_details_body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10BudgetViewsBudgetViewIdBudgetDetailsPost200ResponseInner]",
            ...
            '408': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_budget_details_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10BudgetViewsBudgetViewIdBudgetDetailsPost200ResponseInner]]:
        """List Budget Details
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_budget_details_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_budget_views_budget_view_id_budget_details_post_serialize(
        self,
        procore_company_id,
        budget_view_id,
        project_id,
        ...
        if budget_details_body is not None:
            _body_params = budget_details_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/budget_views/{budget_view_id}/budget_details',
