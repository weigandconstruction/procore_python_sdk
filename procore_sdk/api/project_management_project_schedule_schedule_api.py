...
class ProjectManagementProjectScheduleScheduleApi:
    ...
    def rest_v10_projects_project_id_schedule_get(
        ...
        _param = self._rest_v10_projects_project_id_schedule_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10ProjectsProjectIdScheduleGet200Response",
    ...
    @validate_call
    def rest_v10_projects_project_id_schedule_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10ProjectsProjectIdScheduleGet200Response]:
        """Get Schedule Metadata
    ...
    @validate_call
    def rest_v10_projects_project_id_schedule_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
    ...
    def _rest_v10_projects_project_id_schedule_get_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/schedule',
    ...
    def rest_v10_projects_project_id_schedule_patch(
        ...
        _param = self._rest_v10_projects_project_id_schedule_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            body15=body15,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_schedule_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        body15: Body15,
    ...
    @validate_call
    def rest_v10_projects_project_id_schedule_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        body15: Body15,
    ...
    def _rest_v10_projects_project_id_schedule_patch_serialize(
        self,
        procore_company_id,
        project_id,
        body15,
