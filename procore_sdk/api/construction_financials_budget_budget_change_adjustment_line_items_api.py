...
class ConstructionFinancialsBudgetBudgetChangeAdjustmentLineItemsApi:
    ...
    def rest_v20_companies_company_id_projects_project_id_budget_changes_adjustment_line_items_get(
        ...
        _param = self._rest_v20_companies_company_id_projects_project_id_budget_changes_adjustment_line_items_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200Response",
    ...
    @validate_call
    def rest_v20_companies_company_id_projects_project_id_budget_changes_adjustment_line_items_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictStr, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictStr, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200Response]:
        """Get Adjustment and Adjustment Line Items of a Project
    ...
    @validate_call
    def rest_v20_companies_company_id_projects_project_id_budget_changes_adjustment_line_items_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictStr, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictStr, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v20_companies_company_id_projects_project_id_budget_changes_adjustment_line_items_get_serialize(
        self,
        procore_company_id,
        company_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v2.0/companies/{company_id}/projects/{project_id}/budget_changes/adjustment_line_items',
