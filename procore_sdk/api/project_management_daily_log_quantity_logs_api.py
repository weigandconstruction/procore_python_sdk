...
class ProjectManagementDailyLogQuantityLogsApi:
    ...
    def rest_v10_projects_project_id_quantity_logs_get(
        ...
        _param = self._rest_v10_projects_project_id_quantity_logs_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10ProjectsProjectIdQuantityLogsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        log_date: Annotated[Optional[date], Field(description="Date of specific logs desired in YYYY-MM-DD format")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10ProjectsProjectIdQuantityLogsGet200ResponseInner]]:
        """List Quantity Logs
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        log_date: Annotated[Optional[date], Field(description="Date of specific logs desired in YYYY-MM-DD format")] = None,
    ...
    def _rest_v10_projects_project_id_quantity_logs_get_serialize(
        self,
        procore_company_id,
        project_id,
        log_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/quantity_logs',
    ...
    def rest_v10_projects_project_id_quantity_logs_id_delete(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param id: Quantity Log ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_projects_project_id_quantity_logs_id_delete_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
    ...
    def _rest_v10_projects_project_id_quantity_logs_id_delete_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/projects/{project_id}/quantity_logs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_quantity_logs_id_get(
        ...
        _param = self._rest_v10_projects_project_id_quantity_logs_id_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10ProjectsProjectIdQuantityLogsGet200ResponseInner",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10ProjectsProjectIdQuantityLogsGet200ResponseInner]:
        """Show Quantity Logs
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
    ...
    def _rest_v10_projects_project_id_quantity_logs_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
    ...
    def rest_v10_projects_project_id_quantity_logs_id_patch(
        ...
        :param id: Quantity Log ID (required)
        :type id: int
        :param rest_v10_projects_project_id_quantity_logs_post_request: (required)
        :type rest_v10_projects_project_id_quantity_logs_post_request: RestV10ProjectsProjectIdQuantityLogsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_projects_project_id_quantity_logs_id_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            rest_v10_projects_project_id_quantity_logs_post_request=rest_v10_projects_project_id_quantity_logs_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Quantity Log ID")],
    ...
    def _rest_v10_projects_project_id_quantity_logs_id_patch_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_projects_project_id_quantity_logs_post_request is not None:
            _body_params = rest_v10_projects_project_id_quantity_logs_post_request
    ...
    def rest_v10_projects_project_id_quantity_logs_post(
        ...
        _param = self._rest_v10_projects_project_id_quantity_logs_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            rest_v10_projects_project_id_quantity_logs_post_request=rest_v10_projects_project_id_quantity_logs_post_request,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10ProjectsProjectIdQuantityLogsGet200ResponseInner",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '422': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_projects_project_id_quantity_logs_post_request: RestV10ProjectsProjectIdQuantityLogsPostRequest,
    ...
    @validate_call
    def rest_v10_projects_project_id_quantity_logs_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_projects_project_id_quantity_logs_post_request: RestV10ProjectsProjectIdQuantityLogsPostRequest,
    ...
    def _rest_v10_projects_project_id_quantity_logs_post_serialize(
        self,
        procore_company_id,
        project_id,
        rest_v10_projects_project_id_quantity_logs_post_request,
