...
class ProjectManagementMeetingsMeetingCategoriesApi:
    ...
    def rest_v10_meeting_categories_get(
    ...
    ) -> List[RestV10MeetingCategoriesGet200ResponseInner]:
        ...
        _param = self._rest_v10_meeting_categories_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10MeetingCategoriesGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_meeting_categories_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the meeting")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10MeetingCategoriesGet200ResponseInner]]:
        """List meeting categories
    ...
    @validate_call
    def rest_v10_meeting_categories_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the meeting")],
    ...
    def _rest_v10_meeting_categories_get_serialize(
        self,
        procore_company_id,
        project_id,
        meeting_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/meeting_categories',
    ...
    def rest_v10_meeting_categories_id_patch(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the meeting category")],
        body67: Body67,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param id: ID of the meeting category (required)
        :type id: int
        :param body67: (required)
        :type body67: Body67
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_meeting_categories_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            body67=body67,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10MeetingCategoriesPost201Response",
    ...
    @validate_call
    def rest_v10_meeting_categories_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the meeting category")],
        body67: Body67,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10MeetingCategoriesPost201Response]:
        """Update meeting category
    ...
    @validate_call
    def rest_v10_meeting_categories_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the meeting category")],
        body67: Body67,
    ...
    def _rest_v10_meeting_categories_id_patch_serialize(
        self,
        procore_company_id,
        id,
        body67,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/meeting_categories/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def rest_v10_meeting_categories_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body67: Body67,
        _request_timeout: Union[
        ...
        _param = self._rest_v10_meeting_categories_post_serialize(
            procore_company_id=procore_company_id,
            body67=body67,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10MeetingCategoriesPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_meeting_categories_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body67: Body67,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_meeting_categories_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body67: Body67,
        _request_timeout: Union[
    ...
    def _rest_v10_meeting_categories_post_serialize(
        self,
        procore_company_id,
        body67,
        _request_auth,
