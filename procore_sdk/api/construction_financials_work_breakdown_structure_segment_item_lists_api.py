...
class ConstructionFinancialsWorkBreakdownStructureSegmentItemListsApi:
    ...
    def rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get(
    ...
    ) -> List[RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdListsGet200ResponseInner]:
        ...
        _param = self._rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdListsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        segment_id: Annotated[StrictInt, Field(description="Segment ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdListsGet200ResponseInner]]:
        """List Company WBS Segment Item Lists
    ...
    @validate_call
    def rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        segment_id: Annotated[StrictInt, Field(description="Segment ID")],
    ...
    def _rest_v10_companies_company_id_work_breakdown_structure_segments_segment_id_lists_get_serialize(
        self,
        procore_company_id,
        company_id,
        segment_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/work_breakdown_structure/segments/{segment_id}/lists',
