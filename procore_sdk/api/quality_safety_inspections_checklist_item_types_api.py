...
class QualitySafetyInspectionsChecklistItemTypesApi:
    ...
    def rest_v10_checklist_item_types_get(
        ...
        _param = self._rest_v10_checklist_item_types_get_serialize(
    ...
    @validate_call
    def rest_v10_checklist_item_types_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChecklistItemType]]:
        """List Available Checklist Item Types
    ...
    @validate_call
    def rest_v10_checklist_item_types_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_checklist_item_types_get_serialize(
        self,
        procore_company_id,
        project_id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/checklist/item_types',
    ...
    def rest_v10_checklist_item_types_id_get(
        ...
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Item Type ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param id: Item Type ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_checklist_item_types_id_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            company_id=company_id,
            id=id,
    ...
    @validate_call
    def rest_v10_checklist_item_types_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    @validate_call
    def rest_v10_checklist_item_types_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_checklist_item_types_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/checklist/item_types/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
