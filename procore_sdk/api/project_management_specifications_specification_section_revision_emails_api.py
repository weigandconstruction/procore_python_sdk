...
class ProjectManagementSpecificationsSpecificationSectionRevisionEmailsApi:
    ...
    def rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post(
        ...
        id: Annotated[StrictInt, Field(description="ID of the Specification Section Revision to email")],
        ...
        :type project_id: int
        :param id: ID of the Specification Section Revision to email (required)
        :type id: int
        ...
        _param = self._rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="ID of the Specification Section Revision to email")],
    ...
    @validate_call
    def rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="ID of the Specification Section Revision to email")],
    ...
    def _rest_v10_projects_project_id_specification_section_revision_emails_id_send_email_post_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/projects/{project_id}/specification_section_revision_emails/{id}/send_email',
