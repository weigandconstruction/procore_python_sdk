...
class ConstructionFinancialsCommitmentsPurchaseOrderContractSubcontractorSOVStatusApi:
    ...
    def rest_v10_purchase_order_contracts_purchase_order_contract_id_subcontractor_schedule_of_values_status_patch(
        ...
        _param = self._rest_v10_purchase_order_contracts_purchase_order_contract_id_subcontractor_schedule_of_values_status_patch_serialize(
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_purchase_order_contract_id_subcontractor_schedule_of_values_status_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        purchase_order_contract_id: Annotated[StrictInt, Field(description="Purchase Order Contract ID")],
        body2: Body2,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_purchase_order_contract_id_subcontractor_schedule_of_values_status_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        purchase_order_contract_id: Annotated[StrictInt, Field(description="Purchase Order Contract ID")],
        body2: Body2,
    ...
    def _rest_v10_purchase_order_contracts_purchase_order_contract_id_subcontractor_schedule_of_values_status_patch_serialize(
        self,
        procore_company_id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/purchase_order_contracts/{purchase_order_contract_id}/subcontractor_schedule_of_values_status',
