...
class FieldProductivityTimeAndMaterialsTimeAndMaterialNotificationApi:
    ...
    def rest_v10_projects_project_id_time_and_material_notifications_delete(
        ...
        _param = self._rest_v10_projects_project_id_time_and_material_notifications_delete_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10ProjectsProjectIdTimeAndMaterialNotificationsGet200Response",
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10ProjectsProjectIdTimeAndMaterialNotificationsGet200Response]:
        """Delete a Time And Material Notification
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
    ...
    def _rest_v10_projects_project_id_time_and_material_notifications_delete_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/projects/{project_id}/time_and_material_notifications',
    ...
    def rest_v10_projects_project_id_time_and_material_notifications_get(
        ...
        _param = self._rest_v10_projects_project_id_time_and_material_notifications_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
    ...
    def _rest_v10_projects_project_id_time_and_material_notifications_get_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
    ...
    def rest_v10_projects_project_id_time_and_material_notifications_patch(
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param time_and_material_notification_body: (required)
        :type time_and_material_notification_body: TimeAndMaterialNotificationBody
        ...
        _param = self._rest_v10_projects_project_id_time_and_material_notifications_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            time_and_material_notification_body=time_and_material_notification_body,
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        time_and_material_notification_body: TimeAndMaterialNotificationBody,
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        time_and_material_notification_body: TimeAndMaterialNotificationBody,
    ...
    def _rest_v10_projects_project_id_time_and_material_notifications_patch_serialize(
        self,
        procore_company_id,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if time_and_material_notification_body is not None:
            _body_params = time_and_material_notification_body
    ...
    def rest_v10_projects_project_id_time_and_material_notifications_post(
        ...
        _param = self._rest_v10_projects_project_id_time_and_material_notifications_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            time_and_material_notification_body=time_and_material_notification_body,
            run_configurable_validations=run_configurable_validations,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10ProjectsProjectIdTimeAndMaterialNotificationsGet200Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '422': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        time_and_material_notification_body: TimeAndMaterialNotificationBody,
    ...
    @validate_call
    def rest_v10_projects_project_id_time_and_material_notifications_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        time_and_material_notification_body: TimeAndMaterialNotificationBody,
    ...
    def _rest_v10_projects_project_id_time_and_material_notifications_post_serialize(
        self,
        procore_company_id,
        project_id,
        time_and_material_notification_body,
