...
class ProjectManagementMeetingsMeetingAttendeesApi:
    ...
    def rest_v10_meeting_attendee_records_id_delete(
        ...
        id: Annotated[StrictInt, Field(description="ID of the Meeting Attendee record")],
        ...
        :type project_id: int
        :param id: ID of the Meeting Attendee record (required)
        :type id: int
        ...
        _param = self._rest_v10_meeting_attendee_records_id_delete_serialize(
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_meeting_attendee_records_id_delete_serialize(
        self,
        procore_company_id,
        meeting_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/meeting_attendee_records/{id}',
    ...
    def rest_v10_meeting_attendee_records_id_patch(
        ...
        _param = self._rest_v10_meeting_attendee_records_id_patch_serialize(
            procore_company_id=procore_company_id,
            meeting_id=meeting_id,
            project_id=project_id,
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10MeetingAttendeeRecordsPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10MeetingAttendeeRecordsPost201Response]:
        """Update meeting attendee record
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_meeting_attendee_records_id_patch_serialize(
        self,
        procore_company_id,
        meeting_id,
        project_id,
    ...
    def rest_v10_meeting_attendee_records_post(
        ...
        _param = self._rest_v10_meeting_attendee_records_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            meeting_id=meeting_id,
            body68=body68,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10MeetingAttendeeRecordsPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
    ...
    @validate_call
    def rest_v10_meeting_attendee_records_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        meeting_id: Annotated[StrictInt, Field(description="ID of the Meeting")],
    ...
    def _rest_v10_meeting_attendee_records_post_serialize(
        self,
        procore_company_id,
        project_id,
        meeting_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/meeting_attendee_records',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
