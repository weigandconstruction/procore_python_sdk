...
class CoreProjectDirectoryProjectPeopleApi:
    ...
    def rest_v10_projects_project_id_people_get(
        ...
        _param = self._rest_v10_projects_project_id_people_get_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_people_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        view: Annotated[Optional[StrictStr], Field(description="Specifies which view of the resource to return (which attributes should be present in the response). Users without read permissions to Directory are limited to the normal and extended views. If a valid view is not provided, it will default to normal.")] = None,
    ...
    @validate_call
    def rest_v10_projects_project_id_people_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        view: Annotated[Optional[StrictStr], Field(description="Specifies which view of the resource to return (which attributes should be present in the response). Users without read permissions to Directory are limited to the normal and extended views. If a valid view is not provided, it will default to normal.")] = None,
    ...
    def _rest_v10_projects_project_id_people_get_serialize(
        self,
        procore_company_id,
        project_id,
        view,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/people',
    ...
    def rest_v10_projects_project_id_people_id_patch(
        ...
        :type id: int
        :param project_person_body: (required)
        :type project_person_body: ProjectPersonBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_projects_project_id_people_id_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            project_person_body=project_person_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_projects_project_id_people_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="ID of the project")],
        id: Annotated[StrictInt, Field(description="ID of the person")],
    ...
    @validate_call
    def rest_v10_projects_project_id_people_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="ID of the project")],
        id: Annotated[StrictInt, Field(description="ID of the person")],
    ...
    def _rest_v10_projects_project_id_people_id_patch_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if project_person_body is not None:
            _body_params = project_person_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/projects/{project_id}/people/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_people_post(
        ...
        _param = self._rest_v10_projects_project_id_people_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            project_person_body=project_person_body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_people_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        project_person_body: ProjectPersonBody,
    ...
    @validate_call
    def rest_v10_projects_project_id_people_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        project_person_body: ProjectPersonBody,
    ...
    def _rest_v10_projects_project_id_people_post_serialize(
        self,
        procore_company_id,
        project_id,
        project_person_body,
