...
class ProjectManagementSubmittalsSubmittalApproversApi:
    ...
    def rest_v10_submittal_approvers_id_patch(
        ...
        id: Annotated[StrictInt, Field(description="Submittal Approver ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        submittal_id: Annotated[StrictInt, Field(description="Submittal ID")],
    ...
    ) -> List[RestV10SubmittalApproversIdPatch200ResponseInner]:
        ...
        :param id: Submittal Approver ID (required)
        :type id: int
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param submittal_id: Submittal ID (required)
        :type submittal_id: int
        :param rest_v10_submittal_approvers_id_patch_request: (required)
        :type rest_v10_submittal_approvers_id_patch_request: RestV10SubmittalApproversIdPatchRequest
        ...
        _param = self._rest_v10_submittal_approvers_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            project_id=project_id,
            submittal_id=submittal_id,
            rest_v10_submittal_approvers_id_patch_request=rest_v10_submittal_approvers_id_patch_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10SubmittalApproversIdPatch200ResponseInner]",
    ...
    @validate_call
    def rest_v10_submittal_approvers_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Submittal Approver ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10SubmittalApproversIdPatch200ResponseInner]]:
        """Update Submittal Approver
    ...
    @validate_call
    def rest_v10_submittal_approvers_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Submittal Approver ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_submittal_approvers_id_patch_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        if submittal_id is not None:
            ...
            _query_params.append(('submittal_id', submittal_id))
        ...
        if rest_v10_submittal_approvers_id_patch_request is not None:
            _body_params = rest_v10_submittal_approvers_id_patch_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/submittal_approvers/{id}',
