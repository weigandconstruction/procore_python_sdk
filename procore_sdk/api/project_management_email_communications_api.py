...
class ProjectManagementEmailCommunicationsApi:
    ...
    @validate_call
    def rest_v10_communications_id_get(
        self,
        ...
        _param = self._rest_v10_communications_id_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CommunicationsIdGet200Response",
    ...
    @validate_call
    def rest_v10_communications_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Communication ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CommunicationsIdGet200Response]:
        """Show Communication
    ...
    @validate_call
    def rest_v10_communications_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Communication ID")],
    ...
    def _rest_v10_communications_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/communications/{id}',
