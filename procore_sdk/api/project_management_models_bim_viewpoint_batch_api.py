...
class ProjectManagementModelsBIMViewpointBatchApi:
    ...
    @validate_call
    def rest_v10_bim_viewpoints_batch_post(
        self,
        ...
        :param body122: (required)
        :type body122: Body122
        ...
        _param = self._rest_v10_bim_viewpoints_batch_post_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BIMViewpointBatchCreateResponse",
    ...
    @validate_call
    def rest_v10_bim_viewpoints_batch_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body122: Body122,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BIMViewpointBatchCreateResponse]:
        """Create a batch of BIM Viewpoints
    ...
    @validate_call
    def rest_v10_bim_viewpoints_batch_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body122: Body122,
        _request_timeout: Union[
    ...
    def _rest_v10_bim_viewpoints_batch_post_serialize(
        self,
        procore_company_id,
        body122,
        _request_auth,
        ...
        if body122 is not None:
            _body_params = body122
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/bim_viewpoints/batch',
