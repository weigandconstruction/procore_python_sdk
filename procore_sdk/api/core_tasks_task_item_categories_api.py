...
class CoreTasksTaskItemCategoriesApi:
    ...
    def rest_v10_companies_company_id_projects_project_id_task_item_categories_get(
        ...
        view: Annotated[Optional[StrictStr], Field(description="View to use when generating json. Defaults to normal")] = None,
    ...
    ) -> List[RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCategoriesGet200ResponseInner]:
        ...
        :type per_page: int
        :param view: View to use when generating json. Defaults to normal
        :type view: str
        ...
        _param = self._rest_v10_companies_company_id_projects_project_id_task_item_categories_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCategoriesGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_companies_company_id_projects_project_id_task_item_categories_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCategoriesGet200ResponseInner]]:
        """List task item categories
    ...
    @validate_call
    def rest_v10_companies_company_id_projects_project_id_task_item_categories_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_companies_company_id_projects_project_id_task_item_categories_get_serialize(
        self,
        procore_company_id,
        company_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/projects/{project_id}/task_item_categories',
