...
class CoreCompanyDirectoryDistributionGroupsApi:
    ...
    def rest_v10_companies_company_id_distribution_groups_get(
        ...
        with_domain_users: Annotated[Optional[RestV10CompaniesCompanyIdDistributionGroupsGetWithDomainUsersParameter], Field(description="Return list of user IDs that have permissions to view specified domain.")] = None,
        ...
        :param with_domain_users: Return list of user IDs that have permissions to view specified domain.
        :type with_domain_users: RestV10CompaniesCompanyIdDistributionGroupsGetWithDomainUsersParameter
        ...
        _param = self._rest_v10_companies_company_id_distribution_groups_get_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            page=page,
            per_page=per_page,
            filters_search=filters_search,
            with_domain_users=with_domain_users,
            sort=sort,
            view=view,
    ...
    @validate_call
    def rest_v10_companies_company_id_distribution_groups_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_companies_company_id_distribution_groups_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_distribution_groups_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        if with_domain_users is not None:
            
            _query_params.append(('with_domain_users', with_domain_users))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/distribution_groups',
