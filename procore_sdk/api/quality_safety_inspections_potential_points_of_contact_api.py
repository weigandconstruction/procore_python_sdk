...
class QualitySafetyInspectionsPotentialPointsOfContactApi:
    ...
    def rest_v10_checklist_potential_points_of_contact_get(
        ...
        vendor_id: Annotated[Optional[StrictInt], Field(description="Vendor ID")] = None,
    ...
    ) -> List[ChecklistPotentialPointOfContact]:
        """(Deprecated) List Potential Points of Contact
        ...
        """ # noqa: E501
        warnings.warn("GET /rest/v1.0/checklist/potential_points_of_contact is deprecated.", DeprecationWarning)

        _param = self._rest_v10_checklist_potential_points_of_contact_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ChecklistPotentialPointOfContact]",
    ...
    @validate_call
    def rest_v10_checklist_potential_points_of_contact_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        vendor_id: Annotated[Optional[StrictInt], Field(description="Vendor ID")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChecklistPotentialPointOfContact]]:
        """(Deprecated) List Potential Points of Contact
    ...
    @validate_call
    def rest_v10_checklist_potential_points_of_contact_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        vendor_id: Annotated[Optional[StrictInt], Field(description="Vendor ID")] = None,
    ...
    def _rest_v10_checklist_potential_points_of_contact_get_serialize(
        self,
        procore_company_id,
        project_id,
        vendor_id,
        ...
        if vendor_id is not None:
            ...
            _query_params.append(('vendor_id', vendor_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/checklist/potential_points_of_contact',
