...
class FieldProductivityTimecardGpsPositionsApi:
    ...
    def rest_v10_companies_company_id_gps_positions_get(
    ...
    ) -> List[RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner]:
        """List Gps Positions
        ...
        _param = self._rest_v10_companies_company_id_gps_positions_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner]]:
        """List Gps Positions
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
    ...
    def _rest_v10_companies_company_id_gps_positions_get_serialize(
        self,
        procore_company_id,
        company_id,
        filters_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/gps_positions',
    ...
    def rest_v10_companies_company_id_gps_positions_id_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Gps Position")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param id: ID of the Gps Position (required)
        :type id: int
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._rest_v10_companies_company_id_gps_positions_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            company_id=company_id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Gps Position")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner]:
        """Show Gps Position
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Gps Position")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_companies_company_id_gps_positions_id_get_serialize(
        self,
        procore_company_id,
        id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/gps_positions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_companies_company_id_gps_positions_post(
        ...
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param rest_v10_companies_company_id_gps_positions_post_request: (required)
        :type rest_v10_companies_company_id_gps_positions_post_request: RestV10CompaniesCompanyIdGpsPositionsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_companies_company_id_gps_positions_post_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            rest_v10_companies_company_id_gps_positions_post_request=rest_v10_companies_company_id_gps_positions_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10CompaniesCompanyIdGpsPositionsGet200ResponseInner",
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        rest_v10_companies_company_id_gps_positions_post_request: RestV10CompaniesCompanyIdGpsPositionsPostRequest,
    ...
    @validate_call
    def rest_v10_companies_company_id_gps_positions_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        rest_v10_companies_company_id_gps_positions_post_request: RestV10CompaniesCompanyIdGpsPositionsPostRequest,
    ...
    def _rest_v10_companies_company_id_gps_positions_post_serialize(
        self,
        procore_company_id,
        company_id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_companies_company_id_gps_positions_post_request is not None:
            _body_params = rest_v10_companies_company_id_gps_positions_post_request
