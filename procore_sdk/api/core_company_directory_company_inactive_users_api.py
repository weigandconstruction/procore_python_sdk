...
class CoreCompanyDirectoryCompanyInactiveUsersApi:
    ...
    def rest_v10_companies_company_id_users_inactive_get(
        ...
        _param = self._rest_v10_companies_company_id_users_inactive_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_users_inactive_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_companies_company_id_users_inactive_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_users_inactive_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/users/inactive',
    ...
    def rest_v10_companies_company_id_users_inactive_id_patch(
        ...
        _param = self._rest_v10_companies_company_id_users_inactive_id_patch_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_companies_company_id_users_inactive_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="ID of the user")],
    ...
    @validate_call
    def rest_v10_companies_company_id_users_inactive_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="ID of the user")],
    ...
    def _rest_v10_companies_company_id_users_inactive_id_patch_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/companies/{company_id}/users/inactive/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
