...
class QualitySafetyObservationsCompanyObservationTemplatesApi:
    ...
    def rest_v10_companies_company_id_observation_templates_bulk_update_patch(
        ...
        observation_template_ids: Annotated[Optional[List[StrictInt]], Field(description="IDs of all Company Observation Templates specified for bulk update")] = None,
    ...
    ) -> List[CompanyObservationTemplate1]:
        ...
        :type company_id: int
        :param rest_v10_companies_company_id_observation_templates_bulk_update_patch_request: (required)
        :type rest_v10_companies_company_id_observation_templates_bulk_update_patch_request: RestV10CompaniesCompanyIdObservationTemplatesBulkUpdatePatchRequest
        :param observation_template_ids: IDs of all Company Observation Templates specified for bulk update
        ...
        _param = self._rest_v10_companies_company_id_observation_templates_bulk_update_patch_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            rest_v10_companies_company_id_observation_templates_bulk_update_patch_request=rest_v10_companies_company_id_observation_templates_bulk_update_patch_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[CompanyObservationTemplate1]",
    ...
    @validate_call
    def rest_v10_companies_company_id_observation_templates_bulk_update_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        rest_v10_companies_company_id_observation_templates_bulk_update_patch_request: RestV10CompaniesCompanyIdObservationTemplatesBulkUpdatePatchRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CompanyObservationTemplate1]]:
        """Bulk Update Company Observation Templates
    ...
    @validate_call
    def rest_v10_companies_company_id_observation_templates_bulk_update_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        rest_v10_companies_company_id_observation_templates_bulk_update_patch_request: RestV10CompaniesCompanyIdObservationTemplatesBulkUpdatePatchRequest,
    ...
    def _rest_v10_companies_company_id_observation_templates_bulk_update_patch_serialize(
        self,
        procore_company_id,
        company_id,
        ...
        if rest_v10_companies_company_id_observation_templates_bulk_update_patch_request is not None:
            _body_params = rest_v10_companies_company_id_observation_templates_bulk_update_patch_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/companies/{company_id}/observation_templates/bulk_update',
