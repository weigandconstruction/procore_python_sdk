...
class ProjectManagementModelsBIMGeometryFileBundlesApi:
    ...
    def rest_v10_bim_geometry_file_bundles_id_get(
        ...
        id: Annotated[StrictInt, Field(description="BIM Geometry File Bundle ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        view: Annotated[Optional[StrictStr], Field(description="The compact view contains only ids. The extended view contains the response shown below. The normal view contains ids instead of objects for each file object. The default view is normal.")] = None,
        ...
        :param id: BIM Geometry File Bundle ID (required)
        :type id: int
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param view: The compact view contains only ids. The extended view contains the response shown below. The normal view contains ids instead of objects for each file object. The default view is normal.
        :type view: str
        ...
        _param = self._rest_v10_bim_geometry_file_bundles_id_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10BimGeometryFileBundlesIdGet200Response",
    ...
    @validate_call
    def rest_v10_bim_geometry_file_bundles_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="BIM Geometry File Bundle ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10BimGeometryFileBundlesIdGet200Response]:
        """Show BIM Geometry File Bundle
    ...
    @validate_call
    def rest_v10_bim_geometry_file_bundles_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="BIM Geometry File Bundle ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_bim_geometry_file_bundles_id_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/bim_geometry_file_bundles/{id}',
    ...
    def rest_v10_bim_geometry_file_bundles_post(
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param body139: (required)
        :type body139: Body139
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_bim_geometry_file_bundles_post_serialize(
            procore_company_id=procore_company_id,
            body139=body139,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10BimGeometryFileBundlesPost201Response",
    ...
    @validate_call
    def rest_v10_bim_geometry_file_bundles_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body139: Body139,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10BimGeometryFileBundlesPost201Response]:
        """Create BIM Geometry File Bundle
    ...
    @validate_call
    def rest_v10_bim_geometry_file_bundles_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body139: Body139,
        _request_timeout: Union[
    ...
    def _rest_v10_bim_geometry_file_bundles_post_serialize(
        self,
        procore_company_id,
        body139,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if body139 is not None:
            _body_params = body139
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/bim_geometry_file_bundles',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
