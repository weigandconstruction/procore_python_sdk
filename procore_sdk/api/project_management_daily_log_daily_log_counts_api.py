...
class ProjectManagementDailyLogDailyLogCountsApi:
    ...
    def rest_v11_projects_project_id_daily_logs_counts_get(
        ...
        _param = self._rest_v11_projects_project_id_daily_logs_counts_get_serialize(
    ...
    @validate_call
    def rest_v11_projects_project_id_daily_logs_counts_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        log_date: Annotated[Optional[date], Field(description="Date of specific logs desired. Example formats YYYY-MM-DD, YYYY/MM/DD, DD-MM-YYYY, DD/MM/YYYY")] = None,
    ...
    @validate_call
    def rest_v11_projects_project_id_daily_logs_counts_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        log_date: Annotated[Optional[date], Field(description="Date of specific logs desired. Example formats YYYY-MM-DD, YYYY/MM/DD, DD-MM-YYYY, DD/MM/YYYY")] = None,
    ...
    def _rest_v11_projects_project_id_daily_logs_counts_get_serialize(
        self,
        procore_company_id,
        project_id,
        log_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.1/projects/{project_id}/daily_logs/counts',
