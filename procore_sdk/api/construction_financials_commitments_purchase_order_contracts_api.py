...
class ConstructionFinancialsCommitmentsPurchaseOrderContractsApi:
    ...
    def rest_v10_purchase_order_contracts_get(
        ...
        view: Annotated[Optional[StrictStr], Field(description="Specifies how much information to show for each purchase order contract. The compact view is returned by default.")] = None,
        ...
        filters_status: Annotated[Optional[StrictStr], Field(description="Return item(s) with the specified Purchase Order Contract status.")] = None,
    ...
    ) -> List[RestV10PurchaseOrderContractsGet200ResponseInner]:
        ...
        :type project_id: int
        :param view: Specifies how much information to show for each purchase order contract. The compact view is returned by default.
        :type view: str
        :param page: Page
        :type page: int
        ...
        :param filters_status: Return item(s) with the specified Purchase Order Contract status.
        ...
        _param = self._rest_v10_purchase_order_contracts_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10PurchaseOrderContractsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        view: Annotated[Optional[StrictStr], Field(description="Specifies how much information to show for each purchase order contract. The compact view is returned by default.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10PurchaseOrderContractsGet200ResponseInner]]:
        """List of Purchase Order Contracts
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        view: Annotated[Optional[StrictStr], Field(description="Specifies how much information to show for each purchase order contract. The compact view is returned by default.")] = None,
    ...
    def _rest_v10_purchase_order_contracts_get_serialize(
        self,
        procore_company_id,
        project_id,
        view,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/purchase_order_contracts',
    ...
    def rest_v10_purchase_order_contracts_id_delete(
        ...
        _param = self._rest_v10_purchase_order_contracts_id_delete_serialize(
            procore_company_id=procore_company_id,
            id=id,
            project_id=project_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_purchase_order_contracts_id_delete_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/purchase_order_contracts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_purchase_order_contracts_id_get(
        ...
        _param = self._rest_v10_purchase_order_contracts_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            project_id=project_id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10PurchaseOrderContractsPost201Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10PurchaseOrderContractsPost201Response]:
        """Show Purchase Order Contract
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_purchase_order_contracts_id_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
    ...
    def rest_v10_purchase_order_contracts_id_patch(
        ...
        _param = self._rest_v10_purchase_order_contracts_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            body26=body26,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        body26: Body26,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        body26: Body26,
    ...
    def _rest_v10_purchase_order_contracts_id_patch_serialize(
        self,
        procore_company_id,
        id,
        body26,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body26: Body26,
        run_configurable_validations: Annotated[Optional[StrictBool], Field(description="If true, validations are run for the corresponding Configurable Field Set.")] = None,
        ...
        _param = self._rest_v10_purchase_order_contracts_post_serialize(
            procore_company_id=procore_company_id,
            body26=body26,
            run_configurable_validations=run_configurable_validations,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10PurchaseOrderContractsPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body26: Body26,
        run_configurable_validations: Annotated[Optional[StrictBool], Field(description="If true, validations are run for the corresponding Configurable Field Set.")] = None,
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body26: Body26,
        run_configurable_validations: Annotated[Optional[StrictBool], Field(description="If true, validations are run for the corresponding Configurable Field Set.")] = None,
    ...
    def _rest_v10_purchase_order_contracts_post_serialize(
        self,
        procore_company_id,
        body26,
        run_configurable_validations,
    ...
    def rest_v10_purchase_order_contracts_sync_patch(
        ...
        _param = self._rest_v10_purchase_order_contracts_sync_patch_serialize(
            procore_company_id=procore_company_id,
            body27=body27,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10PurchaseOrderContractsSyncPatch200Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_sync_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body27: Body27,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10PurchaseOrderContractsSyncPatch200Response]:
        """Sync Purchase Order Contracts
    ...
    @validate_call
    def rest_v10_purchase_order_contracts_sync_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body27: Body27,
        _request_timeout: Union[
    ...
    def _rest_v10_purchase_order_contracts_sync_patch_serialize(
        self,
        procore_company_id,
        body27,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/purchase_order_contracts/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
