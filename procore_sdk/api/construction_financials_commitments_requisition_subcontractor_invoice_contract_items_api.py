...
class ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceContractItemsApi:
    ...
    def rest_v10_requisitions_requisition_id_contract_items_get(
    ...
    ) -> List[RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner]:
        ...
        _param = self._rest_v10_requisitions_requisition_id_contract_items_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner]]:
        """List Requisition (Subcontractor Invoice) Contract Items
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_requisitions_requisition_id_contract_items_get_serialize(
        self,
        procore_company_id,
        requisition_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/requisitions/{requisition_id}/contract_items',
    ...
    def rest_v10_requisitions_requisition_id_contract_items_id_get(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        id: Annotated[StrictInt, Field(description="Contract Item ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param requisition_id: Requisition (Subcontractor Invoice) ID (required)
        :type requisition_id: int
        :param id: Contract Item ID (required)
        :type id: int
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._rest_v10_requisitions_requisition_id_contract_items_id_get_serialize(
            procore_company_id=procore_company_id,
            requisition_id=requisition_id,
            id=id,
            project_id=project_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '404': "RestV10WorkOrderContractsWorkOrderContractIdSubcontractorScheduleOfValuesStatusPatch404Response",
        }
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        id: Annotated[StrictInt, Field(description="Contract Item ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner]:
        """Show Requisition (Subcontractor Invoice) Contract Item
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        id: Annotated[StrictInt, Field(description="Contract Item ID")],
    ...
    def _rest_v10_requisitions_requisition_id_contract_items_id_get_serialize(
        self,
        procore_company_id,
        requisition_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/requisitions/{requisition_id}/contract_items/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_requisitions_requisition_id_contract_items_id_patch(
        ...
        """(Deprecated) Update Requisition (Subcontractor Invoice) Contract Item
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PATCH /rest/v1.0/requisitions/{requisition_id}/contract_items/{id} is deprecated.", DeprecationWarning)

        _param = self._rest_v10_requisitions_requisition_id_contract_items_id_patch_serialize(
            procore_company_id=procore_company_id,
            requisition_id=requisition_id,
            id=id,
            project_id=project_id,
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        id: Annotated[StrictInt, Field(description="Contract Item ID")],
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_contract_items_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        id: Annotated[StrictInt, Field(description="Contract Item ID")],
    ...
    def _rest_v10_requisitions_requisition_id_contract_items_id_patch_serialize(
        self,
        procore_company_id,
        requisition_id,
        id,
