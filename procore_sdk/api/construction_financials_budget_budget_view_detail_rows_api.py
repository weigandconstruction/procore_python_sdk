...
class ConstructionFinancialsBudgetBudgetViewDetailRowsApi:
    ...
    def rest_v10_budget_views_budget_view_id_detail_rows_get(
        ...
        budget_row_type: Annotated[Optional[StrictStr], Field(description="Return budgeted, unbudgeted or all item(s) from all budget rows for a project. Default is budgeted. Note that when the unbudgeted or all values are supplied, the id field will be null for rows that have budgeted false")] = None,
        ...
        :type sort: str
        :param budget_row_type: Return budgeted, unbudgeted or all item(s) from all budget rows for a project. Default is budgeted. Note that when the unbudgeted or all values are supplied, the id field will be null for rows that have budgeted false
        ...
        _param = self._rest_v10_budget_views_budget_view_id_detail_rows_get_serialize(
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_detail_rows_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_detail_rows_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_budget_views_budget_view_id_detail_rows_get_serialize(
        self,
        procore_company_id,
        budget_view_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/budget_views/{budget_view_id}/detail_rows',
