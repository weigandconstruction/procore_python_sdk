...
class ProjectManagementCoordinationIssuesCoordinationIssueStatusTotalsApi:
    ...
    def rest_v10_coordination_issues_status_total_get(
        ...
        _param = self._rest_v10_coordination_issues_status_total_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CoordinationIssuesStatusTotalGet200Response",
    ...
    @validate_call
    def rest_v10_coordination_issues_status_total_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CoordinationIssuesStatusTotalGet200Response]:
        """Show Coordination Issue Count by Status
    ...
    @validate_call
    def rest_v10_coordination_issues_status_total_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
    ...
    def _rest_v10_coordination_issues_status_total_get_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/coordination_issues/status_total',
