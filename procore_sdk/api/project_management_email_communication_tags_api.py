...
class ProjectManagementEmailCommunicationTagsApi:
    ...
    @validate_call
    def rest_v10_communication_tags_get(
        self,
    ...
    ) -> List[RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner]:
        ...
        _param = self._rest_v10_communication_tags_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner]",
    ...
    @validate_call
    def rest_v10_communication_tags_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner]]:
        """List communication tags
    ...
    @validate_call
    def rest_v10_communication_tags_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_communication_tags_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/communication_tags',
    ...
    def rest_v10_communication_tags_post(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner:
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param rest_v10_communication_tags_post_request: (required)
        :type rest_v10_communication_tags_post_request: RestV10CommunicationTagsPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_communication_tags_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            rest_v10_communication_tags_post_request=rest_v10_communication_tags_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner",
            '201': "RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def rest_v10_communication_tags_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_communication_tags_post_request: RestV10CommunicationTagsPostRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CommunicationsIdGet200ResponseAllOfCommunicationTagsInner]:
        """Create communication tag
    ...
    @validate_call
    def rest_v10_communication_tags_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        rest_v10_communication_tags_post_request: RestV10CommunicationTagsPostRequest,
    ...
    def _rest_v10_communication_tags_post_serialize(
        self,
        procore_company_id,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_communication_tags_post_request is not None:
            _body_params = rest_v10_communication_tags_post_request
