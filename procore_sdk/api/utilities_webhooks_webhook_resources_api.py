...
class UtilitiesWebhooksWebhookResourcesApi:
    ...
    def rest_v10_webhooks_resources_api_versions_get(
        ...
        _param = self._rest_v10_webhooks_resources_api_versions_get_serialize(
    ...
    @validate_call
    def rest_v10_webhooks_resources_api_versions_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_webhooks_resources_api_versions_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
    ...
    def _rest_v10_webhooks_resources_api_versions_get_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/webhooks/resources/api_versions',
    ...
    @validate_call
    def rest_v10_webhooks_resources_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
        ...
        _param = self._rest_v10_webhooks_resources_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rest_v10_webhooks_resources_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[WebhooksResource]]:
        """List Webhooks Resources
    ...
    @validate_call
    def rest_v10_webhooks_resources_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
    ...
    def _rest_v10_webhooks_resources_get_serialize(
        self,
        procore_company_id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/webhooks/resources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
