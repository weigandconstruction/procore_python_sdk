...
class ConstructionFinancialsCommitmentsBillingPeriodsApi:
    ...
    def rest_v10_projects_project_id_billing_periods_get(
        ...
        filters_status: Annotated[Optional[StrictStr], Field(description="Return item(s) with the specified Billing Period status.")] = None,
        ...
        :param filters_status: Return item(s) with the specified Billing Period status.
        ...
        _param = self._rest_v10_projects_project_id_billing_periods_get_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BillingPeriod]]:
        """List billing periods
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_projects_project_id_billing_periods_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/billing_periods',
    ...
    def rest_v10_projects_project_id_billing_periods_id_delete(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param id: Billing Period ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_projects_project_id_billing_periods_id_delete_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    def _rest_v10_projects_project_id_billing_periods_id_delete_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/projects/{project_id}/billing_periods/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_billing_periods_id_get(
        ...
        _param = self._rest_v10_projects_project_id_billing_periods_id_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    def _rest_v10_projects_project_id_billing_periods_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
    ...
    def rest_v10_projects_project_id_billing_periods_id_patch(
        ...
        :param id: Billing Period ID (required)
        :type id: int
        :param body142: (required)
        :type body142: Body142
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_projects_project_id_billing_periods_id_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            body142=body142,
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Billing Period ID")],
    ...
    def _rest_v10_projects_project_id_billing_periods_id_patch_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if body142 is not None:
            _body_params = body142
    ...
    def rest_v10_projects_project_id_billing_periods_post(
        ...
        _param = self._rest_v10_projects_project_id_billing_periods_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            body142=body142,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        body142: Body142,
    ...
    @validate_call
    def rest_v10_projects_project_id_billing_periods_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        body142: Body142,
    ...
    def _rest_v10_projects_project_id_billing_periods_post_serialize(
        self,
        procore_company_id,
        project_id,
        body142,
