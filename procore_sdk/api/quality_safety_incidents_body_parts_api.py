...
class QualitySafetyIncidentsBodyPartsApi:
    ...
    def rest_v10_companies_company_id_incidents_body_parts_get(
        ...
        filters_selectable: Annotated[Optional[StrictBool], Field(description="If true, return item(s) with 'selectable' status.")] = None,
        ...
        sort: Annotated[Optional[StrictStr], Field(description="Body Parts")] = None,
        ...
        :type per_page: int
        :param filters_selectable: If true, return item(s) with 'selectable' status.
        :type filters_selectable: bool
        ...
        _param = self._rest_v10_companies_company_id_incidents_body_parts_get_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            page=page,
            per_page=per_page,
            filters_selectable=filters_selectable,
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_body_parts_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_body_parts_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_incidents_body_parts_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        if filters_selectable is not None:
            
            _query_params.append(('filters[selectable]', filters_selectable))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/incidents/body_parts',
