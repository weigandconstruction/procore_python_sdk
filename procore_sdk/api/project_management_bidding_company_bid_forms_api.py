...
class ProjectManagementBiddingCompanyBidFormsApi:
    ...
    def rest_v10_companies_company_id_bid_bid_id_bid_forms_bid_form_id_get(
        ...
        bid_id: Annotated[StrictInt, Field(description="Bid ID")],
        ...
        _param = self._rest_v10_companies_company_id_bid_bid_id_bid_forms_bid_form_id_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_bid_bid_id_bid_forms_bid_form_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_id: Annotated[StrictInt, Field(description="Bid ID")],
    ...
    @validate_call
    def rest_v10_companies_company_id_bid_bid_id_bid_forms_bid_form_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_id: Annotated[StrictInt, Field(description="Bid ID")],
    ...
    def _rest_v10_companies_company_id_bid_bid_id_bid_forms_bid_form_id_get_serialize(
        self,
        procore_company_id,
        company_id,
        bid_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/bid/{bid_id}/bid_forms/{bid_form_id}',
