...
class CoreProjectDirectoryProjectMembershipsApi:
    ...
    def rest_v10_projects_project_id_project_memberships_bulk_add_post(
        ...
        :type project_id: int
        :param bulk_create_project_membership_body: (required)
        :type bulk_create_project_membership_body: BulkCreateProjectMembershipBody
        ...
        _param = self._rest_v10_projects_project_id_project_memberships_bulk_add_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            bulk_create_project_membership_body=bulk_create_project_membership_body,
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_bulk_add_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        bulk_create_project_membership_body: BulkCreateProjectMembershipBody,
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_bulk_add_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        bulk_create_project_membership_body: BulkCreateProjectMembershipBody,
    ...
    def _rest_v10_projects_project_id_project_memberships_bulk_add_post_serialize(
        self,
        procore_company_id,
        project_id,
        ...
        if bulk_create_project_membership_body is not None:
            _body_params = bulk_create_project_membership_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/projects/{project_id}/project_memberships/bulk_add',
    ...
    def rest_v10_projects_project_id_project_memberships_get(
        ...
        _param = self._rest_v10_projects_project_id_project_memberships_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectMembership]]:
        """List Project Memberships
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_projects_project_id_project_memberships_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/project_memberships',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_project_memberships_id_delete(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="The ID of the Project Membership")],
        party_id: Annotated[StrictInt, Field(description="The ID of the Party (reference user)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param id: The ID of the Project Membership (required)
        :type id: int
        :param party_id: The ID of the Party (reference user) (required)
        :type party_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_projects_project_id_project_memberships_id_delete_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            id=id,
            party_id=party_id,
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="The ID of the Project Membership")],
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="The ID of the Project Membership")],
    ...
    def _rest_v10_projects_project_id_project_memberships_id_delete_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        if party_id is not None:
            ...
            _query_params.append(('party_id', party_id))
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/projects/{project_id}/project_memberships/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_project_memberships_post(
        ...
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param project_membership_body: (required)
        :type project_membership_body: ProjectMembershipBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_projects_project_id_project_memberships_post_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            project_membership_body=project_membership_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        project_membership_body: ProjectMembershipBody,
    ...
    @validate_call
    def rest_v10_projects_project_id_project_memberships_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        project_membership_body: ProjectMembershipBody,
    ...
    def _rest_v10_projects_project_id_project_memberships_post_serialize(
        self,
        procore_company_id,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if project_membership_body is not None:
            _body_params = project_membership_body
