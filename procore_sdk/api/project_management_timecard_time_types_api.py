...
class ProjectManagementTimecardTimeTypesApi:
    ...
    @validate_call
    def rest_v10_timecard_time_types_get(
        self,
        ...
        _param = self._rest_v10_timecard_time_types_get_serialize(
    ...
    @validate_call
    def rest_v10_timecard_time_types_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TimecardTimeType1]]:
        """List Timecard Time Types
    ...
    @validate_call
    def rest_v10_timecard_time_types_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_timecard_time_types_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/timecard_time_types',
