...
class ProjectManagementCoordinationIssuesCoordinationIssueCountsApi:
    ...
    def rest_v10_coordination_issues_status_count_get(
        ...
        filters_group_by: Annotated[Optional[StrictStr], Field(description="Filter status counts by group_by attribute.")] = None,
    ...
    ) -> List[RestV10CoordinationIssuesStatusCountGet200ResponseInner]:
        ...
        :type project_id: int
        :param filters_group_by: Filter status counts by group_by attribute.
        :type filters_group_by: str
        :param page: Page
        :type page: int
        ...
        _param = self._rest_v10_coordination_issues_status_count_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            filters_group_by=filters_group_by,
            page=page,
            per_page=per_page,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CoordinationIssuesStatusCountGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_coordination_issues_status_count_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_group_by: Annotated[Optional[StrictStr], Field(description="Filter status counts by group_by attribute.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CoordinationIssuesStatusCountGet200ResponseInner]]:
        """List Grouped Coordination Issue Status Count
    ...
    @validate_call
    def rest_v10_coordination_issues_status_count_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_group_by: Annotated[Optional[StrictStr], Field(description="Filter status counts by group_by attribute.")] = None,
    ...
    def _rest_v10_coordination_issues_status_count_get_serialize(
        self,
        procore_company_id,
        project_id,
        filters_group_by,
        ...
        if filters_group_by is not None:
            
            _query_params.append(('filters[group_by]', filters_group_by))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/coordination_issues/status_count',
