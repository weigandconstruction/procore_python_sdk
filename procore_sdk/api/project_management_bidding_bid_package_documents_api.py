...
class ProjectManagementBiddingBidPackageDocumentsApi:
    ...
    def rest_v10_companies_company_id_planroom_bid_packages_bid_package_id_documents_get(
        ...
        _param = self._rest_v10_companies_company_id_planroom_bid_packages_bid_package_id_documents_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CompaniesCompanyIdPlanroomBidPackagesBidPackageIdDocumentsGet200Response",
    ...
    @validate_call
    def rest_v10_companies_company_id_planroom_bid_packages_bid_package_id_documents_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_package_id: Annotated[StrictInt, Field(description="Bid Package ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CompaniesCompanyIdPlanroomBidPackagesBidPackageIdDocumentsGet200Response]:
        """Gets documents attached to Bid Package
    ...
    @validate_call
    def rest_v10_companies_company_id_planroom_bid_packages_bid_package_id_documents_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        bid_package_id: Annotated[StrictInt, Field(description="Bid Package ID")],
    ...
    def _rest_v10_companies_company_id_planroom_bid_packages_bid_package_id_documents_get_serialize(
        self,
        procore_company_id,
        company_id,
        bid_package_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/planroom/bid_packages/{bid_package_id}/documents',
