...
class ConstructionFinancialsInvoicingInvoicingAsyncJobsApi:
    ...
    def rest_v10_companies_company_id_invoices_async_jobs_uuid_get(
        ...
        uuid: Annotated[StrictStr, Field(description="UUID of the Async Job")],
        ...
        :param uuid: UUID of the Async Job (required)
        :type uuid: str
        ...
        _param = self._rest_v10_companies_company_id_invoices_async_jobs_uuid_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CompaniesCompanyIdInvoicesAsyncJobsUuidGet200Response",
    ...
    @validate_call
    def rest_v10_companies_company_id_invoices_async_jobs_uuid_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        uuid: Annotated[StrictStr, Field(description="UUID of the Async Job")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CompaniesCompanyIdInvoicesAsyncJobsUuidGet200Response]:
        """Show an Async Job for a Company
    ...
    @validate_call
    def rest_v10_companies_company_id_invoices_async_jobs_uuid_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        uuid: Annotated[StrictStr, Field(description="UUID of the Async Job")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_companies_company_id_invoices_async_jobs_uuid_get_serialize(
        self,
        procore_company_id,
        uuid,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/invoices/async_jobs/{uuid}',
