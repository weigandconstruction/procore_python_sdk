...
class ProjectManagementModelsBIMViewFoldersApi:
    ...
    @validate_call
    def rest_v10_bim_view_folders_get(
        self,
        ...
        filters_parent_id: Annotated[Optional[StrictInt], Field(description="Filter item(s) with matching parent_id")] = None,
    ...
    ) -> List[RestV10NestedBimViewFoldersPost200Response]:
        ...
        :param filters_parent_id: Filter item(s) with matching parent_id
        ...
        _param = self._rest_v10_bim_view_folders_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10NestedBimViewFoldersPost200Response]",
    ...
    @validate_call
    def rest_v10_bim_view_folders_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10NestedBimViewFoldersPost200Response]]:
        """List BIM View Folders
    ...
    @validate_call
    def rest_v10_bim_view_folders_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_bim_view_folders_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/bim_view_folders',
    ...
    @validate_call
    def rest_v10_bim_view_folders_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body124: Body124,
        _request_timeout: Union[
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param body124: (required)
        :type body124: Body124
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_bim_view_folders_post_serialize(
            procore_company_id=procore_company_id,
            body124=body124,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10NestedBimViewFoldersPost200Response",
    ...
    @validate_call
    def rest_v10_bim_view_folders_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body124: Body124,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10NestedBimViewFoldersPost200Response]:
        """Create BIM View Folder
    ...
    @validate_call
    def rest_v10_bim_view_folders_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body124: Body124,
        _request_timeout: Union[
    ...
    def _rest_v10_bim_view_folders_post_serialize(
        self,
        procore_company_id,
        body124,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if body124 is not None:
            _body_params = body124
