...
class CoreProjectProjectRolesApi:
    ...
    @validate_call
    def rest_v10_project_roles_get(
        self,
        ...
        filters_created_at: Annotated[Optional[datetime], Field(description="Return item(s) created within the specified ISO 8601 datetime range.")] = None,
        ...
        :type per_page: int
        :param filters_created_at: Return item(s) created within the specified ISO 8601 datetime range.
        ...
        _param = self._rest_v10_project_roles_get_serialize(
    ...
    @validate_call
    def rest_v10_project_roles_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_project_roles_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_project_roles_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/project_roles',
    ...
    def rest_v10_project_roles_id_delete(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Project Role")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param id: ID of the Project Role (required)
        :type id: int
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._rest_v10_project_roles_id_delete_serialize(
            procore_company_id=procore_company_id,
            id=id,
            project_id=project_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_project_roles_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Project Role")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_project_roles_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Project Role")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_project_roles_id_delete_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/project_roles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def rest_v10_project_roles_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body36: Body36,
        _request_timeout: Union[
        ...
        _param = self._rest_v10_project_roles_post_serialize(
            procore_company_id=procore_company_id,
            body36=body36,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rest_v10_project_roles_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body36: Body36,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_project_roles_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body36: Body36,
        _request_timeout: Union[
    ...
    def _rest_v10_project_roles_post_serialize(
        self,
        procore_company_id,
        body36,
        _request_auth,
