...
class ProjectManagementCoordinationIssuesCoordinationIssueProcoreItemAssociationsApi:
    ...
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_id_delete(
        ...
        coordination_issue_id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        id: Annotated[StrictInt, Field(description="Procore Item Association ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        item_type: Annotated[StrictStr, Field(description="Type of Procore item")],
        ...
        :param coordination_issue_id: Coordination Issue ID (required)
        :type coordination_issue_id: int
        :param id: Procore Item Association ID (required)
        :type id: int
        :param project_id: Unique identifier for the project. (required)
        :type project_id: int
        :param item_type: Type of Procore item (required)
        :type item_type: str
        ...
        _param = self._rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_id_delete_serialize(
    ...
    @validate_call
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        coordination_issue_id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        id: Annotated[StrictInt, Field(description="Procore Item Association ID")],
    ...
    @validate_call
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        coordination_issue_id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        id: Annotated[StrictInt, Field(description="Procore Item Association ID")],
    ...
    def _rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_id_delete_serialize(
        self,
        procore_company_id,
        ...
        if coordination_issue_id is not None:
            _path_params['coordination_issue_id'] = coordination_issue_id
        if id is not None:
            _path_params['id'] = id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/coordination_issues/{coordination_issue_id}/procore_item_associations/{id}',
    ...
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_post(
        ...
        :param coordination_issue_id: Coordination Issue ID (required)
        :type coordination_issue_id: int
        :param body108: (required)
        :type body108: Body108
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_post_serialize(
            procore_company_id=procore_company_id,
            coordination_issue_id=coordination_issue_id,
            body108=body108,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CoordinationIssuesGet200ResponseInnerAllOfLinkedProcoreItemsInner",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '404': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
    ...
    @validate_call
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        coordination_issue_id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        body108: Body108,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CoordinationIssuesGet200ResponseInnerAllOfLinkedProcoreItemsInner]:
        """Create Procore Item Association
    ...
    @validate_call
    def rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        coordination_issue_id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        body108: Body108,
    ...
    def _rest_v10_coordination_issues_coordination_issue_id_procore_item_associations_post_serialize(
        self,
        procore_company_id,
        coordination_issue_id,
        body108,
        ...
        # process the form parameters
        # process the body parameter
        if body108 is not None:
            _body_params = body108
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/coordination_issues/{coordination_issue_id}/procore_item_associations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
