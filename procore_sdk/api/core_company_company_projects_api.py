...
class CoreCompanyCompanyProjectsApi:
    ...
    def rest_v10_companies_company_id_projects_get(
        ...
        _param = self._rest_v10_companies_company_id_projects_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_projects_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_companies_company_id_projects_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
    ...
    def _rest_v10_companies_company_id_projects_get_serialize(
        self,
        procore_company_id,
        company_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/projects',
