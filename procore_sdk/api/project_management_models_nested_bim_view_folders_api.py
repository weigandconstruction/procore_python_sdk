...
class ProjectManagementModelsNestedBIMViewFoldersApi:
    ...
    @validate_call
    def rest_v10_nested_bim_view_folders_post(
        self,
        ...
        _param = self._rest_v10_nested_bim_view_folders_post_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10NestedBimViewFoldersPost200Response",
    ...
    @validate_call
    def rest_v10_nested_bim_view_folders_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body59: Body59,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_nested_bim_view_folders_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body59: Body59,
        _request_timeout: Union[
    ...
    def _rest_v10_nested_bim_view_folders_post_serialize(
        self,
        procore_company_id,
        body59,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/nested_bim_view_folders',
