...
class ConstructionFinancialsBudgetBudgetDetailFiltersApi:
    ...
    def rest_v10_budget_detail_filters_get(
        ...
        column_id: Annotated[StrictStr, Field(description="Type of filter options to return")],
    ...
    ) -> List[RestV10BudgetDetailFiltersGet200ResponseInner]:
        ...
        :type project_id: int
        :param column_id: Type of filter options to return (required)
        :type column_id: str
        ...
        _param = self._rest_v10_budget_detail_filters_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10BudgetDetailFiltersGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_budget_detail_filters_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        column_id: Annotated[StrictStr, Field(description="Type of filter options to return")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10BudgetDetailFiltersGet200ResponseInner]]:
        """List Budget Detail Filter Options
    ...
    @validate_call
    def rest_v10_budget_detail_filters_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        column_id: Annotated[StrictStr, Field(description="Type of filter options to return")],
    ...
    def _rest_v10_budget_detail_filters_get_serialize(
        self,
        procore_company_id,
        project_id,
        column_id,
        ...
        if column_id is not None:
            ...
            _query_params.append(('column_id', column_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/budget_detail_filters',
