...
class ProjectManagementSubmittalsSubmittalPackagesApi:
    ...
    def rest_v10_projects_project_id_submittal_packages_get(
    ...
    ) -> List[RestV11ProjectsProjectIdSubmittalsPost201ResponseAllOfSubmittalPackage]:
        ...
        _param = self._rest_v10_projects_project_id_submittal_packages_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV11ProjectsProjectIdSubmittalsPost201ResponseAllOfSubmittalPackage]",
    ...
    @validate_call
    def rest_v10_projects_project_id_submittal_packages_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV11ProjectsProjectIdSubmittalsPost201ResponseAllOfSubmittalPackage]]:
        """List Submittal Packages on a project
    ...
    @validate_call
    def rest_v10_projects_project_id_submittal_packages_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
    ...
    def _rest_v10_projects_project_id_submittal_packages_get_serialize(
        self,
        procore_company_id,
        project_id,
        filters_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/submittal_packages',
