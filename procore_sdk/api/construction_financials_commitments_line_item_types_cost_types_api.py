...
class ConstructionFinancialsCommitmentsLineItemTypesCostTypesApi:
    ...
    def rest_v10_line_item_types_get(
        ...
        filters_origin_id: Annotated[Optional[StrictStr], Field(description="Origin ID")] = None,
        ...
        :type per_page: int
        :param filters_origin_id: Origin ID
        ...
        _param = self._rest_v10_line_item_types_get_serialize(
    ...
    @validate_call
    def rest_v10_line_item_types_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LineItemType1]]:
        """List Line Item Types
    ...
    @validate_call
    def rest_v10_line_item_types_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
    ...
    def _rest_v10_line_item_types_get_serialize(
        self,
        procore_company_id,
        company_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/line_item_types',
    ...
    @validate_call
    def rest_v10_line_item_types_id_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        ...
        _param = self._rest_v10_line_item_types_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            company_id=company_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_line_item_types_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    @validate_call
    def rest_v10_line_item_types_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_line_item_types_id_get_serialize(
        self,
        procore_company_id,
        id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/line_item_types/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def rest_v10_line_item_types_id_patch(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        body73: Body73,
        ...
        _param = self._rest_v10_line_item_types_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            body73=body73,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_line_item_types_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        body73: Body73,
    ...
    @validate_call
    def rest_v10_line_item_types_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        body73: Body73,
    ...
    def _rest_v10_line_item_types_id_patch_serialize(
        self,
        procore_company_id,
        id,
        body73,
    ...
    @validate_call
    def rest_v10_line_item_types_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body73: Body73,
        _request_timeout: Union[
        ...
        _param = self._rest_v10_line_item_types_post_serialize(
            procore_company_id=procore_company_id,
            body73=body73,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rest_v10_line_item_types_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body73: Body73,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_line_item_types_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body73: Body73,
        _request_timeout: Union[
    ...
    def _rest_v10_line_item_types_post_serialize(
        self,
        procore_company_id,
        body73,
        _request_auth,
    ...
    def rest_v10_line_item_types_sync_patch(
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param line_item_type_sync_body: (required)
        :type line_item_type_sync_body: LineItemTypeSyncBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_line_item_types_sync_patch_serialize(
            procore_company_id=procore_company_id,
            line_item_type_sync_body=line_item_type_sync_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10LineItemTypesSyncPatch200Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_line_item_types_sync_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        line_item_type_sync_body: LineItemTypeSyncBody,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10LineItemTypesSyncPatch200Response]:
        """Sync Line Item Types
    ...
    @validate_call
    def rest_v10_line_item_types_sync_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        line_item_type_sync_body: LineItemTypeSyncBody,
        _request_timeout: Union[
    ...
    def _rest_v10_line_item_types_sync_patch_serialize(
        self,
        procore_company_id,
        ...
        # process the form parameters
        # process the body parameter
        if line_item_type_sync_body is not None:
            _body_params = line_item_type_sync_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/line_item_types/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
