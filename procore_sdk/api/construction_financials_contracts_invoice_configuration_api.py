...
class ConstructionFinancialsContractsInvoiceConfigurationApi:
    ...
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_get(
        ...
        _param = self._rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10ProjectsProjectIdContractsContractIdInvoiceConfigurationGet200Response",
    ...
    @validate_call
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        contract_id: Annotated[StrictInt, Field(description="ID of the Contract")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10ProjectsProjectIdContractsContractIdInvoiceConfigurationGet200Response]:
        """Get Contract's Invoice Configuration
    ...
    @validate_call
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        contract_id: Annotated[StrictInt, Field(description="ID of the Contract")],
    ...
    def _rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_get_serialize(
        self,
        procore_company_id,
        project_id,
        contract_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/contracts/{contract_id}/invoice_configuration',
    ...
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch(
        ...
        :param contract_id: ID of the Contract (required)
        :type contract_id: int
        :param rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request: (required)
        :type rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request: RestV10ProjectsProjectIdContractsContractIdInvoiceConfigurationPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            contract_id=contract_id,
            rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request=rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        contract_id: Annotated[StrictInt, Field(description="ID of the Contract")],
    ...
    @validate_call
    def rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        contract_id: Annotated[StrictInt, Field(description="ID of the Contract")],
    ...
    def _rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_serialize(
        self,
        procore_company_id,
        project_id,
        contract_id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request is not None:
            _body_params = rest_v10_projects_project_id_contracts_contract_id_invoice_configuration_patch_request
