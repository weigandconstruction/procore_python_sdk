...
class ConstructionFinancialsCommitmentsRequisitionSubcontractorInvoiceChangeHistoriesApi:
    ...
    def rest_v10_requisitions_requisition_id_change_histories_get(
    ...
    ) -> List[RestV10RequisitionsRequisitionIdChangeHistoriesGet200ResponseInner]:
        ...
        _param = self._rest_v10_requisitions_requisition_id_change_histories_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10RequisitionsRequisitionIdChangeHistoriesGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_change_histories_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10RequisitionsRequisitionIdChangeHistoriesGet200ResponseInner]]:
        """List Requisition (Subcontractor Invoice) Change Histories
    ...
    @validate_call
    def rest_v10_requisitions_requisition_id_change_histories_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        requisition_id: Annotated[StrictInt, Field(description="Requisition (Subcontractor Invoice) ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_requisitions_requisition_id_change_histories_get_serialize(
        self,
        procore_company_id,
        requisition_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/requisitions/{requisition_id}/change_histories',
