...
class ProjectManagementGenericToolItemsGenericToolItemsApi:
    ...
    def rest_v10_generic_tool_items_id_get(
        ...
        id: Annotated[StrictInt, Field(description="Generic Tool Item ID")],
        ...
        :type project_id: int
        :param id: Generic Tool Item ID (required)
        :type id: int
        ...
        _param = self._rest_v10_generic_tool_items_id_get_serialize(
    ...
    @validate_call
    def rest_v10_generic_tool_items_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Generic Tool Item ID")],
    ...
    @validate_call
    def rest_v10_generic_tool_items_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="Generic Tool Item ID")],
    ...
    def _rest_v10_generic_tool_items_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/generic_tool_items/{id}',
