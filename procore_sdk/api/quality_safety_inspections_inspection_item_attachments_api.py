...
class QualitySafetyInspectionsInspectionItemAttachmentsApi:
    ...
    def rest_v10_projects_project_id_inspections_inspection_id_item_attachments_id_delete(
        ...
        id: Annotated[StrictInt, Field(description="Item Attachment ID")],
        ...
        :param id: Item Attachment ID (required)
        :type id: int
        ...
        _param = self._rest_v10_projects_project_id_inspections_inspection_id_item_attachments_id_delete_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_inspections_inspection_id_item_attachments_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        inspection_id: Annotated[StrictInt, Field(description="Unique identifier for the inspection.")],
    ...
    @validate_call
    def rest_v10_projects_project_id_inspections_inspection_id_item_attachments_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        inspection_id: Annotated[StrictInt, Field(description="Unique identifier for the inspection.")],
    ...
    def _rest_v10_projects_project_id_inspections_inspection_id_item_attachments_id_delete_serialize(
        self,
        procore_company_id,
        project_id,
        inspection_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/projects/{project_id}/inspections/{inspection_id}/item_attachments/{id}',
