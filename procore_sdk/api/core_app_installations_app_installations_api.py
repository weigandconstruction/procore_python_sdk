...
class CoreAppInstallationsAppInstallationsApi:
    ...
    def rest_v10_app_installations_get(
    ...
    ) -> List[RestV10AppInstallationsGet200ResponseInner]:
        ...
        _param = self._rest_v10_app_installations_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10AppInstallationsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_app_installations_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10AppInstallationsGet200ResponseInner]]:
        """List app installations
    ...
    @validate_call
    def rest_v10_app_installations_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
    ...
    def _rest_v10_app_installations_get_serialize(
        self,
        procore_company_id,
        company_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/app_installations',
    ...
    def rest_v10_app_installations_id_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="App installation ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project. You must supply either a company_id or project_id.")],
        _request_timeout: Union[
            None,
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param id: App installation ID (required)
        :type id: int
        :param company_id: Unique identifier for the company. You must supply either a company_id or project_id. (required)
        :type company_id: int
        :param project_id: Unique identifier for the project. You must supply either a company_id or project_id. (required)
        ...
        _param = self._rest_v10_app_installations_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            company_id=company_id,
            project_id=project_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10AppInstallationsPost201Response",
    ...
    @validate_call
    def rest_v10_app_installations_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="App installation ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10AppInstallationsPost201Response]:
        """Show app installation
    ...
    @validate_call
    def rest_v10_app_installations_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="App installation ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company. You must supply either a company_id or project_id.")],
    ...
    def _rest_v10_app_installations_id_get_serialize(
        self,
        procore_company_id,
        id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/app_installations/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_app_installations_id_patch(
        ...
        :param id: App installation ID (required)
        :type id: int
        :param rest_v10_app_installations_id_patch_request: (required)
        :type rest_v10_app_installations_id_patch_request: RestV10AppInstallationsIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_app_installations_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            rest_v10_app_installations_id_patch_request=rest_v10_app_installations_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10AppInstallationsGet200ResponseInner",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
        }
    ...
    @validate_call
    def rest_v10_app_installations_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="App installation ID")],
        rest_v10_app_installations_id_patch_request: RestV10AppInstallationsIdPatchRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10AppInstallationsGet200ResponseInner]:
        """Update app installation
    ...
    @validate_call
    def rest_v10_app_installations_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="App installation ID")],
        rest_v10_app_installations_id_patch_request: RestV10AppInstallationsIdPatchRequest,
    ...
    def _rest_v10_app_installations_id_patch_serialize(
        self,
        procore_company_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_app_installations_id_patch_request is not None:
            _body_params = rest_v10_app_installations_id_patch_request
    ...
    @validate_call
    def rest_v10_app_installations_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body146: Body146,
        _request_timeout: Union[
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param body146: (required)
        :type body146: Body146
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_app_installations_post_serialize(
            procore_company_id=procore_company_id,
            body146=body146,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10AppInstallationsPost201Response",
            '400': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
    ...
    @validate_call
    def rest_v10_app_installations_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body146: Body146,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_app_installations_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body146: Body146,
        _request_timeout: Union[
    ...
    def _rest_v10_app_installations_post_serialize(
        self,
        procore_company_id,
        body146,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if body146 is not None:
            _body_params = body146
