...
class QualityAndSafetyInspectionsInspectionItemEvidenceConfigurationsApi:
    ...
    def rest_v20_companies_company_id_projects_project_id_inspection_items_item_id_evidence_configuration_get(
        ...
        filters_id: Annotated[Optional[List[StrictStr]], Field(description="Return Item Evidence Configuration(s) with the specified IDs")] = None,
        ...
        :type per_page: int
        :param filters_id: Return Item Evidence Configuration(s) with the specified IDs
        ...
        _param = self._rest_v20_companies_company_id_projects_project_id_inspection_items_item_id_evidence_configuration_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdEvidenceConfigurationGet200Response",
    ...
    @validate_call
    def rest_v20_companies_company_id_projects_project_id_inspection_items_item_id_evidence_configuration_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictStr, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictStr, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdEvidenceConfigurationGet200Response]:
        """Get a list of Inspection Item Evidence Configurations
    ...
    @validate_call
    def rest_v20_companies_company_id_projects_project_id_inspection_items_item_id_evidence_configuration_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictStr, Field(description="Unique identifier for the company.")],
        project_id: Annotated[StrictStr, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v20_companies_company_id_projects_project_id_inspection_items_item_id_evidence_configuration_get_serialize(
        self,
        procore_company_id,
        company_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v2.0/companies/{company_id}/projects/{project_id}/inspection_items/{item_id}/evidence_configuration',
