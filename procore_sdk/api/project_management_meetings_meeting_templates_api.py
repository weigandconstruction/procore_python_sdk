...
class ProjectManagementMeetingsMeetingTemplatesApi:
    ...
    def rest_v10_companies_company_id_meeting_templates_get(
    ...
    ) -> List[RestV10CompaniesCompanyIdMeetingTemplatesGet200ResponseInner]:
        ...
        _param = self._rest_v10_companies_company_id_meeting_templates_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdMeetingTemplatesGet200ResponseInner]",
            ...
            '404': "RestV10ProjectsProjectIdScheduleSettingsGet404Response",
        }
    ...
    @validate_call
    def rest_v10_companies_company_id_meeting_templates_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdMeetingTemplatesGet200ResponseInner]]:
        """List Meeting Templates
    ...
    @validate_call
    def rest_v10_companies_company_id_meeting_templates_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_meeting_templates_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/meeting_templates',
    ...
    def rest_v10_companies_company_id_meeting_templates_id_get(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Meeting Template ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param id: Meeting Template ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_companies_company_id_meeting_templates_id_get_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CompaniesCompanyIdMeetingTemplatesGet200ResponseInner",
            '401': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '403': "RestV10CompaniesCompanyIdWorkflowPermanentLogsGet401Response",
            '404': "RestV10ProjectsProjectIdScheduleSettingsGet404Response",
        }
    ...
    @validate_call
    def rest_v10_companies_company_id_meeting_templates_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Meeting Template ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CompaniesCompanyIdMeetingTemplatesGet200ResponseInner]:
        """Show a Meeting Template
    ...
    @validate_call
    def rest_v10_companies_company_id_meeting_templates_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Meeting Template ID")],
    ...
    def _rest_v10_companies_company_id_meeting_templates_id_get_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/meeting_templates/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
