...
class CoreCompanyDirectoryCompanyPeopleApi:
    ...
    def rest_v10_companies_company_id_people_get(
        ...
        _param = self._rest_v10_companies_company_id_people_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_people_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CompanyPerson]]:
        """List Company People
    ...
    @validate_call
    def rest_v10_companies_company_id_people_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_people_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/people',
    ...
    def rest_v10_companies_company_id_people_id_patch(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        id: Annotated[StrictInt, Field(description="ID of the person")],
        ...
        :param company_id: ID of the company (required)
        :type company_id: int
        :param id: ID of the person (required)
        :type id: int
        :param company_person_body: (required)
        :type company_person_body: CompanyPersonBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_companies_company_id_people_id_patch_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            company_person_body=company_person_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_companies_company_id_people_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        id: Annotated[StrictInt, Field(description="ID of the person")],
    ...
    @validate_call
    def rest_v10_companies_company_id_people_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        id: Annotated[StrictInt, Field(description="ID of the person")],
    ...
    def _rest_v10_companies_company_id_people_id_patch_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if company_person_body is not None:
            _body_params = company_person_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/companies/{company_id}/people/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_companies_company_id_people_post(
        ...
        _param = self._rest_v10_companies_company_id_people_post_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            company_person_body=company_person_body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_companies_company_id_people_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        company_person_body: CompanyPersonBody,
    ...
    @validate_call
    def rest_v10_companies_company_id_people_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the company")],
        company_person_body: CompanyPersonBody,
    ...
    def _rest_v10_companies_company_id_people_post_serialize(
        self,
        procore_company_id,
        company_id,
        company_person_body,
