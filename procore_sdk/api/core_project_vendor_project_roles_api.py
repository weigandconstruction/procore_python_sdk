...
class CoreProjectVendorProjectRolesApi:
    ...
    def rest_v10_projects_project_id_vendor_project_roles_id_patch(
        ...
        _param = self._rest_v10_projects_project_id_vendor_project_roles_id_patch_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_vendor_project_roles_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Project Role")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_projects_project_id_vendor_project_roles_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID of the Project Role")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_projects_project_id_vendor_project_roles_id_patch_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/projects/{project_id}/vendor_project_roles/{id}',
