...
class QualitySafetyPunchListProjectPunchItemTemplatesApi:
    ...
    def rest_v10_projects_project_id_punch_item_templates_get(
        ...
        filters_updated_at: Annotated[Optional[StrictStr], Field(description="Return item(s) within a specific updated at iso8601 datetime range")] = None,
    ...
    ) -> List[ProjectPunchItemTemplates]:
        ...
        :param filters_updated_at: Return item(s) within a specific updated at iso8601 datetime range
        ...
        _param = self._rest_v10_projects_project_id_punch_item_templates_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ProjectPunchItemTemplates]",
    ...
    @validate_call
    def rest_v10_projects_project_id_punch_item_templates_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectPunchItemTemplates]]:
        """List Project Punch Item Templates
    ...
    @validate_call
    def rest_v10_projects_project_id_punch_item_templates_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
    ...
    def _rest_v10_projects_project_id_punch_item_templates_get_serialize(
        self,
        procore_company_id,
        project_id,
        filters_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/punch_item_templates',
