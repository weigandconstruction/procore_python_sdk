...
class ProjectManagementModelsBIMModelChangeHistoryApi:
    ...
    def rest_v10_bim_models_id_change_history_get(
        ...
        """(Deprecated) List BIM Model Change History
        ...
        """ # noqa: E501
        warnings.warn("GET /rest/v1.0/bim_models/{id}/change_history is deprecated.", DeprecationWarning)

        _param = self._rest_v10_bim_models_id_change_history_get_serialize(
    ...
    @validate_call
    def rest_v10_bim_models_id_change_history_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="BIM Model ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_bim_models_id_change_history_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="BIM Model ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_bim_models_id_change_history_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/bim_models/{id}/change_history',
