...
class ConstructionFinancialsUnitsOfMeasureUnitOfMeasureCategoriesApi:
    ...
    def rest_v10_companies_company_id_uom_categories_get(
    ...
    ) -> List[RestV10CompaniesCompanyIdUomCategoriesGet200ResponseInner]:
        ...
        _param = self._rest_v10_companies_company_id_uom_categories_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10CompaniesCompanyIdUomCategoriesGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_companies_company_id_uom_categories_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10CompaniesCompanyIdUomCategoriesGet200ResponseInner]]:
        """List Unit of Measure Categories
    ...
    @validate_call
    def rest_v10_companies_company_id_uom_categories_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
    ...
    def _rest_v10_companies_company_id_uom_categories_get_serialize(
        self,
        procore_company_id,
        company_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/uom_categories',
