...
class ConstructionFinancialsBudgetBudgetViewSnapshotSummaryRowsApi:
    ...
    def rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get(
        ...
        group_by: Annotated[Optional[StrictStr], Field(description="Groups the data. Value can be a comma separated string. Default is biller,root_cost_code")] = None,
        budget_row_type: Annotated[Optional[StrictStr], Field(description="Return budgeted, unbudgeted or all item(s) from all budget rows for a project. Default is all. Note that when the unbudgeted or all values are supplied, the subtotals may change depending on the presence of rows that have budgeted false")] = None,
    ...
    ) -> List[RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner]:
        ...
        :param group_by: Groups the data. Value can be a comma separated string. Default is biller,root_cost_code
        :type group_by: str
        :param budget_row_type: Return budgeted, unbudgeted or all item(s) from all budget rows for a project. Default is all. Note that when the unbudgeted or all values are supplied, the subtotals may change depending on the presence of rows that have budgeted false
        ...
        _param = self._rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_snapshot_id: Annotated[StrictInt, Field(description="Budget View Snapshot ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10BudgetViewSnapshotsBudgetViewSnapshotIdSummaryRowsGet200ResponseInner]]:
        """List Budget View Snapshot Summary Rows
    ...
    @validate_call
    def rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_snapshot_id: Annotated[StrictInt, Field(description="Budget View Snapshot ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_budget_view_snapshots_budget_view_snapshot_id_summary_rows_get_serialize(
        self,
        procore_company_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/budget_view_snapshots/{budget_view_snapshot_id}/summary_rows',
