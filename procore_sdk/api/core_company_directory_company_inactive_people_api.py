...
class CoreCompanyDirectoryCompanyInactivePeopleApi:
    ...
    def rest_v10_companies_company_id_people_inactive_get(
        ...
        company_id: Annotated[StrictInt, Field(description="ID of the project")],
        ...
        :param company_id: ID of the project (required)
        :type company_id: int
        :param page: Page
        :type page: int
        ...
        _param = self._rest_v10_companies_company_id_people_inactive_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_people_inactive_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the project")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_companies_company_id_people_inactive_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="ID of the project")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_people_inactive_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/people/inactive',
