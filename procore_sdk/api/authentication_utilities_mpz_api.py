...
class AuthenticationUtilitiesMPZApi:
    ...
    @validate_call
    def rest_v10_company_base_url_get(
        self,
        ...
        _param = self._rest_v10_company_base_url_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10CompanyBaseUrlGet200Response",
            '400': "RestV10CompanyBaseUrlGet400Response",
        }
    ...
    @validate_call
    def rest_v10_company_base_url_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10CompanyBaseUrlGet200Response]:
        """Check Company Zone
    ...
    @validate_call
    def rest_v10_company_base_url_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        _request_timeout: Union[
            None,
    ...
    def _rest_v10_company_base_url_get_serialize(
        self,
        procore_company_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/company_base_url',
