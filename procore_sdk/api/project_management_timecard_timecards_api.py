...
class ProjectManagementTimecardTimecardsApi:
    ...
    def rest_v10_companies_company_id_timecard_time_types_get(
        ...
        _param = self._rest_v10_companies_company_id_timecard_time_types_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_timecard_time_types_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TimecardTimeType4]]:
        """List Timecard Time Types
    ...
    @validate_call
    def rest_v10_companies_company_id_timecard_time_types_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
    ...
    def _rest_v10_companies_company_id_timecard_time_types_get_serialize(
        self,
        procore_company_id,
        company_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/timecard_time_types',
    ...
    def rest_v10_companies_company_id_timecard_time_types_id_patch(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Id of the Timecard Time Type")],
        ...
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param id: Id of the Timecard Time Type (required)
        :type id: int
        :param timecard_time_type_body: (required)
        :type timecard_time_type_body: TimecardTimeTypeBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_companies_company_id_timecard_time_types_id_patch_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            timecard_time_type_body=timecard_time_type_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_companies_company_id_timecard_time_types_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Id of the Timecard Time Type")],
    ...
    @validate_call
    def rest_v10_companies_company_id_timecard_time_types_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Id of the Timecard Time Type")],
    ...
    def _rest_v10_companies_company_id_timecard_time_types_id_patch_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if timecard_time_type_body is not None:
            _body_params = timecard_time_type_body
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/rest/v1.0/companies/{company_id}/timecard_time_types/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
