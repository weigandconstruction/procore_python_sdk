...
class ProjectManagementModelsBIMViewpointsApi:
    ...
    @validate_call
    def rest_v10_bim_viewpoints_id_get(
        self,
        ...
        _param = self._rest_v10_bim_viewpoints_id_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10BimViewpointsPost201Response",
    ...
    @validate_call
    def rest_v10_bim_viewpoints_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10BimViewpointsPost201Response]:
        """Show BIM Viewpoint
    ...
    @validate_call
    def rest_v10_bim_viewpoints_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_bim_viewpoints_id_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/bim_viewpoints/{id}',
    ...
    @validate_call
    def rest_v10_bim_viewpoints_post(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body121: Body121,
        _request_timeout: Union[
        ...
        :param procore_company_id: Unique company identifier associated with the Procore User Account. (required)
        :type procore_company_id: int
        :param body121: (required)
        :type body121: Body121
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_bim_viewpoints_post_serialize(
            procore_company_id=procore_company_id,
            body121=body121,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RestV10BimViewpointsPost201Response",
    ...
    @validate_call
    def rest_v10_bim_viewpoints_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body121: Body121,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_bim_viewpoints_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body121: Body121,
        _request_timeout: Union[
    ...
    def _rest_v10_bim_viewpoints_post_serialize(
        self,
        procore_company_id,
        body121,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if body121 is not None:
            _body_params = body121
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/bim_viewpoints',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
