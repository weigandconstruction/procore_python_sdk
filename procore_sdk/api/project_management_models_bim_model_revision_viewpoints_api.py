...
class ProjectManagementModelsBIMModelRevisionViewpointsApi:
    ...
    def rest_v10_bim_model_revision_viewpoints_get(
        ...
        filters_primary: Annotated[Optional[StrictBool], Field(description="Filter items by primary flag")] = None,
        view: Annotated[Optional[StrictStr], Field(description="The compact view contains only ids. The extended view contains the response shown below. The normal view contains bim_viewpoint_id instead of object. The default view is normal.")] = None,
    ...
    ) -> List[RestV10BimModelRevisionViewpointsGet200ResponseInner]:
        ...
        :param filters_primary: Filter items by primary flag
        :type filters_primary: bool
        :param view: The compact view contains only ids. The extended view contains the response shown below. The normal view contains bim_viewpoint_id instead of object. The default view is normal.
        :type view: str
        ...
        _param = self._rest_v10_bim_model_revision_viewpoints_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10BimModelRevisionViewpointsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_bim_model_revision_viewpoints_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10BimModelRevisionViewpointsGet200ResponseInner]]:
        """List BIM Model Revision Viewpoints
    ...
    @validate_call
    def rest_v10_bim_model_revision_viewpoints_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_id: Annotated[Optional[List[StrictInt]], Field(description="Return item(s) with the specified IDs.")] = None,
    ...
    def _rest_v10_bim_model_revision_viewpoints_get_serialize(
        self,
        procore_company_id,
        project_id,
        filters_id,
        ...
        if filters_primary is not None:
            
            _query_params.append(('filters[primary]', filters_primary))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/bim_model_revision_viewpoints',
