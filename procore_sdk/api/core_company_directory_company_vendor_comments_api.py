...
class CoreCompanyDirectoryCompanyVendorCommentsApi:
    ...
    def rest_v10_companies_company_id_vendors_vendor_id_comments_get(
        ...
        _param = self._rest_v10_companies_company_id_vendors_vendor_id_comments_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_vendors_vendor_id_comments_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        vendor_id: Annotated[StrictInt, Field(description="Vendor ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[VendorComment]]:
        """List company vendor comments
    ...
    @validate_call
    def rest_v10_companies_company_id_vendors_vendor_id_comments_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        vendor_id: Annotated[StrictInt, Field(description="Vendor ID")],
    ...
    def _rest_v10_companies_company_id_vendors_vendor_id_comments_get_serialize(
        self,
        procore_company_id,
        company_id,
        vendor_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/vendors/{vendor_id}/comments',
