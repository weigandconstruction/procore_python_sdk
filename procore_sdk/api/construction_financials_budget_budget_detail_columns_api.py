...
class ConstructionFinancialsBudgetBudgetDetailColumnsApi:
    ...
    def rest_v10_budget_views_budget_view_id_budget_detail_columns_get(
    ...
    ) -> List[RestV10BudgetViewsBudgetViewIdBudgetDetailColumnsGet200ResponseInner]:
        ...
        _param = self._rest_v10_budget_views_budget_view_id_budget_detail_columns_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RestV10BudgetViewsBudgetViewIdBudgetDetailColumnsGet200ResponseInner]",
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_budget_detail_columns_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RestV10BudgetViewsBudgetViewIdBudgetDetailColumnsGet200ResponseInner]]:
        """List Budget Detail Columns
    ...
    @validate_call
    def rest_v10_budget_views_budget_view_id_budget_detail_columns_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        budget_view_id: Annotated[StrictInt, Field(description="Budget View ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_budget_views_budget_view_id_budget_detail_columns_get_serialize(
        self,
        procore_company_id,
        budget_view_id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/budget_views/{budget_view_id}/budget_detail_columns',
