...
class CoreLocalFilesLocalFilesApi:
    ...
    @validate_call
    def rest_v10_local_files_uuid_get(
        self,
        ...
        uuid: Annotated[StrictStr, Field(description="UUID of the file")],
        ...
        :param uuid: UUID of the file (required)
        :type uuid: str
        ...
        _param = self._rest_v10_local_files_uuid_get_serialize(
    ...
    @validate_call
    def rest_v10_local_files_uuid_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        uuid: Annotated[StrictStr, Field(description="UUID of the file")],
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_local_files_uuid_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        uuid: Annotated[StrictStr, Field(description="UUID of the file")],
        _request_timeout: Union[
    ...
    def _rest_v10_local_files_uuid_get_serialize(
        self,
        procore_company_id,
        uuid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/local_files/{uuid}',
