...
class ProjectManagementProjectScheduleScheduleResourceAssignmentsApi:
    ...
    def rest_v11_projects_project_id_schedule_resource_assignments_id_get(
        ...
        _param = self._rest_v11_projects_project_id_schedule_resource_assignments_id_get_serialize(
    ...
    @validate_call
    def rest_v11_projects_project_id_schedule_resource_assignments_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="ID of the resource")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResourceAssignment]:
        """Show resource assignment
    ...
    @validate_call
    def rest_v11_projects_project_id_schedule_resource_assignments_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        id: Annotated[StrictInt, Field(description="ID of the resource")],
    ...
    def _rest_v11_projects_project_id_schedule_resource_assignments_id_get_serialize(
        self,
        procore_company_id,
        project_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.1/projects/{project_id}/schedule/resource_assignments/{id}',
