...
class CoreCompanyRolesApi:
    ...
    def rest_v10_companies_company_id_roles_get(
        ...
        filters_users_only: Annotated[Optional[StrictBool], Field(description="If true, returns only project roles of type user.")] = None,
        ...
        :type company_id: int
        :param filters_users_only: If true, returns only project roles of type user.
        :type filters_users_only: bool
        ...
        _param = self._rest_v10_companies_company_id_roles_get_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            filters_users_only=filters_users_only,
    ...
    @validate_call
    def rest_v10_companies_company_id_roles_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        filters_users_only: Annotated[Optional[StrictBool], Field(description="If true, returns only project roles of type user.")] = None,
    ...
    @validate_call
    def rest_v10_companies_company_id_roles_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        filters_users_only: Annotated[Optional[StrictBool], Field(description="If true, returns only project roles of type user.")] = None,
    ...
    def _rest_v10_companies_company_id_roles_get_serialize(
        self,
        procore_company_id,
        company_id,
        filters_users_only,
        ...
        if filters_users_only is not None:
            
            _query_params.append(('filters[users_only]', filters_users_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/roles',
