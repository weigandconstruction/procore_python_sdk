...
class ProjectManagementModelsBIMMintTokensApi:
    ...
    @validate_call
    def rest_v10_bim_mint_tokens_post(
        self,
        ...
        :param body135: (required)
        :type body135: Body135
        ...
        _param = self._rest_v10_bim_mint_tokens_post_serialize(
    ...
    @validate_call
    def rest_v10_bim_mint_tokens_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body135: Body135,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_bim_mint_tokens_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        body135: Body135,
        _request_timeout: Union[
    ...
    def _rest_v10_bim_mint_tokens_post_serialize(
        self,
        procore_company_id,
        body135,
        _request_auth,
        ...
        if body135 is not None:
            _body_params = body135
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/bim_mint_tokens',
