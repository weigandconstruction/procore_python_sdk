...
class CoreProjectDepartmentsApi:
    ...
    def rest_v10_departments_get(
        ...
        _param = self._rest_v10_departments_get_serialize(
    ...
    @validate_call
    def rest_v10_departments_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_departments_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_departments_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/departments',
    ...
    @validate_call
    def rest_v10_departments_id_delete(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._rest_v10_departments_id_delete_serialize(
            procore_company_id=procore_company_id,
            id=id,
            company_id=company_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_departments_id_delete_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    @validate_call
    def rest_v10_departments_id_delete_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_departments_id_delete_serialize(
        self,
        procore_company_id,
        id,
        company_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/rest/v1.0/departments/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def rest_v10_departments_id_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        ...
        _param = self._rest_v10_departments_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            company_id=company_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_departments_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    @validate_call
    def rest_v10_departments_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
    ...
    def _rest_v10_departments_id_get_serialize(
        self,
        procore_company_id,
        id,
        company_id,
    ...
    def rest_v10_departments_id_patch(
        ...
        :param id: Department ID (required)
        :type id: int
        :param department_body: (required)
        :type department_body: DepartmentBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_departments_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            department_body=department_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_departments_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        department_body: DepartmentBody,
    ...
    @validate_call
    def rest_v10_departments_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Department ID")],
        department_body: DepartmentBody,
    ...
    def _rest_v10_departments_id_patch_serialize(
        self,
        procore_company_id,
        id,
        department_body,
        ...
        # process the form parameters
        # process the body parameter
        if department_body is not None:
            _body_params = department_body
    ...
    def rest_v10_departments_post(
        ...
        _param = self._rest_v10_departments_post_serialize(
            procore_company_id=procore_company_id,
            department_body=department_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rest_v10_departments_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        department_body: DepartmentBody,
        _request_timeout: Union[
    ...
    @validate_call
    def rest_v10_departments_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        department_body: DepartmentBody,
        _request_timeout: Union[
    ...
    def _rest_v10_departments_post_serialize(
        self,
        procore_company_id,
        department_body,
        _request_auth,
