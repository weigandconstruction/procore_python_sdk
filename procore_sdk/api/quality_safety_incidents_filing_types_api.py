...
class QualitySafetyIncidentsFilingTypesApi:
    ...
    def rest_v10_companies_company_id_incidents_injury_filing_types_get(
        ...
        _param = self._rest_v10_companies_company_id_incidents_injury_filing_types_get_serialize(
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[IncidentFilingType]]:
        """List Incident Filing Types
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_companies_company_id_incidents_injury_filing_types_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/incidents/injury_filing_types',
    ...
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_get(
        ...
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Filing Type ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param company_id: Unique identifier for the company. (required)
        :type company_id: int
        :param id: Filing Type ID (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._rest_v10_companies_company_id_incidents_injury_filing_types_id_get_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Filing Type ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IncidentFilingType]:
        """Show Filing Type
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Filing Type ID")],
    ...
    def _rest_v10_companies_company_id_incidents_injury_filing_types_id_get_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/companies/{company_id}/incidents/injury_filing_types/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_patch(
        ...
        :param id: Filing Type ID (required)
        :type id: int
        :param rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request: (required)
        :type rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request: RestV10CompaniesCompanyIdIncidentsInjuryFilingTypesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_serialize(
            procore_company_id=procore_company_id,
            company_id=company_id,
            id=id,
            rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request=rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Filing Type ID")],
    ...
    @validate_call
    def rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        id: Annotated[StrictInt, Field(description="Filing Type ID")],
    ...
    def _rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_serialize(
        self,
        procore_company_id,
        company_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request is not None:
            _body_params = rest_v10_companies_company_id_incidents_injury_filing_types_id_patch_request
