...
class ProjectManagementCoordinationIssuesCoordinationIssueRecycleBinApi:
    ...
    def rest_v10_coordination_issues_recycle_bin_get(
        ...
        _param = self._rest_v10_coordination_issues_recycle_bin_get_serialize(
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_coordination_issues_recycle_bin_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/coordination_issues/recycle_bin',
    ...
    def rest_v10_coordination_issues_recycle_bin_id_get(
        ...
        _param = self._rest_v10_coordination_issues_recycle_bin_id_get_serialize(
            procore_company_id=procore_company_id,
            id=id,
            project_id=project_id,
            view=view,
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
    ...
    def _rest_v10_coordination_issues_recycle_bin_id_get_serialize(
        self,
        procore_company_id,
        id,
        project_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/coordination_issues/recycle_bin/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_coordination_issues_recycle_bin_id_patch(
        ...
        :param id: Coordination Issue ID (required)
        :type id: int
        :param rest_v10_coordination_issues_recycle_bin_id_patch_request: (required)
        :type rest_v10_coordination_issues_recycle_bin_id_patch_request: RestV10CoordinationIssuesRecycleBinIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_coordination_issues_recycle_bin_id_patch_serialize(
            procore_company_id=procore_company_id,
            id=id,
            rest_v10_coordination_issues_recycle_bin_id_patch_request=rest_v10_coordination_issues_recycle_bin_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_id_patch_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        rest_v10_coordination_issues_recycle_bin_id_patch_request: RestV10CoordinationIssuesRecycleBinIdPatchRequest,
    ...
    @validate_call
    def rest_v10_coordination_issues_recycle_bin_id_patch_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        id: Annotated[StrictInt, Field(description="Coordination Issue ID")],
        rest_v10_coordination_issues_recycle_bin_id_patch_request: RestV10CoordinationIssuesRecycleBinIdPatchRequest,
    ...
    def _rest_v10_coordination_issues_recycle_bin_id_patch_serialize(
        self,
        procore_company_id,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if rest_v10_coordination_issues_recycle_bin_id_patch_request is not None:
            _body_params = rest_v10_coordination_issues_recycle_bin_id_patch_request
