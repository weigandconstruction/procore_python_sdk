...
class ProjectManagementRFIRFIsDefaultDistributionApi:
    ...
    def rest_v10_projects_project_id_rfis_default_distribution_get(
        ...
        _param = self._rest_v10_projects_project_id_rfis_default_distribution_get_serialize(
    ...
    @validate_call
    def rest_v10_projects_project_id_rfis_default_distribution_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_projects_project_id_rfis_default_distribution_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_projects_project_id_rfis_default_distribution_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/rfis/default_distribution',
