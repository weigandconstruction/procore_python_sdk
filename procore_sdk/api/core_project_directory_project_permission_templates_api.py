...
class CoreProjectDirectoryProjectPermissionTemplatesApi:
    ...
    def rest_v10_projects_project_id_permission_templates_get(
        ...
        filters_assignables_only: Annotated[Optional[StrictBool], Field(description="Returns user's assignable permission templates")] = None,
        ...
        :type project_id: int
        :param filters_assignables_only: Returns user's assignable permission templates
        :type filters_assignables_only: bool
        ...
        _param = self._rest_v10_projects_project_id_permission_templates_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            filters_assignables_only=filters_assignables_only,
    ...
    @validate_call
    def rest_v10_projects_project_id_permission_templates_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_assignables_only: Annotated[Optional[StrictBool], Field(description="Returns user's assignable permission templates")] = None,
    ...
    @validate_call
    def rest_v10_projects_project_id_permission_templates_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        filters_assignables_only: Annotated[Optional[StrictBool], Field(description="Returns user's assignable permission templates")] = None,
    ...
    def _rest_v10_projects_project_id_permission_templates_get_serialize(
        self,
        procore_company_id,
        project_id,
        filters_assignables_only,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if filters_assignables_only is not None:
            
            _query_params.append(('filters[assignables_only]', filters_assignables_only))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/permission_templates',
