...
class QualitySafetyInspectionsChecklistScheduleChangeHistoriesApi:
    ...
    def rest_v10_projects_project_id_checklist_schedules_schedule_id_change_history_get(
    ...
    ) -> List[ChecklistScheduleChangeHistory]:
        ...
        _param = self._rest_v10_projects_project_id_checklist_schedules_schedule_id_change_history_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ChecklistScheduleChangeHistory]",
    ...
    @validate_call
    def rest_v10_projects_project_id_checklist_schedules_schedule_id_change_history_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        schedule_id: Annotated[StrictInt, Field(description="Checklist Schedule ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChecklistScheduleChangeHistory]]:
        """List Checklist Schedule Change Histories
    ...
    @validate_call
    def rest_v10_projects_project_id_checklist_schedules_schedule_id_change_history_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        schedule_id: Annotated[StrictInt, Field(description="Checklist Schedule ID")],
    ...
    def _rest_v10_projects_project_id_checklist_schedules_schedule_id_change_history_get_serialize(
        self,
        procore_company_id,
        project_id,
        schedule_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/checklist/schedules/{schedule_id}/change_history',
