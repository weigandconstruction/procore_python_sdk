...
class CoreOpenItemsOpenItemsApi:
    ...
    @validate_call
    def rest_v10_open_items_all_get(
        self,
        ...
        _param = self._rest_v10_open_items_all_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RestV10OpenItemsAllGet200Response",
    ...
    @validate_call
    def rest_v10_open_items_all_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        tool_name: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RestV10OpenItemsAllGet200Response]:
        """Get Open Items Statistics
    ...
    @validate_call
    def rest_v10_open_items_all_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        tool_name: Optional[StrictStr] = None,
    ...
    def _rest_v10_open_items_all_get_serialize(
        self,
        procore_company_id,
        project_id,
        tool_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/open_items/all',
    ...
    @validate_call
    def rest_v10_open_items_mine_get(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        tool_name: Optional[StrictStr] = None,
        ...
        _param = self._rest_v10_open_items_mine_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            tool_name=tool_name,
            _request_auth=_request_auth,
    ...
    @validate_call
    def rest_v10_open_items_mine_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        tool_name: Optional[StrictStr] = None,
    ...
    @validate_call
    def rest_v10_open_items_mine_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        tool_name: Optional[StrictStr] = None,
    ...
    def _rest_v10_open_items_mine_get_serialize(
        self,
        procore_company_id,
        project_id,
        tool_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/open_items/mine',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
