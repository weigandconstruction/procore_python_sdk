...
class QualitySafetyInspectionsChecklistCommentsApi:
    ...
    def rest_v10_checklist_lists_list_id_comments_id_get(
        ...
        _param = self._rest_v10_checklist_lists_list_id_comments_id_get_serialize(
    ...
    @validate_call
    def rest_v10_checklist_lists_list_id_comments_id_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        list_id: Annotated[StrictInt, Field(description="Checklist ID")],
        id: Annotated[StrictInt, Field(description="Comment ID")],
    ...
    @validate_call
    def rest_v10_checklist_lists_list_id_comments_id_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        list_id: Annotated[StrictInt, Field(description="Checklist ID")],
        id: Annotated[StrictInt, Field(description="Comment ID")],
    ...
    def _rest_v10_checklist_lists_list_id_comments_id_get_serialize(
        self,
        procore_company_id,
        list_id,
        id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/checklist/lists/{list_id}/comments/{id}',
    ...
    def rest_v10_checklist_lists_list_id_comments_post(
        ...
        :param list_id: Checklist ID (required)
        :type list_id: int
        :param checklist_comment_body: (required)
        :type checklist_comment_body: ChecklistCommentBody
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._rest_v10_checklist_lists_list_id_comments_post_serialize(
            procore_company_id=procore_company_id,
            list_id=list_id,
            checklist_comment_body=checklist_comment_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rest_v10_checklist_lists_list_id_comments_post_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        list_id: Annotated[StrictInt, Field(description="Checklist ID")],
        checklist_comment_body: ChecklistCommentBody,
    ...
    @validate_call
    def rest_v10_checklist_lists_list_id_comments_post_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        list_id: Annotated[StrictInt, Field(description="Checklist ID")],
        checklist_comment_body: ChecklistCommentBody,
    ...
    def _rest_v10_checklist_lists_list_id_comments_post_serialize(
        self,
        procore_company_id,
        list_id,
        ...
        # process the form parameters
        # process the body parameter
        if checklist_comment_body is not None:
            _body_params = checklist_comment_body
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/rest/v1.0/checklist/lists/{list_id}/comments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_checklist_list_item_comments_get(
        ...
        _param = self._rest_v10_projects_project_id_checklist_list_item_comments_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    def rest_v10_projects_project_id_checklist_list_item_comments_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ChecklistComment]]:
        """List Checklist (Inspection) Comments
    ...
    @validate_call
    def rest_v10_projects_project_id_checklist_list_item_comments_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_projects_project_id_checklist_list_item_comments_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/checklist/list_item_comments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rest_v10_projects_project_id_recycle_bin_checklist_list_item_comments_get(
        ...
        _param = self._rest_v10_projects_project_id_recycle_bin_checklist_list_item_comments_get_serialize(
            procore_company_id=procore_company_id,
            project_id=project_id,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    def rest_v10_projects_project_id_recycle_bin_checklist_list_item_comments_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    @validate_call
    def rest_v10_projects_project_id_recycle_bin_checklist_list_item_comments_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        project_id: Annotated[StrictInt, Field(description="Unique identifier for the project.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_projects_project_id_recycle_bin_checklist_list_item_comments_get_serialize(
        self,
        procore_company_id,
        project_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/projects/{project_id}/recycle_bin/checklist/list_item_comments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
