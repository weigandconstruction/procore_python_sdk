...
class ConstructionFinancialsChangeOrdersChangeOrderChangeReasonsApi:
    ...
    def rest_v10_change_order_change_reasons_get(
    ...
    ) -> List[RFQChangeEventChangeOrderChangeReason]:
        ...
        _param = self._rest_v10_change_order_change_reasons_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RFQChangeEventChangeOrderChangeReason]",
    ...
    @validate_call
    def rest_v10_change_order_change_reasons_get_with_http_info(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RFQChangeEventChangeOrderChangeReason]]:
        """List Change Order Change Reasons
    ...
    @validate_call
    def rest_v10_change_order_change_reasons_get_without_preload_content(
        self,
        procore_company_id: Annotated[StrictInt, Field(description="Unique company identifier associated with the Procore User Account.")],
        company_id: Annotated[StrictInt, Field(description="Unique identifier for the company.")],
        page: Annotated[Optional[StrictInt], Field(description="Page")] = None,
    ...
    def _rest_v10_change_order_change_reasons_get_serialize(
        self,
        procore_company_id,
        company_id,
        page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/rest/v1.0/change_order_change_reasons',
