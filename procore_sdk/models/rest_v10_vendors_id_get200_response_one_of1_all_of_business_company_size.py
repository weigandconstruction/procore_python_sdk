...
class RestV10VendorsIdGet200ResponseOneOf1AllOfBusinessCompanySize(BaseModel):
    """
    Company Size
    """ # noqa: E501
    start: Optional[StrictInt] = Field(default=None, description="Indicates the smallest company size")
    end: Optional[StrictInt] = Field(default=None, description="Indicates the largest company size")
