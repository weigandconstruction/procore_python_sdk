...
class RestV10ProjectsProjectIdBudgetChangesPostRequestProductionQuantitiesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "cost_code_id", "description", "quantity", "ref", "uom", "change_event_production_quantity_id"]
