...
class ChangeEvent(BaseModel):
    ...
    change_event_status_id: StrictInt = Field(description="Change Event Status ID")
    change_order_change_reason_id: Optional[StrictInt] = Field(default=None, description="Change Order Change Reason ID")
    event_scope: StrictStr = Field(description="Event Scope")
    ...
    change_event_line_items_attributes: Optional[List[ChangeEventLineItem]] = Field(default=None, description="Change Event Line Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "change_event_line_items_attributes": [ChangeEventLineItem.from_dict(_item) for _item in obj["change_event_line_items_attributes"]] if obj.get("change_event_line_items_attributes") is not None else None,
