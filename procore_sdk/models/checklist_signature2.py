...
class ChecklistSignature2(BaseModel):
    """
    ChecklistSignature2
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    captured_by: Optional[ChecklistSignatureRequestSignatory] = None
    captured_at: Optional[datetime] = Field(default=None, description="Timestamp of creation")
    attachment: Optional[RestV10WorkOrderContractsPost201ResponseAttachmentsInner] = None
    __properties: ClassVar[List[str]] = ["id", "captured_by", "captured_at", "attachment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "captured_by": ChecklistSignatureRequestSignatory.from_dict(obj["captured_by"]) if obj.get("captured_by") is not None else None,
            "captured_at": obj.get("captured_at"),
            "attachment": RestV10WorkOrderContractsPost201ResponseAttachmentsInner.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
