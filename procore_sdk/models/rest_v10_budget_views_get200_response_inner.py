...
class RestV10BudgetViewsGet200ResponseInner(BaseModel):
    """
    Budget View
    """ # noqa: E501
    ...
    updated_at: Optional[StrictStr] = Field(default=None, description="Updated At timestamp")
    role: Optional[StrictStr] = Field(default=None, description="Role of the view")
    links: Optional[RestV10BudgetViewsGet200ResponseInnerLinks] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "created_at", "created_by", "updated_at", "role", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "links": RestV10BudgetViewsGet200ResponseInnerLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
