...
class RestV11ProjectsProjectIdScheduleRequestedChangesReviewPatchRequestRequestedChangesInner(BaseModel):
    """
    ...
    approved: Optional[StrictBool] = Field(default=None, description="Review result")
    disposition_reason: Optional[StrictStr] = Field(default=None, description="reason of review")
    __properties: ClassVar[List[str]] = ["id", "approved", "disposition_reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "disposition_reason": obj.get("disposition_reason")
        })
        return _obj
