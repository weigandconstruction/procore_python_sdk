...
class RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsIdPatchRequest
    """ # noqa: E501
    segment: Segment1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segment": Segment1.from_dict(obj["segment"]) if obj.get("segment") is not None else None
        })
        return _obj
