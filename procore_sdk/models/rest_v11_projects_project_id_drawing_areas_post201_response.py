...
class RestV11ProjectsProjectIdDrawingAreasPost201Response(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of Drawing Area")
