...
class RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerMarkupLineItemsInnerMarkupDestinationCostCode(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["origin_id", "origin_data"]
