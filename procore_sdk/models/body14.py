...
class Body14(BaseModel):
    ...
    Body14
    """ # noqa: E501
    project_id: StrictInt = Field(description="ID of the project this task belongs to.")
    task: Task1
    __properties: ClassVar[List[str]] = ["project_id", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": Task1.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
        return _obj
