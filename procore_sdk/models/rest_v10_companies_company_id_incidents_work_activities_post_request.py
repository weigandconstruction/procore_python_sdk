...
class RestV10CompaniesCompanyIdIncidentsWorkActivitiesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsWorkActivitiesPostRequest
    """ # noqa: E501
    work_activity: RestV10CompaniesCompanyIdIncidentsWorkActivitiesPostRequestWorkActivity
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "work_activity": RestV10CompaniesCompanyIdIncidentsWorkActivitiesPostRequestWorkActivity.from_dict(obj["work_activity"]) if obj.get("work_activity") is not None else None
        })
        return _obj
