...
class RestV10RequisitionsRequisitionIdWholeChangeOrderItemsIdPatchRequestRequisitionWholeChangeOrderItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["work_completed_this_period", "materials_presently_stored", "work_completed_retainage_retained_this_period", "materials_stored_retainage_currently_retained", "work_completed_retainage_released_this_period", "work_completed_this_period_quantity", "ssr_manual_override", "comment", "status"]
