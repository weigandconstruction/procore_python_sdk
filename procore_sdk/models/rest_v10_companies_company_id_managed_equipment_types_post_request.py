...
class RestV10CompaniesCompanyIdManagedEquipmentTypesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentTypesPostRequest
    """ # noqa: E501
    managed_equipment_type: RestV10CompaniesCompanyIdManagedEquipmentTypesPostRequestManagedEquipmentType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_type": RestV10CompaniesCompanyIdManagedEquipmentTypesPostRequestManagedEquipmentType.from_dict(obj["managed_equipment_type"]) if obj.get("managed_equipment_type") is not None else None
        })
        return _obj
