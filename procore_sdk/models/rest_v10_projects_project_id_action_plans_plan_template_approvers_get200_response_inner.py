...
class RestV10ProjectsProjectIdActionPlansPlanTemplateApproversGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "plan_template_id", "updated_at", "party"]
