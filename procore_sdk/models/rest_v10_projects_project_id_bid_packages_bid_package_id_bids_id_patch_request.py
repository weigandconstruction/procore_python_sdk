...
class RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequest
    """ # noqa: E501
    bid: Optional[RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequestBid] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bid": RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequestBid.from_dict(obj["bid"]) if obj.get("bid") is not None else None
        })
        return _obj
