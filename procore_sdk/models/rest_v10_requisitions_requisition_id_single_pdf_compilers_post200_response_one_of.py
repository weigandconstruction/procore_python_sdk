...
class RestV10RequisitionsRequisitionIdSinglePdfCompilersPost200ResponseOneOf(BaseModel):
    """
    An Invoicing Async Job URL
    """ # noqa: E501
    job_url: Optional[StrictStr] = Field(default=None, description="URL to query for the job status")
    __properties: ClassVar[List[str]] = ["job_url"]
