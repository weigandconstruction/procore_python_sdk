...
class CompanyVendorBody(BaseModel):
    """
    CompanyVendorBody
    """ # noqa: E501
    company_id: StrictInt = Field(description="Company ID")
    vendor: CompanyVendor
    __properties: ClassVar[List[str]] = ["company_id", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendor": CompanyVendor.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
