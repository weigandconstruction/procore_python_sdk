...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingAttachment(BaseModel):
    """
    ...
    content_type: Optional[StrictStr] = Field(default=None, description="Attachment Content Type")
    name: Optional[StrictStr] = Field(default=None, description="Attachment name")
    thumbnail_url: Optional[StrictStr] = Field(default=None, description="Attachment thumbnail URL")
    url: Optional[StrictStr] = Field(default=None, description="Attachment URL")
    viewable_document_id: Optional[StrictInt] = Field(default=None, description="Attachment viewable document ID")
    __properties: ClassVar[List[str]] = ["id", "content_type", "name", "thumbnail_url", "url", "viewable_document_id"]
