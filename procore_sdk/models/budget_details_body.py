...
class BudgetDetailsBody(BaseModel):
    """
    BudgetDetailsBody
    """ # noqa: E501
    filters: Optional[BudgetDetailFilterOptions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": BudgetDetailFilterOptions.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
