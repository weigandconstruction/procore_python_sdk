...
class Observation1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assignee_id", "contributing_behavior_id", "contributing_condition_id", "checklist_item_id", "coordination_issue_id", "created_by_id", "description", "due_date", "hazard_id", "incident_action_id", "name", "number", "personal", "priority", "status", "trade_id", "type_id", "distribution_member_ids", "location_id", "mt_location", "custom_field_%{custom_field_definition_id}"]
