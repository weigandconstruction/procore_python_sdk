...
class RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatch200ResponseInnerAccidentLogInner(BaseModel):
    """
    RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatch200ResponseInnerAccidentLogInner
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of the Log")
    status: StrictStr = Field(description="Status of the Log")
    success: StrictBool = Field(description="Is update was successful")
    error: Optional[StrictStr] = Field(default=None, description="Error description if update for log was not successful")
    __properties: ClassVar[List[str]] = ["id", "status", "success", "error"]
