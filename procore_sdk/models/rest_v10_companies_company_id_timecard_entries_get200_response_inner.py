...
class RestV10CompaniesCompanyIdTimecardEntriesGet200ResponseInner(BaseModel):
    """
    ...
    automatically_split_timecard_entries: Optional[List[TimecardEntry3]] = Field(default=None, description="Timecard entries returned with associated object as part of overtime_management")
    __properties: ClassVar[List[str]] = ["id", "created_at", "date", "deleted_at", "description", "billable", "in_progress", "hours", "time_in", "time_out", "lunch_time", "approval_status", "updated_at", "timecard_type", "origin_id", "origin_data", "timesheet", "cost_code", "sub_job", "created_by", "login_information", "timecard_time_type", "party", "crew", "procore_signature", "project", "clock_in", "clock_out", "line_item_type_id", "custom_fields", "automatically_split_timecard_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "automatically_split_timecard_entries": [TimecardEntry3.from_dict(_item) for _item in obj["automatically_split_timecard_entries"]] if obj.get("automatically_split_timecard_entries") is not None else None
        })
        return _obj
