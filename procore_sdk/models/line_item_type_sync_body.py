...
class LineItemTypeSyncBody(BaseModel):
    """
    LineItemTypeSyncBody
    """ # noqa: E501
    company_id: StrictInt = Field(description="Company ID")
    updates: List[LineItemTypeSyncBodyUpdatesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [LineItemTypeSyncBodyUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
