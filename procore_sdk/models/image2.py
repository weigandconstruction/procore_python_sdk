...
class Image2(BaseModel):
    ...
    image_category_id: Optional[StrictInt] = Field(default=None, description="Image Category ID to move the Image to")
    ...
    __properties: ClassVar[List[str]] = ["private", "description", "image_category_id", "location_id", "mt_location", "trade_ids", "log_date"]
