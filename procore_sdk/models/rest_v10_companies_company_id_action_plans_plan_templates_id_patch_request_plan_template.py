...
class RestV10CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequestPlanTemplate(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequestPlanTemplate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "plan_type_id"]
