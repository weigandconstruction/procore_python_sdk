...
class ChecklistPotentialPointOfContact(BaseModel):
    """
    ChecklistPotentialPointOfContact
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="User ID")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    name_with_vendor: Optional[StrictStr] = Field(default=None, description="Name with Vendor")
    job_title: Optional[StrictStr] = Field(default=None, description="Job Title")
    vendor: Optional[ChecklistPotentialPointOfContactVendor] = None
    __properties: ClassVar[List[str]] = ["id", "name", "name_with_vendor", "job_title", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "name_with_vendor": obj.get("name_with_vendor"),
            "job_title": obj.get("job_title"),
            "vendor": ChecklistPotentialPointOfContactVendor.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
