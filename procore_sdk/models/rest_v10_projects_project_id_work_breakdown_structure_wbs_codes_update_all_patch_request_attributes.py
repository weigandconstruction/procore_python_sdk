...
class RestV10ProjectsProjectIdWorkBreakdownStructureWbsCodesUpdateAllPatchRequestAttributes(BaseModel):
    """
    RestV10ProjectsProjectIdWorkBreakdownStructureWbsCodesUpdateAllPatchRequestAttributes
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="New status of the WBS Codes")
