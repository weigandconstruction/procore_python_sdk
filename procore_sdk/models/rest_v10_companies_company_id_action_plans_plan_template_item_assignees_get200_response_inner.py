...
class RestV10CompaniesCompanyIdActionPlansPlanTemplateItemAssigneesGet200ResponseInner(BaseModel):
    """
    Company Action Plan Template Item Assignee (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    plan_template_item_id: Optional[StrictInt] = Field(default=None, description="Company Plan Template Item ID the Company Action Plan Template Item Assignee belongs to")
    created_at: Optional[datetime] = Field(default=None, description="Time the Company Action Plan Template Item Assignee was created")
    ...
    plan_template_id: Optional[StrictInt] = Field(default=None, description="Plan Template ID the Company Action Plan Template Item Assignee belongs to")
    role: Optional[StrictStr] = Field(default=None, description="Role of the Company Action Plan Template Item Assignee")
    updated_at: Optional[datetime] = Field(default=None, description="Time the Company Action Plan Template Item Assignee was updated")
    ...
    __properties: ClassVar[List[str]] = ["id", "plan_template_item_id", "created_at", "is_holding", "plan_template_id", "role", "updated_at", "verification_method"]
