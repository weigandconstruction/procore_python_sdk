...
class RestV10SubmittalApproversIdPatchRequestSubmittalApproverForwardTo(BaseModel):
    """
    Params used only when forwarding for review. Designates who the new reviewer is and what their due date is
    """ # noqa: E501
    user_id: StrictInt = Field(description="User ID of the new reviewer")
    due_date: Optional[date] = Field(default=None, description="Due Date of the new reviewer")
    __properties: ClassVar[List[str]] = ["user_id", "due_date"]
