...
class SubJobBody(BaseModel):
    """
    SubJobBody
    """ # noqa: E501
    project_id: StrictInt = Field(description="Unique identifier for the project.")
    sub_job: SubJobBodySubJob
    __properties: ClassVar[List[str]] = ["project_id", "sub_job"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sub_job": SubJobBodySubJob.from_dict(obj["sub_job"]) if obj.get("sub_job") is not None else None
        })
        return _obj
