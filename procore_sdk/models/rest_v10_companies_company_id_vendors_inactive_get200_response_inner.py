...
class RestV10CompaniesCompanyIdVendorsInactiveGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "abbreviated_name", "address", "authorized_bidder", "business_id", "business_phone", "city", "contact_count", "company", "company_vendor", "country_code", "created_at", "email_address", "fax_number", "is_active", "is_connected", "labor_union", "license_number", "logo", "mobile_phone", "non_union_prevailing_wage", "notes", "origin_data", "origin_id", "origin_code", "prequalified", "state_code", "synced_to_erp", "trade_name", "union_member", "updated_at", "website", "zip", "business_register", "vendor_group", "primary_contact", "attachments", "children_count", "legal_name", "parent", "trades", "bidding_distribution", "bidding", "project_ids", "standard_cost_codes", "_links"]
