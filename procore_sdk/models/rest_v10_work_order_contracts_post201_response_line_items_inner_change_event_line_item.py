...
class RestV10WorkOrderContractsPost201ResponseLineItemsInnerChangeEventLineItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "cost_rom", "revenue_rom", "event_id", "cost_code", "line_item_type", "currency_configuration"]
