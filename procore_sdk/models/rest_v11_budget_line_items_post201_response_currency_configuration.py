...
class RestV11BudgetLineItemsPost201ResponseCurrencyConfiguration(BaseModel):
    """
    Currency configuration object, the currency for the budget line item
    """ # noqa: E501
    currency_iso_code: Optional[StrictStr] = Field(default=None, description="Currency Configuration ISO code")
