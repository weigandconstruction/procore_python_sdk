...
class ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInnerMarkup(BaseModel):
    """
    ...
    destination_cost_code: Optional[ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInnerMarkupDestinationCostCode] = None
    destination_line_item_type: Optional[LineItemType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "destination_cost_code": ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInnerMarkupDestinationCostCode.from_dict(obj["destination_cost_code"]) if obj.get("destination_cost_code") is not None else None,
            "destination_line_item_type": LineItemType.from_dict(obj["destination_line_item_type"]) if obj.get("destination_line_item_type") is not None else None,
