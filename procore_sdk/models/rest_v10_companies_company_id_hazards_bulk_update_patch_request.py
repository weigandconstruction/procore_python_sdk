...
class RestV10CompaniesCompanyIdHazardsBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdHazardsBulkUpdatePatchRequest
    """ # noqa: E501
    hazard: RestV10CompaniesCompanyIdHazardsBulkUpdatePatchRequestHazard
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hazard": RestV10CompaniesCompanyIdHazardsBulkUpdatePatchRequestHazard.from_dict(obj["hazard"]) if obj.get("hazard") is not None else None
        })
        return _obj
