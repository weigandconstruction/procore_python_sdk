...
class RestV10TaxTypesPostRequest(BaseModel):
    """
    RestV10TaxTypesPostRequest
    """ # noqa: E501
    tax_type: RestV10TaxTypesPostRequestTaxType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax_type": RestV10TaxTypesPostRequestTaxType.from_dict(obj["tax_type"]) if obj.get("tax_type") is not None else None
        })
        return _obj
