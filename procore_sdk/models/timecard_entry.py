...
class TimecardEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "date", "deleted_at", "description", "billable", "hours", "updated_at", "timecard_type", "cost_code", "origin_id", "origin_data", "timesheet_status", "full_cost_code", "created_by", "login_information", "timecard_time_type", "line_item_type_id", "custom_fields"]
