...
class RestV11ProjectsProjectIdSubmittalsRecycleBinGet200ResponseInner(BaseModel):
    """
    RestV11ProjectsProjectIdSubmittalsRecycleBinGet200ResponseInner
    """ # noqa: E501
    approvers: Optional[List[RestV11ProjectsProjectIdSubmittalsRecycleBinGet200ResponseInnerAllOfApproversInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "approvers": [RestV11ProjectsProjectIdSubmittalsRecycleBinGet200ResponseInnerAllOfApproversInner.from_dict(_item) for _item in obj["approvers"]] if obj.get("approvers") is not None else None,
