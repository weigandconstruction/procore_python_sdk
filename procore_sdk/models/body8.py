...
class Body8(BaseModel):
    ...
    Body8
    """ # noqa: E501
    updates: List[UnitOfMeasureToSync]
    deletes: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["updates", "deletes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [UnitOfMeasureToSync.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None,
