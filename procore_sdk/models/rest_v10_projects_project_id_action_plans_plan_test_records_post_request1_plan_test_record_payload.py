...
class RestV10ProjectsProjectIdActionPlansPlanTestRecordsPostRequest1PlanTestRecordPayload(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTestRecordsPostRequest1PlanTestRecordPayload
    """ # noqa: E501
    attachment: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Test Record Attachment. To upload an attachment you must upload the entire payload as `multipart/form-data` content-type with the `attachment` file.")
