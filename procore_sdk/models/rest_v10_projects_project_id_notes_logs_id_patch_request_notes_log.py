...
class RestV10ProjectsProjectIdNotesLogsIdPatchRequestNotesLog(BaseModel):
    """
    ...
    is_issue_day: Optional[StrictBool] = Field(default=None, description="The note being added is an issue affecting the project")
    location_id: Optional[StrictInt] = Field(default=None, description="The ID of the Location of the Notes Log. `location_id` takes precedence over `mt_location`")
    ...
    __properties: ClassVar[List[str]] = ["comment", "date", "datetime", "daily_log_header_id", "is_issue_day", "location_id", "mt_location", "status", "custom_field_%{custom_field_definition_id}"]
