...
class RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOfErrors(BaseModel):
    """
    RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOfErrors
    """ # noqa: E501
    field_name: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["field_name"]
