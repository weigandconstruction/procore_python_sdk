...
class RestV10CompaniesCompanyIdConfigurableFieldSetsIdValidationsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdConfigurableFieldSetsIdValidationsPostRequest
    """ # noqa: E501
    attributes: RestV10CompaniesCompanyIdConfigurableFieldSetsIdValidationsPostRequestAttributes
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": RestV10CompaniesCompanyIdConfigurableFieldSetsIdValidationsPostRequestAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
