...
class ChecklistItemResponseSetBody1(BaseModel):
    """
    ChecklistItemResponseSetBody1
    """ # noqa: E501
    response_set: ItemResponseSet1
    __properties: ClassVar[List[str]] = ["response_set"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response_set": ItemResponseSet1.from_dict(obj["response_set"]) if obj.get("response_set") is not None else None
        })
        return _obj
