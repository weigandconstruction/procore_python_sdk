...
class RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCommentsIdPatchRequestTaskItemComment(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="The status of the task item at the time the comment. Standard users who are assigned to a task item cannot change the status to closed or void.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "status", "attachments", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
