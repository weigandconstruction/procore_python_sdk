...
class RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfSyncedTo(BaseModel):
    """
    ...
    section_id: Optional[StrictInt] = Field(default=None, description="Company Template Section ID that Template Section is Synced to")
    __properties: ClassVar[List[str]] = ["company_id", "section_id"]
