...
class RestV10ProjectsProjectIdRfisPost201ResponseAllOfCustomTextfield1(BaseModel):
    """
    Custom RFI text field 1
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Project label for RFI custom text field 1")
    value: Optional[StrictStr] = Field(default=None, description="Value for RFI custom text field 1")
