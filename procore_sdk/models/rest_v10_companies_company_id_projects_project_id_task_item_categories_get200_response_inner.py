...
class RestV10CompaniesCompanyIdProjectsProjectIdTaskItemCategoriesGet200ResponseInner(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="User given name of category")
