...
class Instruction1(BaseModel):
    """
    Instruction1
    """ # noqa: E501
    number: Optional[StrictStr] = Field(default=None, description="The Number of the Instruction")
    title: Optional[StrictStr] = Field(default=None, description="The Title of the Instruction")
    status: Optional[StrictStr] = Field(default=None, description="The Status of the Instruction")
    instruction_type_id: Optional[StrictInt] = Field(default=None, description="ID of the Instruction Type")
