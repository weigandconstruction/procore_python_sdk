...
class DrawingRevision(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["drawing_date", "received_date", "revision_number", "floorplan", "drawing_set_id", "drawing_id", "custom_field_%{custom_field_definition_id}"]
