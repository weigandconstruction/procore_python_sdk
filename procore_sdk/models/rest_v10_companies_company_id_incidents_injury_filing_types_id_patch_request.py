...
class RestV10CompaniesCompanyIdIncidentsInjuryFilingTypesIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsInjuryFilingTypesIdPatchRequest
    """ # noqa: E501
    filing_type: RestV10CompaniesCompanyIdIncidentsInjuryFilingTypesIdPatchRequestFilingType
    __properties: ClassVar[List[str]] = ["filing_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filing_type": RestV10CompaniesCompanyIdIncidentsInjuryFilingTypesIdPatchRequestFilingType.from_dict(obj["filing_type"]) if obj.get("filing_type") is not None else None
        })
        return _obj
