...
class WbsCodeBulkCreateBulkInner(BaseModel):
    """
    WbsCodeBulkCreateBulkInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the wbs code.")
    segment_items: Optional[List[WbsCodeBulkCreateBulkInnerSegmentItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segment_items": [WbsCodeBulkCreateBulkInnerSegmentItemsInner.from_dict(_item) for _item in obj["segment_items"]] if obj.get("segment_items") is not None else None
        })
        return _obj
