...
class RestV10WorkflowInstancesGet200ResponseInnerCurrentWorkflowActivitiesInnerPerformActivityDataWorkflowActivityHistory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["workflow_activity_id", "workflow_instance_id", "workflow_user_role_id"]
