...
class RestV10CoordinationIssuesStatusTotalGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["open_count", "blocked_count", "unblocked_count", "ready_for_review_count", "moved_to_observation_count", "closed_count"]
