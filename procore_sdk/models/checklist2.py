...
class Checklist2(BaseModel):
    """
    Checklist object
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name for the Checklist.")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "due_at", "inspection_date", "inspection_type_id", "point_of_contact_id", "inspectee_id", "number", "personal", "responsible_contractor_id", "spec_section_id", "status", "trade_id", "inspector_ids", "distribution_member_ids", "location_id", "mt_location", "custom_field_%{custom_field_definition_id}", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
