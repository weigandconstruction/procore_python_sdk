...
class RestV10WorkOrderContractsWorkOrderContractIdLineItemContractDetailsGet200ResponseInner(BaseModel):
    """
    Detail Line Item
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "description", "position", "line_item_id", "billed_to_date", "billed_against", "currency_configuration"]
