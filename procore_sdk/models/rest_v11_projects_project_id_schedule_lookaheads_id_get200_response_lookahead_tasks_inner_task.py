...
class RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerTask(BaseModel):
    """
    ...
    finish: Optional[datetime] = Field(default=None, description="Task finish time")
    start: Optional[datetime] = Field(default=None, description="Task start time")
    __properties: ClassVar[List[str]] = ["id", "finish", "start"]
