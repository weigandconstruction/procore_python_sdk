...
class RestV10ProjectsProjectIdCorrespondenceTypeItemsPatch200ResponseInnerInner(BaseModel):
    """
    RestV10ProjectsProjectIdCorrespondenceTypeItemsPatch200ResponseInnerInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the generic tool item.")
    status: Optional[StrictStr] = Field(default=None, description="Update status for the generic tool item.")
