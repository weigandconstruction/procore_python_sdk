...
class ProjectObservationTypeCreateBody(BaseModel):
    """
    ProjectObservationTypeCreateBody
    """ # noqa: E501
    observation_type: ProjectObservationType1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "observation_type": ProjectObservationType1.from_dict(obj["observation_type"]) if obj.get("observation_type") is not None else None
        })
        return _obj
