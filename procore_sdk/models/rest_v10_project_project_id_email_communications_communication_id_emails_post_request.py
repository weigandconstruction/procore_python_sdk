...
class RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsPostRequest(BaseModel):
    """
    RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsPostRequest
    """ # noqa: E501
    email: RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsPostRequestEmail
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsPostRequestEmail.from_dict(obj["email"]) if obj.get("email") is not None else None
        })
        return _obj
