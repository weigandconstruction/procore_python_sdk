...
class RestV10FilesPost201Response(BaseModel):
    """
    ...
    checked_out_by: Optional[RestV10FilesPost201ResponseCheckedOutBy] = None
    file_type: Optional[StrictStr] = Field(default=None, description="File type")
    file_versions: Optional[List[RestV10FilesPost201ResponseFileVersionsInner]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if checked_out_by (nullable) is None
        # and model_fields_set contains the field
        if self.checked_out_by is None and "checked_out_by" in self.model_fields_set:
            _dict['checked_out_by'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "checked_out_by": RestV10FilesPost201ResponseCheckedOutBy.from_dict(obj["checked_out_by"]) if obj.get("checked_out_by") is not None else None,
            "file_type": obj.get("file_type"),
            "file_versions": [RestV10FilesPost201ResponseFileVersionsInner.from_dict(_item) for _item in obj["file_versions"]] if obj.get("file_versions") is not None else None,
