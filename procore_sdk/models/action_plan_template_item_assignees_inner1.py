...
class ActionPlanTemplateItemAssigneesInner1(BaseModel):
    """
    ActionPlanTemplateItemAssigneesInner1
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of the Action Plan Template Item Assignee")
    ...
    __properties: ClassVar[List[str]] = ["id", "is_holding", "party_id", "role", "verification_method_id"]
