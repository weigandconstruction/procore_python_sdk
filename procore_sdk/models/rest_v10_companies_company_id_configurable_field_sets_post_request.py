...
class RestV10CompaniesCompanyIdConfigurableFieldSetsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdConfigurableFieldSetsPostRequest
    """ # noqa: E501
    configurable_field_set: RestV10CompaniesCompanyIdConfigurableFieldSetsPostRequestConfigurableFieldSet
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configurable_field_set": RestV10CompaniesCompanyIdConfigurableFieldSetsPostRequestConfigurableFieldSet.from_dict(obj["configurable_field_set"]) if obj.get("configurable_field_set") is not None else None
        })
        return _obj
