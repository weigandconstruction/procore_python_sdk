...
class ChecklistSignature1(BaseModel):
    """
    ChecklistSignature1
    """ # noqa: E501
    ...
    attachment: Optional[ChecklistSignature1Attachment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachment": ChecklistSignature1Attachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
