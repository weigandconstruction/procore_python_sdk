...
class RestV10ProjectsProjectIdActionPlansPlansPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansPostRequest
    """ # noqa: E501
    plan: RestV10ProjectsProjectIdActionPlansPlansPostRequestPlan
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan": RestV10ProjectsProjectIdActionPlansPlansPostRequestPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
