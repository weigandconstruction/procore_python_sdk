...
class RestV10CompaniesCompanyIdUomsGet200ResponseInnerUomCategory(BaseModel):
    """
    RestV10CompaniesCompanyIdUomsGet200ResponseInnerUomCategory
    """ # noqa: E501
    id: StrictInt = Field(description="ID")
    name: StrictStr = Field(description="Name of Unit of Measure Category")
