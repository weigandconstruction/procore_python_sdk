...
class RestV10ProjectsProjectIdChecklistListsFilterOptionsClosedByContactsGet200ResponseInner(BaseModel):
    """
    Checklist List Filter Options Response
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="ID of Checklist List filter object")
    value: Optional[StrictStr] = Field(default=None, description="Value of Checklist List filter object")
