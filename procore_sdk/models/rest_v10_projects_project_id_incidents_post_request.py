...
class RestV10ProjectsProjectIdIncidentsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsPostRequest
    """ # noqa: E501
    incident: RestV10ProjectsProjectIdIncidentsPostRequestIncident
    __properties: ClassVar[List[str]] = ["incident"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "incident": RestV10ProjectsProjectIdIncidentsPostRequestIncident.from_dict(obj["incident"]) if obj.get("incident") is not None else None
        })
        return _obj
