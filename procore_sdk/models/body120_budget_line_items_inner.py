...
class Body120BudgetLineItemsInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="Budget Line Item ID")
    __properties: ClassVar[List[str]] = ["wbs_code_id", "original_budget_amount", "uom", "quantity", "unit_cost", "calculation_strategy", "id"]
