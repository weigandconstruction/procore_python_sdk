...
class TimeAndMaterialEntry3(BaseModel):
    """
    Time and Material Entry Object
    """ # noqa: E501
    equipment_name: Optional[StrictStr] = Field(default=None, description="Equipment Name")
    __properties: ClassVar[List[str]] = ["equipment_name"]
