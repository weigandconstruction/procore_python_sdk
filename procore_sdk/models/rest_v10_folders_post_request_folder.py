...
class RestV10FoldersPostRequestFolder(BaseModel):
    """
    RestV10FoldersPostRequestFolder
    """ # noqa: E501
    parent_id: Optional[StrictInt] = Field(default=None, description="The ID of the parent folder to create the folder in. If not set the folder will be created under the root folder.")
    name: StrictStr = Field(description="The Name of the folder")
    is_tracked: Optional[StrictBool] = Field(default=False, description="Status if a folder should be tracked (true/false)")
    explicit_permissions: Optional[StrictBool] = Field(default=None, description="Set folder to private (true/false)")
    ...
    __properties: ClassVar[List[str]] = ["parent_id", "name", "is_tracked", "explicit_permissions", "custom_field_%{custom_field_definition_id}"]
