...
class ChangeOrderRequestSync(BaseModel):
    """
    ChangeOrderRequestSync
    """ # noqa: E501
    updates: List[ChangeOrderRequestSyncUpdatesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [ChangeOrderRequestSyncUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
