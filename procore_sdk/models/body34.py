...
class Body34(BaseModel):
    ...
    Body34
    """ # noqa: E501
    project_type: ProjectType3
    __properties: ClassVar[List[str]] = ["project_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_type": ProjectType3.from_dict(obj["project_type"]) if obj.get("project_type") is not None else None
        })
        return _obj
