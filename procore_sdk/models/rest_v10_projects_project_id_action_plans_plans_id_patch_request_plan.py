...
class RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlan(BaseModel):
    """
    ...
    plan_type_id: Optional[StrictInt] = Field(default=None, description="Plan Type ID to be set on the Action Plan")
    status_id: Optional[StrictInt] = Field(default=None, description="Action Plan Status ID to be set on the Action Plan")
    plan_approvers_attributes: Optional[List[RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanApproversAttributesInner]] = None
    plan_receivers_attributes: Optional[List[RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanReceiversAttributesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "private", "location_id", "manager_id", "plan_type_id", "status_id", "plan_approvers_attributes", "plan_receivers_attributes", "custom_field_%{custom_field_definition_id}"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan_approvers_attributes": [RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanApproversAttributesInner.from_dict(_item) for _item in obj["plan_approvers_attributes"]] if obj.get("plan_approvers_attributes") is not None else None,
            "plan_receivers_attributes": [RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanReceiversAttributesInner.from_dict(_item) for _item in obj["plan_receivers_attributes"]] if obj.get("plan_receivers_attributes") is not None else None,
