...
class RestV10CompaniesCompanyIdGenericToolsGenericToolIdStatusesGet200ResponseInner(BaseModel):
    """
    RestV10CompaniesCompanyIdGenericToolsGenericToolIdStatusesGet200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    status_name: Optional[StrictStr] = Field(default=None, description="Status Name")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    is_used: Optional[StrictBool] = Field(default=None, description="Is Used in generic tool item or workflow")
    __properties: ClassVar[List[str]] = ["id", "status_name", "status", "is_used"]
