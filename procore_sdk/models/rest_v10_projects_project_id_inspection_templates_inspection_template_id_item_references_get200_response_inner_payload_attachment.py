...
class RestV10ProjectsProjectIdInspectionTemplatesInspectionTemplateIdItemReferencesGet200ResponseInnerPayloadAttachment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "thumbnail_url", "name", "content_type"]
