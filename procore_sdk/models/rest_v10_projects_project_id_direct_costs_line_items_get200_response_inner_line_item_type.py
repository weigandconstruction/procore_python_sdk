...
class RestV10ProjectsProjectIdDirectCostsLineItemsGet200ResponseInnerLineItemType(BaseModel):
    """
    Line Item Type
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "base_type", "code", "name", "origin_data", "origin_id"]
