...
class RestV10ProjectsProjectIdSpecificationSetsGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "company_id", "name", "created_at", "deleted_at", "updated_at", "date", "position"]
