...
class RestV10SpecificationSectionsPostRequest(BaseModel):
    """
    RestV10SpecificationSectionsPostRequest
    """ # noqa: E501
    specification_section: RestV10SpecificationSectionsPostRequestSpecificationSection
    __properties: ClassVar[List[str]] = ["specification_section"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "specification_section": RestV10SpecificationSectionsPostRequestSpecificationSection.from_dict(obj["specification_section"]) if obj.get("specification_section") is not None else None
        })
        return _obj
