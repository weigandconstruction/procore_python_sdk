...
class RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsBulkDestroyDelete207Response(BaseModel):
    """
    Response of a bulk action
    """ # noqa: E501
    successes: Optional[List[StrictInt]] = Field(default=None, description="IDs that succeeded")
    failures: Optional[List[RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsBulkDestroyDelete207ResponseFailuresInner]] = Field(default=None, description="List of failures")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failures": [RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsBulkDestroyDelete207ResponseFailuresInner.from_dict(_item) for _item in obj["failures"]] if obj.get("failures") is not None else None
        })
        return _obj
