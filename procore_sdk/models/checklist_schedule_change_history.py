...
class ChecklistScheduleChangeHistory(BaseModel):
    """
    ...
    created_by_id: Optional[StrictInt] = Field(default=None, description="The ID of the user")
    created_at: Optional[datetime] = Field(default=None, description="Created date")
    __properties: ClassVar[List[str]] = ["id", "column", "old_value", "new_value", "created_by_id", "created_at"]
