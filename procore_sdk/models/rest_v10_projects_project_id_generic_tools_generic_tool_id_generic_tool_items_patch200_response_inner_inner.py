...
class RestV10ProjectsProjectIdGenericToolsGenericToolIdGenericToolItemsPatch200ResponseInnerInner(BaseModel):
    """
    RestV10ProjectsProjectIdGenericToolsGenericToolIdGenericToolItemsPatch200ResponseInnerInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the Generic Tool Item")
    status: Optional[StrictStr] = Field(default=None, description="status of the update on that Generic Tool Item")
    errors: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "status", "errors"]
