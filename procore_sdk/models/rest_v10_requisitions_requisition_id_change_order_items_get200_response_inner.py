...
class RestV10RequisitionsRequisitionIdChangeOrderItemsGet200ResponseInner(BaseModel):
    """
    Requisition (Subcontractor Invoice) Change Order Item
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID for Change Order Item")
    ...
    commitment_line_item_id: Optional[StrictInt] = Field(default=None, description="Commitment Line Item ID")
    commitment_line_item_origin_id: Optional[StrictStr] = Field(default=None, description="Commitment Line Item Origin ID")
    ...
    wbs_code: Optional[RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInnerWbsCode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "commitment_line_item_id": obj.get("commitment_line_item_id"),
            "commitment_line_item_origin_id": obj.get("commitment_line_item_origin_id"),
            ...
            "wbs_code": RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInnerWbsCode.from_dict(obj["wbs_code"]) if obj.get("wbs_code") is not None else None,
