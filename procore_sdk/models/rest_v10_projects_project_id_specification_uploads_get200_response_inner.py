...
class RestV10ProjectsProjectIdSpecificationUploadsGet200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdSpecificationUploadsGet200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    issued_date: Optional[StrictStr] = None
    received_date: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    spec_format: Optional[StrictStr] = None
    specification_set_id: Optional[StrictInt] = None
    locale: Optional[StrictStr] = Field(default=None, description="Language used for parsing text")
    __properties: ClassVar[List[str]] = ["id", "issued_date", "received_date", "status", "spec_format", "specification_set_id", "locale"]
