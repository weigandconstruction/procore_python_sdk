...
class RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsPostRequest(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsPostRequest
    """ # noqa: E501
    signatory_id: Optional[StrictStr] = Field(default=None, description="Party ID of the signatory")
    __properties: ClassVar[List[str]] = ["signatory_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signatory_id": obj.get("signatory_id")
        })
        return _obj
