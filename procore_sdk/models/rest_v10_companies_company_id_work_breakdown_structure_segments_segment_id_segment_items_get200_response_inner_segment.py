...
class RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsGet200ResponseInnerSegment(BaseModel):
    """
    Segment attributes
    """ # noqa: E501
    ...
    segment_items_count: Optional[StrictInt] = None
    project_can_modify_origin_project: Optional[StrictBool] = None
    project_can_delete_origin_company: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "position", "delimiter", "required", "segment_items_count", "project_can_modify_origin_project", "project_can_delete_origin_company", "structure", "created_at", "updated_at", "wbs_pattern_id"]
