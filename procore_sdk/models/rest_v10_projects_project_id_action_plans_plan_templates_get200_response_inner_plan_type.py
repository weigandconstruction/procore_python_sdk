...
class RestV10ProjectsProjectIdActionPlansPlanTemplatesGet200ResponseInnerPlanType(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplatesGet200ResponseInnerPlanType
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    active: Optional[StrictBool] = Field(default=None, description="Flag indicating if Action Plan Type is intended for use")
    ...
    source_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "active", "created_at", "name", "updated_at", "source_key"]
