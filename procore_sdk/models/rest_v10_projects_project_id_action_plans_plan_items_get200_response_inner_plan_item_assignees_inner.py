...
class RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInner(BaseModel):
    """
    Action Plan Item Assignee (Compact)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    created_at: Optional[datetime] = Field(default=None, description="Time the Plan Item Assignee was created")
    ...
    role: Optional[StrictStr] = Field(default=None, description="Role of the Plan Item Assignee")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Time the Plan Item Assignee was updated")
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "is_holding", "is_locked", "party", "role", "role_id", "signature", "updated_at", "verification_method"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['contractor', 'specialty_contractor', 'client', 'architect', 'third_party', 'null', 'internal']):
            raise ValueError("must be one of enum values ('contractor', 'specialty_contractor', 'client', 'architect', 'third_party', 'null', 'internal')")
        return value
