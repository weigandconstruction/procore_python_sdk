...
class RestV10LinksPostRequest(BaseModel):
    """
    RestV10LinksPostRequest
    """ # noqa: E501
    link: RestV10LinksPostRequestLink
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": RestV10LinksPostRequestLink.from_dict(obj["link"]) if obj.get("link") is not None else None
        })
        return _obj
