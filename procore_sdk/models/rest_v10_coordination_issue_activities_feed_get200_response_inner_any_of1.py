...
class RestV10CoordinationIssueActivitiesFeedGet200ResponseInnerAnyOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "details": Comment.from_dict(obj["details"]) if obj.get("details") is not None else None,
