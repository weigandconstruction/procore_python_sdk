...
class RestV10ProjectsProjectIdDailyLogsDelayLogTypesGet200ResponseInner(BaseModel):
    """
    Delay Log Type
    """ # noqa: E501
    id: Optional[StrictInt] = None
    display_name: Optional[StrictStr] = Field(default=None, description="The name displayed in the web UI")
    translation_key: Optional[StrictStr] = Field(default=None, description="The key used to translate default delay log types")
    visible: Optional[StrictBool] = Field(default=None, description="Whether the type is visible in the UI")
    ...
    __properties: ClassVar[List[str]] = ["id", "display_name", "translation_key", "visible", "created_at", "updated_at"]
