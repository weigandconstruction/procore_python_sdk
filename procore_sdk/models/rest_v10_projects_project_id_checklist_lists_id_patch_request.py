...
class RestV10ProjectsProjectIdChecklistListsIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdChecklistListsIdPatchRequest
    """ # noqa: E501
    list: RestV10ProjectsProjectIdChecklistListsIdPatchRequestList
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": RestV10ProjectsProjectIdChecklistListsIdPatchRequestList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
