...
class RestV10RequisitionsRequisitionIdContractItemsGet200ResponseInner(BaseModel):
    """
    Requisition (Subcontractor Invoice) item
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID for Contract Item or Whole Change Order Item")
    item_type: Optional[StrictStr] = Field(default=None, description="Item Type - (contract_item, contract_detail_item, change_order_item)")
