...
class Body144(BaseModel):
    """
    Body144
    """ # noqa: E501
    title: StrictStr = Field(description="Bid Form Title")
    base_bid: Optional[List[Body144BaseBidInner]] = Field(default=None, description="Base Bids")
    alternates: Optional[List[Body144AlternatesInner]] = Field(default=None, description="Alternate bids")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "base_bid": [Body144BaseBidInner.from_dict(_item) for _item in obj["base_bid"]] if obj.get("base_bid") is not None else None,
            "alternates": [Body144AlternatesInner.from_dict(_item) for _item in obj["alternates"]] if obj.get("alternates") is not None else None
        })
        return _obj
