...
class RestV10SettingsPermissionsGet200ResponseToolsInnerPermittedActionsInner(BaseModel):
    """
    RestV10SettingsPermissionsGet200ResponseToolsInnerPermittedActionsInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    action_name: Optional[StrictStr] = None
    label: Optional[StrictStr] = None
    tool_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "action_name", "label", "tool_name"]
