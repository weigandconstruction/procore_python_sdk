...
class RestV10FoldersPostRequest(BaseModel):
    """
    RestV10FoldersPostRequest
    """ # noqa: E501
    folder: RestV10FoldersPostRequestFolder
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "folder": RestV10FoldersPostRequestFolder.from_dict(obj["folder"]) if obj.get("folder") is not None else None
        })
        return _obj
