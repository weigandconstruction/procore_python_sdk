...
class ChangeOrderRequestSyncUpdatesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "change_order_package_id", "description", "due_date", "grand_total", "invoiced_date", "origin_data", "origin_id", "paid_date", "schedule_impact_amount", "status", "title"]
