...
class BIMFileExtractionCreatedBy(BaseModel):
    """
    BIMFileExtractionCreatedBy
    """ # noqa: E501
    company_name: Optional[StrictStr] = Field(default=None, description="User Company name")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "locale", "company_name", "login"]
