...
class RestV10ProjectsProjectIdRfisRfiIdRepliesIdPatchRequestReply(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["official", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
