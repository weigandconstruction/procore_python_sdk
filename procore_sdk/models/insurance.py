...
class Insurance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "effective_date", "enable_expired_insurance_notifications", "exempt", "expiration_date", "info_received", "insurance_provider", "insurance_type", "limit", "notes", "policy_number", "status", "vendor_id", "additional_insured", "division_template", "insurance_sets", "origin_data", "origin_id"]
