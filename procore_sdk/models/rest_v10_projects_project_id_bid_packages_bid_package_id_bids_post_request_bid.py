...
class RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequestBid(BaseModel):
    """
    RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequestBid
    """ # noqa: E501
    vendor_id: StrictInt = Field(description="Vendor responsible for bid")
    ...
    __properties: ClassVar[List[str]] = ["vendor_id", "lump_sum_amount", "bidder_comments", "is_bidder_committed", "submitted", "recipient_ids"]
