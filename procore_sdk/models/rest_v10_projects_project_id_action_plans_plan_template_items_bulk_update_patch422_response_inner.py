...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemsBulkUpdatePatch422ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplateItemsBulkUpdatePatch422ResponseInner
    """ # noqa: E501
    id: StrictInt = Field(description="ID of Action Plan Item")
    errors: RestV10ProjectsProjectIdActionPlansPlanTemplateItemsBulkUpdatePatch422ResponseInnerErrors
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "errors": RestV10ProjectsProjectIdActionPlansPlanTemplateItemsBulkUpdatePatch422ResponseInnerErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None
        })
        return _obj
