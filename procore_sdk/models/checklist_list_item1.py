...
class ChecklistListItem1(BaseModel):
    """
    ChecklistListItem1
    """ # noqa: E501
    ...
    response_set: Optional[ChecklistListItem1ResponseSet] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "details", "item_response", "list_id", "name", "position", "responded_with", "response", "response_set", "response_type_id", "section_id", "status", "template_item_id", "type", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if response_set (nullable) is None
        # and model_fields_set contains the field
        if self.response_set is None and "response_set" in self.model_fields_set:
            _dict['response_set'] = None

        # set to None if response_type_id (nullable) is None
        # and model_fields_set contains the field
        if self.response_type_id is None and "response_type_id" in self.model_fields_set:
            _dict['response_type_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response_set": ChecklistListItem1ResponseSet.from_dict(obj["response_set"]) if obj.get("response_set") is not None else None,
