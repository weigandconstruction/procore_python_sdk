...
class RestV10ProjectsProjectIdActionPlansPlansPostRequestPlanPlanReceiversAttributesInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansPostRequestPlanPlanReceiversAttributesInner
    """ # noqa: E501
    party_id: StrictInt = Field(description="Party Person ID of the Action Plan Receiver to be set")
