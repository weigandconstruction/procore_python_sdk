...
class RestV10ProjectsProjectIdVisitorLogsGet200ResponseInnerCustomFieldsCustomFieldCustomFieldLovEntriesDefinitionIdValueInner(BaseModel):
    """
    RestV10ProjectsProjectIdVisitorLogsGet200ResponseInnerCustomFieldsCustomFieldCustomFieldLovEntriesDefinitionIdValueInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the LOV Entry")
    label: Optional[StrictStr] = Field(default=None, description="Label of the LOV Entry")
