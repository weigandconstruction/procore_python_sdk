...
class RestV10CompaniesCompanyIdIncidentsHarmSourcesBulkUpdatePatchRequestHarmSource(BaseModel):
    """
    IDs of all Harm Sources specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Harm Sources are available for use")
