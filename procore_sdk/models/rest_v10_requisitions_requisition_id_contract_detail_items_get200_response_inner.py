...
class RestV10RequisitionsRequisitionIdContractDetailItemsGet200ResponseInner(BaseModel):
    """
    Requisition (Subcontractor Invoice) contract detail item
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID for a Contract Detail Item")
    cost_code_id: Optional[StrictInt] = Field(default=None, description="Cost Code ID")
    detail_line_item_id: Optional[StrictInt] = Field(default=None, description="ID for a Work Order Contract Detail Line Item or Purchase Order Contract Detail Line Item")
