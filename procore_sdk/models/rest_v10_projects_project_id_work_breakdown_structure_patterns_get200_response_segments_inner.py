...
class RestV10ProjectsProjectIdWorkBreakdownStructurePatternsGet200ResponseSegmentsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "position", "segment_items_count", "required", "delimiter", "project_can_modify_origin_project", "project_can_delete_origin_company", "structure", "selectable_tiers", "is_included_in_project_pattern", "created_at", "updated_at", "wbs_pattern_id"]
