...
class RestV20CompaniesCompanyIdProjectsProjectIdAdvancedForecastingsRowsPostRequestForecastingRowsInnerPeriodsInner(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdAdvancedForecastingsRowsPostRequestForecastingRowsInnerPeriodsInner
    """ # noqa: E501
    period_date: StrictStr = Field(description="The period of the line item in the format 'YYYY-MM'")
    amount: Union[StrictFloat, StrictInt] = Field(description="The amount of the period")
    __properties: ClassVar[List[str]] = ["period_date", "amount"]
