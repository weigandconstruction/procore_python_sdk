...
class RestV10ChangeOrderRequestsPostRequestChangeOrder(BaseModel):
    """
    ...
    grand_total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total including markup")
    ...
    __properties: ClassVar[List[str]] = ["change_order_package_id", "description", "due_date", "grand_total", "invoiced_date", "origin_data", "origin_id", "paid_date", "schedule_impact_amount", "status", "title"]
