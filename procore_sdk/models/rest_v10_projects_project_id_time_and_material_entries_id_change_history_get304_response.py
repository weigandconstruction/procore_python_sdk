...
class RestV10ProjectsProjectIdTimeAndMaterialEntriesIdChangeHistoryGet304Response(BaseModel):
    """
    Change History
    """ # noqa: E501
    ...
    formatted_column: Optional[StrictStr] = Field(default=None, description="Human readable name of the column changed")
    ...
    created_by: Optional[RestV10ProjectsProjectIdTimeAndMaterialEntriesIdChangeHistoryGet304ResponseCreatedBy] = None
    created_at: Optional[datetime] = Field(default=None, description="Created date")
    __properties: ClassVar[List[str]] = ["id", "column", "readable_column", "formatted_column", "old_value", "new_value", "created_by", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "formatted_column": obj.get("formatted_column"),
            "old_value": obj.get("old_value"),
            "new_value": obj.get("new_value"),
            "created_by": RestV10ProjectsProjectIdTimeAndMaterialEntriesIdChangeHistoryGet304ResponseCreatedBy.from_dict(obj["created_by"]) if obj.get("created_by") is not None else None,
