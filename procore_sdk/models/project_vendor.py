...
class ProjectVendor(BaseModel):
    ...
    business_phone: Optional[StrictStr] = Field(default=None, description="Business phone number")
    ...
    mobile_phone: Optional[StrictStr] = Field(default=None, description="Mobile phone number")
