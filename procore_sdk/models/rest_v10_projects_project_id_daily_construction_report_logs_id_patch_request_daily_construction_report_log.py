...
class RestV10ProjectsProjectIdDailyConstructionReportLogsIdPatchRequestDailyConstructionReportLog(BaseModel):
    """
    ...
    local_county_hours: Optional[StrictStr] = Field(default=None, description="Number of hours performecd by local county resident workers")
    ...
    other_hours: Optional[StrictStr] = Field(default=None, description="Number of hours that the other workers were on site")
    vendor_id: Optional[StrictInt] = Field(default=None, description="The ID of the associated Vendor")
    status: Optional[StrictStr] = Field(default=None, description="Approval for pending logs")
    trade_id: Optional[StrictInt] = Field(default=None, description="The ID of the associated trade")
