...
class LineItemSyncBody1(BaseModel):
    """
    LineItemSyncBody1
    """ # noqa: E501
    updates: List[LineItem1]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [LineItem1.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
