...
class RestV11ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequest(BaseModel):
    """
    RestV11ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequest
    """ # noqa: E501
    bid: Optional[RestV11ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequestBid] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bid": RestV11ProjectsProjectIdBidPackagesBidPackageIdBidsIdPatchRequestBid.from_dict(obj["bid"]) if obj.get("bid") is not None else None
        })
        return _obj
