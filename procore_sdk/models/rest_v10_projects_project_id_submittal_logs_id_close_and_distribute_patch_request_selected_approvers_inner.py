...
class RestV10ProjectsProjectIdSubmittalLogsIdCloseAndDistributePatchRequestSelectedApproversInner(BaseModel):
    """
    RestV10ProjectsProjectIdSubmittalLogsIdCloseAndDistributePatchRequestSelectedApproversInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    include_comment: Optional[StrictBool] = None
    attachment_ids: Optional[List[StrictInt]] = Field(default=None, description="The prostore_file_id of the selected attachments.")
    __properties: ClassVar[List[str]] = ["id", "include_comment", "attachment_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "include_comment": obj.get("include_comment"),
