...
class RestV10ProjectsProjectIdRecycleBinActionPlansPlanItemAssigneesGet200ResponseInner(BaseModel):
    """
    Recycled Action Plan Item Assignee (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    plan_item_id: Optional[StrictInt] = Field(default=None, description="Plan Item ID of the Recycled Action Plan Item Assignee")
    created_at: Optional[StrictStr] = Field(default=None, description="Time the Recycled Action Plan Item Assignee was created")
    deleted_at: Optional[StrictStr] = Field(default=None, description="Time the Recycled Action Plan Item Assignee was deleted")
    ...
    role: Optional[StrictStr] = Field(default=None, description="Role of the Recycled Action Plan Item Assignee")
    signature: Optional[RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInnerSignature] = None
    updated_at: Optional[StrictStr] = Field(default=None, description="Time the Recycled Action Plan Item Assignee was updated")
    ...
    __properties: ClassVar[List[str]] = ["id", "plan_item_id", "created_at", "deleted_at", "is_holding", "is_locked", "party", "plan_id", "role", "signature", "updated_at", "verification_method"]
