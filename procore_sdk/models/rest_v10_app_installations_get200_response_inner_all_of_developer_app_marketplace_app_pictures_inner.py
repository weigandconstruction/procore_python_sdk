...
class RestV10AppInstallationsGet200ResponseInnerAllOfDeveloperAppMarketplaceAppPicturesInner(BaseModel):
    """
    RestV10AppInstallationsGet200ResponseInnerAllOfDeveloperAppMarketplaceAppPicturesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "name", "original_file_name", "type", "url"]
