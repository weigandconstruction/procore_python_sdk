...
class RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInnerTrigger(BaseModel):
    """
    RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInnerTrigger
    """ # noqa: E501
    resource_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource_name"]
