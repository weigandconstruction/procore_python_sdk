...
class ArrayOfPotentialChangeOrders(BaseModel):
    """
    ArrayOfPotentialChangeOrders
    """ # noqa: E501
    entities: Optional[List[ArrayOfPotentialChangeOrdersEntitiesInner]] = None
    errors: Optional[List[ArrayOfPotentialChangeOrdersErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [ArrayOfPotentialChangeOrdersEntitiesInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [ArrayOfPotentialChangeOrdersErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
