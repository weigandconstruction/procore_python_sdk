...
class RestV10ProjectsProjectIdRecycleBinActionPlansPlansGet200ResponseInner(BaseModel):
    """
    ...
    created_at: Optional[StrictStr] = Field(default=None, description="Time the Action Plan was created")
    deleted_at: Optional[StrictStr] = Field(default=None, description="Time the Action Plan was deleted")
    deleted_by: Optional[RestV10ProjectsProjectIdRecycleBinActionPlansPlansGet200ResponseInnerDeletedBy] = None
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the Action Plan")
    ...
    __properties: ClassVar[List[str]] = ["id", "plan_approvers", "created_at", "deleted_at", "deleted_by", "description", "description_plain_text", "location", "manager", "number", "plan_receivers", "plan_type", "plan_status", "status", "title", "updated_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['draft', 'in_progress', 'completed']):
            raise ValueError("must be one of enum values ('draft', 'in_progress', 'completed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deleted_by": RestV10ProjectsProjectIdRecycleBinActionPlansPlansGet200ResponseInnerDeletedBy.from_dict(obj["deleted_by"]) if obj.get("deleted_by") is not None else None,
