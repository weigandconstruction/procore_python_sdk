...
class RestV10CompaniesCompanyIdWorkBreakdownStructurePatternsGet200ResponseSegmentsInner(BaseModel):
    """
    ...
    position: Optional[StrictInt] = Field(default=None, description="Position of the Wbs Segment according to the Company Wbs Pattern.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "name", "position", "segment_items_count", "required", "delimiter", "project_can_modify_origin_project", "project_can_delete_origin_company", "structure", "created_at", "updated_at", "wbs_pattern_id"]
