...
class RestV10ProjectsProjectIdRecycleBinActionPlansPlanTestRecordsGet200ResponseInnerPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["checklist_id", "checklist_template_id", "attachment"]
