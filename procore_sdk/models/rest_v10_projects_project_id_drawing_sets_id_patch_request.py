...
class RestV10ProjectsProjectIdDrawingSetsIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdDrawingSetsIdPatchRequest
    """ # noqa: E501
    drawing_set: DrawingSet
    __properties: ClassVar[List[str]] = ["drawing_set"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "drawing_set": DrawingSet.from_dict(obj["drawing_set"]) if obj.get("drawing_set") is not None else None
        })
        return _obj
