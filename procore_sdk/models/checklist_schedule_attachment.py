...
class ChecklistScheduleAttachment(BaseModel):
    """
    ...
    schedule_id: Optional[StrictInt] = Field(default=None, description="Checklist Schedule ID associated with attachment")
    attachment: Optional[ChecklistScheduleAttachmentAttachment] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "schedule_id", "attachment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachment": ChecklistScheduleAttachmentAttachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
