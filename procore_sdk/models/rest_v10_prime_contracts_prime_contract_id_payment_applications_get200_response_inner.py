...
class RestV10PrimeContractsPrimeContractIdPaymentApplicationsGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "billing_date", "invoice_number", "origin_data", "origin_id", "percent_complete", "period_start", "period_end", "period_id", "status", "total_amount_paid", "number", "total_amount_accrued_this_period", "formatted_contract_company", "currency_configuration", "g702", "billing_period", "contract", "created_at", "updated_at"]
