...
class RestV10ProjectsProjectIdNotesLogsPostRequestNotesLog(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "date", "datetime", "daily_log_header_id", "is_issue_day", "location_id", "mt_location", "custom_field_%{custom_field_definition_id}"]
