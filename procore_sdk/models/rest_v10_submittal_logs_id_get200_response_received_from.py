...
class RestV10SubmittalLogsIdGet200ResponseReceivedFrom(BaseModel):
    """
    RestV10SubmittalLogsIdGet200ResponseReceivedFrom
    """ # noqa: E501
    name: Optional[StrictStr] = None
    login: Optional[StrictStr] = None
    login_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "login", "login_id"]
