...
class RestV10FoldersIdPatchRequest(BaseModel):
    """
    RestV10FoldersIdPatchRequest
    """ # noqa: E501
    folder: RestV10FoldersIdPatchRequestFolder
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "folder": RestV10FoldersIdPatchRequestFolder.from_dict(obj["folder"]) if obj.get("folder") is not None else None
        })
        return _obj
