...
class RestV10CompaniesCompanyIdManagedEquipmentTypesBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentTypesBulkUpdatePatchRequest
    """ # noqa: E501
    managed_equipment_type: RestV10CompaniesCompanyIdManagedEquipmentTypesBulkUpdatePatchRequestManagedEquipmentType
    __properties: ClassVar[List[str]] = ["managed_equipment_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_type": RestV10CompaniesCompanyIdManagedEquipmentTypesBulkUpdatePatchRequestManagedEquipmentType.from_dict(obj["managed_equipment_type"]) if obj.get("managed_equipment_type") is not None else None
        })
        return _obj
