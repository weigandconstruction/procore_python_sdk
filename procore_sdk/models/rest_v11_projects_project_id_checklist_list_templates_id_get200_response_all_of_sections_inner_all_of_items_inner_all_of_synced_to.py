...
class RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfItemsInnerAllOfSyncedTo(BaseModel):
    """
    ...
    item_id: Optional[StrictInt] = Field(default=None, description="Company Template Item ID that Template Item is Synced to")
    __properties: ClassVar[List[str]] = ["company_id", "item_id"]
