...
class RestV11ProjectsProjectIdMeetingsGet200ResponseOneOfInner(BaseModel):
    """
    Group of meetings
    """ # noqa: E501
    group_title: Optional[StrictStr] = Field(default=None, description="Meeting group title")
    meetings: Optional[List[RestV11ProjectsProjectIdMeetingsGet200ResponseOneOfInnerMeetingsInner]] = Field(default=None, description="Meetings")
    __properties: ClassVar[List[str]] = ["group_title", "meetings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meetings": [RestV11ProjectsProjectIdMeetingsGet200ResponseOneOfInnerMeetingsInner.from_dict(_item) for _item in obj["meetings"]] if obj.get("meetings") is not None else None
        })
        return _obj
