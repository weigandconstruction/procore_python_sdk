...
class ChecklistScheduleBody(BaseModel):
    """
    ChecklistScheduleBody
    """ # noqa: E501
    schedule: ChecklistSchedule1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schedule": ChecklistSchedule1.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None
        })
        return _obj
