...
class ArrayOfPotentialChangeOrderLineItemsErrorsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "company", "cost_code", "created_at", "description", "extended_type", "holder", "line_item_type", "origin_data", "origin_id", "position", "project", "quantity", "tax_code_id", "total_amount", "extended_amount", "unit_cost", "uom", "updated_at", "change_event_line_item", "errors"]
