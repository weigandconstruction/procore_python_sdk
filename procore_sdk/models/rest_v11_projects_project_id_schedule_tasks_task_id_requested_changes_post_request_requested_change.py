...
class RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequestRequestedChange(BaseModel):
    """
    RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequestRequestedChange
    """ # noqa: E501
    change_reason: Optional[StrictStr] = Field(default=None, description="Requested change reason")
    other_change: Optional[StrictStr] = None
    task: Optional[RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequestRequestedChangeTask] = None
    notes: Optional[StrictStr] = Field(default=None, description="Requested change notes")
    __properties: ClassVar[List[str]] = ["change_reason", "other_change", "task", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": RestV11ProjectsProjectIdScheduleTasksTaskIdRequestedChangesPostRequestRequestedChangeTask.from_dict(obj["task"]) if obj.get("task") is not None else None,
            "notes": obj.get("notes")
        })
        return _obj
