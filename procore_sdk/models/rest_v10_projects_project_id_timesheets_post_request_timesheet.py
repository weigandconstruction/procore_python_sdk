...
class RestV10ProjectsProjectIdTimesheetsPostRequestTimesheet(BaseModel):
    """
    RestV10ProjectsProjectIdTimesheetsPostRequestTimesheet
    """ # noqa: E501
    var_date: date = Field(description="The Date of the Timesheet", alias="date")
