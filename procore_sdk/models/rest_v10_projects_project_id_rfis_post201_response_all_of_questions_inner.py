...
class RestV10ProjectsProjectIdRfisPost201ResponseAllOfQuestionsInner(BaseModel):
    """
    RestV10ProjectsProjectIdRfisPost201ResponseAllOfQuestionsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    question_date: Optional[datetime] = Field(default=None, description="Date")
    ...
    answers: Optional[List[RestV10ProjectsProjectIdRfisPost201ResponseAllOfQuestionsInnerAnswersInner]] = Field(default=None, description="Answers")
    __properties: ClassVar[List[str]] = ["id", "question_date", "plain_text_body", "rich_text_body", "created_by", "attachments", "answers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "answers": [RestV10ProjectsProjectIdRfisPost201ResponseAllOfQuestionsInnerAnswersInner.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
