...
class RestV10ProjectsProjectIdActionPlansPlanReceiversPlanReceiverIdSignaturePostRequest1(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanReceiversPlanReceiverIdSignaturePostRequest1
    """ # noqa: E501
    signature: Optional[RestV10ProjectsProjectIdActionPlansPlanReceiversPlanReceiverIdSignaturePostRequest1Signature] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signature": RestV10ProjectsProjectIdActionPlansPlanReceiversPlanReceiverIdSignaturePostRequest1Signature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
