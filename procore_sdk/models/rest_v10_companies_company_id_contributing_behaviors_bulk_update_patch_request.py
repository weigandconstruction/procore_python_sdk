...
class RestV10CompaniesCompanyIdContributingBehaviorsBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdContributingBehaviorsBulkUpdatePatchRequest
    """ # noqa: E501
    contributing_behavior: RestV10CompaniesCompanyIdContributingBehaviorsBulkUpdatePatchRequestContributingBehavior
    __properties: ClassVar[List[str]] = ["contributing_behavior"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributing_behavior": RestV10CompaniesCompanyIdContributingBehaviorsBulkUpdatePatchRequestContributingBehavior.from_dict(obj["contributing_behavior"]) if obj.get("contributing_behavior") is not None else None
        })
        return _obj
