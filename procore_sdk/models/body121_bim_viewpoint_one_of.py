...
class Body121BimViewpointOneOf(BaseModel):
    """
    ...
    sections_data: Optional[StrictStr] = Field(default=None, description="JSON string representation of sections applied to a 3d model")
