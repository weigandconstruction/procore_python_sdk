...
class RestV10ProjectsProjectIdPrimeChangeOrderBatchesPost201Response(BaseModel):
    """
    Prime Change Order Batch
    """ # noqa: E501
    attachments: Optional[List[Default2AttachmentsInner]] = Field(default=None, description="Attachments")
    id: Optional[StrictInt] = Field(default=None, description="Prime Change Order Batch ID")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Description of the Prime Change Order Batch")
    due_date: Optional[date] = Field(default=None, description="Due date")
    executed: Optional[StrictBool] = Field(default=None, description="Whether or not the Prime Change Order Batch is executed")
    ...
    created_by: Optional[RestV10ProjectsProjectIdPrimeChangeOrderBatchesGet200ResponseCreatedBy] = None
    designated_reviewer: Optional[RestV10ProjectsProjectIdPrimeChangeOrderBatchesGet200ResponseDesignatedReviewer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created_by": RestV10ProjectsProjectIdPrimeChangeOrderBatchesGet200ResponseCreatedBy.from_dict(obj["created_by"]) if obj.get("created_by") is not None else None,
            "designated_reviewer": RestV10ProjectsProjectIdPrimeChangeOrderBatchesGet200ResponseDesignatedReviewer.from_dict(obj["designated_reviewer"]) if obj.get("designated_reviewer") is not None else None,
