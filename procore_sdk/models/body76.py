...
class Body76(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instruction_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instruction_type": InstructionType.from_dict(obj["instruction_type"]) if obj.get("instruction_type") is not None else None
        })
        return _obj
