...
class ArrayOfDirectCostLineItems(BaseModel):
    """
    ArrayOfDirectCostLineItems
    """ # noqa: E501
    entities: Optional[List[RestV10ProjectsProjectIdDirectCostsDirectCostIdLineItemsGet200ResponseInner]] = None
    errors: Optional[List[ArrayOfPotentialChangeOrderLineItemsErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [RestV10ProjectsProjectIdDirectCostsDirectCostIdLineItemsGet200ResponseInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [ArrayOfPotentialChangeOrderLineItemsErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
