...
class RestV11ProjectsProjectIdMeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInner(BaseModel):
    """
    Meeting topic
    """ # noqa: E501
    ...
    download_all_url: Optional[StrictStr] = Field(default=None, description="URL to download all attachments for this meeting")
    __properties: ClassVar[List[str]] = ["id", "number", "created_on", "position", "due_date", "priority", "status", "title", "minutes", "description", "meeting_category", "assignments", "attachments", "download_all_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "download_all_url": obj.get("download_all_url")
        })
        return _obj
