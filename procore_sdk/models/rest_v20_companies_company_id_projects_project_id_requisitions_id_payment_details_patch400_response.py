...
class RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch400Response(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch400Response
    """ # noqa: E501
    error: Optional[RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
