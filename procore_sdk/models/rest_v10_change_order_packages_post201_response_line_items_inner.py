...
class RestV10ChangeOrderPackagesPost201ResponseLineItemsInner(BaseModel):
    """
    ...
    cost_code: Optional[RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerCostCode] = None
    ...
    line_item_type: Optional[LineItemType3] = None
    markup_line_items: Optional[List[RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerMarkupLineItemsInner]] = None
    currency_configuration: Optional[RestV10WorkOrderContractsGet200ResponseInnerCurrencyConfiguration] = None
    __properties: ClassVar[List[str]] = ["id", "position", "description", "quantity", "uom", "total_amount", "extended_amount", "cost_code", "wbs_code", "unit_cost", "holder", "line_item_type", "markup_line_items", "currency_configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost_code": RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerCostCode.from_dict(obj["cost_code"]) if obj.get("cost_code") is not None else None,
            ...
            "line_item_type": LineItemType3.from_dict(obj["line_item_type"]) if obj.get("line_item_type") is not None else None,
            "markup_line_items": [RestV10ChangeOrderPackagesPost201ResponseLineItemsInnerMarkupLineItemsInner.from_dict(_item) for _item in obj["markup_line_items"]] if obj.get("markup_line_items") is not None else None,
