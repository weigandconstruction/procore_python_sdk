...
class RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf2(BaseModel):
    """
    RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf2
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["logo", "is_active", "id", "name"]
