...
class DrawingUpload1(BaseModel):
    """
    Drawing Upload
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "company_id", "created_by_id", "created_at", "updated_at", "error_email_sent", "notify_on_success", "deletion_in_progress", "success_email_sent", "drawing_area_id", "status", "pre_adaptive_complete", "drawing_number_contains_revision", "get_info_from_filename", "language"]
