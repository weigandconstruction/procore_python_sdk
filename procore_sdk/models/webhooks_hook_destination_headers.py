...
class WebhooksHookDestinationHeaders(BaseModel):
    """
    WebhooksHookDestinationHeaders
    """ # noqa: E501
    authorization: Optional[StrictStr] = Field(default=None, description="Authorization header", alias="Authorization")
