...
class RestV10ProjectsProjectIdActionPlansPlanTemplateReceiversPostRequestPlanTemplateReceiver(BaseModel):
    """
    ...
    party_id: StrictStr = Field(description="ID of the Party to be designated as the Plan Receiver")
