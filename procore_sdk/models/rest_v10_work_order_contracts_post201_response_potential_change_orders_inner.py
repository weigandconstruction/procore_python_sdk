...
class RestV10WorkOrderContractsPost201ResponsePotentialChangeOrdersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "deleted_at", "due_date", "invoiced_date", "number", "paid_date", "reviewed_at", "title", "status", "updated_at", "currency_configuration"]
