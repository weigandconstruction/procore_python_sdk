...
class CompanyVendor(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bidding": CompanyVendorBidding.from_dict(obj["bidding"]) if obj.get("bidding") is not None else None
        })
        return _obj
