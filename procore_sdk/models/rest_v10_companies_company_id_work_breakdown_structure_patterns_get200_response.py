...
class RestV10CompaniesCompanyIdWorkBreakdownStructurePatternsGet200Response(BaseModel):
    """
    ...
    segments: Optional[List[RestV10CompaniesCompanyIdWorkBreakdownStructurePatternsGet200ResponseSegmentsInner]] = Field(default=None, description="Array of Wbs Segments")
    __properties: ClassVar[List[str]] = ["id", "description", "created_at", "updated_at", "segments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segments": [RestV10CompaniesCompanyIdWorkBreakdownStructurePatternsGet200ResponseSegmentsInner.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
