...
class RestV10CompaniesCompanyIdIncidentsActionTypesBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsActionTypesBulkUpdatePatchRequest
    """ # noqa: E501
    action_type: RestV10CompaniesCompanyIdIncidentsActionTypesBulkUpdatePatchRequestActionType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action_type": RestV10CompaniesCompanyIdIncidentsActionTypesBulkUpdatePatchRequestActionType.from_dict(obj["action_type"]) if obj.get("action_type") is not None else None
        })
        return _obj
