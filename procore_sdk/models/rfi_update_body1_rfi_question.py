...
class RFIUpdateBody1RfiQuestion(BaseModel):
    """
    The Question of the RFI
    """ # noqa: E501
    body: StrictStr = Field(description="The Body of the Question")
    attachments: Optional[List[StrictStr]] = Field(default=None, description="RFI's Attachments. To upload attachments you must upload the entire payload as `multipart/form-data` content-type and specify each parameter as form-data together with `attachments[]` as files.")
