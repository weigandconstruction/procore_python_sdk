...
class RestV10ProjectsProjectIdWeatherLogsConditionsGet200Response(BaseModel):
    """
    RestV10ProjectsProjectIdWeatherLogsConditionsGet200Response
    """ # noqa: E501
    sky: Optional[List[StrictStr]] = None
    ground: Optional[List[StrictStr]] = None
    calamity: Optional[List[StrictStr]] = None
    wind: Optional[List[StrictStr]] = None
    temperature: Optional[List[StrictStr]] = None
