...
class RestV10ProjectsProjectIdScheduleCalendarItemsSyncPatch200Response(BaseModel):
    """
    RestV10ProjectsProjectIdScheduleCalendarItemsSyncPatch200Response
    """ # noqa: E501
    entities: Optional[List[RestV10ProjectsProjectIdScheduleCalendarItemsGet200ResponseInner]] = None
    errors: Optional[List[RestV10TaxTypesPost400Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [RestV10ProjectsProjectIdScheduleCalendarItemsGet200ResponseInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [RestV10TaxTypesPost400Response.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
