...
class RestV10BimFilesGet200ResponseInner(BaseModel):
    """
    RestV10BimFilesGet200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    name: Optional[StrictStr] = Field(default=None, description="Name of the file to be associated to a project")
    uuid: Optional[StrictStr] = Field(default=None, description="Unique UUID associated with the file")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "uuid", "project_id", "company_id", "created_at", "updated_at"]
