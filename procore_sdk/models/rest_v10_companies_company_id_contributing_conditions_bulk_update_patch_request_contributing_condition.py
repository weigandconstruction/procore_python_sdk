...
class RestV10CompaniesCompanyIdContributingConditionsBulkUpdatePatchRequestContributingCondition(BaseModel):
    """
    IDs of all Contributing Conditions specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Contributing Conditions are available for use")
    __properties: ClassVar[List[str]] = ["ids", "active"]
