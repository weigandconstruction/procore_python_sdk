...
class PunchItemTypeBody(BaseModel):
    """
    PunchItemTypeBody
    """ # noqa: E501
    project_id: StrictInt = Field(description="The ID of the Project the Punch Item Type belongs to")
    punch_item_type: PunchItemType2
    __properties: ClassVar[List[str]] = ["project_id", "punch_item_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "punch_item_type": PunchItemType2.from_dict(obj["punch_item_type"]) if obj.get("punch_item_type") is not None else None
        })
        return _obj
