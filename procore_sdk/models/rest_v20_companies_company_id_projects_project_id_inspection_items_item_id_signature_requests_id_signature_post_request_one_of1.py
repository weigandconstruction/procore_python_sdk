...
class RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsIdSignaturePostRequestOneOf1(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsIdSignaturePostRequestOneOf1
    """ # noqa: E501
    attachment_id: StrictStr = Field(description="Prostore File ID")
