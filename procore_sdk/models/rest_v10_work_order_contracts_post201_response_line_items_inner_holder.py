...
class RestV10WorkOrderContractsPost201ResponseLineItemsInnerHolder(BaseModel):
    """
    Holder
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    holder_type: Optional[StrictStr] = Field(default=None, description="Holder type")
    __properties: ClassVar[List[str]] = ["id", "holder_type"]
