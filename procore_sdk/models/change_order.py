...
class ChangeOrder(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids", "contract_id", "batch_id", "change_order_change_reason_id", "location_id", "designated_reviewer_id", "received_from_id", "description", "due_date", "paid_date", "invoiced_date", "title", "status", "reference", "number", "revision", "field_change", "signature_required", "signed_change_order_received_date", "schedule_impact_amount", "executed", "private", "paid", "custom_field_%{custom_field_definition_id}"]
