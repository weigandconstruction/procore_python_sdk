...
class ChecklistSectionBody(BaseModel):
    """
    ChecklistSectionBody
    """ # noqa: E501
    project_id: StrictInt = Field(description="The ID of the Project the Section belongs to")
    section: Section
    __properties: ClassVar[List[str]] = ["project_id", "section"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "section": Section.from_dict(obj["section"]) if obj.get("section") is not None else None
        })
        return _obj
