...
class RestV10WorkOrderContractsPost201ResponseChangeOrderPackagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "contract_id", "created_at", "deleted_at", "due_date", "invoiced_date", "number", "origin_data", "origin_id", "paid_date", "reviewed_at", "title", "status", "updated_at", "currency_configuration"]
