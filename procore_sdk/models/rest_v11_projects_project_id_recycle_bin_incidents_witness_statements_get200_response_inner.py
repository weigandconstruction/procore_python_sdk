...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInner(BaseModel):
    """
    ...
    recording: Optional[RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecording] = None
    __properties: ClassVar[List[str]] = ["id", "incident_id", "attachments", "statement", "statement_plain_text", "date_received", "created_at", "deleted_at", "updated_at", "witness", "custom_fields", "recording"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recording": RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecording.from_dict(obj["recording"]) if obj.get("recording") is not None else None
        })
        return _obj
