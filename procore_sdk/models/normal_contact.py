...
class NormalContact(BaseModel):
    """
    The Contact associated with the Project Person
    """ # noqa: E501
    is_active: Optional[StrictBool] = Field(default=None, description="The active status of the Contact associated with the Project Person")
