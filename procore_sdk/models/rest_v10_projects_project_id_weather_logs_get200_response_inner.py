...
class RestV10ProjectsProjectIdWeatherLogsGet200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdWeatherLogsGet200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    attachments: Optional[List[RestV10CompaniesCompanyIdWorkflowPermanentLogsGet200ResponseInnerAttachmentsInner]] = Field(default=None, description=":filename to be depricated, use :name")
