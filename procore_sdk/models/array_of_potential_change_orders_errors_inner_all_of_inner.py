...
class ArrayOfPotentialChangeOrdersErrorsInnerAllOfInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "contract_id", "created_at", "due_date", "invoiced_date", "number", "paid_date", "reviewed_at", "status", "title", "updated_at"]
