...
class CompanyTrigger1(BaseModel):
    """
    CompanyTrigger1
    """ # noqa: E501
    company_id: StrictInt = Field(description="Company ID. You must supply either a company_id or project_id.")
    api_version: StrictStr = Field(description="API Version")
    triggers: List[CompanyTriggerTrigger]
    __properties: ClassVar[List[str]] = ["company_id", "api_version", "triggers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "triggers": [CompanyTriggerTrigger.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None
        })
        return _obj
