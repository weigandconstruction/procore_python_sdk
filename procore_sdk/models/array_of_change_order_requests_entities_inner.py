...
class ArrayOfChangeOrderRequestsEntitiesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "change_order_package_id", "contract_id", "created_at", "creator", "deleted_at", "description", "due_date", "grand_total", "invoiced_date", "number", "origin_data", "origin_id", "paid_date", "position", "private", "revision", "schedule_impact_amount", "status", "title", "updated_at", "attachments", "currency_configuration"]
