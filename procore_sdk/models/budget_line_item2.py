...
class BudgetLineItem2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["cost_code_id", "line_item_type_id", "original_budget_amount", "uom", "quantity", "unit_cost", "calculation_strategy"]
