...
class ChecklistTemplate5(BaseModel):
    """
    ChecklistTemplate5
    """ # noqa: E501
    ...
    sections: Optional[List[ChecklistTemplate5SectionsInner]] = Field(default=None, description="Checklist Sections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sections": [ChecklistTemplate5SectionsInner.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
