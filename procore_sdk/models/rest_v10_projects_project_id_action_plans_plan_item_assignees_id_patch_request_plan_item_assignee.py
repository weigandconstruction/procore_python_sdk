...
class RestV10ProjectsProjectIdActionPlansPlanItemAssigneesIdPatchRequestPlanItemAssignee(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanItemAssigneesIdPatchRequestPlanItemAssignee
    """ # noqa: E501
    is_holding: Optional[StrictBool] = Field(default=None, description="Indicates whether or not the Action Plan Item Assignee's signature is holding")
    ...
    __properties: ClassVar[List[str]] = ["is_holding", "party_id", "verification_method_id"]
