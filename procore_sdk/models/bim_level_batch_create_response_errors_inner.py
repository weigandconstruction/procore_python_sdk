...
class BIMLevelBatchCreateResponseErrorsInner(BaseModel):
    """
    BIMLevelBatchCreateResponseErrorsInner
    """ # noqa: E501
    elevation: Union[StrictFloat, StrictInt] = Field(description="Level elevation")
    bim_file_id: StrictInt = Field(description="ID of the BIM File linked to the Level")
    location_id: StrictInt = Field(description="ID of location linked to the Level")
    errors: Optional[RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOfErrors] = None
    __properties: ClassVar[List[str]] = ["elevation", "bim_file_id", "location_id", "errors"]
