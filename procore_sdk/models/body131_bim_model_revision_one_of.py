...
class Body131BimModelRevisionOneOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["home_viewpoint_id", "suitability", "publish_status", "min_boundary", "max_boundary", "rotation", "published_model_upload_uuid", "object_definition_upload_uuid"]
