...
class RestV10BudgetViewSnapshotsPost429Response(BaseModel):
    """
    RestV10BudgetViewSnapshotsPost429Response
    """ # noqa: E501
    error: Optional[RestV10BudgetViewSnapshotsPost429ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RestV10BudgetViewSnapshotsPost429ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
