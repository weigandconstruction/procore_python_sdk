...
class ChecklistTemplate4SectionsInnerItemsInner(BaseModel):
    """
    ...
    section_position: Optional[StrictInt] = Field(default=None, description="Checklist Section Position")
    position: Optional[StrictInt] = Field(default=None, description="Position")
    __properties: ClassVar[List[str]] = ["id", "name", "status", "section_id", "section_position", "position"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "section_position": obj.get("section_position"),
