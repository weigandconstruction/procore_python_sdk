...
class RestV11ProjectsProjectIdProjectTimesheetTimecardEntriesIdPatchRequest(BaseModel):
    """
    RestV11ProjectsProjectIdProjectTimesheetTimecardEntriesIdPatchRequest
    """ # noqa: E501
    timesheet: Optional[RestV11ProjectsProjectIdProjectTimesheetTimecardEntriesIdPatchRequestTimesheet] = None
