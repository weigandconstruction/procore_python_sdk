...
class RestV11CompaniesCompanyIdActionPlansPlanTemplatesGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "description", "description_plain_text", "status", "private", "title", "plan_type", "provider_type", "updated_at"]
