...
class IncidentNormalAllOfEnvironmentalsInner(BaseModel):
    """
    ...
    quantity_value: Optional[StrictStr] = Field(default=None, description="Numeric portion of the \"quantity\" field")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of environmental_type
        if self.environmental_type:
            _dict['environmental_type'] = self.environmental_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "environmental_type": EnvironmentalType.from_dict(obj["environmental_type"]) if obj.get("environmental_type") is not None else None,
