...
class Body36(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_id", "project_role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "project_role": ProjectRole.from_dict(obj["project_role"]) if obj.get("project_role") is not None else None
        })
        return _obj
