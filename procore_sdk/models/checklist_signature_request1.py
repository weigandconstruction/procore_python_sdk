...
class ChecklistSignatureRequest1(BaseModel):
    """
    ChecklistSignatureRequest1
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    signatory: Optional[ChecklistSignatureRequestSignatory] = None
    signature: Optional[ChecklistSignature2] = None
    __properties: ClassVar[List[str]] = ["id", "signatory", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "signatory": ChecklistSignatureRequestSignatory.from_dict(obj["signatory"]) if obj.get("signatory") is not None else None,
            "signature": ChecklistSignature2.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
