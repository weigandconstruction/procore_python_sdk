...
class RestV10TaxCodesPostRequest(BaseModel):
    """
    RestV10TaxCodesPostRequest
    """ # noqa: E501
    tax_code: RestV10TaxCodesPostRequestTaxCode
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax_code": RestV10TaxCodesPostRequestTaxCode.from_dict(obj["tax_code"]) if obj.get("tax_code") is not None else None
        })
        return _obj
