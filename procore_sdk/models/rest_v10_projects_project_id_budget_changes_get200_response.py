...
class RestV10ProjectsProjectIdBudgetChangesGet200Response(BaseModel):
    """
    Result set of budget change summary rows. Summary row doesn't contain all fields of a budget change.
    """ # noqa: E501
    data: Optional[List[RestV10ProjectsProjectIdBudgetChangesGet200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RestV10ProjectsProjectIdBudgetChangesGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
