...
class ProjectTrigger1(BaseModel):
    """
    ProjectTrigger1
    """ # noqa: E501
    project_id: StrictInt = Field(description="Project ID. You must supply either a company_id or project_id.")
    api_version: StrictStr = Field(description="API Version")
    triggers: List[CompanyTriggerTrigger]
    __properties: ClassVar[List[str]] = ["project_id", "api_version", "triggers"]
