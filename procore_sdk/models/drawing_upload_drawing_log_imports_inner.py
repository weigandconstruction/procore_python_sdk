...
class DrawingUploadDrawingLogImportsInner(BaseModel):
    """
    DrawingUploadDrawingLogImportsInner
    """ # noqa: E501
    upload_uuid: StrictStr = Field(description="An Uploads objects uuid. Must be a pdf.")
    drawing_date: datetime = Field(description="Drawing date *Required only if a drawing_id is provided")
    received_date: Optional[datetime] = Field(default=None, description="Received date")
    default_revision: StrictStr = Field(description="Default Revision for any Drawing Revisions in the Import *Required only if a drawing_id is provided")
    drawing_id: Optional[StrictInt] = Field(default=None, description="Drawing ID to associate any created Drawing Revisions to")
    ...
    __properties: ClassVar[List[str]] = ["upload_uuid", "drawing_date", "received_date", "default_revision", "drawing_id", "custom_field_%{custom_field_definition_id}"]
