...
class RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseData(BaseModel):
    """
    ...
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount of the budget change")
    prime_contract: Optional[RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseDataAllOfPrimeContract] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "status", "title", "description", "erp_status", "amount", "prime_contract", "attachments", "adjustment_line_items", "production_quantities", "currency_configuration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of prime_contract
        if self.prime_contract:
            _dict['prime_contract'] = self.prime_contract.to_dict()
        ...
        # set to None if prime_contract (nullable) is None
        # and model_fields_set contains the field
        if self.prime_contract is None and "prime_contract" in self.model_fields_set:
            _dict['prime_contract'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prime_contract": RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseDataAllOfPrimeContract.from_dict(obj["prime_contract"]) if obj.get("prime_contract") is not None else None,
