...
class Body73(BaseModel):
    ...
    line_item_type: LineItemType2
    __properties: ClassVar[List[str]] = ["company_id", "line_item_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_item_type": LineItemType2.from_dict(obj["line_item_type"]) if obj.get("line_item_type") is not None else None
        })
        return _obj
