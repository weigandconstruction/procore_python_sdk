...
class RestV10ProjectsProjectIdChecklistSchedulesCalculateTotalInspectionsCountGetRequestSchedule(BaseModel):
    """
    RestV10ProjectsProjectIdChecklistSchedulesCalculateTotalInspectionsCountGetRequestSchedule
    """ # noqa: E501
    starts_at: datetime = Field(description="Schedule start date")
    ends_at: datetime = Field(description="Schedule end date")
    frequency: StrictStr = Field(description="Schedule frequency type name")
    __properties: ClassVar[List[str]] = ["starts_at", "ends_at", "frequency"]
