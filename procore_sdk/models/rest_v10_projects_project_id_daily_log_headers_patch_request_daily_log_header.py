...
class RestV10ProjectsProjectIdDailyLogHeadersPatchRequestDailyLogHeader(BaseModel):
    """
    RestV10ProjectsProjectIdDailyLogHeadersPatchRequestDailyLogHeader
    """ # noqa: E501
    completed: StrictBool = Field(description="Set the completion status for the day")
    distributed: StrictBool = Field(description="Distribute the Daily Log for the day")
    __properties: ClassVar[List[str]] = ["completed", "distributed"]
