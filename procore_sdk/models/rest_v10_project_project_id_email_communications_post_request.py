...
class RestV10ProjectProjectIdEmailCommunicationsPostRequest(BaseModel):
    """
    RestV10ProjectProjectIdEmailCommunicationsPostRequest
    """ # noqa: E501
    communication: RestV10ProjectProjectIdEmailCommunicationsPostRequestCommunication
    email: RestV10ProjectProjectIdEmailCommunicationsPostRequestEmail
    __properties: ClassVar[List[str]] = ["communication", "email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "communication": RestV10ProjectProjectIdEmailCommunicationsPostRequestCommunication.from_dict(obj["communication"]) if obj.get("communication") is not None else None,
            "email": RestV10ProjectProjectIdEmailCommunicationsPostRequestEmail.from_dict(obj["email"]) if obj.get("email") is not None else None
        })
        return _obj
