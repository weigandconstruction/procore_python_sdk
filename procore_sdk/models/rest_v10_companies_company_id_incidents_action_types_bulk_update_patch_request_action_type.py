...
class RestV10CompaniesCompanyIdIncidentsActionTypesBulkUpdatePatchRequestActionType(BaseModel):
    """
    IDs of all Incident Action Types specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Incident Action Types are available for use")
