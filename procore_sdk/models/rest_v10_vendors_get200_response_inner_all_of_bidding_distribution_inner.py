...
class RestV10VendorsGet200ResponseInnerAllOfBiddingDistributionInner(BaseModel):
    """
    RestV10VendorsGet200ResponseInnerAllOfBiddingDistributionInner
    """ # noqa: E501
    company_name: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    login: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["company_name", "id", "login", "name"]
