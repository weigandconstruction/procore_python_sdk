...
class RestV10CoordinationIssueActivitiesFeedGet200ResponseInnerAnyOf(BaseModel):
    """
    ...
    details: Optional[CoordinationIssueAssignmentActivityDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "details": CoordinationIssueAssignmentActivityDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
