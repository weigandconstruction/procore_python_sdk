...
class ChecklistSchedule2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "first_inspection_due_at", "ends_at", "frequency", "location_id", "point_of_contact_id", "responsible_contractor_id", "specification_section_id", "assignee_ids", "distribution_member_ids"]
    ...
    def frequency_validate_enum(cls, value):
        ...
        if value not in set(['once', 'daily', 'once_every_two_weeks', 'weekly', 'monthly', 'yearly']):
            raise ValueError("must be one of enum values ('once', 'daily', 'once_every_two_weeks', 'weekly', 'monthly', 'yearly')")
        return value
