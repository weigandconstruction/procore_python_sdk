...
class DirectCostLineItem1(BaseModel):
    """
    DirectCostLineItem1
    """ # noqa: E501
    ...
    currency_configuration: Optional[DirectCostLineItem1CurrencyConfiguration] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "company", "cost_code", "created_at", "currency_configuration", "description", "extended_type", "line_item_type", "origin_data", "origin_id", "position", "quantity", "tax_code_id", "total_amount", "extended_amount", "unit_cost", "uom", "updated_at", "wbs_code", "ref"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currency_configuration": DirectCostLineItem1CurrencyConfiguration.from_dict(obj["currency_configuration"]) if obj.get("currency_configuration") is not None else None,
