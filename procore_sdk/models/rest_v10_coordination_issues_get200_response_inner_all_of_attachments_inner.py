...
class RestV10CoordinationIssuesGet200ResponseInnerAllOfAttachmentsInner(BaseModel):
    """
    ...
    viewable: Optional[StrictBool] = Field(default=None, description="Boolean value indicating whether or not a viewable document has been created for the file.")
    __properties: ClassVar[List[str]] = ["id", "name", "content_type", "url", "viewable"]
