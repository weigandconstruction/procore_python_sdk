...
class RestV10CommunicationTagsPostRequestCommunicationTag(BaseModel):
    """
    RestV10CommunicationTagsPostRequestCommunicationTag
    """ # noqa: E501
    title: StrictStr = Field(description="name of the tag")
