...
class RestV10TaxCodesIdPatchRequest(BaseModel):
    """
    RestV10TaxCodesIdPatchRequest
    """ # noqa: E501
    tax_code: RestV10TaxCodesIdPatchRequestTaxCode
    __properties: ClassVar[List[str]] = ["tax_code"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tax_code:
            _dict['tax_code'] = self.tax_code.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax_code": RestV10TaxCodesIdPatchRequestTaxCode.from_dict(obj["tax_code"]) if obj.get("tax_code") is not None else None
        })
        return _obj
