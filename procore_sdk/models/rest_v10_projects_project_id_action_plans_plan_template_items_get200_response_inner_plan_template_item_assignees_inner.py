...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemsGet200ResponseInnerPlanTemplateItemAssigneesInner(BaseModel):
    """
    ...
    verification_method: Optional[RestV10ProjectsProjectIdActionPlansPlanTemplateItemsGet200ResponseInnerPlanTemplateItemAssigneesInnerVerificationMethod] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "is_holding", "party", "role", "updated_at", "verification_method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verification_method": RestV10ProjectsProjectIdActionPlansPlanTemplateItemsGet200ResponseInnerPlanTemplateItemAssigneesInnerVerificationMethod.from_dict(obj["verification_method"]) if obj.get("verification_method") is not None else None
        })
        return _obj
