...
class ErrorsResponse(BaseModel):
    ...
    """ # noqa: E501
    base: List[StrictStr]
    fields: ErrorsResponseFields
    __properties: ClassVar[List[str]] = ["base", "fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base": obj.get("base"),
            "fields": ErrorsResponseFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
        return _obj
