...
class RestV10DocumentMarkupDownloadablePdfsFindOrCreatePost200Response(BaseModel):
    """
    ...
    pusher_message_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "error_message", "status", "url", "pusher_message_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "pusher_message_name": obj.get("pusher_message_name")
        })
        return _obj
