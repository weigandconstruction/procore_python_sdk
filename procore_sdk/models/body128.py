...
class Body128(BaseModel):
    ...
    bim_model: Body128BimModel
    __properties: ClassVar[List[str]] = ["project_id", "view", "bim_model"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bim_model
        if self.bim_model:
            _dict['bim_model'] = self.bim_model.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "view": obj.get("view"),
            "bim_model": Body128BimModel.from_dict(obj["bim_model"]) if obj.get("bim_model") is not None else None
        })
        return _obj
