...
class IncidentInjuryUpdateParameters(BaseModel):
    """
    IncidentInjuryUpdateParameters
    """ # noqa: E501
    date_of_death: Optional[datetime] = Field(default=None, description="Date of death")
