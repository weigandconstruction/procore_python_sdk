...
class RestV10CompaniesCompanyIdContributingBehaviorsBulkUpdatePatchRequestContributingBehavior(BaseModel):
    """
    IDs of all Contributing Behaviors specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Contributing Behaviors are available for use")
