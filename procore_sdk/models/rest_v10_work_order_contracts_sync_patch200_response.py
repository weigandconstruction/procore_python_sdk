...
class RestV10WorkOrderContractsSyncPatch200Response(BaseModel):
    """
    RestV10WorkOrderContractsSyncPatch200Response
    """ # noqa: E501
    entities: Optional[List[RestV10WorkOrderContractsGet200ResponseInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [RestV10WorkOrderContractsGet200ResponseInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
