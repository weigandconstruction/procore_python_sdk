...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesBulkCreatePost200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesBulkCreatePost200ResponseInner
    """ # noqa: E501
    plan_template_item_id: Optional[StrictInt] = Field(default=None, description="The ID of the Item")
    is_holding: Optional[StrictBool] = Field(default=None, description="status of the update on that Item")
    errors: Optional[Dict[str, Any]] = None
    role: Optional[StrictStr] = Field(default=None, description="Role of the Project Action Plan Template Item Assignee to be set")
    verification_method_id: Optional[StrictInt] = Field(default=None, description="Verification Method ID of the Project Action Plan Template Item Assignee to be set")
    ...
    __properties: ClassVar[List[str]] = ["plan_template_item_id", "is_holding", "errors", "role", "verification_method_id", "party_id", "status"]
