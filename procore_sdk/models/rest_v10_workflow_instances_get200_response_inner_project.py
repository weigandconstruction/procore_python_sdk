...
class RestV10WorkflowInstancesGet200ResponseInnerProject(BaseModel):
    """
    RestV10WorkflowInstancesGet200ResponseInnerProject
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the associated project")
