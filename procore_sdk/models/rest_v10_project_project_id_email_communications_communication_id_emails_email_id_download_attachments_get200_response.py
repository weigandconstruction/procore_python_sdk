...
class RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsEmailIdDownloadAttachmentsGet200Response(BaseModel):
    """
    RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsEmailIdDownloadAttachmentsGet200Response
    """ # noqa: E501
    download_all_attachments_url: Optional[StrictStr] = Field(default=None, description="URL to download all email attachments in .zip")
    __properties: ClassVar[List[str]] = ["download_all_attachments_url"]
