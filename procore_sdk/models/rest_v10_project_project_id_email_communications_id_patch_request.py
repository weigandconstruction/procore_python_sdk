...
class RestV10ProjectProjectIdEmailCommunicationsIdPatchRequest(BaseModel):
    """
    RestV10ProjectProjectIdEmailCommunicationsIdPatchRequest
    """ # noqa: E501
    private: StrictBool = Field(description="Private Indicator")
