...
class RestV10CompaniesCompanyIdProgramsPost201ResponseAllOfProjectsInner(BaseModel):
    """
    RestV10CompaniesCompanyIdProgramsPost201ResponseAllOfProjectsInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "project_number"]
