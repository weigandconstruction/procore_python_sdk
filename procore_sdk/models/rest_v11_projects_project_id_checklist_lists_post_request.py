...
class RestV11ProjectsProjectIdChecklistListsPostRequest(BaseModel):
    """
    ...
    list: RestV11ProjectsProjectIdChecklistListsPostRequestList
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": RestV11ProjectsProjectIdChecklistListsPostRequestList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
