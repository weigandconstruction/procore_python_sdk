...
class ConfigurableFieldSet1(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Specificies the type the configurable field set is associated with.")
    __properties: ClassVar[List[str]] = ["id", "name", "category", "class_name", "fields", "sections", "inspection_type_id", "generic_tool_id", "action_plan_type_id", "type"]
