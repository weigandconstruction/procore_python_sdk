...
class RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsBulkDestroyDeleteRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsBulkDestroyDeleteRequest
    """ # noqa: E501
    segment_item_ids: List[StrictInt] = Field(description="List of segment item IDs")
    __properties: ClassVar[List[str]] = ["segment_item_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "segment_item_ids": obj.get("segment_item_ids")
        })
        return _obj
