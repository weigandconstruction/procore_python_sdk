...
class IncidentWitnessStatementCreateParameters(BaseModel):
    """
    ...
    witness_id: StrictInt = Field(description="Witness ID")
    ...
    __properties: ClassVar[List[str]] = ["incident_id", "statement", "date_received", "witness_id", "upload_uuids", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "custom_field_%{custom_field_definition_id}"]
