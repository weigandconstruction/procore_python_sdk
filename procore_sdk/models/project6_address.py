...
class Project6Address(BaseModel):
    """
    Address
    """ # noqa: E501
    ...
    country_code: Optional[StrictStr] = Field(default=None, description="CityCountry code")
    __properties: ClassVar[List[str]] = ["street", "city", "state_code", "zip", "country_code"]
