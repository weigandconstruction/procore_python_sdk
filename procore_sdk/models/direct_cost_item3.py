...
class DirectCostItem3(BaseModel):
    """
    ...
    employee_id: Optional[StrictInt] = Field(default=None, description="Employee ID")
    ...
    direct_cost_type: Optional[StrictStr] = Field(default=None, description="Type. Note: Can only be set when creating a direct cost item.")
    __properties: ClassVar[List[str]] = ["id", "description", "direct_cost_date", "employee_id", "invoice_number", "origin_data", "origin_id", "payment_date", "received_date", "status", "terms", "vendor_id", "direct_cost_type"]
