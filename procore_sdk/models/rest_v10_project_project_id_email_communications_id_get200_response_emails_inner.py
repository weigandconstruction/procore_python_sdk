...
class RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner(BaseModel):
    """
    ...
    attachments: Optional[List[RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInnerAttachmentsInner]] = Field(default=None, description="Email attachnents")
    ...
    __properties: ClassVar[List[str]] = ["id", "communication_id", "private", "attachments", "bcc_distribution", "body", "sanitized_body_html", "cc_distribution", "distribution", "email_sent_at", "login_information"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachments": [RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInnerAttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
