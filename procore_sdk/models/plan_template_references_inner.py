...
class PlanTemplateReferencesInner(BaseModel):
    """
    PlanTemplateReferencesInner
    """ # noqa: E501
    plan_template_item_id: StrictInt = Field(description="Plan Template Item ID")
    type: StrictStr = Field(description="Plan Template Reference Type")
    payload: PlanTemplateReferencesInnerPayload
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "payload": PlanTemplateReferencesInnerPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
