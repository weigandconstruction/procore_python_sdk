...
class RestV13CompaniesCompanyIdUsersBulkRemovePost200Response(BaseModel):
    """
    One key for each user ID passed in
    """ # noqa: E501
    user_id: Optional[RestV13CompaniesCompanyIdUsersBulkRemovePost200ResponseUserId] = Field(default=None, alias="userId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userId": RestV13CompaniesCompanyIdUsersBulkRemovePost200ResponseUserId.from_dict(obj["userId"]) if obj.get("userId") is not None else None
        })
