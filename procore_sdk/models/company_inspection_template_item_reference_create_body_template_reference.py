...
class CompanyInspectionTemplateItemReferenceCreateBodyTemplateReference(BaseModel):
    """
    CompanyInspectionTemplateItemReferenceCreateBodyTemplateReference
    """ # noqa: E501
    item_id: StrictInt = Field(description="ID of the associated Company Inspection Template Item")
    type: StrictStr = Field(description="Company Inspection Template Item Reference Type")
    payload: CompanyInspectionTemplateItemReferenceCreateBodyTemplateReferencePayload
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "payload": CompanyInspectionTemplateItemReferenceCreateBodyTemplateReferencePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
