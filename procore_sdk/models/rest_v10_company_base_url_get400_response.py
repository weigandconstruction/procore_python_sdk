...
class RestV10CompanyBaseUrlGet400Response(BaseModel):
    """
    RestV10CompanyBaseUrlGet400Response
    """ # noqa: E501
    error: Optional[RestV10CompanyBaseUrlGet400ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RestV10CompanyBaseUrlGet400ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
