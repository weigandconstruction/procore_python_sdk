...
class RestV10CompaniesCompanyIdManagedEquipmentBulkDestroyDeleteRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentBulkDestroyDeleteRequest
    """ # noqa: E501
    managed_equipment: RestV10CompaniesCompanyIdManagedEquipmentBulkDestroyDeleteRequestManagedEquipment
    __properties: ClassVar[List[str]] = ["managed_equipment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment": RestV10CompaniesCompanyIdManagedEquipmentBulkDestroyDeleteRequestManagedEquipment.from_dict(obj["managed_equipment"]) if obj.get("managed_equipment") is not None else None
        })
        return _obj
