...
class TimecardEntry8Crew(BaseModel):
    """
    TimecardEntry8Crew
    """ # noqa: E501
    ...
    employees: Optional[List[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy]] = None
    created_by: Optional[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy] = None
    lead: Optional[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy] = None
    created_at: Optional[datetime] = Field(default=None, description="Created at")
    updated_at: Optional[datetime] = Field(default=None, description="Created at")
    __properties: ClassVar[List[str]] = ["id", "name", "project_id", "company_id", "employees", "created_by", "lead", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employees": [RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy.from_dict(_item) for _item in obj["employees"]] if obj.get("employees") is not None else None,
            ...
            "lead": RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy.from_dict(obj["lead"]) if obj.get("lead") is not None else None,
