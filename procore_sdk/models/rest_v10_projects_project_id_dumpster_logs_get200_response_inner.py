...
class RestV10ProjectsProjectIdDumpsterLogsGet200ResponseInner(BaseModel):
    """
    ...
    quantity_delivered: Optional[StrictInt] = Field(default=None, description="Number of dumpsters delivered on site")
    quantity_removed: Optional[StrictInt] = Field(default=None, description="Number of dumpsters removed from site")
    ...
    attachments: Optional[List[RestV10CompaniesCompanyIdWorkflowPermanentLogsGet200ResponseInnerAttachmentsInner]] = Field(default=None, description="Dumpster Log Attachments are not viewable or used on web")
    __properties: ClassVar[List[str]] = ["id", "comments", "created_at", "date", "datetime", "deleted_at", "position", "quantity_delivered", "quantity_removed", "updated_at", "created_by", "vendor", "attachments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quantity_removed": obj.get("quantity_removed"),
