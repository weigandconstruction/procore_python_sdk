...
class RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanReceiversAttributesInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanReceiversAttributesInner
    """ # noqa: E501
    party_id: StrictInt = Field(description="Party Person ID of the Action Receiver to be set")
