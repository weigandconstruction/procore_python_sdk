...
class Body35(BaseModel):
    ...
    Body35
    """ # noqa: E501
    project_stage: ProjectStage3
    __properties: ClassVar[List[str]] = ["project_stage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_stage": ProjectStage3.from_dict(obj["project_stage"]) if obj.get("project_stage") is not None else None
        })
        return _obj
