...
class RestV10ProjectsProjectIdRfisPost201ResponseAllOfCustomTextfield2(BaseModel):
    """
    Custom RFI text field 2
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Project label for RFI custom text field 2")
    value: Optional[StrictStr] = Field(default=None, description="Value for RFI custom text field 2")
