...
class UpdateSegmentOrderBodyUpdatedOrderInner(BaseModel):
    """
    UpdateSegmentOrderBodyUpdatedOrderInner
    """ # noqa: E501
    segment_id: StrictInt = Field(description="Segment ID")
    position: StrictInt = Field(description="New position for the segment")
    __properties: ClassVar[List[str]] = ["segment_id", "position"]
