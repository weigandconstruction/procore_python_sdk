...
class RestV10ProjectsProjectIdActionPlansPlanSectionsPostRequestPlanSection(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanSectionsPostRequestPlanSection
    """ # noqa: E501
    plan_id: StrictInt = Field(description="Action Plan ID")
    title: StrictStr = Field(description="Title")
    __properties: ClassVar[List[str]] = ["plan_id", "title"]
