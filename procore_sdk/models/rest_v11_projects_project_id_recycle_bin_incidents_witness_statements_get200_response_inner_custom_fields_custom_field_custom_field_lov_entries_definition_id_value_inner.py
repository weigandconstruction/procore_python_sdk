...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerCustomFieldsCustomFieldCustomFieldLovEntriesDefinitionIdValueInner(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the list of values (LOV) entry.")
    label: Optional[StrictStr] = Field(default=None, description="The label of the list of values (LOV) entry.")
