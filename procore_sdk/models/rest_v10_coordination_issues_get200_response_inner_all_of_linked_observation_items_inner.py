...
class RestV10CoordinationIssuesGet200ResponseInnerAllOfLinkedObservationItemsInner(BaseModel):
    """
    ...
    title: Optional[StrictStr] = Field(default=None, description="Formatted Observation Item title")
    url: Optional[StrictStr] = Field(default=None, description="Deep-link URL to Observation Item")
    created_by_id: Optional[StrictInt] = Field(default=None, description="ID of user that created the Observation Item")
    __properties: ClassVar[List[str]] = ["id", "number", "personal", "title", "url", "created_by_id"]
