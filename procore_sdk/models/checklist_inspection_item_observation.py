...
class ChecklistInspectionItemObservation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "checklist_item_id", "checklist_list_id", "created_at", "updated_at", "created_by"]
