...
class RestV10CompaniesCompanyIdIncidentsWorkActivitiesBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsWorkActivitiesBulkUpdatePatchRequest
    """ # noqa: E501
    work_activity: RestV10CompaniesCompanyIdIncidentsWorkActivitiesBulkUpdatePatchRequestWorkActivity
    __properties: ClassVar[List[str]] = ["work_activity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "work_activity": RestV10CompaniesCompanyIdIncidentsWorkActivitiesBulkUpdatePatchRequestWorkActivity.from_dict(obj["work_activity"]) if obj.get("work_activity") is not None else None
        })
        return _obj
