...
class BusinessRegisterBody(BaseModel):
    ...
    """ # noqa: E501
    business_register: Optional[BusinessRegisterBodyBusinessRegister] = None
    __properties: ClassVar[List[str]] = ["business_register"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "business_register": BusinessRegisterBodyBusinessRegister.from_dict(obj["business_register"]) if obj.get("business_register") is not None else None
        })
        return _obj
