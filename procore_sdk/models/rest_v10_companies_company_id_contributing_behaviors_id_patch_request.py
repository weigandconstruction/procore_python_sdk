...
class RestV10CompaniesCompanyIdContributingBehaviorsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdContributingBehaviorsIdPatchRequest
    """ # noqa: E501
    contributing_behavior: RestV10CompaniesCompanyIdContributingBehaviorsIdPatchRequestContributingBehavior
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributing_behavior": RestV10CompaniesCompanyIdContributingBehaviorsIdPatchRequestContributingBehavior.from_dict(obj["contributing_behavior"]) if obj.get("contributing_behavior") is not None else None
        })
        return _obj
