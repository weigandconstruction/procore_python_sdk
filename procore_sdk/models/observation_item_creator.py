...
class ObservationItemCreator(BaseModel):
    """
    ...
    vendor: Optional[ObservationItemCreatorSCompany] = None
    __properties: ClassVar[List[str]] = ["id", "name", "login", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "login": obj.get("login"),
            "vendor": ObservationItemCreatorSCompany.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
