...
class RestV11ProjectsProjectIdMeetingsPost201ResponseAttendeesInner(BaseModel):
    """
    RestV11ProjectsProjectIdMeetingsPost201ResponseAttendeesInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Attendee id")
    status: Optional[StrictStr] = Field(default=None, description="Attendee status")
    login_information: Optional[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy] = None
    __properties: ClassVar[List[str]] = ["id", "status", "login_information"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Present', 'Absent', 'For Distribution Only', 'Conference', 'null']):
            raise ValueError("must be one of enum values ('Present', 'Absent', 'For Distribution Only', 'Conference', 'null')")
        return value
