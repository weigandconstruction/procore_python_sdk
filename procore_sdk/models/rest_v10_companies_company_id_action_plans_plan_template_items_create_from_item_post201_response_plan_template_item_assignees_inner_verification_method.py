...
class RestV10CompaniesCompanyIdActionPlansPlanTemplateItemsCreateFromItemPost201ResponsePlanTemplateItemAssigneesInnerVerificationMethod(BaseModel):
    """
    ...
    active: Optional[StrictBool] = Field(default=None, description="Flag indicating if the Company Action Plan Template Verification Method is intended for use")
