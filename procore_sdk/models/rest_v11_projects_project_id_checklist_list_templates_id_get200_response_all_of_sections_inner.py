...
class RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInner(BaseModel):
    """
    ...
    items: Optional[List[RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfItemsInner]] = None
    synced_to: Optional[RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfSyncedTo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "synced_to": RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfSyncedTo.from_dict(obj["synced_to"]) if obj.get("synced_to") is not None else None
        })
        return _obj
