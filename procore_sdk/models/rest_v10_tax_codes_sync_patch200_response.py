...
class RestV10TaxCodesSyncPatch200Response(BaseModel):
    """
    RestV10TaxCodesSyncPatch200Response
    """ # noqa: E501
    entities: Optional[List[RestV10TaxCodesGet200ResponseInner]] = None
    errors: Optional[List[RestV10TaxCodesSyncPatch200ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [RestV10TaxCodesGet200ResponseInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [RestV10TaxCodesSyncPatch200ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
