...
class RestV10PaymentApplicationsIdGet200Response(BaseModel):
    """
    ...
    g703: Optional[List[RestV10PaymentApplicationsIdGet200ResponseAllOfG703Inner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "g703": [RestV10PaymentApplicationsIdGet200ResponseAllOfG703Inner.from_dict(_item) for _item in obj["g703"]] if obj.get("g703") is not None else None,
            "id": obj.get("id"),
