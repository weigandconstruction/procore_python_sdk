...
class TimeAndMaterialSignatureCreateBody(BaseModel):
    """
    TimeAndMaterialSignatureCreateBody
    """ # noqa: E501
    signature: TimeAndMaterialSignatureCreateBodySignature
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signature": TimeAndMaterialSignatureCreateBodySignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
