...
class Insurance2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "effective_date", "enable_expired_insurance_notifications", "exempt", "expiration_date", "info_received", "insurance_type", "limit", "name", "notes", "policy_number", "status", "additional_insured", "division_template", "insurance_sets", "origin_data", "origin_id"]
