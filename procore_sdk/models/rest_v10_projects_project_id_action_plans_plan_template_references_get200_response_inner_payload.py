...
class RestV10ProjectsProjectIdActionPlansPlanTemplateReferencesGet200ResponseInnerPayload(BaseModel):
    """
    ...
    image_id: Optional[StrictInt] = Field(default=None, description="Image ID")
    ...
    __properties: ClassVar[List[str]] = ["attachment", "drawing_id", "drawing_revision_id", "file_version_id", "folder_id", "specification_section_id", "specification_section_current_revision_id", "generic_tool_item_id", "form_id", "image_id", "meeting_id", "observation_item_id"]
