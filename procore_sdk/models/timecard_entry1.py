...
class TimecardEntry1(BaseModel):
    """
    TimecardEntry1
    """ # noqa: E501
    ...
    timesheet_status: Optional[Timesheet1] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timesheet_status": Timesheet1.from_dict(obj["timesheet_status"]) if obj.get("timesheet_status") is not None else None,
...
TimecardEntry1.model_rebuild(raise_errors=False)
