...
class RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInner(BaseModel):
    """
    Action Plan Approver (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    plan_id: Optional[StrictInt] = Field(default=None, description="Action Plan ID")
    updated_at: Optional[StrictStr] = Field(default=None, description="Time the Action Plan Approver was updated")
    party: Optional[RestV10ProjectsProjectIdActionPlansPlanTemplatesGet200ResponseInnerManager] = None
    signature: Optional[RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInnerSignature] = None
    __properties: ClassVar[List[str]] = ["id", "plan_id", "updated_at", "party", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signature": RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanApproversInnerSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
