...
class LineItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "cost_code_id", "description", "extended_type", "quantity", "line_item_type_id", "origin_data", "origin_id", "tax_code_id", "unit_cost", "uom", "wbs_code_id"]
