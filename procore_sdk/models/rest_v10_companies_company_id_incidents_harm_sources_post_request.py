...
class RestV10CompaniesCompanyIdIncidentsHarmSourcesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsHarmSourcesPostRequest
    """ # noqa: E501
    harm_source: RestV10CompaniesCompanyIdIncidentsHarmSourcesPostRequestHarmSource
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "harm_source": RestV10CompaniesCompanyIdIncidentsHarmSourcesPostRequestHarmSource.from_dict(obj["harm_source"]) if obj.get("harm_source") is not None else None
        })
        return _obj
