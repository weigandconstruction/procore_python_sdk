...
class Checklist(BaseModel):
    ...
    specification_section: Optional[ChecklistSpecificationSection] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specification_section": ChecklistSpecificationSection.from_dict(obj["specification_section"]) if obj.get("specification_section") is not None else None,
