...
class RestV20CompaniesCompanyIdProjectsProjectIdAdvancedForecastingsRowsGet200ResponseDataInner(BaseModel):
    """
    ...
    wbs_code_id: Optional[StrictStr] = Field(default=None, description="ID of the WBS code")
    ...
    periods: Optional[List[RestV20CompaniesCompanyIdProjectsProjectIdAdvancedForecastingsRowsGet200ResponseDataInnerPeriodsInner]] = Field(default=None, description="The periods of the line item")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "periods": [RestV20CompaniesCompanyIdProjectsProjectIdAdvancedForecastingsRowsGet200ResponseDataInnerPeriodsInner.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None
        })
        return _obj
