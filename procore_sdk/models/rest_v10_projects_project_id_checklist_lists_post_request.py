...
class RestV10ProjectsProjectIdChecklistListsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdChecklistListsPostRequest
    """ # noqa: E501
    list_template_id: StrictInt = Field(description="ID of the Checklist List Template (Inspection Template) that the Checklist (Inspection) will be created from")
    list: RestV10ProjectsProjectIdChecklistListsPostRequestList
    __properties: ClassVar[List[str]] = ["list_template_id", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": RestV10ProjectsProjectIdChecklistListsPostRequestList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
