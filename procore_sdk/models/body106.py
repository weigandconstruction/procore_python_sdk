...
class Body106(BaseModel):
    """
    Body106
    """ # noqa: E501
    project_id: StrictInt = Field(description="Unique identifier for the project.")
    updates: List[Body104CoordinationIssue] = Field(description="An array of coordination issue payloads")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [Body104CoordinationIssue.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
