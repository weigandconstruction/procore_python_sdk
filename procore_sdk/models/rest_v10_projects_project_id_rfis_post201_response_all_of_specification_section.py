...
class RestV10ProjectsProjectIdRfisPost201ResponseAllOfSpecificationSection(BaseModel):
    """
    RestV10ProjectsProjectIdRfisPost201ResponseAllOfSpecificationSection
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    description: Optional[StrictStr] = Field(default=None, description="Description")
    number: Optional[StrictStr] = Field(default=None, description="Number")
    __properties: ClassVar[List[str]] = ["id", "description", "number"]
