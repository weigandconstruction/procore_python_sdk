...
class RestV10ProjectsProjectIdToolsPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdToolsPatchRequest
    """ # noqa: E501
    tools: List[RestV10ProjectsProjectIdToolsPatchRequestToolsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tools": [RestV10ProjectsProjectIdToolsPatchRequestToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None
        })
        return _obj
