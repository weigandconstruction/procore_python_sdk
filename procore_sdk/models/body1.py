...
class Body1(BaseModel):
    ...
    updates: List[WorkOrderContract1] = Field(description="Updated Work order contracts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [WorkOrderContract1.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
