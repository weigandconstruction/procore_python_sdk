...
class IncidentWitnessStatementUpdateParameters(BaseModel):
    """
    ...
    date_received: Optional[date] = Field(default=None, description="Date that the Witness Statement was received. This assumes the dates provided are in the project timezone.")
    witness_id: Optional[StrictInt] = Field(default=None, description="Witness ID")
    ...
    __properties: ClassVar[List[str]] = ["statement", "date_received", "witness_id", "upload_uuids", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "custom_field_%{custom_field_definition_id}"]
