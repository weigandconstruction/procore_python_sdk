...
class CreateDistributionGroupBody(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "distribution_group": DistributionGroup.from_dict(obj["distribution_group"]) if obj.get("distribution_group") is not None else None
        })
        return _obj
