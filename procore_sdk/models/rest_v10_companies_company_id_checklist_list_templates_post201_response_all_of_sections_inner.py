...
class RestV10CompaniesCompanyIdChecklistListTemplatesPost201ResponseAllOfSectionsInner(BaseModel):
    """
    RestV10CompaniesCompanyIdChecklistListTemplatesPost201ResponseAllOfSectionsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    position: Optional[StrictInt] = Field(default=None, description="Position")
    items: Optional[List[RestV10CompaniesCompanyIdChecklistListTemplatesPost201ResponseAllOfSectionsInnerAllOfItemsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "position", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RestV10CompaniesCompanyIdChecklistListTemplatesPost201ResponseAllOfSectionsInnerAllOfItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
