...
class RestV11CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequest(BaseModel):
    """
    RestV11CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequest
    """ # noqa: E501
    plan_template: RestV11CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequestPlanTemplate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan_template": RestV11CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequestPlanTemplate.from_dict(obj["plan_template"]) if obj.get("plan_template") is not None else None
        })
        return _obj
