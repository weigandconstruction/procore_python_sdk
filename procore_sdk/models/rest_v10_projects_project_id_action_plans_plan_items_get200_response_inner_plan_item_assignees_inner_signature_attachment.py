...
class RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInnerSignatureAttachment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "content_type", "name", "url"]
