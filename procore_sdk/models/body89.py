...
class Body89(BaseModel):
    """
    Body89
    """ # noqa: E501
    drawing_revision: DrawingRevision
    __properties: ClassVar[List[str]] = ["drawing_revision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "drawing_revision": DrawingRevision.from_dict(obj["drawing_revision"]) if obj.get("drawing_revision") is not None else None
        })
        return _obj
