...
class Meeting2(BaseModel):
    ...
    Meeting object
    """ # noqa: E501
    position: StrictInt = Field(description="The Position of the Meeting")
    ...
    meeting_date: Optional[date] = Field(default=None, description="The Date of the Meeting")
    ...
    start_time: Optional[StrictStr] = Field(default=None, description="The Start Time of the Meeting")
    finish_time: Optional[StrictStr] = Field(default=None, description="The Finish Time of the Meeting")
    ...
    attendees: Optional[List[StrictInt]] = Field(default=None, description="An array of the IDs of the Attendees of the Meeting")
    ...
    __properties: ClassVar[List[str]] = ["position", "title", "location", "minutes", "meeting_date", "overview", "occurred", "start_time", "finish_time", "time_zone", "is_private", "conclusion", "is_draft", "attendees", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "position": obj.get("position") if obj.get("position") is not None else 1,
            "title": obj.get("title"),
