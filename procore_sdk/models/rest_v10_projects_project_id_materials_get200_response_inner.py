...
class RestV10ProjectsProjectIdMaterialsGet200ResponseInner(BaseModel):
    """
    Material
    """ # noqa: E501
    ...
    project_id: Optional[StrictInt] = Field(default=None, description="ID of the project the material was logged for")
    time_and_material_entry_id: Optional[StrictInt] = Field(default=None, description="Time And Material Entry ID the material is associated with")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "uom", "quantity", "project_id", "time_and_material_entry_id", "updated_at", "created_at", "deleted_at", "created_by"]
