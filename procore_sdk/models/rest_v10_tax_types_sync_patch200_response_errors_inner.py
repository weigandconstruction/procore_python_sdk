...
class RestV10TaxTypesSyncPatch200ResponseErrorsInner(BaseModel):
    """
    RestV10TaxTypesSyncPatch200ResponseErrorsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the Tax Type")
    description: Optional[StrictStr] = Field(default=None, description="Description of the Tax Type")
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "name", "origin_data", "origin_id", "errors"]
