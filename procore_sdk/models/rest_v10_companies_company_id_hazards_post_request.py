...
class RestV10CompaniesCompanyIdHazardsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdHazardsPostRequest
    """ # noqa: E501
    hazard: RestV10CompaniesCompanyIdHazardsPostRequestHazard
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hazard": RestV10CompaniesCompanyIdHazardsPostRequestHazard.from_dict(obj["hazard"]) if obj.get("hazard") is not None else None
        })
        return _obj
