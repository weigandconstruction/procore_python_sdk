...
class InstructionScheduleImpact(BaseModel):
    """
    The Schedule Impact of the Instruction
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The Status of the Schedule Impact")
    value: Optional[StrictInt] = Field(default=None, description="The Value in days of the Schedule Impact")
