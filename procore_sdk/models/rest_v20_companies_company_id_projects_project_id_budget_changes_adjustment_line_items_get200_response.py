...
class RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200Response(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200Response
    """ # noqa: E501
    data: Optional[List[RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200ResponseDataInner]] = Field(default=None, description="Array of Budget Change Adjustment Line Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [RestV20CompaniesCompanyIdProjectsProjectIdBudgetChangesAdjustmentLineItemsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
