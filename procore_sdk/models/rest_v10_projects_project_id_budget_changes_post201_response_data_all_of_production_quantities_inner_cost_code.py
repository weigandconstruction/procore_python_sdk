...
class RestV10ProjectsProjectIdBudgetChangesPost201ResponseDataAllOfProductionQuantitiesInnerCostCode(BaseModel):
    """
    The cost code associated with the Production Quantity
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the Cost Code")
    label: Optional[StrictStr] = Field(default=None, description="The display value for the Cost Code")
