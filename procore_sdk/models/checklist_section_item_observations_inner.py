...
class ChecklistSectionItemObservationsInner(BaseModel):
    """
    ...
    type: Optional[ChecklistSectionItemObservationsInnerType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "type": ChecklistSectionItemObservationsInnerType.from_dict(obj["type"]) if obj.get("type") is not None else None,
