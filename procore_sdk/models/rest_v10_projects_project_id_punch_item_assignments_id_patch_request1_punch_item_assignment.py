...
class RestV10ProjectsProjectIdPunchItemAssignmentsIdPatchRequest1PunchItemAssignment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["approved", "comment", "login_information_id"]
