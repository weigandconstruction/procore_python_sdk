...
class ArrayOfTodosErrorsInner(BaseModel):
    """
    ArrayOfTodosErrorsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ToDo id")
    assignment: Optional[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy] = None
    color: Optional[StrictStr] = Field(default=None, description="ToDo color")
    created_by: Optional[RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy] = None
    description: Optional[StrictStr] = Field(default=None, description="ToDo description")
    finish_datetime: Optional[datetime] = Field(default=None, description="ToDo finish date-time")
    ...
    milestone: Optional[StrictBool] = Field(default=None, description="ToDo milestone status")
    name: Optional[StrictStr] = Field(default=None, description="ToDo name")
    percentage: Optional[StrictInt] = Field(default=None, description="ToDo percentage")
    private: Optional[StrictBool] = Field(default=None, description="ToDo private status")
    start_datetime: Optional[datetime] = Field(default=None, description="ToDo start date-time")
    task_name: Optional[StrictStr] = Field(default=None, description="ToDo name (corresponds to matching field on Tasks)")
    updated_at: Optional[datetime] = Field(default=None, description="Date/time the ToDo was last updated")
    errors: Optional[RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOfErrors] = None
    __properties: ClassVar[List[str]] = ["id", "assignment", "color", "created_by", "description", "finish_datetime", "full_outline_path", "milestone", "name", "percentage", "private", "start_datetime", "task_name", "updated_at", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "assignment": RestV10ProjectsProjectIdWorkLogsGet200ResponseInnerCreatedBy.from_dict(obj["assignment"]) if obj.get("assignment") is not None else None,
            "color": obj.get("color"),
