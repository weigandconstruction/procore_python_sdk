...
class RestV11RequisitionsGet200ResponseInnerItemsInnerWbsCodeSegmentItemsInner(BaseModel):
    """
    ...
    segment_type: Optional[StrictStr] = Field(default=None, description="Segment Type")
    segment_id: Optional[StrictInt] = Field(default=None, description="Segment ID")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "path_ids", "path_codes", "segment_type", "segment_id"]
