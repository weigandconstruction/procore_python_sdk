...
class RestV10CompaniesCompanyIdConfigurableFieldSetsPostRequestConfigurableFieldSetFieldsField1(BaseModel):
    """
    An example of what a field would look like
    """ # noqa: E501
    name: StrictStr = Field(description="the name of the field")
    visible: StrictBool = Field(description="whether the field is visible or not in the form")
