...
class Body104CoordinationIssueViewpointsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "view_folder_id", "snapshot_upload_uuid", "camera_data", "redlines_data", "sections_data", "render_mode", "visibility"]
