...
class RestV10ProjectsProjectIdRfisGet200ResponseInnerAllOfScheduleImpact(BaseModel):
    """
    RestV10ProjectsProjectIdRfisGet200ResponseInnerAllOfScheduleImpact
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Schedule impact status")
    value: Optional[StrictInt] = Field(default=None, description="Schedule impact value")
