...
class RestV10BimPlansGet200ResponseInnerAllOfThumbnail(BaseModel):
    """
    RestV10BimPlansGet200ResponseInnerAllOfThumbnail
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    size: Optional[StrictStr] = Field(default=None, description="Thumbnail size")
