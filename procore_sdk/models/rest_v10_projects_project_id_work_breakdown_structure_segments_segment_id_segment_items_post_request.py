...
class RestV10ProjectsProjectIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsPostRequest(BaseModel):
    """
    ...
    sub_job_id: Optional[StrictInt] = Field(default=None, description="Required to create a legacy cost code for a specific sub job")
    __properties: ClassVar[List[str]] = ["code", "name", "parent_id", "sub_job_id"]
