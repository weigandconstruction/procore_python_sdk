...
class RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseGenerationErrorsInner(BaseModel):
    """
    Errors and their corresponding Scheduled Tasks.
    """ # noqa: E501
    task: Optional[RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseGenerationErrorsInnerTask] = None
    errors: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["task", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "task": RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseGenerationErrorsInnerTask.from_dict(obj["task"]) if obj.get("task") is not None else None,
