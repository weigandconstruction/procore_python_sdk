...
class BIMFileExtractionItemArtifactGrid(BaseModel):
    """
    BIMFileExtractionItemArtifactGrid
    """ # noqa: E501
    filename: Optional[StrictStr] = None
    coordinate_system: Optional[StrictStr] = None
    gridline_file: Optional[RestV11ProjectsProjectIdDailyLogsWeatherLogsGet200ResponseInnerAttachmentsInner] = None
    __properties: ClassVar[List[str]] = ["filename", "coordinate_system", "gridline_file"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gridline_file": RestV11ProjectsProjectIdDailyLogsWeatherLogsGet200ResponseInnerAttachmentsInner.from_dict(obj["gridline_file"]) if obj.get("gridline_file") is not None else None
        })
        return _obj
