...
class RestV10ProjectsGetDefaultResponse(BaseModel):
    """
    RestV10ProjectsGetDefaultResponse
    """ # noqa: E501
    error: RestV10ProjectsGetDefaultResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RestV10ProjectsGetDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
