...
class RestV10CompaniesCompanyIdContributingConditionsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdContributingConditionsPostRequest
    """ # noqa: E501
    contributing_condition: RestV10CompaniesCompanyIdContributingConditionsPostRequestContributingCondition
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributing_condition": RestV10CompaniesCompanyIdContributingConditionsPostRequestContributingCondition.from_dict(obj["contributing_condition"]) if obj.get("contributing_condition") is not None else None
        })
        return _obj
