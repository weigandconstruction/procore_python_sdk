...
class CompanyChecklistSectionUpdateBody(BaseModel):
    """
    CompanyChecklistSectionUpdateBody
    """ # noqa: E501
    section: CompanyChecklistSection
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "section": CompanyChecklistSection.from_dict(obj["section"]) if obj.get("section") is not None else None
        })
        return _obj
