...
class RFIUpdateBody1Rfi(BaseModel):
    """
    RFIUpdateBody1Rfi
    """ # noqa: E501
    ...
    accepted: Optional[StrictBool] = Field(default=False, description="The Accepted status of the RFI - closes or opens an RFI")
    assignee_id: Optional[StrictInt] = Field(default=None, description="The ID of the Assignee User. Note: not required if the creator is an admin and the RFI is a draft. *Only admin users can set this field DEPRECATED. Please use assignee_ids instead")
    ...
    ball_in_court_id: Optional[StrictInt] = Field(default=None, description="The ID of the Ball in Court of the RFI. This field is DEPRECATED as of March 31, 2019 and will no longer be supported as of October 1, 2019.")
    draft: Optional[StrictBool] = Field(default=False, description="The Draft status of the RFI (Can only be changed on draft RFIs)")
    ...
    question: Optional[RFIUpdateBody1RfiQuestion] = None
    ...
    __properties: ClassVar[List[str]] = ["subject", "reference", "accepted", "assignee_id", "assignee_ids", "required_assignee_ids", "ball_in_court_id", "draft", "due_date", "received_from_login_information_id", "responsible_contractor_id", "distribution_ids", "number", "private", "project_stage_id", "schedule_impact", "cost_impact", "location_id", "drawing_number", "specification_section_id", "cost_code_id", "rfi_manager_id", "question", "custom_textfield_1", "custom_textfield_2", "custom_field_%{custom_field_definition_id}"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ball_in_court_id": obj.get("ball_in_court_id"),
            ...
            "question": RFIUpdateBody1RfiQuestion.from_dict(obj["question"]) if obj.get("question") is not None else None,
