...
class ChecklistTemplate1(BaseModel):
    """
    ChecklistTemplate1
    """ # noqa: E501
    ...
    company_description: Optional[StrictStr] = Field(default=None, description="Company Checklist Template description")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "synced_to", "company_description", "description", "created_at", "updated_at", "inspection_type", "trade"]
