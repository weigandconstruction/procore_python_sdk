...
class RestV10ProjectsProjectIdIncidentsPropertyDamagesFilterOptionsAffectedCompaniesGet200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsPropertyDamagesFilterOptionsAffectedCompaniesGet200ResponseInner
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The option chosen as stored on the server. For example, an id or enum string.")
    value: Optional[StrictStr] = Field(default=None, description="The display value for the option")
