...
class RestV10ProjectsProjectIdChecklistSchedulesFilterOptionsAssigneesGet200ResponseInner(BaseModel):
    """
    Checklist List Filter Options Response
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of Checklist List filter object")
    label: Optional[StrictStr] = Field(default=None, description="Value of Checklist List filter object")
