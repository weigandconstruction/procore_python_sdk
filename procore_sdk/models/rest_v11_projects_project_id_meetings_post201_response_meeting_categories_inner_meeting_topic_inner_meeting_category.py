...
class RestV11ProjectsProjectIdMeetingsPost201ResponseMeetingCategoriesInnerMeetingTopicInnerMeetingCategory(BaseModel):
    """
    Meeting category
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Meeting category id")
    title: Optional[StrictStr] = Field(default=None, description="Meeting category title")
