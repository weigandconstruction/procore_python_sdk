...
class TimecardEntriesTimecardEntriesInner(BaseModel):
    """
    ...
    location_id: Optional[StrictInt] = Field(default=None, description="The ID of the Location for the Timecard Entry")
    ...
    project_id: Optional[StrictInt] = Field(default=None, description="The ID of the Project of the Timecard Entry")
    ...
    __properties: ClassVar[List[str]] = ["approval_status", "billable", "cost_code_id", "crew_id", "date", "description", "hours", "location_id", "origin_id", "origin_data", "party_id", "project_id", "set_timecard_time_type_automatically", "sub_job_id", "time_in", "time_out", "timesheet_id", "timecard_time_type_id", "user_id", "work_classification_id"]
