...
class RestV11ProjectsProjectIdDirectCostsPost201Response(BaseModel):
    """
    ...
    line_items: Optional[List[DirectCostLineItem1]] = Field(default=None, description="Line items that should be assoicated with the direct cost item.")
    __properties: ClassVar[List[str]] = ["id", "attachments", "attachments_count", "company", "created_at", "deleted_at", "description", "direct_cost_type", "employee", "invoice_number", "direct_cost_date", "origin_data", "origin_id", "grand_total", "line_items_count", "payment_date", "project", "received_date", "status", "terms", "updated_at", "vendor", "vendor_id", "vendor_name", "currency_configuration", "line_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_items": [DirectCostLineItem1.from_dict(_item) for _item in obj["line_items"]] if obj.get("line_items") is not None else None
        })
        return _obj
