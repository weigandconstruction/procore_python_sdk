...
class RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200ResponseLoginInformation(BaseModel):
    """
    RestV10ProjectsProjectIdPunchItemAssignmentsIdGet200ResponseLoginInformation
    """ # noqa: E501
