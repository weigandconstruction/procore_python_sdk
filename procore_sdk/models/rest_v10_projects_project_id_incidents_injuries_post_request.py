...
class RestV10ProjectsProjectIdIncidentsInjuriesPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsInjuriesPostRequest
    """ # noqa: E501
    injury: IncidentInjuryCreateParameters
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "injury": IncidentInjuryCreateParameters.from_dict(obj["injury"]) if obj.get("injury") is not None else None
        })
        return _obj
