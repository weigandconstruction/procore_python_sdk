...
class RestV10CompaniesCompanyIdContributingConditionsBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdContributingConditionsBulkUpdatePatchRequest
    """ # noqa: E501
    contributing_condition: RestV10CompaniesCompanyIdContributingConditionsBulkUpdatePatchRequestContributingCondition
    __properties: ClassVar[List[str]] = ["contributing_condition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributing_condition": RestV10CompaniesCompanyIdContributingConditionsBulkUpdatePatchRequestContributingCondition.from_dict(obj["contributing_condition"]) if obj.get("contributing_condition") is not None else None
        })
        return _obj
