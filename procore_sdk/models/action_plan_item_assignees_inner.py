...
class ActionPlanItemAssigneesInner(BaseModel):
    """
    ActionPlanItemAssigneesInner
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of the Action Plan Item Assignee")
    ...
    __properties: ClassVar[List[str]] = ["id", "party_id", "verification_method_id", "role"]
