...
class RestV10ProjectsProjectIdCommitmentChangeOrderBatchesPost201Response(BaseModel):
    """
    Commitment Change Order Batch
    """ # noqa: E501
    attachments: Optional[List[Default2AttachmentsInner]] = Field(default=None, description="Attachments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attachments": [Default2AttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
            "id": obj.get("id"),
