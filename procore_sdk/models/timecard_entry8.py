...
class TimecardEntry8(BaseModel):
    """
    TimecardEntry8
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "billable", "created_at", "date", "datetime", "deleted_at", "description", "hours", "timesheet_status", "approval_status", "lunch_time", "time_in", "time_out", "injured", "signed", "origin_id", "origin_data", "timesheet", "updated_at", "cost_code", "crew", "location", "party", "procore_signature", "sub_job", "created_by", "login_information", "timecard_time_type", "line_item_type_id", "custom_fields"]
