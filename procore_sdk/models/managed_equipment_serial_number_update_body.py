...
class ManagedEquipmentSerialNumberUpdateBody(BaseModel):
    """
    ManagedEquipmentSerialNumberUpdateBody
    """ # noqa: E501
    managed_equipment: ManagedEquipment1
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment": ManagedEquipment1.from_dict(obj["managed_equipment"]) if obj.get("managed_equipment") is not None else None
        })
        return _obj
