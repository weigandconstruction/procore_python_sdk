...
class ArrayOfPotentialChangeOrderLineItems(BaseModel):
    """
    ArrayOfPotentialChangeOrderLineItems
    """ # noqa: E501
    entities: Optional[List[Default]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [Default.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
