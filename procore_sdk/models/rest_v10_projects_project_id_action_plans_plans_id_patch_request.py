...
class RestV10ProjectsProjectIdActionPlansPlansIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansIdPatchRequest
    """ # noqa: E501
    plan: RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlan
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan": RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
