...
class Body93(BaseModel):
    ...
    direct_cost: Optional[DirectCostItem1] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "direct_cost": DirectCostItem1.from_dict(obj["direct_cost"]) if obj.get("direct_cost") is not None else None
        })
        return _obj
