...
class RestV10BimModelRevisionViewpointsGet200ResponseInnerOneOf(BaseModel):
    """
    ...
    bim_viewpoint_id: Optional[StrictInt] = Field(default=None, description="ID of associated BIM Viewpoint")
    ...
    __properties: ClassVar[List[str]] = ["id", "bim_model_revision_id", "bim_viewpoint_id", "primary", "created_at", "updated_at"]
