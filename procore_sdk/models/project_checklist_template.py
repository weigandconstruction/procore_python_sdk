...
class ProjectChecklistTemplate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "deletable", "company_description", "description", "trade", "synced_to", "created_at", "updated_at"]
