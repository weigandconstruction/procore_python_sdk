...
class RestV10CompaniesCompanyIdManagedEquipmentModelsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentModelsPostRequest
    """ # noqa: E501
    managed_equipment_model: RestV10CompaniesCompanyIdManagedEquipmentModelsPostRequestManagedEquipmentModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_model": RestV10CompaniesCompanyIdManagedEquipmentModelsPostRequestManagedEquipmentModel.from_dict(obj["managed_equipment_model"]) if obj.get("managed_equipment_model") is not None else None
        })
        return _obj
