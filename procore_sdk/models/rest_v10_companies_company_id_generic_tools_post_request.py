...
class RestV10CompaniesCompanyIdGenericToolsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdGenericToolsPostRequest
    """ # noqa: E501
    generic_tool: TheGenericToolObject
    __properties: ClassVar[List[str]] = ["generic_tool"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "generic_tool": TheGenericToolObject.from_dict(obj["generic_tool"]) if obj.get("generic_tool") is not None else None
        })
        return _obj
