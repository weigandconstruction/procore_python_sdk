...
class RestV10FoldersIdPatchRequestFolder(BaseModel):
    """
    RestV10FoldersIdPatchRequestFolder
    """ # noqa: E501
    parent_id: Optional[StrictInt] = Field(default=None, description="The ID of the parent folder to move the folder to.")
