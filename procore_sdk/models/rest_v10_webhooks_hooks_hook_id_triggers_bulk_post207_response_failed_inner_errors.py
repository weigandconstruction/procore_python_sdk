...
class RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInnerErrors(BaseModel):
    """
    RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInnerErrors
    """ # noqa: E501
