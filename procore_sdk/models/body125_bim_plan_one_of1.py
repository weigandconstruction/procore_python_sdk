...
class Body125BimPlanOneOf1(BaseModel):
    """
    BIM Plan
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["bim_level_id", "drawing_id", "upload_uuid", "sheet_map_start", "sheet_map_end", "model_map_start", "model_map_end"]
