...
class RFQQuote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "commitment_quote_number", "cost", "schedule_impact", "description", "request_for_quote_id", "attachments_count", "import_origin_id", "created_by_id", "created_at", "deleted_at", "updated_at", "prostore_file_ids", "created_by", "attachments"]
