...
class RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerAssigneesInner(BaseModel):
    """
    RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerAssigneesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    email: Optional[StrictStr] = None
    login_information_id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "email", "login_information_id", "name"]
