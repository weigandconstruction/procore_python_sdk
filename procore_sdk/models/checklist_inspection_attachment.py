...
class ChecklistInspectionAttachment(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Filename")
    filename: Optional[StrictStr] = Field(default=None, description="Filename (deprecated)")
    content_type: Optional[StrictStr] = None
    viewable_document_id: Optional[StrictInt] = Field(default=None, description="Viewable Document ID")
    __properties: ClassVar[List[str]] = ["id", "url", "thumbnail_url", "name", "filename", "content_type", "viewable_document_id"]
