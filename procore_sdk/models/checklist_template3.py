...
class ChecklistTemplate3(BaseModel):
    """
    ChecklistTemplate3
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Checklist Template ID")
    ...
    description: Optional[StrictStr] = Field(default=None, description="Checklist Template Description")
    inspection_type: Optional[InspectionType2] = None
    trade: Optional[Trade] = None
    __properties: ClassVar[List[str]] = ["id", "name", "created_at", "updated_at", "description", "inspection_type", "trade"]
