...
class RestV10CompaniesCompanyIdActionPlansPlanTemplatesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTemplatesPostRequest
    """ # noqa: E501
    plan_template: RestV10CompaniesCompanyIdActionPlansPlanTemplatesPostRequestPlanTemplate
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan_template": RestV10CompaniesCompanyIdActionPlansPlanTemplatesPostRequestPlanTemplate.from_dict(obj["plan_template"]) if obj.get("plan_template") is not None else None
        })
        return _obj
