...
class IncidentWitnessStatementUpdateParameters1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["statement", "date_received", "witness_id", "custom_field_%{custom_field_definition_id}"]
