...
class RestV10CompaniesCompanyIdActionPlansPlanTypesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTypesPostRequest
    """ # noqa: E501
    plan_type: RestV10CompaniesCompanyIdActionPlansPlanTypesPostRequestPlanType
    __properties: ClassVar[List[str]] = ["plan_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan_type": RestV10CompaniesCompanyIdActionPlansPlanTypesPostRequestPlanType.from_dict(obj["plan_type"]) if obj.get("plan_type") is not None else None
        })
        return _obj
