...
class ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInner(BaseModel):
    """
    ...
    markup: Optional[ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInnerMarkup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "markup": ArrayOfPotentialChangeOrdersEntitiesInnerLineItemsInnerMarkupLineItemsInnerMarkup.from_dict(obj["markup"]) if obj.get("markup") is not None else None,
