...
class ArrayOfCompanyVendorInsurances(BaseModel):
    """
    ArrayOfCompanyVendorInsurances
    """ # noqa: E501
    entities: Optional[List[Insurance]] = None
    errors: Optional[List[ArrayOfCompanyVendorInsurancesErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [Insurance.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [ArrayOfCompanyVendorInsurancesErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
