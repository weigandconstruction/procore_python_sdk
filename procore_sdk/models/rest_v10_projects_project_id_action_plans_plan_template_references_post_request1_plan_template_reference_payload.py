...
class RestV10ProjectsProjectIdActionPlansPlanTemplateReferencesPostRequest1PlanTemplateReferencePayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["drawing_revision_id", "file_version_id", "specification_section_id", "attachment", "generic_tool_item_id", "form_id", "image_id", "meeting_id", "observation_item_id"]
