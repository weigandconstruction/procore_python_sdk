...
class RestV10SettingsPermissionsGet200ResponseToolsInner(BaseModel):
    """
    ...
    user_access_level: Optional[RestV10SettingsPermissionsGet200ResponseToolsInnerUserAccessLevel] = None
    permitted_actions: Optional[List[RestV10SettingsPermissionsGet200ResponseToolsInnerPermittedActionsInner]] = None
    create_url: Optional[StrictStr] = None
    can_create: Optional[StrictBool] = None
    trial: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "friendly_name", "domain_id", "tab_group", "available_for_user", "url", "user_access_level", "permitted_actions", "create_url", "can_create", "trial"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.create_url is None and "create_url" in self.model_fields_set:
            _dict['create_url'] = None

        # set to None if can_create (nullable) is None
        # and model_fields_set contains the field
        if self.can_create is None and "can_create" in self.model_fields_set:
            _dict['can_create'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "url": obj.get("url"),
            "user_access_level": RestV10SettingsPermissionsGet200ResponseToolsInnerUserAccessLevel.from_dict(obj["user_access_level"]) if obj.get("user_access_level") is not None else None,
