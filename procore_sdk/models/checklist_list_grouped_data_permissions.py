...
class ChecklistListGroupedDataPermissions(BaseModel):
    """
    User permissions for the specific Inspection
    """ # noqa: E501
    can_edit: Optional[StrictBool] = Field(default=None, description="Flag indicating if the user can edit the specific Inspection")
