...
class RestV10CompaniesCompanyIdActionPlansPlanTemplateTestRecordRequestsPostRequestPlanTemplateTestRecordRequestPayload(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTemplateTestRecordRequestsPostRequestPlanTemplateTestRecordRequestPayload
    """ # noqa: E501
    checklist_template_id: Optional[StrictInt] = Field(default=None, description="Company Checklist Template ID")
    __properties: ClassVar[List[str]] = ["checklist_template_id"]
