...
class Body38(BaseModel):
    ...
    Body38
    """ # noqa: E501
    project_owner_type: ProjectOwnerType3
    __properties: ClassVar[List[str]] = ["project_owner_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_owner_type": ProjectOwnerType3.from_dict(obj["project_owner_type"]) if obj.get("project_owner_type") is not None else None
        })
        return _obj
