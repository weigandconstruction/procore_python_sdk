...
class RestV10ProjectsProjectIdActionPlansPlansCreateFromTemplatePost201Response(BaseModel):
    """
    Action Plan
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Action Plan ID")
