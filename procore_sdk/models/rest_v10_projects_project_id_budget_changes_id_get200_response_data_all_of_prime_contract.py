...
class RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseDataAllOfPrimeContract(BaseModel):
    """
    Information on the prime contract this budget change is associated with
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the prime contract")
    ...
    __properties: ClassVar[List[str]] = ["id", "number", "title"]
