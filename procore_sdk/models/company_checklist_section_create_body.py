...
class CompanyChecklistSectionCreateBody(BaseModel):
    """
    CompanyChecklistSectionCreateBody
    """ # noqa: E501
    section: CompanyChecklistSection1
    __properties: ClassVar[List[str]] = ["section"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "section": CompanyChecklistSection1.from_dict(obj["section"]) if obj.get("section") is not None else None
        })
        return _obj
