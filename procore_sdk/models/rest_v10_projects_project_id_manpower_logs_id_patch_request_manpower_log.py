...
class RestV10ProjectsProjectIdManpowerLogsIdPatchRequestManpowerLog(BaseModel):
    """
    RestV10ProjectsProjectIdManpowerLogsIdPatchRequestManpowerLog
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, description="Date of inspection. Mutually exclusive with the datetime property.", alias="date")
    ...
    __properties: ClassVar[List[str]] = ["date", "datetime", "notes", "num_workers", "num_hours", "contact_id", "user_id", "cost_code_id", "location_id", "trade_id", "mt_location", "status", "custom_field_%{custom_field_definition_id}"]
