...
class RestV10CompaniesCompanyIdInvoicesAsyncJobsUuidGet200ResponseResultOneOf(BaseModel):
    """
    An Invoicing Async Job Result
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL of the result of the Async Job")
