...
class ChecklistScheduleInspectionTemplate(BaseModel):
    """
    ...
    inspection_type: Optional[ChecklistScheduleInspectionTemplateInspectionType] = None
    name: Optional[StrictStr] = Field(default=None, description="Name")
    trade_id: Optional[StrictInt] = Field(default=None, description="Trade ID")
    __properties: ClassVar[List[str]] = ["id", "attachment_ids", "description", "inspection_type", "name", "trade_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inspection_type": ChecklistScheduleInspectionTemplateInspectionType.from_dict(obj["inspection_type"]) if obj.get("inspection_type") is not None else None,
            "name": obj.get("name"),
