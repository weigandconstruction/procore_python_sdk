...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerCustomFieldsCustomFieldCustomFieldLovEntryDefinitionIdValue(BaseModel):
    """
    ...
    label: Optional[StrictStr] = Field(default=None, description="Label of the list of values (LOV) entry.")
