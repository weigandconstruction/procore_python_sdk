...
class RestV13CompaniesCompanyIdUsersGet200ResponseInnerOneOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "verified_employee": obj.get("verified_employee")
        })
        return _obj
