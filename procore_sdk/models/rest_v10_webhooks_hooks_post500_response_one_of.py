...
class RestV10WebhooksHooksPost500ResponseOneOf(BaseModel):
    """
    RestV10WebhooksHooksPost500ResponseOneOf
    """ # noqa: E501
    error: Optional[RestV10WebhooksHooksPost500ResponseOneOfError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": RestV10WebhooksHooksPost500ResponseOneOfError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
