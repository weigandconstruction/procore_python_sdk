...
class RestV10ProjectsProjectIdChecklistListTemplatesPost201Response(BaseModel):
    """
    ...
    company_attachments: Optional[List[RestV10WorkOrderContractsPost201ResponseAttachmentsInner]] = None
