...
class Body141(BaseModel):
    """
    Body141
    """ # noqa: E501
    project_id: StrictInt = Field(description="Unique identifier for the project.")
    bim_file: BIMFile1
    __properties: ClassVar[List[str]] = ["project_id", "bim_file"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bim_file": BIMFile1.from_dict(obj["bim_file"]) if obj.get("bim_file") is not None else None
        })
        return _obj
