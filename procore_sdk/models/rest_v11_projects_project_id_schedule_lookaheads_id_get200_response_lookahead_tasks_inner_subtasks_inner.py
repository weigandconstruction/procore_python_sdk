...
class RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerSubtasksInner(BaseModel):
    """
    Schedule Lookahead Task
    """ # noqa: E501
    id: Optional[StrictInt] = None
    parent_id: Optional[StrictInt] = Field(default=None, description="ID reference to the parent task")
    ...
    subtasks: Optional[List[Dict[str, Any]]] = Field(default=None, description="Subtask(s) assigned to this Lookahead Task")
