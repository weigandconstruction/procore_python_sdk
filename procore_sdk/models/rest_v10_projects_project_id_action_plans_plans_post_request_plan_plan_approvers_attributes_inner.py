...
class RestV10ProjectsProjectIdActionPlansPlansPostRequestPlanPlanApproversAttributesInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansPostRequestPlanPlanApproversAttributesInner
    """ # noqa: E501
    party_id: StrictInt = Field(description="Party Person ID of the Action Plan Approver to be set")
    __properties: ClassVar[List[str]] = ["party_id"]
