...
class WorkClassificationBody1(BaseModel):
    """
    WorkClassificationBody1
    """ # noqa: E501
    work_classification: WorkClassification2
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "work_classification": WorkClassification2.from_dict(obj["work_classification"]) if obj.get("work_classification") is not None else None
        })
        return _obj
