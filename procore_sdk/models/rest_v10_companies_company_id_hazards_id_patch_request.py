...
class RestV10CompaniesCompanyIdHazardsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdHazardsIdPatchRequest
    """ # noqa: E501
    hazard: RestV10CompaniesCompanyIdHazardsIdPatchRequestHazard
    __properties: ClassVar[List[str]] = ["hazard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hazard": RestV10CompaniesCompanyIdHazardsIdPatchRequestHazard.from_dict(obj["hazard"]) if obj.get("hazard") is not None else None
        })
        return _obj
