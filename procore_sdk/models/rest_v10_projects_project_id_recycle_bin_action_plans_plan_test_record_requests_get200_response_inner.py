...
class RestV10ProjectsProjectIdRecycleBinActionPlansPlanTestRecordRequestsGet200ResponseInner(BaseModel):
    """
    ...
    created_at: Optional[datetime] = Field(default=None, description="Time the Action Plan Test Record Request was created")
    deleted_at: Optional[datetime] = Field(default=None, description="Time the Recycled Action Plan Test Record Request was deleted")
    payload: Optional[RestV10ProjectsProjectIdRecycleBinActionPlansPlanTestRecordRequestsGet200ResponseInnerPayload] = None
    ...
    type: Optional[StrictStr] = Field(default=None, description="Action Plan Test Record Request Type")
    updated_at: Optional[datetime] = Field(default=None, description="Time the Action Plan Test Record Request was updated")
    __properties: ClassVar[List[str]] = ["id", "plan_item_id", "created_at", "deleted_at", "payload", "plan_id", "plan_test_records_count", "type", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": RestV10ProjectsProjectIdRecycleBinActionPlansPlanTestRecordRequestsGet200ResponseInnerPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
