...
class RestV11CompaniesCompanyIdActionPlansPlanTemplatesPostRequestPlanTemplate(BaseModel):
    """
    ...
    plan_type_id: StrictInt = Field(description="ID of an Action Plan Type")
