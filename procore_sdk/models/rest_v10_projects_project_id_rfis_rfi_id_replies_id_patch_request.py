...
class RestV10ProjectsProjectIdRfisRfiIdRepliesIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdRfisRfiIdRepliesIdPatchRequest
    """ # noqa: E501
    reply: RestV10ProjectsProjectIdRfisRfiIdRepliesIdPatchRequestReply
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reply": RestV10ProjectsProjectIdRfisRfiIdRepliesIdPatchRequestReply.from_dict(obj["reply"]) if obj.get("reply") is not None else None
        })
        return _obj
