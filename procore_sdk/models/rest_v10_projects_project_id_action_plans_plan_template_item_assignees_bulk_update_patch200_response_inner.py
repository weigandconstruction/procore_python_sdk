...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesBulkUpdatePatch200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesBulkUpdatePatch200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of the Item")
    ...
    __properties: ClassVar[List[str]] = ["id", "is_holding", "errors", "role", "verification_method_id", "party_id", "status"]
