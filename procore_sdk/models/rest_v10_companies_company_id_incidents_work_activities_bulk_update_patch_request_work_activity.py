...
class RestV10CompaniesCompanyIdIncidentsWorkActivitiesBulkUpdatePatchRequestWorkActivity(BaseModel):
    """
    IDs of all Work Activities specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Work Activities are available for use")
