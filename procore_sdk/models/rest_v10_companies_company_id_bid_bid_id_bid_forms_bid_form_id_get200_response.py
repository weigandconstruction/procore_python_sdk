...
class RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200Response(BaseModel):
    """
    Bid Form
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    title: Optional[StrictStr] = Field(default=None, description="Bid Form Title")
    base_bid: Optional[List[RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner]] = None
    alternates: Optional[List[RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseAlternatesInner]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "base_bid", "alternates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "base_bid": [RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInner.from_dict(_item) for _item in obj["base_bid"]] if obj.get("base_bid") is not None else None,
            "alternates": [RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseAlternatesInner.from_dict(_item) for _item in obj["alternates"]] if obj.get("alternates") is not None else None
        })
        return _obj
