...
class RestV10CompaniesCompanyIdBidsBidIdUploadsGet200ResponseInnerLinks(BaseModel):
    """
    Path to uploaded file
    """ # noqa: E501
    var_self: Optional[StrictStr] = Field(default=None, description="Path to uploaded file", alias="self")
