...
class RestV11ProjectsProjectIdSubmittalsPostRequestSubmittal(BaseModel):
    """
    ...
    buffer_time: Optional[StrictInt] = Field(default=None, description="The buffer working days for the dynamic submittal plan calculation *This field is only available to be set if Dynamic Submittal Plan is enabled")
    ...
    for_record_only: Optional[StrictBool] = Field(default=None, description="The field that controls if the dynamic submittal plan is for record only or not *This field is only available to be set if Dynamic Submittal Plan is enabled")
    ...
    workflow_data: Optional[List[List[RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner]]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "workflow_data": [
                    [RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner.from_dict(_inner_item) for _inner_item in _item]
