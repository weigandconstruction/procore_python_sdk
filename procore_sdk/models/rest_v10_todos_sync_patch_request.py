...
class RestV10TodosSyncPatchRequest(BaseModel):
    """
    RestV10TodosSyncPatchRequest
    """ # noqa: E501
    updates: List[RestV10TodosSyncPatchRequestUpdatesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [RestV10TodosSyncPatchRequestUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
