...
class RestV10VendorsGet200ResponseInner(BaseModel):
    """
    ...
    bidding_distribution: Optional[List[RestV10VendorsGet200ResponseInnerAllOfBiddingDistributionInner]] = Field(default=None, description="Bidding distribution list")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "abbreviated_name", "address", "attachments", "authorized_bidder", "business_id", "business_phone", "business_register", "city", "contact_count", "company", "country_code", "created_at", "email_address", "fax_number", "is_active", "is_connected", "labor_union", "license_number", "logo", "mobile_phone", "non_union_prevailing_wage", "notes", "origin_code", "origin_data", "origin_id", "prequalified", "primary_contact", "state_code", "synced_to_erp", "trade_name", "union_member", "updated_at", "vendor_group", "website", "zip", "bidding", "bidding_distribution", "children_count", "company_vendor", "legal_name", "parent", "project_ids", "standard_cost_codes", "trades"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bidding_distribution": [RestV10VendorsGet200ResponseInnerAllOfBiddingDistributionInner.from_dict(_item) for _item in obj["bidding_distribution"]] if obj.get("bidding_distribution") is not None else None,
