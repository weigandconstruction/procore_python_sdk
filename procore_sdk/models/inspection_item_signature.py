...
class InspectionItemSignature(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "captured_by": InspectionItemSignatureCapturedBy.from_dict(obj["captured_by"]) if obj.get("captured_by") is not None else None,
            "captured_at": obj.get("captured_at"),
            "attachment": InspectionItemSignatureAttachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None
        })
        return _obj
