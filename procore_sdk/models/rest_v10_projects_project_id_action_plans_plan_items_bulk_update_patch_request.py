...
class RestV10ProjectsProjectIdActionPlansPlanItemsBulkUpdatePatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanItemsBulkUpdatePatchRequest
    """ # noqa: E501
    plan_items: List[RestV10ProjectsProjectIdActionPlansPlanItemsBulkUpdatePatchRequestPlanItemsInner]
    __properties: ClassVar[List[str]] = ["plan_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plan_items": [RestV10ProjectsProjectIdActionPlansPlanItemsBulkUpdatePatchRequestPlanItemsInner.from_dict(_item) for _item in obj["plan_items"]] if obj.get("plan_items") is not None else None
        })
        return _obj
