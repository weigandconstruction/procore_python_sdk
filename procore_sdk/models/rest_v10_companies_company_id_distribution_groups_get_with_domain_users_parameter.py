...
class RestV10CompaniesCompanyIdDistributionGroupsGetWithDomainUsersParameter(BaseModel):
    """
    RestV10CompaniesCompanyIdDistributionGroupsGetWithDomainUsersParameter
    """ # noqa: E501
    domain_id: Optional[StrictInt] = Field(default=None, description="Domain ID")
    provider_id: Optional[StrictInt] = Field(default=None, description="Provider ID (provider class is inderred from domain)")
    __properties: ClassVar[List[str]] = ["domain_id", "provider_id"]
