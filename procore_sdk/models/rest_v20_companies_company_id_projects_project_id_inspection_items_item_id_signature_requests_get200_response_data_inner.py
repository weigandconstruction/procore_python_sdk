...
class RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsGet200ResponseDataInner(BaseModel):
    """
    ...
    requested_by_id: Optional[StrictStr] = Field(default=None, description="Party ID of the user who requested the signature")
    signatory: Optional[InspectionItemSignatureCapturedBy] = None
    signature: Optional[ChecklistSignature] = None
    __properties: ClassVar[List[str]] = ["id", "requested_by_id", "signatory", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "requested_by_id": obj.get("requested_by_id"),
            "signatory": InspectionItemSignatureCapturedBy.from_dict(obj["signatory"]) if obj.get("signatory") is not None else None,
            "signature": ChecklistSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
