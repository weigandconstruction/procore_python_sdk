...
class RestV10CompaniesCompanyIdBidsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdBidsIdPatchRequest
    """ # noqa: E501
    bid: Optional[RestV10CompaniesCompanyIdBidsIdPatchRequestBid] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bid": RestV10CompaniesCompanyIdBidsIdPatchRequestBid.from_dict(obj["bid"]) if obj.get("bid") is not None else None
        })
        return _obj
