...
class RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseEntitiesInnerChangeEventLineItem(BaseModel):
    """
    Change Event Line Item
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Change Event Line Item ID")
    cost_rom: Optional[StrictStr] = Field(default=None, description="Change Event Line Item Cost ROM")
    revenue_rom: Optional[StrictStr] = Field(default=None, description="Change Event Line Item Revenue ROM")
    ...
    __properties: ClassVar[List[str]] = ["id", "cost_rom", "revenue_rom", "event_id", "cost_code", "line_item_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "cost_rom": obj.get("cost_rom"),
            "revenue_rom": obj.get("revenue_rom"),
