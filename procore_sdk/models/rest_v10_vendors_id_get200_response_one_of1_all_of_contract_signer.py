...
class RestV10VendorsIdGet200ResponseOneOf1AllOfContractSigner(BaseModel):
    """
    RestV10VendorsIdGet200ResponseOneOf1AllOfContractSigner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "company_name", "contact_id", "is_active", "login", "name"]
