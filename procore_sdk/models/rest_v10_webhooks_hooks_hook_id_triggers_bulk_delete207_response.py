...
class RestV10WebhooksHooksHookIdTriggersBulkDelete207Response(BaseModel):
    """
    RestV10WebhooksHooksHookIdTriggersBulkDelete207Response
    """ # noqa: E501
    success: Optional[List[StrictInt]] = None
    failed: Optional[List[RestV10WebhooksHooksHookIdTriggersBulkDelete207ResponseFailedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [RestV10WebhooksHooksHookIdTriggersBulkDelete207ResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
