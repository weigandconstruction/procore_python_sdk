...
class RequisitionSubcontractorInvoice1(BaseModel):
    """
    Requisition (Subcontractor Invoice)
    """ # noqa: E501
    items: Optional[List[RequisitionSubcontractorInvoice1ItemsInner]] = None
    ...
    prostore_file_ids: Optional[List[StrictInt]] = Field(default=None, description="An array of Prostore File IDs. The Prostore Files will be associated with the Requisition (Subcontractor Invoice) as attachments.")
    ...
    __properties: ClassVar[List[str]] = ["items", "period_id", "requisition_start", "requisition_end", "billing_date", "final", "invoice_number", "payment_date", "origin_data", "origin_id", "status", "submitted_at", "prostore_file_ids", "custom_field_%{custom_field_definition_id}"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [RequisitionSubcontractorInvoice1ItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
