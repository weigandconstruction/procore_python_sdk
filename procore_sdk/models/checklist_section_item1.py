...
class ChecklistSectionItem1(BaseModel):
    """
    ...
    observations: Optional[List[ChecklistSectionItem1ObservationsInner]] = Field(default=None, description="Observations created from the Checklist Item")
    attachment_histories: Optional[List[ChecklistSectionItem1AttachmentHistoriesInner]] = Field(default=None, description="Item attachment histories")
    attachments: Optional[List[ChecklistSectionItem1AttachmentsInner]] = Field(default=None, description="Item attachments")
    ...
    response_set: Optional[ChecklistSectionItem1ResponseSet] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "details", "status", "responded_with", "origin_id", "section_id", "position", "observations", "attachment_histories", "attachments", "histories", "item_response", "comments", "response", "response_set", "response_set_id", "type", "template_item_id", "response_type_id", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "observations": [ChecklistSectionItem1ObservationsInner.from_dict(_item) for _item in obj["observations"]] if obj.get("observations") is not None else None,
            "attachment_histories": [ChecklistSectionItem1AttachmentHistoriesInner.from_dict(_item) for _item in obj["attachment_histories"]] if obj.get("attachment_histories") is not None else None,
            "attachments": [ChecklistSectionItem1AttachmentsInner.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
            ...
            "response_set": ChecklistSectionItem1ResponseSet.from_dict(obj["response_set"]) if obj.get("response_set") is not None else None,
