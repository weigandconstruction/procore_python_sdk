...
class RestV10CompaniesCompanyIdManagedEquipmentModelsBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentModelsBulkUpdatePatchRequest
    """ # noqa: E501
    managed_equipment_model: RestV10CompaniesCompanyIdManagedEquipmentModelsBulkUpdatePatchRequestManagedEquipmentModel
    __properties: ClassVar[List[str]] = ["managed_equipment_model"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_model": RestV10CompaniesCompanyIdManagedEquipmentModelsBulkUpdatePatchRequestManagedEquipmentModel.from_dict(obj["managed_equipment_model"]) if obj.get("managed_equipment_model") is not None else None
        })
        return _obj
