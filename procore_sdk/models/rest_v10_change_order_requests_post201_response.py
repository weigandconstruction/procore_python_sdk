...
class RestV10ChangeOrderRequestsPost201Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "contract_id", "created_at", "creator", "description", "due_date", "grand_total", "invoiced_date", "number", "origin_data", "origin_id", "paid_date", "position", "private", "revision", "schedule_impact_amount", "status", "title", "updated_at", "currency_configuration"]
