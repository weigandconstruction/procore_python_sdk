...
class RestV11ProjectsProjectIdMeetingTopicsPost201Response(BaseModel):
    """
    Meeting topic
    """ # noqa: E501
    ...
    def priority_validate_enum(cls, value):
        ...
        if value not in set(['', 'High', 'Medium', 'Low', 'null']):
            raise ValueError("must be one of enum values ('', 'High', 'Medium', 'Low', 'null')")
        return value
