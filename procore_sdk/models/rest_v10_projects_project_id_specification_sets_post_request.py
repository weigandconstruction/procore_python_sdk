...
class RestV10ProjectsProjectIdSpecificationSetsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdSpecificationSetsPostRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of specification set")
    var_date: Optional[StrictStr] = Field(default=None, description="Creation date of specification set", alias="date")
