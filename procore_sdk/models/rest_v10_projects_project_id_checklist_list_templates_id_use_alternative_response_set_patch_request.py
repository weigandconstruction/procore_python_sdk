...
class RestV10ProjectsProjectIdChecklistListTemplatesIdUseAlternativeResponseSetPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdChecklistListTemplatesIdUseAlternativeResponseSetPatchRequest
    """ # noqa: E501
    alternative_response_set_id: StrictInt = Field(description="Alternative Response Set ID")
    __properties: ClassVar[List[str]] = ["alternative_response_set_id"]
