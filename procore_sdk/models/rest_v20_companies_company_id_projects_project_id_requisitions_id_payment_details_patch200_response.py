...
class RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch200Response(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdRequisitionsIdPaymentDetailsPatch200Response
    """ # noqa: E501
    data: Optional[PaymentDueDate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PaymentDueDate.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
