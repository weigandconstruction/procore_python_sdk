...
class RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequest
    """ # noqa: E501
    bid: Optional[RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequestBid] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bid": RestV10ProjectsProjectIdBidPackagesBidPackageIdBidsPostRequestBid.from_dict(obj["bid"]) if obj.get("bid") is not None else None
        })
        return _obj
