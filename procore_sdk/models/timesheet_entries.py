...
class TimesheetEntries(BaseModel):
    """
    TimesheetEntries
    """ # noqa: E501
    ...
    timecard_time_type: Optional[TimecardTimeType1] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "date", "deleted_at", "description", "hours", "updated_at", "time_in", "time_out", "injured", "lunch_time", "billable", "origin_id", "origin_data", "crew", "cost_code", "created_by", "login_information", "location", "timecard_time_type", "wbs_code_id", "custom_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timecard_time_type": TimecardTimeType1.from_dict(obj["timecard_time_type"]) if obj.get("timecard_time_type") is not None else None,
