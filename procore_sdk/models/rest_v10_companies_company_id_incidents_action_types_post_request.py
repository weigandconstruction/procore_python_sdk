...
class RestV10CompaniesCompanyIdIncidentsActionTypesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsActionTypesPostRequest
    """ # noqa: E501
    action_type: RestV10CompaniesCompanyIdIncidentsActionTypesPostRequestActionType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action_type": RestV10CompaniesCompanyIdIncidentsActionTypesPostRequestActionType.from_dict(obj["action_type"]) if obj.get("action_type") is not None else None
        })
        return _obj
