...
class RestV10ProjectsProjectIdActionPlansPlanTemplateSectionsCreateFromSectionPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplateSectionsCreateFromSectionPostRequest
    """ # noqa: E501
    template_section_id: StrictInt = Field(description="ID of the Action Plan Template Section to copy from.")
    __properties: ClassVar[List[str]] = ["template_section_id"]
