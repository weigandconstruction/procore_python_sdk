...
class RestV10CompaniesCompanyIdChecklistListTemplatesPost201ResponseAllOfSectionsInnerAllOfItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "section_id", "position", "response_set"]
