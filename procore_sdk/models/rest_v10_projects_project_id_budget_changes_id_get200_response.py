...
class RestV10ProjectsProjectIdBudgetChangesIdGet200Response(BaseModel):
    """
    RestV10ProjectsProjectIdBudgetChangesIdGet200Response
    """ # noqa: E501
    data: Optional[RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RestV10ProjectsProjectIdBudgetChangesIdGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
