...
class RestV10ProjectsProjectIdToolsGet200ResponseInner(BaseModel):
    """
    ...
    title: Optional[StrictStr] = Field(default=None, description="A display name for the tool")
    __properties: ClassVar[List[str]] = ["id", "engine_name", "is_active", "position", "required", "title"]
