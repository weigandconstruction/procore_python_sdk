...
class RestV10LinksPostRequestLink(BaseModel):
    """
    RestV10LinksPostRequestLink
    """ # noqa: E501
    title: StrictStr = Field(description="The user-facing title of the link")
    url: StrictStr = Field(description="The full URL for the link")
