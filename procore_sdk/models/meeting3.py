...
class Meeting3(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["position", "title", "location", "minutes", "meeting_date", "overview", "occurred", "start_time", "finish_time", "time_zone", "is_private", "conclusion", "is_draft", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
