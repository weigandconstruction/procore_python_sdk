...
class ManagedEquipmentChangeHistory(BaseModel):
    """
    ...
    new_value: Optional[StrictStr] = Field(default=None, description="Created By")
    old_value: Optional[StrictStr] = Field(default=None, description="Created By")
    __properties: ClassVar[List[str]] = ["column", "created_at", "created_by", "new_value", "old_value"]
