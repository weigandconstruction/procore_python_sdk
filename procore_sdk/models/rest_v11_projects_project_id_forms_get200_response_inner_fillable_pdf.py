...
class RestV11ProjectsProjectIdFormsGet200ResponseInnerFillablePdf(BaseModel):
    """
    RestV11ProjectsProjectIdFormsGet200ResponseInnerFillablePdf
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "url", "filename", "name"]
