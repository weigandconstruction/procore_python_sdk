...
class WorkClassificationBulkBody(BaseModel):
    """
    WorkClassificationBulkBody
    """ # noqa: E501
    work_classification: WorkClassification1
    __properties: ClassVar[List[str]] = ["work_classification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "work_classification": WorkClassification1.from_dict(obj["work_classification"]) if obj.get("work_classification") is not None else None
        })
        return _obj
