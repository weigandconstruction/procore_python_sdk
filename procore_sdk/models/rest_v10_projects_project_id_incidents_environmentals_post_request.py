...
class RestV10ProjectsProjectIdIncidentsEnvironmentalsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsEnvironmentalsPostRequest
    """ # noqa: E501
    environmental: IncidentEnvironmentalCreateParameters
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environmental": IncidentEnvironmentalCreateParameters.from_dict(obj["environmental"]) if obj.get("environmental") is not None else None
        })
        return _obj
