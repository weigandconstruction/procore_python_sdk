...
class IncidentEnvironmentalCreateParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["incident_id", "environmental_type_id", "description", "estimated_cost_impact", "quantity_value", "quantity_unit_of_measure", "affected_company_id", "managed_equipment_id", "work_activity_id", "custom_field_%{custom_field_definition_id}"]
