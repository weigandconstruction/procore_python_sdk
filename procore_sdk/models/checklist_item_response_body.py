...
class ChecklistItemResponseBody(BaseModel):
    """
    ChecklistItemResponseBody
    """ # noqa: E501
    item_response: ItemResponse
    __properties: ClassVar[List[str]] = ["item_response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "item_response": ItemResponse.from_dict(obj["item_response"]) if obj.get("item_response") is not None else None
        })
        return _obj
