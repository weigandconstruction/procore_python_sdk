...
class RestV11CompaniesCompanyIdActionPlansPlanTemplatesIdPatchRequestPlanTemplate(BaseModel):
    """
    ...
    private: Optional[StrictBool] = Field(default=None, description="Privacy flag of the Company Action Plan Template")
    plan_type_id: Optional[StrictInt] = Field(default=None, description="ID of an Action Plan Type")
    __properties: ClassVar[List[str]] = ["title", "description", "private", "plan_type_id"]
