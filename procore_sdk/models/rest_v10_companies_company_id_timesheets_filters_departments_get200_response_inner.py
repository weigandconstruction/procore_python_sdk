...
class RestV10CompaniesCompanyIdTimesheetsFiltersDepartmentsGet200ResponseInner(BaseModel):
    """
    RestV10CompaniesCompanyIdTimesheetsFiltersDepartmentsGet200ResponseInner
    """ # noqa: E501
