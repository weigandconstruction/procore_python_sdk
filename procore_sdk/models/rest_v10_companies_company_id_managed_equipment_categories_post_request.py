...
class RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequest
    """ # noqa: E501
    managed_equipment_category: RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequestManagedEquipmentCategory
    __properties: ClassVar[List[str]] = ["managed_equipment_category"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_category": RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequestManagedEquipmentCategory.from_dict(obj["managed_equipment_category"]) if obj.get("managed_equipment_category") is not None else None
        })
        return _obj
