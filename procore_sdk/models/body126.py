...
class Body126(BaseModel):
    ...
    bim_plan: Body126BimPlan
    __properties: ClassVar[List[str]] = ["project_id", "view", "bim_plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "view": obj.get("view"),
            "bim_plan": Body126BimPlan.from_dict(obj["bim_plan"]) if obj.get("bim_plan") is not None else None
        })
        return _obj
