...
class RestV10ProjectsProjectIdNotesLogsGet200ResponseInnerAttachmentsInner(BaseModel):
    """
    RestV10ProjectsProjectIdNotesLogsGet200ResponseInnerAttachmentsInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    content_type: Optional[StrictStr] = None
    name: Optional[StrictStr] = Field(default=None, description="Use :name, :filename to be deprecated")
    url: Optional[StrictStr] = None
    filename: Optional[StrictStr] = Field(default=None, description=":filename to be deprecated, use :name")
    share_url: Optional[StrictStr] = None
    viewable_type: Optional[StrictStr] = None
    viewable_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "content_type", "name", "url", "filename", "share_url", "viewable_type", "viewable_url"]
