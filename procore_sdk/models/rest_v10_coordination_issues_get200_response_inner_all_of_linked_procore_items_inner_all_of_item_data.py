...
class RestV10CoordinationIssuesGet200ResponseInnerAllOfLinkedProcoreItemsInnerAllOfItemData(BaseModel):
    """
    ...
    """ # noqa: E501
    has_official_response: Optional[StrictBool] = None
    subject: Optional[StrictStr] = None
    number: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["has_official_response", "subject", "number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "has_official_response": obj.get("has_official_response"),
