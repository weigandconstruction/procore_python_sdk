...
class RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInnerBidFormItemsInnerCostCode(BaseModel):
    """
    RestV10CompaniesCompanyIdBidBidIdBidFormsBidFormIdGet200ResponseBaseBidInnerBidFormItemsInnerCostCode
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = Field(default=None, description="The cost code name")
    full_code: Optional[StrictStr] = Field(default=None, description="The cost code long name")
    __properties: ClassVar[List[str]] = ["id", "name", "full_code"]
