...
class StandardCostCodeSyncBody(BaseModel):
    """
    ...
    updates: List[StandardCostCodeSyncBodyUpdatesInner]
    __properties: ClassVar[List[str]] = ["company_id", "standard_cost_code_list_id", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [StandardCostCodeSyncBodyUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
