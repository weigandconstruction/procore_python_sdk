...
class RestV10SpecificationSectionsPostRequestSpecificationSection(BaseModel):
    """
    RestV10SpecificationSectionsPostRequestSpecificationSection
    """ # noqa: E501
    number: StrictStr
    description: Optional[StrictStr] = None
    specification_section_division_id: StrictInt = Field(description="The ID of the parent Specification Section Division")
    __properties: ClassVar[List[str]] = ["number", "description", "specification_section_division_id"]
