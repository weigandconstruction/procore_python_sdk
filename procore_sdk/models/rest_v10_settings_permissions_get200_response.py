...
class RestV10SettingsPermissionsGet200Response(BaseModel):
    """
    RestV10SettingsPermissionsGet200Response
    """ # noqa: E501
    tools: Optional[List[RestV10SettingsPermissionsGet200ResponseToolsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tools": [RestV10SettingsPermissionsGet200ResponseToolsInner.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None
        })
        return _obj
