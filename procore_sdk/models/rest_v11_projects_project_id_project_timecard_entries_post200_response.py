...
class RestV11ProjectsProjectIdProjectTimecardEntriesPost200Response(BaseModel):
    """
    ...
    automatically_split_timecard_entries: Optional[List[TimecardEntry]] = Field(default=None, description="Timecard entries returned with associated object as part of overtime_management")
    __properties: ClassVar[List[str]] = ["id", "created_at", "date", "deleted_at", "description", "billable", "hours", "updated_at", "timecard_type", "cost_code", "origin_id", "origin_data", "timesheet_status", "full_cost_code", "created_by", "login_information", "timecard_time_type", "line_item_type_id", "custom_fields", "automatically_split_timecard_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "automatically_split_timecard_entries": [TimecardEntry.from_dict(_item) for _item in obj["automatically_split_timecard_entries"]] if obj.get("automatically_split_timecard_entries") is not None else None
        })
        return _obj
