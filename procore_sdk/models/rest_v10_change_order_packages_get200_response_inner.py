...
class RestV10ChangeOrderPackagesGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "contract_id", "created_at", "created_by_id", "deleted_at", "due_date", "executed", "invoiced_date", "number", "origin_code", "origin_data", "origin_id", "paid_date", "reviewed_at", "signed_change_order_received_date", "status", "title", "updated_at", "revision", "grand_total", "designated_reviewer", "currency_configuration", "custom_fields"]
