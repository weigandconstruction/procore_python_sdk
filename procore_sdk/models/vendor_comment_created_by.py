...
class VendorCommentCreatedBy(BaseModel):
    """
    The creator of the Comment
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    avatar_url: Optional[StrictStr] = Field(default=None, description="The URL pointing to the user avatar.")
    initials: Optional[StrictStr] = Field(default=None, description="The initials of the user.")
    __properties: ClassVar[List[str]] = ["id", "name", "avatar_url", "initials"]
