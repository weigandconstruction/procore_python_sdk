...
class RestV10ChecklistPossibleInspectorsGet200Response(BaseModel):
    """
    RestV10ChecklistPossibleInspectorsGet200Response
    """ # noqa: E501
    people: Optional[List[Inspector]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "people": [Inspector.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None
        })
        return _obj
