...
class RestV10TaxTypesSyncPatch200Response(BaseModel):
    """
    RestV10TaxTypesSyncPatch200Response
    """ # noqa: E501
    entities: Optional[List[RestV10TaxTypesGet200ResponseInner]] = None
    errors: Optional[List[RestV10TaxTypesSyncPatch200ResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [RestV10TaxTypesGet200ResponseInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "errors": [RestV10TaxTypesSyncPatch200ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
