...
class RestV10CoordinationIssueActivitiesGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "coordination_issue_id", "type", "created_at", "updated_at"]
