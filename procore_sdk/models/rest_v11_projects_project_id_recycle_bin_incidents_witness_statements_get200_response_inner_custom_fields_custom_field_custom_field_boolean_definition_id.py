...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerCustomFieldsCustomFieldCustomFieldBooleanDefinitionId(BaseModel):
    """
    ...
    value: Optional[StrictBool] = Field(default=None, description="The value of the custom field.")
