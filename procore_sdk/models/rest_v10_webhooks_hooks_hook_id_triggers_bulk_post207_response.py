...
class RestV10WebhooksHooksHookIdTriggersBulkPost207Response(BaseModel):
    """
    RestV10WebhooksHooksHookIdTriggersBulkPost207Response
    """ # noqa: E501
    success: Optional[List[WebhooksTrigger]] = None
    failed: Optional[List[RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "success": [WebhooksTrigger.from_dict(_item) for _item in obj["success"]] if obj.get("success") is not None else None,
            "failed": [RestV10WebhooksHooksHookIdTriggersBulkPost207ResponseFailedInner.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
