...
class RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf(BaseModel):
    """
    RestV11ProjectsProjectIdVendorsGet200ResponseInnerOneOf
    """ # noqa: E501
    bidding: Optional[ExtendedView2Bidding] = None
    bidding_distribution: Optional[List[ExtendedView2BiddingDistributionInner]] = Field(default=None, description="Bidding Distribution List")
    business: Optional[BusinessNormalView] = None
    children_count: Optional[StrictInt] = Field(default=None, description="Count of Vendors whose parent_id is this Vendor's ID")
    ...
    __properties: ClassVar[List[str]] = ["bidding", "bidding_distribution", "business", "children_count", "legal_name", "company_vendor", "parent", "trades", "id", "name", "abbreviated_name", "address", "attachments", "authorized_bidder", "business_id", "business_phone", "business_register", "city", "company", "country_code", "created_at", "email_address", "fax_number", "is_active", "is_connected", "labor_union", "license_number", "logo", "mobile_phone", "non_union_prevailing_wage", "notes", "origin_code", "origin_data", "origin_id", "prequalified", "primary_contact", "project_ids", "state_code", "synced_to_erp", "trade_name", "union_member", "updated_at", "vendor_group", "website", "zip"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bidding_distribution": [ExtendedView2BiddingDistributionInner.from_dict(_item) for _item in obj["bidding_distribution"]] if obj.get("bidding_distribution") is not None else None,
            "business": BusinessNormalView.from_dict(obj["business"]) if obj.get("business") is not None else None,
