...
class RestV10CompaniesCompanyIdBidsIdPatchRequestBidUploadsInner(BaseModel):
    """
    RestV10CompaniesCompanyIdBidsIdPatchRequestBidUploadsInner
    """ # noqa: E501
    uuid: Optional[StrictStr] = Field(default=None, description="uuid of the upload")
