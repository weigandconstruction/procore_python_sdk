...
class ChecklistSignatureRequest2(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signature": ChecklistSignature3.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
