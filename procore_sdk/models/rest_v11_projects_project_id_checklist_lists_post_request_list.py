...
class RestV11ProjectsProjectIdChecklistListsPostRequestList(BaseModel):
    """
    ...
    identifier: Optional[StrictStr] = Field(default=None, description="Identifier of the Inspection")
    ...
    __properties: ClassVar[List[str]] = ["description", "due_at", "identifier", "inspection_date", "inspection_type_id", "number", "managed_equipment_id", "point_of_contact_id", "inspector_ids", "private", "responsible_contractor_id", "spec_section_id", "status", "trade_id", "distribution_member_ids", "location_id", "custom_field_%{custom_field_definition_id}", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
