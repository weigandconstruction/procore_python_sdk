...
class RestV10ProjectsProjectIdWasteLogsGet200ResponseInner(BaseModel):
    """
    ...
    time_hour: Optional[Annotated[int, Field(le=23, strict=True, ge=0)]] = Field(default=None, description="Time of waste disposal - hour")
    time_minute: Optional[Annotated[int, Field(le=59, strict=True, ge=0)]] = Field(default=None, description="Time of waste disposal - minute")
    ...
    attachments: Optional[List[RestV10CompaniesCompanyIdWorkflowPermanentLogsGet200ResponseInnerAttachmentsInner]] = Field(default=None, description="Waste Log Attachments are not viewable or used on web")
    __properties: ClassVar[List[str]] = ["id", "approximate_quantity", "created_at", "date", "datetime", "deleted_at", "description", "disposal_location", "material", "method_of_disposal", "position", "time_hour", "time_minute", "updated_at", "created_by", "vendor", "attachments"]
