...
class RestV10CoordinationIssuesGet200ResponseInnerAllOfDrawingRevision(BaseModel):
    """
    RestV10CoordinationIssuesGet200ResponseInnerAllOfDrawingRevision
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    title: Optional[StrictStr] = Field(default=None, description="Formatted title of the drawing revision")
