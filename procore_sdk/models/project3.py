...
class Project3(BaseModel):
    ...
    is_demo: Optional[StrictBool] = Field(default=None, description="Indicates if the project is a test project")
    template: Optional[StrictBool] = Field(default=None, description="Indicates if the project is a template project")
    ...
    is_erp_integrated: Optional[StrictBool] = Field(default=None, description="True if project is ERP integrated")
    ...
    inbound_email_address: Optional[StrictStr] = Field(default=None, description="The inbound email address for the project.")
    ...
    code: Optional[StrictStr] = Field(default=None, description="The Code of the project.")
    persistent_message: Optional[ProjectPersistentMessage1] = None
    office: Optional[ProjectOffice1] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "logo_url", "name", "is_demo", "template", "display_name", "project_number", "address", "city", "state_code", "country_code", "zip", "time_zone", "tz_name", "latitude", "longitude", "county", "parent_job_id", "description", "square_feet", "start_date", "completion_date", "total_value", "store_number", "accounting_project_number", "designated_market_area", "warranty_start_date", "warranty_end_date", "active", "flag", "phone", "public_notes", "actual_start_date", "projected_finish_date", "created_at", "updated_at", "origin_id", "origin_data", "origin_code", "standard_cost_code_list_id", "is_erp_integrated", "owners_project_id", "photo_id", "inbound_email", "inbound_email_address", "estimated_start_date", "estimated_completion_date", "estimated_value", "code", "persistent_message", "office", "project_bid_type_id", "project_bid_type", "project_owner_type_id", "project_owner_type", "project_region_id", "project_region", "project_stage_id", "project_stage", "project_type", "program", "departments", "company", "dictionary_type", "custom_fields"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if inbound_email (nullable) is None
        # and model_fields_set contains the field
        if self.inbound_email is None and "inbound_email" in self.model_fields_set:
            _dict['inbound_email'] = None

        # set to None if inbound_email_address (nullable) is None
        # and model_fields_set contains the field
        if self.inbound_email_address is None and "inbound_email_address" in self.model_fields_set:
            _dict['inbound_email_address'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "persistent_message": ProjectPersistentMessage1.from_dict(obj["persistent_message"]) if obj.get("persistent_message") is not None else None,
            "office": ProjectOffice1.from_dict(obj["office"]) if obj.get("office") is not None else None,
