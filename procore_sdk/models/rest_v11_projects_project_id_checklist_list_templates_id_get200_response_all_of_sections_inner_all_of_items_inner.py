...
class RestV11ProjectsProjectIdChecklistListTemplatesIdGet200ResponseAllOfSectionsInnerAllOfItemsInner(BaseModel):
    """
    ...
    response_set: Optional[ChecklistTemplateItemResponseSet] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "section_id", "position", "response_set", "details", "company_template_item_details", "synced_to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response_set": ChecklistTemplateItemResponseSet.from_dict(obj["response_set"]) if obj.get("response_set") is not None else None,
