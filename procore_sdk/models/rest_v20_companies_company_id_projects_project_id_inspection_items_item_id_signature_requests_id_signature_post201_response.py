...
class RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsIdSignaturePost201Response(BaseModel):
    """
    RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsIdSignaturePost201Response
    """ # noqa: E501
    data: Optional[InspectionItemSignature] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": InspectionItemSignature.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
