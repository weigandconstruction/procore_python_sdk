...
class SpecificationSectionDivision(BaseModel):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description="Address of a PDF file containing the PDFs for all of the SpecificationSections in this division, concatenated into one.")
    __properties: ClassVar[List[str]] = ["id", "number", "description", "url"]
