...
class RestV20CompaniesCompanyIdProjectsProjectIdInspectionItemsItemIdSignatureRequestsIdSignaturePostRequestOneOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attachment_string"]
