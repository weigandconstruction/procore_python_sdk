...
class ActionPlanTemplateItemAssigneesInner(BaseModel):
    """
    ActionPlanTemplateItemAssigneesInner
    """ # noqa: E501
    plan_template_item_id: StrictInt = Field(description="The ID of the Action Plan Template Item Assignee")
    ...
    __properties: ClassVar[List[str]] = ["plan_template_item_id", "is_holding", "party_id", "role", "verification_method_id"]
