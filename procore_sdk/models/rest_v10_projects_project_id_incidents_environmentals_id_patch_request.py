...
class RestV10ProjectsProjectIdIncidentsEnvironmentalsIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsEnvironmentalsIdPatchRequest
    """ # noqa: E501
    environmental: IncidentEnvironmentalUpdateParameters1
    __properties: ClassVar[List[str]] = ["environmental"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "environmental": IncidentEnvironmentalUpdateParameters1.from_dict(obj["environmental"]) if obj.get("environmental") is not None else None
        })
        return _obj
