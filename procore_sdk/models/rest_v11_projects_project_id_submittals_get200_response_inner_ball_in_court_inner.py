...
class RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInner(BaseModel):
    """
    RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    initials: Optional[StrictStr] = None
    vendor: Optional[RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInnerVendor] = None
    __properties: ClassVar[List[str]] = ["id", "name", "initials", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendor": RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerBallInCourtInnerVendor.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
