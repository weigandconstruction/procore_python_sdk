...
class RestV10ProjectsProjectIdIncidentsConfigurationPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsConfigurationPatchRequest
    """ # noqa: E501
    configuration: RestV10ProjectsProjectIdIncidentsConfigurationPatchRequestConfiguration
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": RestV10ProjectsProjectIdIncidentsConfigurationPatchRequestConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
