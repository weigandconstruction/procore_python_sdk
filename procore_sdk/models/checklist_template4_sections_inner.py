...
class ChecklistTemplate4SectionsInner(BaseModel):
    """
    ...
    items: Optional[List[ChecklistTemplate4SectionsInnerItemsInner]] = Field(default=None, description="Checklist Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ChecklistTemplate4SectionsInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
