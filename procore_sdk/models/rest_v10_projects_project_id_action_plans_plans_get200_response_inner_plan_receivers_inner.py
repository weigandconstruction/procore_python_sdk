...
class RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInner(BaseModel):
    """
    Action Plan Receiver (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    plan_id: Optional[StrictInt] = Field(default=None, description="Action Plan ID")
    updated_at: Optional[datetime] = Field(default=None, description="Time the Action Plan Receiver was updated")
    party: Optional[RestV10ProjectsProjectIdActionPlansPlanTemplatesGet200ResponseInnerManager] = None
    signature: Optional[RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInnerSignature] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signature": RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanReceiversInnerSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
