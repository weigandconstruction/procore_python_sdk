...
class ChecklistSectionItem1ResponseSet(BaseModel):
    """
    ChecklistSectionItem1ResponseSet
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the response set")
    name: Optional[StrictStr] = Field(default=None, description="Name of the response set")
    responses: Optional[List[ChecklistResponse]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "responses", "created_at", "updated_at"]
