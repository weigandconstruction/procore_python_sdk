...
class Body41(BaseModel):
    ...
    Body41
    """ # noqa: E501
    project_bid_type: ProjectBidType3
    __properties: ClassVar[List[str]] = ["project_bid_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_bid_type": ProjectBidType3.from_dict(obj["project_bid_type"]) if obj.get("project_bid_type") is not None else None
        })
        return _obj
