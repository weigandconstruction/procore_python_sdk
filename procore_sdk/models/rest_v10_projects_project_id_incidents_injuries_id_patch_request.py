...
class RestV10ProjectsProjectIdIncidentsInjuriesIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdIncidentsInjuriesIdPatchRequest
    """ # noqa: E501
    injury: IncidentInjuryUpdateParameters
    __properties: ClassVar[List[str]] = ["injury"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "injury": IncidentInjuryUpdateParameters.from_dict(obj["injury"]) if obj.get("injury") is not None else None
        })
        return _obj
