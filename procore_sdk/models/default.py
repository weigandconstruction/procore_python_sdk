...
class Default(BaseModel):
    ...
    cost_code: Optional[Extended] = None
    ...
    change_event_line_item: Optional[RestV10WorkOrderContractsPost201ResponseLineItemsInnerChangeEventLineItem] = None
    currency_configuration: Optional[RestV10WorkOrderContractsGet200ResponseInnerCurrencyConfiguration] = None
    __properties: ClassVar[List[str]] = ["id", "amount", "company", "cost_code", "created_at", "description", "extended_type", "holder", "line_item_type", "origin_data", "origin_id", "position", "project", "quantity", "tax_code_id", "total_amount", "extended_amount", "unit_cost", "uom", "wbs_code", "updated_at", "change_event_line_item", "currency_configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost_code": Extended.from_dict(obj["cost_code"]) if obj.get("cost_code") is not None else None,
            ...
            "change_event_line_item": RestV10WorkOrderContractsPost201ResponseLineItemsInnerChangeEventLineItem.from_dict(obj["change_event_line_item"]) if obj.get("change_event_line_item") is not None else None,
