...
class RestV10ProjectsProjectIdBudgetChangesPost201ResponseDataAllOfProductionQuantitiesInnerSubJob(BaseModel):
    """
    The sub job associated with the Production Quantity
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The ID of the sub job")
    label: Optional[StrictStr] = Field(default=None, description="The name of the Sub Job")
