...
class RestV10CompaniesCompanyIdContributingConditionsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdContributingConditionsIdPatchRequest
    """ # noqa: E501
    contributing_condition: RestV10CompaniesCompanyIdContributingConditionsIdPatchRequestContributingCondition
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributing_condition": RestV10CompaniesCompanyIdContributingConditionsIdPatchRequestContributingCondition.from_dict(obj["contributing_condition"]) if obj.get("contributing_condition") is not None else None
        })
        return _obj
