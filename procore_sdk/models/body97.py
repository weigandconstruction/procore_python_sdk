...
class Body97(BaseModel):
    ...
    item: Optional[DirectCostItem4] = None
    __properties: ClassVar[List[str]] = ["attachments", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": DirectCostItem4.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
