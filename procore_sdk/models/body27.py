...
class Body27(BaseModel):
    ...
    updates: List[PurchaseOrderContract1] = Field(description="Updated Purchase Order Contracts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [PurchaseOrderContract1.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
