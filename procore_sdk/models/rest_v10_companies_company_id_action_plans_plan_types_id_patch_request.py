...
class RestV10CompaniesCompanyIdActionPlansPlanTypesIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTypesIdPatchRequest
    """ # noqa: E501
    type: RestV10CompaniesCompanyIdActionPlansPlanTypesIdPatchRequestType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": RestV10CompaniesCompanyIdActionPlansPlanTypesIdPatchRequestType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
