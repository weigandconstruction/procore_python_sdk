...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemsGet200ResponseInnerPlanTemplateItemAssigneesInnerVerificationMethod(BaseModel):
    """
    ...
    active: Optional[StrictBool] = Field(default=None, description="Flag indicating if the Project Action Plan Template Verification Method is intended for use")
