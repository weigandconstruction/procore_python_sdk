...
class ChecklistCommentBody(BaseModel):
    """
    ChecklistCommentBody
    """ # noqa: E501
    project_id: StrictInt = Field(description="The ID of the Project")
    item_id: StrictInt = Field(description="The ID of the Item")
    comment: Comment2
    __properties: ClassVar[List[str]] = ["project_id", "item_id", "comment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": Comment2.from_dict(obj["comment"]) if obj.get("comment") is not None else None
        })
        return _obj
