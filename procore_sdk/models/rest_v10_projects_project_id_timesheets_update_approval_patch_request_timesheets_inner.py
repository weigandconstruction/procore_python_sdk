...
class RestV10ProjectsProjectIdTimesheetsUpdateApprovalPatchRequestTimesheetsInner(BaseModel):
    """
    RestV10ProjectsProjectIdTimesheetsUpdateApprovalPatchRequestTimesheetsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID of Timesheet to change the status of")
    status: Optional[StrictStr] = Field(default=None, description="The status of the Timesheet - pending/approved")
