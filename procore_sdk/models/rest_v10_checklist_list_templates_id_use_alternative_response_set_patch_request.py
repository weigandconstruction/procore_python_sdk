...
class RestV10ChecklistListTemplatesIdUseAlternativeResponseSetPatchRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["project_id", "alternative_response_set_id"]
