...
class RestV10VendorsIdGet200ResponseOneOf1AllOfBusinessAvgContractSize(BaseModel):
    """
    Average Contract Size
    """ # noqa: E501
    start: Optional[StrictInt] = Field(default=None, description="Indicates the smallest average contract size")
    end: Optional[StrictInt] = Field(default=None, description="Indicates the largest average contract size")
