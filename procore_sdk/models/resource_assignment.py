...
class ResourceAssignment(BaseModel):
    ...
    ResourceAssignment
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Resource Assignment id")
    task_id: Optional[StrictInt] = Field(default=None, description="Task id")
    ...
    __properties: ClassVar[List[str]] = ["id", "task_id", "resource_id", "schedule_attributes"]
