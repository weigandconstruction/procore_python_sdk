...
class ExtendedView2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contact", "employee_id", "first_name", "id", "is_employee", "last_name", "user_id", "user_uuid", "work_classification_id", "origin_id", "work_classification", "vendor"]
