...
class RestV10WorkflowInstancesGet200ResponseInnerWorkflow(BaseModel):
    """
    Workflow
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "class_name", "created_at", "updated_at", "domain"]
