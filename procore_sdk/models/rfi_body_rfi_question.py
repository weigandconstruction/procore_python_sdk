...
class RFIBodyRfiQuestion(BaseModel):
    """
    The Question of the RFI
    """ # noqa: E501
    body: StrictStr = Field(description="The Body of the Question")
    attachments: Optional[List[Union[StrictBytes, StrictStr]]] = Field(default=None, description="RFI Question Attachments. To upload attachments you must upload the entire payload as `multipart/form-data` content-type and specify each parameter as form-data together with `attachments[]` as files.")
    ...
    __properties: ClassVar[List[str]] = ["body", "attachments", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
