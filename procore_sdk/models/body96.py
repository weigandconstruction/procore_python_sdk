...
class Body96(BaseModel):
    """
    Body96
    """ # noqa: E501
    updates: List[DirectCostItem3] = Field(description="An array of Direct Cost Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [DirectCostItem3.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
