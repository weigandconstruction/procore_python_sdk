...
class TimecardTimeTypeBody(BaseModel):
    """
    TimecardTimeTypeBody
    """ # noqa: E501
    timecard_time_type: TimeAndMaterialEntry
    __properties: ClassVar[List[str]] = ["timecard_time_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timecard_time_type": TimeAndMaterialEntry.from_dict(obj["timecard_time_type"]) if obj.get("timecard_time_type") is not None else None
        })
        return _obj
