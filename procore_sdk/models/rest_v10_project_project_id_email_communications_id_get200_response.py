...
class RestV10ProjectProjectIdEmailCommunicationsIdGet200Response(BaseModel):
    """
    RestV10ProjectProjectIdEmailCommunicationsIdGet200Response
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Communication ID")
    private: Optional[StrictBool] = Field(default=None, description="Private Indicator")
    subject: Optional[StrictStr] = Field(default=None, description="Subject of the email communication")
    emails: Optional[List[RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner]] = Field(default=None, description="Emails")
    __properties: ClassVar[List[str]] = ["id", "private", "subject", "emails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emails": [RestV10ProjectProjectIdEmailCommunicationsIdGet200ResponseEmailsInner.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None
        })
        return _obj
