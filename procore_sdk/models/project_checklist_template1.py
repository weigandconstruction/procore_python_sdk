...
class ProjectChecklistTemplate1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "company_description", "description", "inspection_type", "trade", "synced_to", "created_at", "updated_at"]
