...
class ObservationItemAssignee(BaseModel):
    """
    ...
    vendor: Optional[ObservationItemAssigneeSCompany] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "vendor": ObservationItemAssigneeSCompany.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
