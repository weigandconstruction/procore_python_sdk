...
class ChangeEventLineItem(BaseModel):
    """
    ChangeEventLineItem
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    budget_code: Optional[ChangeEventLineItemBudgetCode] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "budget_code", "description", "uom", "estimated_cost_amount", "estimated_cost_quantity", "estimated_cost_unit_cost", "estimated_cost_calculation_strategy", "line_item_type_id", "cost_code_id", "proposed_vendor_id", "proposed_contract_id", "commitment_contract_line_item_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "budget_code": ChangeEventLineItemBudgetCode.from_dict(obj["budget_code"]) if obj.get("budget_code") is not None else None,
