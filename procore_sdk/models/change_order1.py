...
class ChangeOrder1(BaseModel):
    """
    Change Order object
    """ # noqa: E501
    attachment_ids: Optional[List[StrictInt]] = Field(default=None, description="Existing attachments to preserve on the response")
    ...
    batch_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for a change order batch.")
    change_order_change_reason_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the change reason.")
    location_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the location.")
    ...
    received_from_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the received from entity.")
    ...
    number: Optional[StrictStr] = Field(default=None, description="Number of the Change Order")
    ...
    signature_required: Optional[StrictBool] = Field(default=None, description="Whether a signature will be required for this Change Order")
    ...
    executed: Optional[StrictBool] = Field(default=None, description="Whether or not the Change Order is executed")
    private: Optional[StrictBool] = Field(default=None, description="Whether or not the Commitment Change Order is private")
    ...
    __properties: ClassVar[List[str]] = ["attachment_ids", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids", "contract_id", "batch_id", "change_order_change_reason_id", "location_id", "designated_reviewer_id", "received_from_id", "description", "due_date", "paid_date", "invoiced_date", "title", "status", "reference", "number", "revision", "field_change", "signature_required", "signed_change_order_received_date", "schedule_impact_amount", "executed", "private", "paid", "custom_field_%{custom_field_definition_id}"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if field_change (nullable) is None
        # and model_fields_set contains the field
        if self.field_change is None and "field_change" in self.model_fields_set:
            _dict['field_change'] = None
