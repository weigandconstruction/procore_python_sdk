...
class RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInner(BaseModel):
    """
    ...
    markup_line_items: Optional[List[RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner]] = None
    currency_configuration: Optional[RestV10WorkOrderContractsGet200ResponseInnerCurrencyConfiguration] = None
    __properties: ClassVar[List[str]] = ["id", "position", "description", "quantity", "uom", "total_amount", "extended_amount", "unit_cost", "cost_code", "wbs_code", "holder", "line_item_type", "markup_line_items", "currency_configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "markup_line_items": [RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInner.from_dict(_item) for _item in obj["markup_line_items"]] if obj.get("markup_line_items") is not None else None,
