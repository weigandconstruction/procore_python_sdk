...
class RestV10ProjectsProjectIdProductivityLogsPostRequestProductivityLog(BaseModel):
    """
    ...
    line_item_id: StrictInt = Field(description="Line Item ID of an approved contract")
