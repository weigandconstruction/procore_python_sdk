...
class RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerStatus(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerStatus
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Status ID for the Action Plan Item (1 - open, 2 - in_progress, 3 - delayed, 4 - closed)")
