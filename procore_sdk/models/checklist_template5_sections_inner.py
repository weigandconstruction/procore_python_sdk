...
class ChecklistTemplate5SectionsInner(BaseModel):
    """
    ...
    items: Optional[List[ChecklistTemplate5SectionsInnerItemsInner]] = Field(default=None, description="Checklist Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ChecklistTemplate5SectionsInnerItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
