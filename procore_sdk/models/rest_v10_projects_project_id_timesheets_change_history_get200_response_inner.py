...
class RestV10ProjectsProjectIdTimesheetsChangeHistoryGet200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdTimesheetsChangeHistoryGet200ResponseInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Change History ID")
    ref_id: Optional[StrictInt] = Field(default=None, description="Timesheet ID")
    ...
    column: Optional[StrictStr] = Field(default=None, description="Column that changed value")
    old_value: Optional[StrictStr] = Field(default=None, description="Old value in the column")
    new_value: Optional[StrictStr] = Field(default=None, description="New value in the column")
    __properties: ClassVar[List[str]] = ["id", "ref_id", "created_at", "created_by", "column", "old_value", "new_value"]
