...
class RestV10DocumentMarkupDownloadablePdfsFindOrCreatePostRequest(BaseModel):
    """
    RestV10DocumentMarkupDownloadablePdfsFindOrCreatePostRequest
    """ # noqa: E501
    project_id: StrictInt
    item_id: StrictInt = Field(description="The ID of the parent item this document belongs to")
    item_type: StrictStr = Field(description="The type of the parent item this document belongs to (eg SubmittalLog)")
    attachment_id: StrictInt
    __properties: ClassVar[List[str]] = ["project_id", "item_id", "item_type", "attachment_id"]
