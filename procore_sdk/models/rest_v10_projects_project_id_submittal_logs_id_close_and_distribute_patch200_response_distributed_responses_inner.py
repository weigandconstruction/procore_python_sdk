...
class RestV10ProjectsProjectIdSubmittalLogsIdCloseAndDistributePatch200ResponseDistributedResponsesInner(BaseModel):
    """
    ...
    response_name: Optional[StrictStr] = None
    ...
    user: Optional[RestV10ProjectsProjectIdDistributionGroupsPost200ResponseUsersInner] = None
    __properties: ClassVar[List[str]] = ["id", "comment", "distributed_attachments", "response_name", "submittal_response", "submittal_response_id", "submittal_approver_id", "user_id", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response_name": obj.get("response_name"),
            ...
            "user": RestV10ProjectsProjectIdDistributionGroupsPost200ResponseUsersInner.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
