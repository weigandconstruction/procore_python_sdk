...
class ChecklistItemAttachment1(BaseModel):
    """
    ...
    created_by: Optional[ChecklistItemAttachment1CreatedBy] = None
    attachment: Optional[ChecklistItemAttachment1Attachment] = None
    item_id: Optional[StrictInt] = Field(default=None, description="Checklist Item ID")
    __properties: ClassVar[List[str]] = ["id", "created_at", "created_by", "attachment", "item_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created_by": ChecklistItemAttachment1CreatedBy.from_dict(obj["created_by"]) if obj.get("created_by") is not None else None,
            "attachment": ChecklistItemAttachment1Attachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None,
