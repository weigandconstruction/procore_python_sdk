...
class RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfSectionsInner(BaseModel):
    """
    ...
    items: Optional[List[RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfSectionsInnerAllOfItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfSectionsInnerAllOfItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
