...
class RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatchRequest
    """ # noqa: E501
    updates: RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatchRequestUpdates
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": RestV10ProjectsProjectIdDailyLogsBulkUpdatesBulkUpdatePatchRequestUpdates.from_dict(obj["updates"]) if obj.get("updates") is not None else None
        })
        return _obj
