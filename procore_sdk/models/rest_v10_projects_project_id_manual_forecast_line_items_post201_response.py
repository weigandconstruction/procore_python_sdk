...
class RestV10ProjectsProjectIdManualForecastLineItemsPost201Response(BaseModel):
    """
    RestV10ProjectsProjectIdManualForecastLineItemsPost201Response
    """ # noqa: E501
    data: Optional[RestV10ProjectsProjectIdManualForecastLineItemsGet200ResponseInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RestV10ProjectsProjectIdManualForecastLineItemsGet200ResponseInner.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
