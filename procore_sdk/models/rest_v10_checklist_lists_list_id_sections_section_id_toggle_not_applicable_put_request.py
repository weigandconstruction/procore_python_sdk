...
class RestV10ChecklistListsListIdSectionsSectionIdToggleNotApplicablePutRequest(BaseModel):
    """
    RestV10ChecklistListsListIdSectionsSectionIdToggleNotApplicablePutRequest
    """ # noqa: E501
    project_id: StrictInt = Field(description="Unique identifier for the project.")
    not_applicable: StrictBool = Field(description="Not applicable status")
    __properties: ClassVar[List[str]] = ["project_id", "not_applicable"]
