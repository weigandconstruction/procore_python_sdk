...
class ArrayOfTaskItemsThatWereSentOutInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["number", "date_notified", "description", "due_date", "status", "private", "task_item_category", "assignee", "assignees", "id", "title"]
