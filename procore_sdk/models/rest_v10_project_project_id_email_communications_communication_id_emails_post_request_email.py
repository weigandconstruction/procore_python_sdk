...
class RestV10ProjectProjectIdEmailCommunicationsCommunicationIdEmailsPostRequestEmail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["body", "prostore_file_ids", "distribution_ids", "cc_distribution_ids", "bcc_distribution_ids", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
