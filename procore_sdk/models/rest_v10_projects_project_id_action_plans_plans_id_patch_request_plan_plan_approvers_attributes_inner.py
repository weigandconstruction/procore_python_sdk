...
class RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanApproversAttributesInner(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlansIdPatchRequestPlanPlanApproversAttributesInner
    """ # noqa: E501
    party_id: StrictInt = Field(description="Party Person ID of the Action Approver to be set")
