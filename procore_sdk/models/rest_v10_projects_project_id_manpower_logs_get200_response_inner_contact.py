...
class RestV10ProjectsProjectIdManpowerLogsGet200ResponseInnerContact(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "business_phone", "business_phone_extension", "email", "fax_number", "job_title", "login_information_id", "mobile_phone", "name", "vendor_name"]
