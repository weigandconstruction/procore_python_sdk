...
class Body37(BaseModel):
    ...
    Body37
    """ # noqa: E501
    project_region: ProjectRegion3
    __properties: ClassVar[List[str]] = ["project_region"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_region": ProjectRegion3.from_dict(obj["project_region"]) if obj.get("project_region") is not None else None
        })
        return _obj
