...
class RestV10ProjectsProjectIdTimesheetsPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdTimesheetsPostRequest
    """ # noqa: E501
    timesheet: RestV10ProjectsProjectIdTimesheetsPostRequestTimesheet
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timesheet": RestV10ProjectsProjectIdTimesheetsPostRequestTimesheet.from_dict(obj["timesheet"]) if obj.get("timesheet") is not None else None
        })
        return _obj
