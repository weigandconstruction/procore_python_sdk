...
class RestV10CompaniesCompanyIdActionPlansVerificationMethodsIdPatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansVerificationMethodsIdPatchRequest
    """ # noqa: E501
    verification_method: RestV10CompaniesCompanyIdActionPlansVerificationMethodsIdPatchRequestVerificationMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verification_method": RestV10CompaniesCompanyIdActionPlansVerificationMethodsIdPatchRequestVerificationMethod.from_dict(obj["verification_method"]) if obj.get("verification_method") is not None else None
        })
        return _obj
