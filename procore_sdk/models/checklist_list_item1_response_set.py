...
class ChecklistListItem1ResponseSet(BaseModel):
    """
    ...
    responses: Optional[List[ChecklistResponse2]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "responses": [ChecklistResponse2.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,
