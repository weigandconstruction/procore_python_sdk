...
class RestV11ProjectsProjectIdSubmittalsPost201ResponseAllOfSubmittalPackage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attachments_count", "created_by", "description", "attachments", "submittal_ids", "id", "number", "title"]
