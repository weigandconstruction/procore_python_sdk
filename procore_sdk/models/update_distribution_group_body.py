...
class UpdateDistributionGroupBody(BaseModel):
    """
    UpdateDistributionGroupBody
    """ # noqa: E501
    distribution_group: DistributionGroup1
    __properties: ClassVar[List[str]] = ["distribution_group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "distribution_group": DistributionGroup1.from_dict(obj["distribution_group"]) if obj.get("distribution_group") is not None else None
        })
        return _obj
