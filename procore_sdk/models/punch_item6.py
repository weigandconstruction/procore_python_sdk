...
class PunchItem6(BaseModel):
    ...
    assignments: Optional[List[PunchItem6AssignmentsInner]] = Field(default=None, description="Array of Punch Item Assignments")
    assignees: Optional[List[Optional[PunchItem6CreatedBy]]] = Field(default=None, description="Punch Item Assignees")
    latitude: Optional[StrictStr] = Field(default=None, description="Latitude of Punch Item (Deprecated)")
    longitude: Optional[StrictStr] = Field(default=None, description="Longitude of Punch Item (Deprecated)")
    horizontal_accuracy: Optional[StrictStr] = Field(default=None, description="Horizontal Accuracy of Punch Item (Deprecated)")
    vertical_accuracy: Optional[StrictStr] = Field(default=None, description="Vertical Accuracy of Punch Item (Deprecated)")
    altitude: Optional[StrictStr] = Field(default=None, description="Altitude of Punch Item (Deprecated)")
    ...
    __properties: ClassVar[List[str]] = ["id", "ball_in_court", "closed_at", "cost_impact", "cost_impact_amount", "created_at", "deleted_at", "description", "due_date", "name", "reference", "schedule_impact", "schedule_impact_days", "schedule_risk", "schedule_risk_reason", "schedule_risk_confidence", "schedule_risk_probability", "position", "priority", "private", "status", "has_resolved_responses", "has_unresolved_responses", "updated_at", "location", "trade", "created_by", "punch_item_manager", "final_approver", "punch_item_type", "cost_code", "assignments", "assignees", "latitude", "longitude", "horizontal_accuracy", "vertical_accuracy", "altitude", "workflow_status", "custom_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignments": [PunchItem6AssignmentsInner.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
            "assignees": [PunchItem6CreatedBy.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None,
