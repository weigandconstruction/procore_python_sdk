...
class RestV10CustomFieldDefinitionsCustomFieldDefinitionIdCustomFieldLovEntriesBulkCreatePostRequest(BaseModel):
    """
    RestV10CustomFieldDefinitionsCustomFieldDefinitionIdCustomFieldLovEntriesBulkCreatePostRequest
    """ # noqa: E501
    custom_field_lov_entries: List[CustomFieldLovEntriesInner]
    __properties: ClassVar[List[str]] = ["custom_field_lov_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "custom_field_lov_entries": [CustomFieldLovEntriesInner.from_dict(_item) for _item in obj["custom_field_lov_entries"]] if obj.get("custom_field_lov_entries") is not None else None
        })
        return _obj
