...
class RestV13CompaniesCompanyIdUsersIdGet200ResponseOneOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "avatar", "business_id", "business_phone", "business_phone_extension", "city", "contact_id", "country_code", "email_address", "email_signature", "employee_id", "fax_number", "first_name", "id", "initials", "is_active", "is_employee", "is_insurance_manager", "job_title", "last_login_at", "last_name", "mobile_phone", "name", "notes", "state_code", "zip", "origin_id", "origin_data", "created_at", "updated_at", "vendor", "work_classification_id", "default_permission_template_id", "company_permission_template_id"]
