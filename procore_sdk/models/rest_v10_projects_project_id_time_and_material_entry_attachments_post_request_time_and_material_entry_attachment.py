...
class RestV10ProjectsProjectIdTimeAndMaterialEntryAttachmentsPostRequestTimeAndMaterialEntryAttachment(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["documents", "folders", "upload_uuids"]
