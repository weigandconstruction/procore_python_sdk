...
class DirectCostItem(BaseModel):
    ...
    line_items: Optional[List[DirectCostLineItem]] = Field(default=None, description="Line items that should be assoicated with the direct cost item.")
    __properties: ClassVar[List[str]] = ["description", "direct_cost_date", "employee_id", "invoice_number", "origin_data", "origin_id", "payment_date", "received_date", "status", "terms", "vendor_id", "direct_cost_type", "line_items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "line_items": [DirectCostLineItem.from_dict(_item) for _item in obj["line_items"]] if obj.get("line_items") is not None else None
        })
        return _obj
