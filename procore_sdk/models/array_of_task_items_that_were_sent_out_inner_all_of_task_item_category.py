...
class ArrayOfTaskItemsThatWereSentOutInnerAllOfTaskItemCategory(BaseModel):
    """
    ArrayOfTaskItemsThatWereSentOutInnerAllOfTaskItemCategory
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name given to the task item category")
