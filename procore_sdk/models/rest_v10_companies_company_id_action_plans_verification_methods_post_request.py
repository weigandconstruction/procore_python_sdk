...
class RestV10CompaniesCompanyIdActionPlansVerificationMethodsPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansVerificationMethodsPostRequest
    """ # noqa: E501
    verification_method: RestV10CompaniesCompanyIdActionPlansVerificationMethodsPostRequestVerificationMethod
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verification_method": RestV10CompaniesCompanyIdActionPlansVerificationMethodsPostRequestVerificationMethod.from_dict(obj["verification_method"]) if obj.get("verification_method") is not None else None
        })
        return _obj
