...
class RestV10TasksSyncPatchRequest(BaseModel):
    """
    RestV10TasksSyncPatchRequest
    """ # noqa: E501
    project_id: StrictInt = Field(description="The ID of the Project the Tasks belongs to")
    updates: List[RestV10TasksSyncPatchRequestUpdatesInner]
    __properties: ClassVar[List[str]] = ["project_id", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [RestV10TasksSyncPatchRequestUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
