...
class RestV10ChecklistListTemplatesIdRemoveAlternativeResponseSetPatchRequest(BaseModel):
    """
    RestV10ChecklistListTemplatesIdRemoveAlternativeResponseSetPatchRequest
    """ # noqa: E501
