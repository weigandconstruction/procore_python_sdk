...
class RestV10ProjectsProjectIdRfisRfiIdRepliesPostRequestReply(BaseModel):
    """
    RestV10ProjectsProjectIdRfisRfiIdRepliesPostRequestReply
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Body")
    official: Optional[StrictBool] = Field(default=None, description="Official Status")
    ...
    __properties: ClassVar[List[str]] = ["body", "official", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
