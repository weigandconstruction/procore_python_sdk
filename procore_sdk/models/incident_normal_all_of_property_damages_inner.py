...
class IncidentNormalAllOfPropertyDamagesInner(BaseModel):
    """
    ...
    responsible_company: Optional[RestV10ProjectsProjectIdWasteLogsGet200ResponseInnerVendor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responsible_company": RestV10ProjectsProjectIdWasteLogsGet200ResponseInnerVendor.from_dict(obj["responsible_company"]) if obj.get("responsible_company") is not None else None,
