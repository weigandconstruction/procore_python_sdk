...
class ObservationItemPDF(BaseModel):
    """
    ObservationItemPDF
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Observation Item ID")
    url: Optional[StrictStr] = Field(default=None, description="URL of PDF file")
    pdf_url: Optional[StrictStr] = Field(default=None, description="URL of PDF file")
    __properties: ClassVar[List[str]] = ["id", "url", "pdf_url"]
