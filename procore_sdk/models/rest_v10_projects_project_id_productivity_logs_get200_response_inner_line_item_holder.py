...
class RestV10ProjectsProjectIdProductivityLogsGet200ResponseInnerLineItemHolder(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="The type of object that the Line Item belongs to")
    __properties: ClassVar[List[str]] = ["id", "title", "number", "type"]
