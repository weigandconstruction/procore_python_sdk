...
class RestV10CoordinationIssueActivitiesFeedGet200ResponseInnerAnyOf2(BaseModel):
    """
    ...
    details: Optional[CoordinationIssueCreationActivityDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "details": CoordinationIssueCreationActivityDetails.from_dict(obj["details"]) if obj.get("details") is not None else None,
