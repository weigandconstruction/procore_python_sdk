...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecording(BaseModel):
    """
    RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecording
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Recording ID")
    witness_statement_id: Optional[StrictInt] = Field(default=None, description="Witeness Statement ID")
    attachment: Optional[RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingAttachment] = None
    captured_by: Optional[RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingCapturedBy] = None
    created_at: Optional[datetime] = Field(default=None, description="Timestamp of creation")
    __properties: ClassVar[List[str]] = ["id", "witness_statement_id", "attachment", "captured_by", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "witness_statement_id": obj.get("witness_statement_id"),
            "attachment": RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingAttachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None,
            "captured_by": RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingCapturedBy.from_dict(obj["captured_by"]) if obj.get("captured_by") is not None else None,
