...
class RestV10TaxTypesIdPatchRequest(BaseModel):
    """
    RestV10TaxTypesIdPatchRequest
    """ # noqa: E501
    tax_type: RestV10TaxTypesIdPatchRequestTaxType
    __properties: ClassVar[List[str]] = ["tax_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tax_type:
            _dict['tax_type'] = self.tax_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tax_type": RestV10TaxTypesIdPatchRequestTaxType.from_dict(obj["tax_type"]) if obj.get("tax_type") is not None else None
        })
        return _obj
