...
class ObservationItemAssignee1(BaseModel):
    """
    ...
    vendor: Optional[ObservationItemAssignee1Vendor] = None
    __properties: ClassVar[List[str]] = ["id", "name", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "vendor": ObservationItemAssignee1Vendor.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
