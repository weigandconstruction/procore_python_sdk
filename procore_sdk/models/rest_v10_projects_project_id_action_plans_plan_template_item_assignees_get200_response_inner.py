...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInner(BaseModel):
    """
    Project Action Plan Template Item Assignee (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    plan_template_item_id: Optional[StrictInt] = Field(default=None, description="Project Action Plan Template Item ID the Project Action Plan Template Item Assignee belongs to")
    created_at: Optional[datetime] = Field(default=None, description="Time the Project Action Plan Template Item Assignee was created")
    ...
    plan_template_id: Optional[StrictInt] = Field(default=None, description="Plan Template ID the Project Action Plan Template Item Assignee belongs to")
    role: Optional[StrictStr] = Field(default=None, description="Role of the Project Action Plan Template Item Assignee")
    updated_at: Optional[datetime] = Field(default=None, description="Time the Project Action Plan Template Item Assignee was updated")
    verification_method: Optional[RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInnerVerificationMethod] = None
    __properties: ClassVar[List[str]] = ["id", "plan_template_item_id", "created_at", "is_holding", "party", "plan_template_id", "role", "updated_at", "verification_method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verification_method": RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInnerVerificationMethod.from_dict(obj["verification_method"]) if obj.get("verification_method") is not None else None
        })
        return _obj
