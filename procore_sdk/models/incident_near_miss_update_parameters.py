...
class IncidentNearMissUpdateParameters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "affected_person_id", "affected_party_id", "harm_source_id", "affected_company_id", "managed_equipment_id", "work_activity_id", "custom_field_%{custom_field_definition_id}"]
