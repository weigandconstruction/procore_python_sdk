...
class RestV10ProjectsProjectIdActionPlansPlansGet200ResponseInnerPlanStatus(BaseModel):
    """
    ...
    var_global: Optional[StrictBool] = Field(default=None, description="Flag indicating if Action Plan Status applies to all Companies", alias="global")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    status: Optional[StrictStr] = Field(default=None, description="Status")
    updated_at: Optional[datetime] = Field(default=None, description="Timestamp of the last update")
    __properties: ClassVar[List[str]] = ["id", "created_at", "global", "name", "status", "updated_at"]
