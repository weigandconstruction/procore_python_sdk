...
class GenericToolItemResponse(BaseModel):
    """
    Generic Tool Item Response
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Drawing Upload ID")
    notes: Optional[StrictStr] = Field(default=None, description="The text of the Response")
    created_at: Optional[datetime] = Field(default=None, description="Generic Tool Item Response created at")
    official: Optional[StrictBool] = Field(default=None, description="If the response is an Official Response")
    position: Optional[StrictInt] = Field(default=None, description="Position of the Response")
    status: Optional[StrictStr] = Field(default=None, description="Status of the Generic Tool Item Response")
    ...
    __properties: ClassVar[List[str]] = ["id", "notes", "created_at", "official", "position", "status", "created_by", "attachments"]
