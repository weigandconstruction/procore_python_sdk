...
class RestV10ProjectsProjectIdRfisGet200ResponseInnerAllOfAssigneesInner(BaseModel):
    """
    ...
    response_required: Optional[StrictBool] = Field(default=None, description="Designate whether or not the assignee is required to respond")
    __properties: ClassVar[List[str]] = ["login", "id", "name", "locale", "response_required"]
