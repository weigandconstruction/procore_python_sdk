...
class RFQChangeEventChangeEventLineItemsInnerStatuses(BaseModel):
    """
    Statuses
    """ # noqa: E501
    ...
    commitment_pco_cost: Optional[StrictStr] = Field(default=None, description="Commitment Potential Change Order cost status")
    prime_pco_cost: Optional[StrictStr] = Field(default=None, description="Prime Potential Change Order cost status")
    rfq_amount: Optional[StrictStr] = Field(default=None, description="RFQ status")
    __properties: ClassVar[List[str]] = ["contract", "commitment_contract_cost", "commitment_pco_cost", "prime_pco_cost", "rfq_amount"]
