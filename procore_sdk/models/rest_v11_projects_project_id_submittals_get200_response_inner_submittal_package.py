...
class RestV11ProjectsProjectIdSubmittalsGet200ResponseInnerSubmittalPackage(BaseModel):
    """
    ...
    submittal_ids: Optional[List[StrictInt]] = None
    title: Optional[StrictStr] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "attachments", "created_by", "description", "number", "specification_section_id", "submittal_ids", "title", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submittal_ids": obj.get("submittal_ids"),
            "title": obj.get("title"),
