...
class RestV10ProjectsProjectIdRecentActivityGet200ResponseInnerInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "details", "number", "created_by", "created_at", "updated_at", "status", "type", "activity_type", "url", "due_date"]
