...
class RestV10CompaniesCompanyIdManagedEquipmentBulkRestorePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentBulkRestorePatchRequest
    """ # noqa: E501
    managed_equipment: RestV10CompaniesCompanyIdManagedEquipmentBulkRestorePatchRequestManagedEquipment
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment": RestV10CompaniesCompanyIdManagedEquipmentBulkRestorePatchRequestManagedEquipment.from_dict(obj["managed_equipment"]) if obj.get("managed_equipment") is not None else None
        })
        return _obj
