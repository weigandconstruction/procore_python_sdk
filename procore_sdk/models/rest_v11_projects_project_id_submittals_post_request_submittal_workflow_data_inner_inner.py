...
class RestV11ProjectsProjectIdSubmittalsPostRequestSubmittalWorkflowDataInnerInner(BaseModel):
    """
    ...
    submittal_log_approver_id: Optional[StrictInt] = Field(default=None, description="The id of the submittal log approver in the workflow")
    __properties: ClassVar[List[str]] = ["login_information_id", "approver_type", "days_to_respond", "due_date", "response_required", "submittal_log_approver_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submittal_log_approver_id": obj.get("submittal_log_approver_id")
        })
        return _obj
