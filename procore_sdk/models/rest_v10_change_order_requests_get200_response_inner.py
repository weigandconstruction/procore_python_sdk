...
class RestV10ChangeOrderRequestsGet200ResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "created_by_id", "deleted_at", "due_date", "invoiced_date", "number", "paid_date", "status", "title", "change_order_package_id", "updated_at", "revision", "grand_total", "schedule_impact_amount", "currency_configuration"]
