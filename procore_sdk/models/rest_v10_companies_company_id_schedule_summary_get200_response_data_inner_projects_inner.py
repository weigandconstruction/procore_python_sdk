...
class RestV10CompaniesCompanyIdScheduleSummaryGet200ResponseDataInnerProjectsInner(BaseModel):
    """
    ...
    tasks_count: Optional[StrictInt] = Field(default=None, description="Number of tasks on this day")
    calendar_items_count: Optional[StrictInt] = Field(default=None, description="Number of calendar items on this day")
    __properties: ClassVar[List[str]] = ["id", "name", "tasks_count", "calendar_items_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "calendar_items_count": obj.get("calendar_items_count")
        })
        return _obj
