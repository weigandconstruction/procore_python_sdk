...
class RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInnerSignature(BaseModel):
    """
    Action Plan Item Assignee Signature (Show)
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    attachment: Optional[RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInnerSignatureAttachment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "attachment": RestV10ProjectsProjectIdActionPlansPlanItemsGet200ResponseInnerPlanItemAssigneesInnerSignatureAttachment.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None,
