...
class TimecardEntries(BaseModel):
    """
    TimecardEntries
    """ # noqa: E501
    timecard_entries: Optional[List[TimecardEntriesTimecardEntriesInner]] = Field(default=None, description="Array of Timecard Entries you want to create")
    __properties: ClassVar[List[str]] = ["timecard_entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timecard_entries": [TimecardEntriesTimecardEntriesInner.from_dict(_item) for _item in obj["timecard_entries"]] if obj.get("timecard_entries") is not None else None
        })
        return _obj
