...
class RestV11ProjectsProjectIdDirectCostsGet200ResponseInnerEmployee(BaseModel):
    """
    Employee tied to the Direct Cost Item
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Employee ID")
    name: Optional[StrictStr] = Field(default=None, description="Employee name")
