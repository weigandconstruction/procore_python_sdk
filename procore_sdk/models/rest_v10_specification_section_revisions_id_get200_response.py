...
class RestV10SpecificationSectionRevisionsIdGet200Response(BaseModel):
    """
    ...
    section_id: Optional[StrictInt] = None
    section_name: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "source_id", "name", "section_id", "section_name", "source_create_time", "source_update_time", "url", "custom_fields"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source_create_time": obj.get("source_create_time"),
            "source_update_time": obj.get("source_update_time"),
            "url": obj.get("url"),
