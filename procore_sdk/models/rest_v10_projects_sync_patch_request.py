...
class RestV10ProjectsSyncPatchRequest(BaseModel):
    """
    RestV10ProjectsSyncPatchRequest
    """ # noqa: E501
    company_id: StrictInt = Field(description="The company identifier the project is associated with. Required only if `company_id` is not included in the request's query parameters.")
    updates: List[RestV10ProjectsSyncPatchRequestUpdatesInner]
    __properties: ClassVar[List[str]] = ["company_id", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [RestV10ProjectsSyncPatchRequestUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
