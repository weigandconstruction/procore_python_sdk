...
class BIMModelRevisionPlanBatchCreateResponseErrorsInner(BaseModel):
    """
    BIMModelRevisionPlanBatchCreateResponseErrorsInner
    """ # noqa: E501
    bim_model_revision_id: StrictInt = Field(description="ID of BIM Model Revision")
    bim_plan_id: StrictInt = Field(description="ID of BIM Plan. The BIM Plan should be associated to the same BIM File as the BIM Model Revision")
    errors: Optional[RestV10WorkOrderContractsWorkOrderContractIdLineItemsSyncPatch200ResponseErrorsInnerAllOfErrors] = None
    __properties: ClassVar[List[str]] = ["bim_model_revision_id", "bim_plan_id", "errors"]
