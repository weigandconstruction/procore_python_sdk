...
class ProjectObservationTypeCreateBody1(BaseModel):
    """
    ProjectObservationTypeCreateBody1
    """ # noqa: E501
    observation_type: ProjectObservationType2
    __properties: ClassVar[List[str]] = ["observation_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "observation_type": ProjectObservationType2.from_dict(obj["observation_type"]) if obj.get("observation_type") is not None else None
        })
        return _obj
