...
class RestV10ChangeOrderPackagesIdGet200ResponseLineItemsInnerMarkupLineItemsInnerMarkup(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "position", "markup_set", "name", "percentage", "compounds_markups_above", "created_at", "updated_at", "wbs_code_id", "destination_cost_code", "destination_line_item_type", "desitination_budget_line_item_id", "destination_sub_job"]
