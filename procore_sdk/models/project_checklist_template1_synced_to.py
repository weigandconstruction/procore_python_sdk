...
class ProjectChecklistTemplate1SyncedTo(BaseModel):
    """
    ProjectChecklistTemplate1SyncedTo
    """ # noqa: E501
    company_id: Optional[StrictInt] = Field(default=None, description="Company ID")
    list_template_id: Optional[StrictInt] = Field(default=None, description="Company List Template ID that List Template is Synced to")
    __properties: ClassVar[List[str]] = ["company_id", "list_template_id"]
