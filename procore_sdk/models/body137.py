...
class Body137(BaseModel):
    """
    Body137
    """ # noqa: E501
    project_id: StrictInt = Field(description="Unique identifier for the project.")
    bim_level: BIMLevel
    __properties: ClassVar[List[str]] = ["project_id", "bim_level"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bim_level": BIMLevel.from_dict(obj["bim_level"]) if obj.get("bim_level") is not None else None
        })
        return _obj
