...
class RestV10CompaniesCompanyIdHazardsBulkUpdatePatchRequestHazard(BaseModel):
    """
    IDs of all Hazards specified for bulk update
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = None
    active: Optional[StrictBool] = Field(default=None, description="Flag that denotes if the Hazards are available for use")
