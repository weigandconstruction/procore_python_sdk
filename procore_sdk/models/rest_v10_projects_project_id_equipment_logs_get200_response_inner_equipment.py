...
class RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInnerEquipment(BaseModel):
    """
    RestV10ProjectsProjectIdEquipmentLogsGet200ResponseInnerEquipment
    """ # noqa: E501
    id: Optional[StrictInt] = None
    project_id: Optional[StrictInt] = None
    position: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "project_id", "position", "name"]
