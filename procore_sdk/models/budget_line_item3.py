...
class BudgetLineItem3(BaseModel):
    """
    ...
    direct_costs: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Direct Costs (Include only if Direct Cost tool is turned off.)")
    __properties: ClassVar[List[str]] = ["cost_code_id", "line_item_type_id", "original_budget_amount", "uom", "quantity", "unit_cost", "calculation_strategy", "direct_costs"]
