...
class RFIUpdateBody(BaseModel):
    """
    RFIUpdateBody
    """ # noqa: E501
    rfi: RFIUpdateBodyRfi
    __properties: ClassVar[List[str]] = ["rfi"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rfi": RFIUpdateBodyRfi.from_dict(obj["rfi"]) if obj.get("rfi") is not None else None
        })
        return _obj
