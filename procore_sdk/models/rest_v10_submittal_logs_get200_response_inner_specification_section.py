...
class RestV10SubmittalLogsGet200ResponseInnerSpecificationSection(BaseModel):
    """
    RestV10SubmittalLogsGet200ResponseInnerSpecificationSection
    """ # noqa: E501
    id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    section: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "description", "section"]
