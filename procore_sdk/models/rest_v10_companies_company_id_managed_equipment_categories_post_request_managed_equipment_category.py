...
class RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequestManagedEquipmentCategory(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentCategoriesPostRequestManagedEquipmentCategory
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the category")
    is_active: Optional[StrictBool] = Field(default=None, description="If the category is active")
