...
class ChecklistSectionItem1ObservationsInner(BaseModel):
    """
    ...
    type: Optional[ChecklistSectionItem1ObservationsInnerType] = None
    assignee: Optional[RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfCreatedBy] = None
    created_by: Optional[RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfCreatedBy] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "number", "status", "title", "type", "assignee", "created_by"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "type": ChecklistSectionItem1ObservationsInnerType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "assignee": RestV10ProjectsProjectIdChecklistListTemplatesPost201ResponseAllOfCreatedBy.from_dict(obj["assignee"]) if obj.get("assignee") is not None else None,
