...
class RestV11ProjectsProjectIdSubmittalsIdWorkflowDataGet200ResponseApproversInner(BaseModel):
    """
    RestV11ProjectsProjectIdSubmittalsIdWorkflowDataGet200ResponseApproversInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "attachment_ids", "company_name", "name", "response_required"]
