...
class RequisitionChangeOrderItem(BaseModel):
    """
    ...
    materials_presently_stored: Optional[StrictStr] = Field(default=None, description="The amount of materials presently stored (amount accounting only)")
    ...
    work_completed_this_period_quantity: Optional[StrictStr] = Field(default=None, description="Work completed this period quantity (unit accounting only)")
