...
class RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInnerVerificationMethod(BaseModel):
    """
    RestV10ProjectsProjectIdActionPlansPlanTemplateItemAssigneesGet200ResponseInnerVerificationMethod
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Action Plan Verification Method ID")
    active: Optional[StrictBool] = Field(default=None, description="Flag indicating if Action Plan Verification Method is active")
    name: Optional[StrictStr] = Field(default=None, description="Name of the Action Plan Verification Method")
    source_key: Optional[StrictStr] = Field(default=None, description="Internal Translation Key")
    __properties: ClassVar[List[str]] = ["id", "active", "name", "source_key"]
