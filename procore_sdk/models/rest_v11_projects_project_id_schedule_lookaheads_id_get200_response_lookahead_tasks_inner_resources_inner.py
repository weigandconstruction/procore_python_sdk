...
class RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerResourcesInner(BaseModel):
    """
    RestV11ProjectsProjectIdScheduleLookaheadsIdGet200ResponseLookaheadTasksInnerResourcesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    company_id: Optional[StrictInt] = None
    deleted_at: Optional[datetime] = None
    project_id: Optional[StrictInt] = None
    source_uid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "company_id", "deleted_at", "project_id", "source_uid"]
