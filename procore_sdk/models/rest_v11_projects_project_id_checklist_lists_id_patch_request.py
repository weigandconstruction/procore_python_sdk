...
class RestV11ProjectsProjectIdChecklistListsIdPatchRequest(BaseModel):
    """
    RestV11ProjectsProjectIdChecklistListsIdPatchRequest
    """ # noqa: E501
    list: RestV11ProjectsProjectIdChecklistListsIdPatchRequestList
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": RestV11ProjectsProjectIdChecklistListsIdPatchRequestList.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
