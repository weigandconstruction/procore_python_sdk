...
class RestV10BudgetViewSnapshotsPost202Response(BaseModel):
    """
    RestV10BudgetViewSnapshotsPost202Response
    """ # noqa: E501
    data: Optional[RestV10BudgetViewSnapshotsPost202ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RestV10BudgetViewSnapshotsPost202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
