...
class NormalView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "abbreviated_name", "address", "attachments", "authorized_bidder", "business_id", "business_phone", "business_register", "city", "company", "country_code", "created_at", "email_address", "fax_number", "is_active", "is_connected", "labor_union", "license_number", "logo", "mobile_phone", "non_union_prevailing_wage", "notes", "origin_code", "origin_data", "origin_id", "prequalified", "primary_contact", "project_ids", "state_code", "synced_to_erp", "trade_name", "union_member", "updated_at", "vendor_group", "website", "zip"]
