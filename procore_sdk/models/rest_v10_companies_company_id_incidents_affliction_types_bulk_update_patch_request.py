...
class RestV10CompaniesCompanyIdIncidentsAfflictionTypesBulkUpdatePatchRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdIncidentsAfflictionTypesBulkUpdatePatchRequest
    """ # noqa: E501
    affliction_type: RestV10CompaniesCompanyIdIncidentsAfflictionTypesBulkUpdatePatchRequestAfflictionType
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affliction_type": RestV10CompaniesCompanyIdIncidentsAfflictionTypesBulkUpdatePatchRequestAfflictionType.from_dict(obj["affliction_type"]) if obj.get("affliction_type") is not None else None
        })
        return _obj
