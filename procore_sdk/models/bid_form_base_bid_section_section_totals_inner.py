...
class BidFormBaseBidSectionSectionTotalsInner(BaseModel):
    """
    Base Bid Columns
    """ # noqa: E501
    ...
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total of all base bid items")
    __properties: ClassVar[List[str]] = ["bid_id", "vendor_id", "vendor_name", "total"]
