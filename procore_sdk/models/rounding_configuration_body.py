...
class RoundingConfigurationBody(BaseModel):
    """
    RoundingConfigurationBody
    """ # noqa: E501
    rounding_configuration: RoundingConfigurationBodyRoundingConfiguration
    __properties: ClassVar[List[str]] = ["rounding_configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rounding_configuration": RoundingConfigurationBodyRoundingConfiguration.from_dict(obj["rounding_configuration"]) if obj.get("rounding_configuration") is not None else None
        })
        return _obj
