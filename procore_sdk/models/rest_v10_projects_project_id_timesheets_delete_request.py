...
class RestV10ProjectsProjectIdTimesheetsDeleteRequest(BaseModel):
    """
    RestV10ProjectsProjectIdTimesheetsDeleteRequest
    """ # noqa: E501
    ids: Optional[List[StrictInt]] = Field(default=None, description="IDs of Timesheets to be deleted")
