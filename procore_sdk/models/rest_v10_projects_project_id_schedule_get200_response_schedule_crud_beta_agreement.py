...
class RestV10ProjectsProjectIdScheduleGet200ResponseScheduleCrudBetaAgreement(BaseModel):
    """
    RestV10ProjectsProjectIdScheduleGet200ResponseScheduleCrudBetaAgreement
    """ # noqa: E501
    signed: Optional[StrictBool] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["signed", "version"]
