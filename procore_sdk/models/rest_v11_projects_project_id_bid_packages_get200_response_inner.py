...
class RestV11ProjectsProjectIdBidPackagesGet200ResponseInner(BaseModel):
    """
    ...
    number: Optional[StrictInt] = Field(default=None, description="Package Number")
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "bid_due_date", "number", "title", "submitted_bids_count"]
