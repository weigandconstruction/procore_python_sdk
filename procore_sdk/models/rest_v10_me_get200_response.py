...
class RestV10MeGet200Response(BaseModel):
    """
    RestV10MeGet200Response
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    login: Optional[StrictStr] = Field(default=None, description="The email address that the user uses to log into Procore.")
