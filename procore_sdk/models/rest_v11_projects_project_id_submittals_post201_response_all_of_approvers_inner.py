...
class RestV11ProjectsProjectIdSubmittalsPost201ResponseAllOfApproversInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["approver_type", "comment", "distributed", "response", "returned_date", "sent_date", "due_date", "response_required", "user", "attachments", "submittal_associated_attachment_ids", "workflow_group_number", "id"]
