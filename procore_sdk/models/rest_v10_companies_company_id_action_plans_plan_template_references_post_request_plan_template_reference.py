...
class RestV10CompaniesCompanyIdActionPlansPlanTemplateReferencesPostRequestPlanTemplateReference(BaseModel):
    """
    RestV10CompaniesCompanyIdActionPlansPlanTemplateReferencesPostRequestPlanTemplateReference
    """ # noqa: E501
    plan_template_item_id: StrictInt = Field(description="ID of the associated Template Item")
    type: StrictStr = Field(description="Company Action Plan Template Reference Type")
