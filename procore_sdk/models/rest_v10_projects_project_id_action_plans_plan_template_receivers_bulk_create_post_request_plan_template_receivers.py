...
class RestV10ProjectsProjectIdActionPlansPlanTemplateReceiversBulkCreatePostRequestPlanTemplateReceivers(BaseModel):
    """
    ...
    party_ids: List[StrictInt] = Field(description="Array of Party IDs")
    __properties: ClassVar[List[str]] = ["plan_template_id", "party_ids"]
