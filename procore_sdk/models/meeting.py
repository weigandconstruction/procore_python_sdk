...
class Meeting(BaseModel):
    ...
    starts_at: StrictStr = Field(description="The Start Time of the Meeting")
    ends_at: StrictStr = Field(description="The Finish Time of the Meeting")
    ...
    is_draft: Optional[StrictBool] = Field(default=None, description="The Draft status of the Meeting")
    ...
    __properties: ClassVar[List[str]] = ["position", "title", "location", "minutes", "overview", "occurred", "starts_at", "ends_at", "time_zone", "is_private", "conclusion", "is_draft", "attendees", "drawing_revision_ids", "file_version_ids", "form_ids", "image_ids", "upload_ids"]
