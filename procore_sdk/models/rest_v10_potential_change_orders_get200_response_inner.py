...
class RestV10PotentialChangeOrdersGet200ResponseInner(BaseModel):
    """
    ...
    created_by_id: Optional[StrictInt] = Field(default=None, description="Created by id")
    ...
    schedule_impact_amount: Optional[StrictInt] = Field(default=None, description="Schedule Impact")
    change_order_request_id: Optional[StrictInt] = Field(default=None, description="Change Order Request")
    executed: Optional[StrictBool] = Field(default=False, description="Executed")
    ...
    __properties: ClassVar[List[str]] = ["id", "contract_id", "created_at", "created_by_id", "deleted_at", "due_date", "invoiced_date", "number", "paid_date", "reviewed_at", "status", "title", "updated_at", "revision", "change_reason", "schedule_impact_amount", "change_order_request_id", "executed", "grand_total", "change_order_request_title", "change_order_package_title", "potential_change_order_acronym_number", "change_order_request_acronym_number", "change_order_package_acronym_number", "change_order_tiers", "currency_configuration", "custom_fields"]
