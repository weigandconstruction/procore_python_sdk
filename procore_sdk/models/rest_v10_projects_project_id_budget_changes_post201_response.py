...
class RestV10ProjectsProjectIdBudgetChangesPost201Response(BaseModel):
    """
    RestV10ProjectsProjectIdBudgetChangesPost201Response
    """ # noqa: E501
    data: Optional[RestV10ProjectsProjectIdBudgetChangesPost201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": RestV10ProjectsProjectIdBudgetChangesPost201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
