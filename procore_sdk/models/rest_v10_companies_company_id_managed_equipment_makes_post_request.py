...
class RestV10CompaniesCompanyIdManagedEquipmentMakesPostRequest(BaseModel):
    """
    RestV10CompaniesCompanyIdManagedEquipmentMakesPostRequest
    """ # noqa: E501
    managed_equipment_make: RestV10CompaniesCompanyIdManagedEquipmentMakesPostRequestManagedEquipmentMake
    __properties: ClassVar[List[str]] = ["managed_equipment_make"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managed_equipment_make": RestV10CompaniesCompanyIdManagedEquipmentMakesPostRequestManagedEquipmentMake.from_dict(obj["managed_equipment_make"]) if obj.get("managed_equipment_make") is not None else None
        })
        return _obj
