...
class RestV10BimModelsGet200ResponseInnerOneOf(BaseModel):
    """
    BIM Model
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "auto_publish", "project_id", "revisions_count", "web_url", "created_at", "updated_at", "current_revision_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if current_revision_id (nullable) is None
        # and model_fields_set contains the field
        if self.current_revision_id is None and "current_revision_id" in self.model_fields_set:
            _dict['current_revision_id'] = None
