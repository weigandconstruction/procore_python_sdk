...
class RestV10ProjectsProjectIdUsersIdActionsAddPostRequest(BaseModel):
    """
    RestV10ProjectsProjectIdUsersIdActionsAddPostRequest
    """ # noqa: E501
    user: Optional[RestV10ProjectsProjectIdUsersIdActionsAddPostRequestUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": RestV10ProjectsProjectIdUsersIdActionsAddPostRequestUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
