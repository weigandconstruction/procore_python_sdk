...
class ManagedEquipmentType(BaseModel):
    """
    Equipment Type
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID")
    name: Optional[StrictStr] = Field(default=None, description="Name of the equipment Type")
    managed_equipment_category_id: Optional[StrictInt] = Field(default=None, description="Equipment category ID the type is associated with")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Date the equipment type was updated")
    created_at: Optional[datetime] = Field(default=None, description="Date the equipment type was created")
    deleted_at: Optional[datetime] = Field(default=None, description="Date the equipment type was deleted")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "managed_equipment_category_id", "company_id", "is_active", "updated_at", "created_at", "deleted_at", "managed_equipment_category", "created_by"]
