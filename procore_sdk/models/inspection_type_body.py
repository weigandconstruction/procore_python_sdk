...
class InspectionTypeBody(BaseModel):
    """
    InspectionTypeBody
    """ # noqa: E501
    inspection_type: InspectionType3
    __properties: ClassVar[List[str]] = ["inspection_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inspection_type": InspectionType3.from_dict(obj["inspection_type"]) if obj.get("inspection_type") is not None else None
        })
        return _obj
