...
class ObservationOrigin1(BaseModel):
    """
    ...
    payload: Optional[OriginPayload1] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "payload": OriginPayload1.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
