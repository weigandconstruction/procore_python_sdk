...
class RestV10ProjectsProjectIdDirectoryFilterOptionsPermissionTemplatesGet200ResponseInner(BaseModel):
    """
    RestV10ProjectsProjectIdDirectoryFilterOptionsPermissionTemplatesGet200ResponseInner
    """ # noqa: E501
    filter_value: Optional[StrictInt] = Field(default=None, description="Permission template ID")
    label: Optional[StrictStr] = Field(default=None, description="Permission template name")
