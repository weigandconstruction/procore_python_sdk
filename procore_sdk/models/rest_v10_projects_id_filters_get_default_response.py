...
class RestV10ProjectsIdFiltersGetDefaultResponse(BaseModel):
    """
    RestV10ProjectsIdFiltersGetDefaultResponse
    """ # noqa: E501
    errors: Optional[StrictStr] = Field(default=None, description="Description of the error thrown.")
