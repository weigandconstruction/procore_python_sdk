...
class CoordinationIssueSyncResponse1(BaseModel):
    """
    CoordinationIssueSyncResponse1
    """ # noqa: E501
    entities: Optional[List[CoordinationIssueSyncResponse1EntitiesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [CoordinationIssueSyncResponse1EntitiesInner.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
