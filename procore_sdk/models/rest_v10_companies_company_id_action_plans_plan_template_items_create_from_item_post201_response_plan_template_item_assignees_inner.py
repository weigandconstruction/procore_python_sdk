...
class RestV10CompaniesCompanyIdActionPlansPlanTemplateItemsCreateFromItemPost201ResponsePlanTemplateItemAssigneesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "is_holding", "role", "updated_at", "verification_method"]
