...
class RestV10CostCodesCopySubsetFromStandardListPost201Response(BaseModel):
    """
    ...
    failures: Optional[List[StrictStr]] = Field(default=None, description="An empty array")
