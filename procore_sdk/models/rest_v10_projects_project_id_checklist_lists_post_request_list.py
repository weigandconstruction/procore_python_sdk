...
class RestV10ProjectsProjectIdChecklistListsPostRequestList(BaseModel):
    """
    ...
    managed_equipment_id: Optional[StrictInt] = Field(default=None, description="The ID of the Inspection's Managed Equipment")
    ...
    __properties: ClassVar[List[str]] = ["description", "due_at", "inspection_date", "inspection_type_id", "number", "managed_equipment_id", "point_of_contact_id", "inspector_ids", "private", "responsible_contractor_id", "spec_section_id", "status", "trade_id", "distribution_member_ids", "location_id", "custom_field_%{custom_field_definition_id}"]
