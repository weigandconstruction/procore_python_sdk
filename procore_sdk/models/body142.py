...
class Body142(BaseModel):
    """
    Body142
    """ # noqa: E501
    billing_period: BillingPeriod1
    __properties: ClassVar[List[str]] = ["billing_period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "billing_period": BillingPeriod1.from_dict(obj["billing_period"]) if obj.get("billing_period") is not None else None
        })
        return _obj
