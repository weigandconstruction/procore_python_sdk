...
class RestV10ProjectsProjectIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsIdPatchRequest(BaseModel):
    """
    RestV10ProjectsProjectIdWorkBreakdownStructureSegmentsSegmentIdSegmentItemsIdPatchRequest
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Segment Item Code")
    name: Optional[StrictStr] = Field(default=None, description="Segment Item Name")
    status: Optional[StrictStr] = Field(default=None, description="Segment Item Status")
    sub_job_id: Optional[StrictInt] = Field(default=None, description="Required to update a legacy cost code for a specific sub job")
    __properties: ClassVar[List[str]] = ["code", "name", "status", "sub_job_id"]
