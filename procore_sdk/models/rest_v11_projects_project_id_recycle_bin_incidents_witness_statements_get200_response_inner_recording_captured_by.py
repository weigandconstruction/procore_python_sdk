...
class RestV11ProjectsProjectIdRecycleBinIncidentsWitnessStatementsGet200ResponseInnerRecordingCapturedBy(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "locale", "login"]
